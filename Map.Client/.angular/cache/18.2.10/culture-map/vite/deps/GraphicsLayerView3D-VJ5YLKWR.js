...
var m2 = class extends l(y2) {
  ...
  initialize() {
    ...
    })), this.addResolvingPromise(this.processor.initializePromise), this.addHandles(this.layer.on("graphic-update", (e2) => this.processor.graphicsCore.graphicUpdateHandler(e2))), this.addResolvingPromise(l2(this).then((e2) => this.fullExtentInLocalViewSpatialReference = e2)), this.layer.internal ? this.notifyChange("updating") : this.addHandles(p(() => this.view?.basemapTerrain?.ready, () => () => this.notifyChange("updating"), {
      once: true
    }));
  }
  destroy() {
  ...
  elevationAlignPointsInFeatures(e2, s2) {
    return __async(this, null, function* () {
      const {
        processor: t2
      } = this;
      if (null == t2?.graphics3DGraphics) throw new s("graphicslayerview3d:missing-processor", "A Graphics3D processor is needed to resolve graphics elevation.");
      const {
        graphics3DGraphics: i
      } = t2, o = (e3) => "number" == typeof e3 ? i.get(e3) : void 0;
      return m(this.view, this.layer, o, e2, s2);
    });
  }
  queryForSymbologySnapping(e2, r2) {
    return __async(this, null, function* () {
...
e([y()], m2.prototype, "loadedGraphics", null), e([y({
  readOnly: true
})], m2.prototype, "legendEnabled", null), e([y()], m2.prototype, "layer", void 0), e([y({
  readOnly: true
})], m2.prototype, "processor", void 0), e([y({
  readOnly: true
})], m2.prototype, "visibleAtCurrentScale", null), e([y()], m2.prototype, "_slicePlaneEnabled", void 0), e([y({
  type: Boolean
})], m2.prototype, "slicePlaneEnabled", null), m2 = e([a("esri.views.3d.layers.GraphicsLayerView3D")], m2);
var g = m2;
export {
  g as default
};
//# sourceMappingURL=GraphicsLayerView3D-VJ5YLKWR.js.map
