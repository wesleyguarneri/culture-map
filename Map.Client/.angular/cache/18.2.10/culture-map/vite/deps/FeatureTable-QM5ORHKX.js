...
var t2 = class extends S {
  constructor(o4) {
    super(o4), this.sortAscending = true, this.sortDescending = true;
  }
};
e([y({
  type: Boolean,
  nonNullable: true
})], t2.prototype, "sortAscending", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], t2.prototype, "sortDescending", void 0), t2 = e([a2("esri.widgets.FeatureTable.ColumnMenuVisibleElements")], t2);
var c3 = t2;
...
var c4 = {
  sorter: `${l2}__sorter`,
  headerContent: `${l2}__header-content`,
  headerLabel: `${l2}__header-label`,
  headerMenuIcon: `${l2}__header-menu-icon`
};
var a5 = class extends o2.EventedAccessor {
  constructor(e11) {
    super(e11), this._menuIsOpen = false, this.autoWidth = false, this.cellValueFormatFunction = (e12) => {
      const {
        rowData: t4,
        value: o4
      } = e12, {
        formatFunction: n12
      } = this, i6 = j.sanitize(o4);
      if (n12 && t4) {
        const {
          index: e13,
          item: {
      ...
      return i6;
    }, this.direction = null, this.fieldName = null, this.flexGrow = 1, this.footerRenderFunction = null, this.formatFunction = null, this.frozen = false, this.frozenToEnd = false, this.grid = null, this.headerRenderFunction = (e12) => {
      const {
        root: t4
      } = e12, o4 = this.createHeaderContent();
      this.removeCellContent(t4), t4.appendChild(o4);
    }, this.hidden = false, this.icon = null, this.initialSortPriority = null, this.label = null, this.menuConfig = null, this.messages = null, this.messagesCommon = null, this.messagesURIUtils = null, this.renderFunction = ({
      root: e12,
      column: t4,
      rowData: o4
    }) => {
      const n12 = this.getCellValue(t4, o4), i6 = this.cellValueFormatFunction({
        column: t4,
        rowData: o4,
        value: n12
      });
      let r7 = null;
      r7 = i6 instanceof HTMLElement ? i6 : a3(this.messagesURIUtils, i6), this.removeCellContent(e12), r7 instanceof HTMLElement ? e12.appendChild(r7) : null != r7 && (e12.innerHTML = r7.toString());
    }, this.resizable = true, this.sortable = false, this.store = null, this.textAlign = "start", this.textWrap = false, this.timeZone = null, this.timeZoneName = null, this.visibleElements = null, this.width = 200;
  }
  initialize() {
    const {
      fieldName: e11
    } = this;
    this._set("sortElement", this.createSortElement()), this.sortElement.setAttribute("path", e11), this.addHandles([d2(() => this.direction, (e12) => {
      const {
        sortElement: t4
      } = this;
      this.sortable && t4 && (e12 ? this.sortElement.direction !== e12 && t4.setAttribute("direction", e12) : t4.removeAttribute("direction"));
    }), d2(() => this.hidden, () => this.closeMenu()), d2(() => this.fieldName, (e12) => {
      const {
        sortElement: t4
      } = this;
      t4 && t4.path !== e12 && t4.setAttribute("path", e12);
    }), d2(() => this.effectiveLabel, (e12) => {
      const {
        sortElement: t4
      } = this;
      t4 && t4.textContent !== e12 && (t4.setAttribute("title", e12), t4.textContent = e12);
    })]);
  }
  get customMenuItems() {
    return this.menuConfig?.items?.map(({
      disabled: e11,
      hidden: t4,
      icon: o4,
      iconClass: n12,
      ...
      selected: s10,
      clickFunction: r7
    }) => this.createCalciteDropdownItem({
      disabled: e11,
      hidden: t4,
      iconClass: n12,
      iconStart: o4,
  ...
  get defaultMenuItems() {
    ...
    const e11 = this.messages, t4 = [], o4 = this.visibleElements?.columnMenuItems;
    if (false !== o4?.sortAscending) {
      const o5 = this.createCalciteDropdownItem({
        iconStart: "sort-ascending-arrow",
        textContent: e11?.sortAsc,
        onclick: () => this.direction = "asc"
      });
      t4.push(o5);
    }
    if (false !== o4?.sortDescending) {
      const o5 = this.createCalciteDropdownItem({
        iconStart: "sort-descending-arrow",
        textContent: e11?.sortDesc,
        onclick: () => this.direction = "desc"
      });
      t4.push(o5);
    }
    return t4;
  ...
  get effectiveLabel() {
    return j.sanitize(this.label || this.fieldName);
  }
  get iconNode() {
    const {
      icon: e11
    } = this;
    return e11 ? this.createCalciteIcon({
      icon: e11
    }) : null;
  }
  set invalid(e11) {
    this._set("invalid", e11), this.grid?.generateCellPartNames();
  }
  get menu() {
    const {
      customMenuItems: e11,
      defaultMenuItems: t4,
      menuConfig: o4
    } = this, n12 = !!o4?.open, i6 = this.createCalciteAction({
      icon: o4?.icon ?? "ellipsis",
      text: this.messages?.menu ?? "",
      slot: "trigger"
    }), s10 = document.createElement("calcite-dropdown");
    if (s10.maxItems = o4?.maxItems ?? 4, s10.placement = "top-end", s10.overlayPositioning = "fixed", s10.scale = o4?.scale ?? "m", n12 && (s10.open = n12, this._menuIsOpen = true), s10.appendChild(i6), s10.addEventListener("calciteDropdownOpen", () => this._menuIsOpen = true), s10.addEventListener("calciteDropdownClose", () => this._menuIsOpen = false), s10.onkeydown = this._stopPropagationOnSelect, s10.addEventListener("mousewheel", (e12) => {
      e12.stopPropagation();
    }), t4.length) {
      const e12 = s10.appendChild(document.createElement("calcite-dropdown-group"));
      e12.selectionMode = "none", e12.append(...t4);
    }
    if (e11.length) {
      const t5 = s10.appendChild(document.createElement("calcite-dropdown-group"));
      t5.selectionMode = o4?.selectionMode ?? "none", t5.append(...e11);
    }
    return s10;
  }
  get menuItems() {
  ...
  getCellValue(e11, t4) {
    return e11.path && t4?.item ? t4.item[e11.path] : "";
  }
  createSortElement() {
    const {
      effectiveLabel: e11,
      direction: t4,
      fieldName: o4,
      initialSortPriority: n12
    } = this, i6 = document.createElement("vaadin-grid-sorter");
    return i6.classList.add(c4.sorter), i6.setAttribute("path", o4), i6.setAttribute("title", e11), i6.textContent = e11, t4 && i6.setAttribute("direction", t4), null != n12 && (i6._initialOrder = n12), i6.addEventListener("direction-changed", () => {
      this.direction !== i6.direction && this._set("direction", i6.direction);
    }), i6;
  }
  createCalciteAction(e11) {
    const t4 = document.createElement("calcite-action"), {
      className: o4,
      disabled: n12,
      icon: i6,
      label: s10,
    ...
    return t4.className = o4 ?? "", t4.disabled = !!n12, t4.icon = i6 ?? "", t4.label = s10 ?? "", t4.scale = r7 ?? "s", t4.slot = l8 ?? "", t4.text = t4.title = c5 ?? "", t4.textEnabled = !!a10, t4.onclick = d8 ?? null, t4;
  }
  createCalciteButton(e11) {
    const t4 = document.createElement("calcite-button"), {
      appearance: o4,
      className: n12,
      disabled: i6,
      iconEnd: s10,
    ...
    return t4.className = n12 ?? "", t4.scale = a10 ?? "s", t4.appearance = o4 ?? "transparent", t4.disabled = !!i6, t4.iconEnd = s10 ?? "", r7 && (t4.iconFlipRtl = r7), t4.loading = !!l8, t4.textContent = t4.title = d8 ?? "", t4.onclick = c5 ?? null, t4;
  }
  createCalciteDropdownItem(e11) {
    const t4 = document.createElement("calcite-dropdown-item"), {
      disabled: o4,
      hidden: n12,
      iconClass: i6,
      iconStart: s10,
    ...
    if (i6 && !s10) {
      const e12 = document.createElement("span"), o5 = document.createElement("span");
      o5.classList.add(c4.headerMenuIcon, i6), e12.textContent = e12.title = d8, e12.insertBefore(o5, e12.firstChild), t4.appendChild(e12);
    } else t4.iconStart = s10 ?? "", t4.textContent = t4.title = d8;
    return t4.disabled = !!o4, t4.hidden = "function" == typeof n12 ? n12() : !!n12, t4.selected = !!a10, l8 && (t4.addEventListener("calciteDropdownItemSelect", l8), t4.onkeydown = this._stopPropagationOnSelect), t4;
  }
  createCalciteIcon(e11) {
    const {
      effectiveLabel: t4
    } = this, {
      icon: o4,
      scale: n12,
      textLabel: i6
    } = e11, s10 = document.createElement("calcite-icon"), r7 = i6 ?? t4;
    return s10.icon = o4, s10.scale = n12 ?? "s", s10.textLabel = r7, s10.title = r7, s10;
  }
  createHeaderContent() {
    const {
      effectiveLabel: e11,
    ...
    if (o4.classList.add(c4.headerContent), t4 && o4.appendChild(t4), this.sortable) o4.appendChild(this.sortElement);
    else if ("" !== e11) {
      const t5 = document.createElement("div");
      t5.classList.add(c4.headerLabel);
      const n12 = t5.appendChild(document.createElement("span"));
      n12.textContent = e11, n12.setAttribute("title", e11), o4.appendChild(t5);
    }
    return this.menuIsVisible && o4.appendChild(this.menu), o4;
  }
  removeCellContent(e11) {
    if (e11 && e11.firstChild) try {
      for (; e11?.firstChild; ) e11?.removeChild(e11.firstChild);
    } catch (t4) {
    }
  }
  openMenu() {
    this.menuIsVisible && (this.menu.open = true, this.menuItems[0]?.setFocus());
  }
  sort() {
    this.sortable && this.sortElement?.click();
  }
  _stopPropagationOnSelect(e11) {
    "Enter" !== e11.key && " " !== e11.key || e11.stopPropagation();
  }
};
e([y()], a5.prototype, "_menuIsOpen", void 0), e([y()], a5.prototype, "autoWidth", void 0), e([y()], a5.prototype, "cellValueFormatFunction", void 0), e([y()], a5.prototype, "customMenuItems", null), e([y()], a5.prototype, "defaultMenuItems", null), e([y()], a5.prototype, "direction", void 0), e([y()], a5.prototype, "effectiveLabel", null), e([y({
  constructOnly: true
})], a5.prototype, "fieldName", void 0), e([y()], a5.prototype, "flexGrow", void 0), e([y()], a5.prototype, "footerRenderFunction", void 0), e([y()], a5.prototype, "formatFunction", void 0), e([y()], a5.prototype, "frozen", void 0), e([y()], a5.prototype, "frozenToEnd", void 0), e([y()], a5.prototype, "grid", void 0), e([y()], a5.prototype, "iconNode", null), e([y()], a5.prototype, "invalid", null), e([y()], a5.prototype, "headerRenderFunction", void 0), e([y()], a5.prototype, "hidden", void 0), e([y()], a5.prototype, "icon", void 0), e([y({
  constructOnly: true
})], a5.prototype, "initialSortPriority", void 0), e([y()], a5.prototype, "label", void 0), e([y()], a5.prototype, "menu", null), e([y()], a5.prototype, "menuItems", null), e([y()], a5.prototype, "menuConfig", void 0), e([y()], a5.prototype, "menuIsOpen", null), e([y()], a5.prototype, "menuIsVisible", null), e([y()], a5.prototype, "messages", void 0), e([y()], a5.prototype, "messagesCommon", void 0), e([y()], a5.prototype, "messagesURIUtils", void 0), e([y()], a5.prototype, "renderFunction", void 0), e([y()], a5.prototype, "resizable", void 0), e([y()], a5.prototype, "sortable", void 0), e([y({
  readOnly: true
})], a5.prototype, "sortElement", void 0), e([y()], a5.prototype, "store", void 0), e([y()], a5.prototype, "textAlign", void 0), e([y()], a5.prototype, "textWrap", void 0), e([y()], a5.prototype, "timeZone", void 0), e([y()], a5.prototype, "timeZoneName", void 0), e([y()], a5.prototype, "visibleElements", void 0), e([y()], a5.prototype, "width", void 0), a5 = e([a2("esri.widgets.FeatureTable.Grid.Column")], a5);
var d5 = a5;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/tableUtils.js
var e8 = {
  action: "EsriFeatureTableActionColumn",
  attachments: "EsriFeatureTableAttachmentsColumn",
  relationship: "EsriFeatureTableRelationshipColumn"
};
function t3(e11) {
  return null != e11 && "object" == typeof e11 && "createQuery" in e11 && "getField" in e11 && "queryFeatureCount" in e11 && "queryFeatures" in e11 && "queryObjectIds" in e11 && "capabilities" in e11 && "fields" in e11 && "fieldsIndex" in e11 && "id" in e11 && "load" in e11 && "objectIdField" in e11 && "type" in e11 && "when" in e11;
}
function i4(e11) {
  return t3(e11) && "queryAttachments" in e11;
}
function r3(e11) {
  return t3(e11) && "editingEnabled" in e11 && "applyEdits" in e11;
}
function a6(e11) {
  return t3(e11) && "relationships" in e11 && "queryRelatedFeatures" in e11 && "queryRelatedFeaturesCount" in e11;
}
function u(e11) {
  return null != e11 && "object" == typeof e11 && "type" in e11 && null !== e11.type && ("column" === e11.type || "field" === e11.type || "group" === e11.type);
}
function l3(e11) {
  return null != e11 && "object" == typeof e11 && "type" in e11 && "map-image" === e11.type;
}
function s5(e11, n12, {
  relatedTableId: t4
}) {
  if (!n12?.map) return;
  const i6 = "scene" === e11.type && e11.associatedLayer ? e11.associatedLayer.url : e11.url, r7 = (n13) => !(!a6(n13) || n13 === e11) && ("sublayer" === n13.type && n13.layer?.url === e11.url ? n13.id === t4 : i6 === n13.url && n13.layerId === t4);
  if ("sublayer" === e11.type && l3(e11.parent)) {
    const n13 = (n14) => a6(n14) && n14 !== e11 && n14.id === t4, i7 = e11.parent, r8 = i7.sublayers?.find(n13) || i7.subtables?.find(n13);
    if (a6(r8)) return r8;
  }
  const u4 = [...n12.map.allLayers, ...n12.map.allTables];
  let s10 = null;
  for (const a10 of u4) if (l3(a10)) {
    const e12 = a10.sublayers?.find(r7) || a10.subtables?.find(r7);
    if (e12) {
      s10 = e12;
      break;
    }
  ...
  return a6(s10) ? s10 : void 0;
}

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/ActionColumn.js
var s6 = {
  action: "esri-column__action"
};
var n7 = class extends d5 {
  constructor(o4) {
    super(o4), this.autoWidth = false, this.callback = () => {
    }, this.fieldName = e8.action, this.flexGrow = 0, this.frozenToEnd = true, this.disabled = null, this.headerRenderFunction = () => {
    }, this.icon = "pencil", this.renderFunction = ({
      root: o5,
      rowData: t4
    }) => {
      if (!t4) return;
      const {
        ...
        icon: a10,
        effectiveLabel: d8
      } = this, c5 = n12 instanceof Function ? n12({
        feature: i6,
        index: e11
      }) : !!n12, l8 = (o6) => {
        o6.stopPropagation(), r7({
          index: e11,
          feature: i6,
          native: o6
        });
      ...
      if (o5.firstChild) {
        const t5 = o5.firstChild;
        return t5.disabled = c5, t5.icon = a10, t5.text = d8, void (t5.onclick = l8);
      }
      const p8 = this.createCalciteAction({
        className: s6.action,
        disabled: c5,
        icon: a10,
        text: d8,
      ...
      this.removeCellContent(o5), o5.appendChild(p8);
    }, this.resizable = false, this.sortable = false, this.width = "50px";
  }
};
e([y({
  readOnly: true
})], n7.prototype, "autoWidth", void 0), e([y()], n7.prototype, "callback", void 0), e([y({
  readOnly: true
})], n7.prototype, "fieldName", void 0), e([y({
  readOnly: true
})], n7.prototype, "flexGrow", void 0), e([y()], n7.prototype, "frozenToEnd", void 0), e([y()], n7.prototype, "disabled", void 0), e([y()], n7.prototype, "headerRenderFunction", void 0), e([y()], n7.prototype, "icon", void 0), e([y()], n7.prototype, "renderFunction", void 0), e([y({
  readOnly: true
})], n7.prototype, "resizable", void 0), e([y({
  readOnly: true
})], n7.prototype, "sortable", void 0), e([y({
  readOnly: true
})], n7.prototype, "width", void 0), n7 = e([a2("esri.widgets.FeatureTable.ActionColumn")], n7);
var a7 = n7;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/AttachmentsColumn.js
var a8 = class extends d5 {
  constructor(t4) {
    super(t4), this.fieldName = e8.attachments, this.icon = "attachment", this.renderFunction = ({
      root: t5,
      rowData: e11
    }) => {
      const o4 = e11?.item?.attachments?.length ?? 0;
      t5.textContent = o4.toString();
    }, this.sortable = false, this.textAlign = "center";
  }
  get effectiveLabel() {
    return j.sanitize(this.label || this.messages?.attachments || this.fieldName);
  }
};
e([y()], a8.prototype, "effectiveLabel", null), e([y()], a8.prototype, "fieldName", void 0), e([y()], a8.prototype, "icon", void 0), e([y()], a8.prototype, "renderFunction", void 0), e([y({
  readOnly: true
})], a8.prototype, "sortable", void 0), e([y({
  readOnly: true
})], a8.prototype, "textAlign", void 0), a8 = e([a2("esri.widgets.FeatureTable.AttachmentsColumn")], a8);
var n8 = a8;
...
var l4 = class extends d5 {
  constructor(t4) {
    super(t4), this.editInfo = null, this.cellValueValidatorFunction = ({
      oldValue: t5,
      value: e11
    }) => t5 !== e11, this.editable = true, this.headerRenderFunction = (t5) => {
      const {
        root: e11
      } = t5, o4 = this.createHeaderContent();
      this.tableEditingEnabled && !this.effectiveEditable && o4.prepend(this._lockIconNode), this.removeCellContent(e11), e11.appendChild(o4);
      ...
      const n12 = this.getCellValue(e11, o4), i6 = this.createInputElement({
        root: t5,
        column: e11,
        rowData: o4,
        value: n12
      ...
      a10.appendChild(i6), this.removeCellContent(t5), t5.appendChild(a10), i6.focus(), i6 instanceof HTMLInputElement && i6.select();
    }, this.loadingMessage = "", this.inputType = "text", this.maxLength = null, this.parseInputValueFunction = ({
      inputs: t5
    }) => t5?.length || 1 !== t5.length || Array.isArray(t5[0].value) ? null : t5[0].value, this.renderFunction = (t5) => {
      const {
        root: e11,
        column: o4,
        rowData: n12
      ...
      if (i6) return;
      const l8 = this.getCellValue(o4, n12), s10 = this.cellValueFormatFunction({
        column: o4,
        rowData: n12,
        value: l8
      });
      let u4 = null;
      e11.onclick = () => e11.focus(), e11.ondblclick = () => this.inputRenderFunction(t5), e11.ontouchend = () => this.inputRenderFunction(t5);
      const c5 = this.grid?.getSlotElementByName(e11.slot), d8 = c5?.parentElement;
      d8 && !d8.onkeydown && (d8.onkeydown = (e12) => {
        e12.key !== r4.showInput || this.editInfo || this.inputRenderFunction(t5), e12.key === r4.hideInput && this.editInfo && this.cancel();
      }), null != l8 && null != s10 ? e11.title = s10.toString() : e11.title && e11.removeAttribute("title"), u4 = s10 instanceof HTMLElement ? s10 : a3(this.messagesURIUtils, s10), this.removeCellContent(e11), u4 instanceof HTMLElement ? e11.appendChild(u4) : null != u4 && (e11.innerHTML = u4.toString());
    }, this.required = false, this.tableEditingEnabled = false, this.updateRowItemFunction = ({
      rowData: t5,
      column: o4,
      value: n12
    }) => {
      n2(t5), o4.path && t5?.item && (t5.item[o4.path] = n12);
    }, this.updateStoreItemFunction = (_0) => __async(this, [_0], function* ({
      rowData: t5,
      column: o4,
      value: n12
    }) {
      n2(t5), o4.path && (yield this.store?.updateItem({
        index: t5.index,
        name: o4.path,
        value: n12
      }));
  ...
  cancel() {
    ...
    this.onEditComplete(), this.renderFunction({
      column: e11,
      root: o4,
      rowData: n12
    });
  ...
  createInputElement({
    ...
    return null != this.maxLength && (e11.maxLength = this.maxLength), e11.type = this.inputType, e11.value = t4, e11.onblur = () => {
      e11.onblur = null, this.submit();
    }, e11;
  }
  createDateComponent() {
    const t4 = document.createElement("calcite-input-date-picker");
    return t4.focusTrapDisabled = true, t4.overlayPositioning = "fixed", t4;
  }
  createTimeComponent() {
    const t4 = document.createElement("calcite-input-time-picker");
    return t4.overlayPositioning = "fixed", t4.placement = "auto-start", t4.step = 1, t4;
  }
  createTimeZoneComponent() {
    const t4 = document.createElement("calcite-input-time-zone");
    return t4.maxItems = 4, t4.overlayPositioning = "fixed", t4;
  }
  submit() {
    return __async(this, null, function* () {
      ...
      const {
        ...
        rowData: i6,
        oldValue: a10
      } = t4, r7 = this.parseInputValueFunction({
        inputs: o4,
        column: e11,
        rowData: i6
      });
      if (!this.cellValueValidatorFunction({
        value: r7,
        oldValue: a10,
        column: e11,
        rowData: i6
        ...
        n12.textContent = this.loadingMessage;
        try {
          yield this.updateStoreItemFunction({
            rowData: i6,
            column: e11,
            value: r7
          }), this.updateRowItemFunction({
            rowData: i6,
            column: e11,
            value: r7
          }), this.onEditComplete(), this.renderFunction({
            ...
            column: e11,
            rowData: i6,
            value: this.getCellValue(e11, i6)
          });
        } catch (l8) {
          this.cancel();
        }
...
e([y()], l4.prototype, "_lockIconNode", null), e([y({
  readOnly: true
})], l4.prototype, "editInfo", void 0), e([y()], l4.prototype, "cellValueValidatorFunction", void 0), e([y()], l4.prototype, "editable", void 0), e([y()], l4.prototype, "effectiveEditable", null), e([y()], l4.prototype, "editing", null), e([y()], l4.prototype, "headerRenderFunction", void 0), e([y()], l4.prototype, "inputRenderFunction", void 0), e([y({
  constructOnly: true
})], l4.prototype, "loadingMessage", void 0), e([y()], l4.prototype, "inputType", void 0), e([y()], l4.prototype, "maxLength", void 0), e([y()], l4.prototype, "parseInputValueFunction", void 0), e([y()], l4.prototype, "renderFunction", void 0), e([y()], l4.prototype, "required", void 0), e([y()], l4.prototype, "tableEditingEnabled", void 0), e([y()], l4.prototype, "updateRowItemFunction", void 0), e([y()], l4.prototype, "updateStoreItemFunction", void 0), l4 = e([a2("esri.widgets.FeatureTable.Grid.EditorColumn")], l4);
var s7 = l4;
...
var L = "esri-column";
var O2 = {
  input: `${L}__cell-input`,
  inputContainer: `${L}__cell__input-container`
};
var j2 = E("short-date-short-time");
var R = E("short-date");
var T2 = {
  useGrouping: true,
  maximumFractionDigits: 20
};
var A = class extends s7 {
  constructor(e11) {
    super(e11), this._activeFieldInput = null, this.cellValueFormatFunction = ({
      rowData: e12,
      value: t4
    }) => {
      const {
      ...
      const {
        field: n12
      } = this, o4 = this._getDomainForFeature(e12?.item?.feature);
      if (o4) {
        const e13 = this._getComputedDomain(t4, o4);
        if ("date" === n12.type && "range" === o4.type) return this._formatDateValueForDisplay(n12, e13);
        if (pe(n12) && "range" === o4.type) {
          const e14 = this.template?.format, i7 = e14 ? i(e14) : T2;
          return l(parseFloat(t4), i7);
        }
        return H.has(n12.type) ? "range" === o4.type ? j.sanitize(T(n12, e13)) : j.sanitize(e13) : e13;
      }
      if ("date" === n12.type || H.has(n12.type)) return this._formatDateValueForDisplay(n12, t4);
      if (pe(n12)) {
        const e13 = this.template?.format, i7 = e13 ? i(e13) : T2;
        return l(parseFloat(t4), i7);
      }
      return j.sanitize(t4);
    }, this.cellValueValidatorFunction = ({
      oldValue: e12,
      value: i6
    }) => {
      const {
      ...
      if (this.effectiveRequired && (null == i6 || "" === i6)) return false;
      if (pe(n12) && Ae(n12, i6)) return n.getLogger(this).warn("value-exceeds-valid-range", "Field value exceeds valid range. Attempted edit was rejected."), false;
      if (this._isAnyDateOrTimeField) {
        const e13 = n12.type, t4 = this._effectiveRange;
        if (!$({
          type: e13,
          range: t4,
          value: i6
      ...
      return e12 !== i6;
    }, this.expressionInfos = null, this.field = null, this.formatFunction = null, this.inputRenderFunction = ({
      root: e12,
      column: i6,
      rowData: n12
    }) => {
      if (this.editInfo || !this.effectiveEditable) return;
      const o4 = this.getCellValue(i6, n12), {
        field: a10
      } = this;
      if ("big-integer" === a10.type && Ae(a10, o4)) return void n.getLogger(this).warn("value-exceeds-valid-range", "Field value is beyond supported limit. Editing is disabled for this field value.");
      const l8 = n12?.item.feature;
      if (!l8) return;
      this._activeFieldInput = this._setUpFieldInput(l8, o4);
      const r7 = document.createElement("div");
      r7.classList.add(O2.inputContainer);
      const s10 = [], u4 = "coded-value" === this._effectiveDomain?.type;
      if (this._isAnyDateOrTimeField && !u4) {
        const e13 = document.createElement("div"), t4 = this._setUpDateComponents(o4), i7 = this._setUpDateActionBar();
        t4.forEach((t5) => e13.appendChild(t5)), r7.appendChild(e13), r7.appendChild(i7), s10.push(...t4);
      } else {
        const t4 = this.createInputElement({
          root: e12,
          column: i6,
          rowData: n12,
          value: o4
        });
        r7.appendChild(t4), s10.push(t4);
      }
      this._set("editInfo", {
        column: i6,
        inputs: s10,
        ...
        rowData: n12,
        oldValue: o4
      }), this.removeCellContent(e12), e12.appendChild(r7), this._syncRowEditingState(e12, true), this.grid?.generateCellPartNames();
      const p8 = s10[0];
      p8 && (p8.focus(), p8 instanceof HTMLInputElement && p8.select());
    }, this.layer = null, this.parseInputValueFunction = ({
      inputs: e12
    }) => {
      const {
        editInfo: t4,
      ...
      if (!t4 || !e12.length) return null;
      const o4 = e12[0];
      if (this._isAnyDateOrTimeField) {
        const a11 = t4.oldValue ?? void 0;
        if ("coded-value" === this._effectiveDomain?.type) return null != o4.value ? parseFloat(o4.value) : null;
        switch (i6.type) {
          case "date-only": {
            const e13 = o4.value;
            return "" !== e13 ? e13 : null;
          ...
          case "time-only": {
            const e13 = U(o4.value);
            return "" !== e13 ? e13 : null;
          }
          case "timestamp-offset": {
            const t5 = n12 ? e12[1] : void 0, i7 = e12.at(-1);
            return D({
              oldValue: a11,
              dateComponent: o4,
              timeComponent: t5,
              timeZoneComponent: i7,
      ...
      const a10 = o4.value, {
        effectiveRequired: l8
      } = this;
      return l8 || "" !== a10 ? pe(i6) ? parseFloat(a10) : ye(i6) ? a10.trim() : a10 : null;
    }, this.sortable = true, this.store = null, this.template = null, this.updateRowItemFunction = ({
      rowData: e12,
      column: t4,
      value: i6
    }) => {
      e12 && t4.path && (e12.item.feature.attributes[t4.path] = i6);
    }, this.updateStoreItemFunction = (_0) => __async(this, [_0], function* ({
      rowData: e12,
      column: t4,
      value: i6
    }) {
      if (!e12 || !this.store || !t4.path) return;
      const n12 = e12.item.objectId, o4 = this.store.getItemIndexByObjectId(n12), a10 = o4 > -1 ? o4 : e12.index;
      yield this.store.updateItem({
        index: a10,
        name: t4.path,
        value: i6
      });
  ...
  get _effectiveDomain() {
    const e11 = this._activeFieldInput?.feature;
    return e11 ? this._getDomainForFeature(e11) : null;
  }
  get _effectiveRange() {
    return this._activeFieldInput?.range ?? {
      max: null,
      min: null
    };
  }
  ...
  get description() {
    return this.template?.description ?? this.field?.description ?? null;
  }
  get effectiveEditable() {
    const {
      editable: e11,
      field: t4,
      layer: i6,
      tableEditingEnabled: n12
    } = this;
    if (null == t4 || null == i6) return false;
    const o4 = e6(i6), a10 = i6.effectiveCapabilities ?? i6.capabilities, l8 = a10?.operations?.supportsUpdate;
    return !!(t4.editable && o4 && l8 && "oid" !== t4.type && n12) && e11;
  }
  get effectiveLabel() {
    return j.sanitize(this.label || this.alias || this.fieldName);
  }
  get effectiveRequired() {
    return !this.nullable || this._activeFieldInput?.required || this.required;
  }
  get includeTime() {
    const {
      field: e11,
    ...
    return "time-only" === e11.type || "date-only" !== e11.type && (!t4?.input || "includeTime" in t4.input && false !== t4.input.includeTime);
  }
  get loadingMessage() {
  ...
  get maxLength() {
    const {
      field: e11,
      template: t4
    } = this, i6 = e11?.length ?? -1, n12 = t4?.input && "maxLength" in t4.input ? t4.input.maxLength : null;
    return null != n12 && !isNaN(n12) && n12 >= -1 && (-1 === i6 || n12 <= i6) ? n12 : i6;
  }
  get minLength() {
    const {
      template: e11,
      maxLength: t4
    } = this, i6 = e11?.input && "minLength" in e11.input ? e11.input.minLength : null;
    return t4 && i6 <= t4 ? i6 : null;
  }
  get name() {
  ...
  createInputElement({
    ...
    const {
      ...
      maxLength: n12,
      minLength: o4,
      effectiveRequired: a10
    } = this;
    let l8;
    "coded-value" === t4?.type ? (l8 = this._createSelectElement(e11, t4.codedValues.map(({
      code: e12,
      name: t5
    }) => ({
      value: e12,
      ...
      l8.onblur = null, s10();
    }) : (l8 = document.createElement("input"), l8.type = pe(i6) ? "number" : "text", n12 > -1 && (l8.maxLength = n12), o4 > 0 && (l8.minLength = o4)), l8.classList.add(O2.input), l8.value = e11, l8.required = a10;
    let r7 = false;
    l8.onkeydown = (e12) => {
      r7 = e12.key === w.cancelEdit;
    }, l8.onblur = () => {
      l8.onblur = null, s10();
    };
    const s10 = () => {
      r7 ? this.cancel() : this.submit();
    };
    return l8;
  }
  getCellValue({
    ...
    return e11 && t4?.item?.feature?.attributes ? t4.item.feature.attributes?.[e11] : null;
  }
  onEditComplete() {
    const e11 = this.editInfo?.root;
    e11 && this._syncRowEditingState(e11, false), this._activeFieldInput = null, super.onEditComplete();
  }
  _clearActiveEditValues() {
    this.editInfo?.inputs?.forEach((e11) => e11.value = "");
  }
  _setUpDateActionBar() {
    const {
      messagesCommon: e11
    } = this, t4 = e11?.cancel ?? "", i6 = e11?.clear ?? "", n12 = e11?.save ?? "", o4 = document.createElement("calcite-action-bar");
    return o4.expandDisabled = true, o4.layout = "horizontal", o4.appendChild(this.createCalciteAction({
      text: n12,
      icon: "save",
      onclick: () => this.submit()
    })), this.effectiveRequired || o4.appendChild(this.createCalciteAction({
      text: i6,
      icon: "trash",
      onclick: () => {
        this._clearActiveEditValues(), this.submit();
      }
    })), o4.appendChild(this.createCalciteAction({
      text: t4,
      icon: "x",
      onclick: () => this.cancel()
    })), o4;
  }
  _formatDateValueForDisplay(e11, t4) {
    const {
      timeZone: i6,
      timeZoneName: n12
    } = this;
    return null != t4 ? T(e11, t4, __spreadProps(__spreadValues({}, this._getDateFormatOptions()), {
      timeZone: i6 ?? void 0,
      timeZoneName: n12 ?? void 0
    })) : null;
  }
  _setUpDateComponents(e11) {
    const {
      _effectiveRange: {
        max: t4,
        min: i6,
      ...
      field: a10,
      effectiveRequired: l8
    } = this, r7 = this._getDateFieldValuesForComponents(a10, e11), s10 = [];
    if (Z(a10)) {
      const e12 = this.createDateComponent(), u4 = Fe(a10) || Ie(a10) ? n12 : t4, p8 = Fe(a10) || Ie(a10) ? o4 : i6, d8 = this._getDateFieldValuesForComponents(a10, u4 ?? null), c5 = this._getDateFieldValuesForComponents(a10, p8 ?? null);
      e12.value = r7.date ?? "", e12.max = d8.date ?? "", e12.min = c5.date ?? "", e12.required = l8, e12.addEventListener("calciteInputDatePickerOpen", () => this._onDateComponentOpen(e12)), s10.push(e12);
    }
    if (this.includeTime) {
      const e12 = this.createTimeComponent();
      e12.value = r7.time ?? "", e12.required = l8, e12.addEventListener("calciteInputTimePickerOpen", () => this._onDateComponentOpen(e12)), s10.push(e12);
    }
    if ("timestamp-offset" === a10.type) {
      const e12 = this.createTimeZoneComponent();
      e12.value = r7.timeZoneOffset ?? "0", e12.addEventListener("calciteInputTimeZoneOpen", () => this._onDateComponentOpen(e12)), s10.push(e12);
    }
    return s10;
  }
  _onDateComponentOpen(e11) {
    this.editInfo?.inputs.forEach((t4) => {
      t4 !== e11 && "open" in t4 && (t4.open = false);
    });
  }
  _syncRowEditingState(e11, t4 = false) {
    const i6 = this.grid?.getRowContainingNode(e11);
    i6 && (t4 ? i6.setAttribute("editing", "true") : i6.removeAttribute("editing"));
  }
  _getDateFieldValuesForComponents(e11, t4) {
    switch (e11.type) {
      case "date":
        return V2(t4, this.timeZone ?? void 0);
      case "date-only":
        return {
          date: t4
        };
  ...
  _createSelectElement(e11, t4, i6 = false) {
    let n12 = false;
    const o4 = t4.map((t5) => {
      t5.value === e11 && (n12 = true);
      const i7 = document.createElement("option");
      return i7.text = t5.name, i7.value = t5.value, i7;
    });
    if (null != e11 && "" !== e11 && !n12) {
      const t5 = document.createElement("option");
      t5.text = e11, t5.value = e11, o4.unshift(t5);
    }
    if (!i6 && null == e11) {
      const e12 = document.createElement("option");
      e12.value = "", o4.unshift(e12);
    }
    const a10 = document.createElement("select");
    return o4.forEach((e12) => a10.add(e12)), a10.value = e11, a10;
  }
  _setUpFieldInput(e11, t4) {
    const {
      field: i6,
      layer: n12,
      timeZone: o4
      ...
      feature: e11,
      field: i6,
      initialFeature: e11.clone(),
      layer: n12,
      timeZone: o4
    });
    return a10.set("value", t4), a10;
  }
  _isDomainCompatible(e11) {
    const {
      field: t4
    } = this;
    if (e11 && "coded-value" === e11.type) {
      const i6 = typeof e11.codedValues[0].code;
      if ("string" === i6 && ye(t4) || "number" === i6 && pe(t4)) return true;
    }
    return !(!e11 || "range" !== e11.type || !pe(t4));
  }
  _getDomainForFeature(e11) {
    const {
      layer: t4,
      name: i6,
      template: n12
    } = this;
    if (!e11 || !t4?.getFieldDomain) return null;
    if ("wfs" === t4.type || "geojson" === t4.type || "csv" === t4.type || "knowledge-graph-sublayer" === t4.type) return null;
    if (n12?.domain && this._isDomainCompatible(n12.domain)) return n12.domain;
    const {
      typeIdField: o4
    } = t4, a10 = o4 === i6, l8 = this.field.domain;
    if (a10 && !l8) return new i2({
      name: "__internal-type-based-coded-value-domain__",
      codedValues: t4.types?.map(({
        id: e12,
        name: t5
      }) => new p2({
        code: e12,
    ...
    return o4 && null != i6 && t4.getFieldDomain(i6, {
      feature: e11
    }) || l8;
  }
  _getComputedDomain(e11, t4) {
    if (!t4) return null;
    if ("range" === t4.type) return e11;
    if ("coded-value" === t4.type) {
      const i6 = t4.codedValues.filter((t5) => t5.hasOwnProperty("code") && t5.code === e11);
      return i6 && i6.length ? i6[0].name : e11;
    }
    return null;
  }
  _getDateFormatOptions() {
    const {
      template: e11
    } = this, t4 = e11?.format?.dateFormat;
    return t4 ? E(t4) : e11?.input && "includeTime" in e11.input && false === e11.input.includeTime ? R : j2;
  }
};
e([y()], A.prototype, "_effectiveDomain", null), e([y()], A.prototype, "_activeFieldInput", void 0), e([y()], A.prototype, "_effectiveRange", null), e([y()], A.prototype, "_isAnyDateOrTimeField", null), e([y({
  readOnly: true
})], A.prototype, "alias", null), e([y()], A.prototype, "cellValueFormatFunction", void 0), e([y()], A.prototype, "cellValueValidatorFunction", void 0), e([y({
  readOnly: true
})], A.prototype, "defaultValue", null), e([y({
  readOnly: true
})], A.prototype, "description", null), e([y()], A.prototype, "effectiveEditable", null), e([y()], A.prototype, "effectiveLabel", null), e([y()], A.prototype, "effectiveRequired", null), e([y()], A.prototype, "expressionInfos", void 0), e([y()], A.prototype, "field", void 0), e([y()], A.prototype, "formatFunction", void 0), e([y()], A.prototype, "includeTime", null), e([y()], A.prototype, "inputRenderFunction", void 0), e([y()], A.prototype, "layer", void 0), e([y({
  readOnly: true
})], A.prototype, "loadingMessage", null), e([y()], A.prototype, "maxLength", null), e([y()], A.prototype, "minLength", null), e([y({
  readOnly: true
})], A.prototype, "name", null), e([y({
  readOnly: true
})], A.prototype, "nullable", null), e([y()], A.prototype, "parseInputValueFunction", void 0), e([y()], A.prototype, "sortable", void 0), e([y()], A.prototype, "store", void 0), e([y()], A.prototype, "template", void 0), e([y()], A.prototype, "updateRowItemFunction", void 0), e([y()], A.prototype, "updateStoreItemFunction", void 0), A = e([a2("esri.widgets.FeatureTable.FieldColumn")], A);
var Z2 = A;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/RelationshipColumn.js
var l5 = {
  showRecordsButton: "esri-column__show-related-records-button"
};
var n9 = class extends d5 {
  constructor(t4) {
    super(t4), this.flexGrow = 1, this.icon = "link", this.layer = null, this.relatedLayer = null, this.relationshipId = null, this.renderFunction = ({
      root: t5,
      rowData: e11
    }) => {
      if (!e11) return;
      ...
      if (!o4?.feature || !a6(r7) || !a6(n12)) return;
      const {
        messages: a10
      } = this, {
        index: p8
        ...
        collapsed: d8,
        showRelatedTableCallback: h3,
        relationshipId: u4
      } = this, y2 = o4.relatedRecords, b2 = y2?.find((t6) => t6.relationshipId === u4)?.count ?? 0, f5 = !d8 && h3 && a10?.recordsCount ? s3(a10.recordsCount, {
        count: b2
      }) : `${b2}`, m3 = (t6) => {
        t6.preventDefault(), d8 || this.showRelatedTableCallback?.({
          feature: c5,
          index: p8,
          layer: r7,
          relatedLayer: n12,
      ...
      if (t5.firstChild) {
        const e12 = t5.firstChild;
        return e12.textContent = f5, e12.onclick = m3, void (e12.iconEnd = C3);
      }
      const g4 = this.createCalciteButton({
        className: l5.showRecordsButton,
        iconEnd: C3,
        iconFlipRtl: "both",
        scale: "m",
        textContent: f5,
      ...
      this.removeCellContent(t5), t5.appendChild(g4);
  ...
  get iconNode() {
    ...
    return t4 ? this.createCalciteIcon({
      icon: t4,
      textLabel: this._relationshipLabel
    }) : null;
  }
  get originRelationship() {
    const t4 = this.relationshipId;
    return this.relatedLayer.relationships?.find(({
      id: e11
    }) => e11 === t4);
  }
  get relationship() {
    const t4 = this.relationshipId;
    return this.layer.relationships?.find(({
      id: e11
    }) => e11 === t4);
  }
};
e([y()], n9.prototype, "_relationshipLabel", null), e([y()], n9.prototype, "collapsed", null), e([y()], n9.prototype, "effectiveLabel", null), e([y()], n9.prototype, "flexGrow", void 0), e([y()], n9.prototype, "icon", void 0), e([y()], n9.prototype, "iconNode", null), e([y()], n9.prototype, "layer", void 0), e([y()], n9.prototype, "originRelationship", null), e([y()], n9.prototype, "relatedLayer", void 0), e([y()], n9.prototype, "relationship", null), e([y()], n9.prototype, "relationshipId", void 0), e([y()], n9.prototype, "renderFunction", void 0), e([y()], n9.prototype, "resizable", void 0), e([y()], n9.prototype, "showRelatedTableCallback", void 0), e([y()], n9.prototype, "textAlign", void 0), e([y()], n9.prototype, "width", void 0), n9 = e([a2("esri.widgets.FeatureTable.RelationshipColumn")], n9);
var a9 = n9;
...
var css = (strings, ...values) => {
  const cssText = strings.length === 1 ? strings[0] : values.reduce((acc, v3, idx) => acc + textFromCSSResult(v3) + strings[idx + 1], strings[0]);
...
var adoptStyles = (renderRoot, styles) => {
  if (supportsAdoptingStyleSheets) {
    ...
    for (const s10 of styles) {
      ...
      style2.textContent = s10.cssText;
...
var DEV_MODE = true;
var issueWarning;
var trustedTypes2 = global2.trustedTypes;
...
var ReactiveElement = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.hasOwnProperty(JSCompiler_renameProperty2("properties", this))) {
      ...
      for (const p8 of propKeys) {
        this.createProperty(p8, props[p8]);
      }
    }
    ...
    if (metadata !== null) {
      ...
      if (properties !== void 0) {
        for (const [p8, options] of properties) {
          this.elementProperties.set(p8, options);
        }
      }
    }
    this.__attributeToPropertyMap = /* @__PURE__ */ new Map();
    for (const [p8, options] of this.elementProperties) {
      const attr = this.__attributeNameForProperty(p8, options);
      if (attr !== void 0) {
        this.__attributeToPropertyMap.set(attr, p8);
      }
    }
  ...
  __initialize() {
    ...
    this.requestUpdate();
    this.constructor._initializers?.forEach((i6) => i6(this));
  }
  /**
  ...
  __saveInstanceProperties() {
    ...
    for (const p8 of elementProperties.keys()) {
      if (this.hasOwnProperty(p8)) {
        instanceProperties.set(p8, this[p8]);
        delete this[p8];
      }
    }
  ...
  connectedCallback() {
    ...
    this.__controllers?.forEach((c5) => c5.hostConnected?.());
  }
  /**
  ...
  disconnectedCallback() {
    this.__controllers?.forEach((c5) => c5.hostDisconnected?.());
  }
  /**
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (DEV_MODE) {
        const ctor = this.constructor;
        const shadowedProperties = [...ctor.elementProperties.keys()].filter((p8) => this.hasOwnProperty(p8) && p8 in getPrototypeOf(this));
        if (shadowedProperties.length) {
          throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${shadowedProperties.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`);
        }
      }
      if (this.__instanceProperties) {
        for (const [p8, value] of this.__instanceProperties) {
          this[p8] = value;
        }
        this.__instanceProperties = void 0;
      }
      ...
      if (elementProperties.size > 0) {
        for (const [p8, options] of elementProperties) {
          if (options.wrapped === true && !this._$changedProperties.has(p8) && this[p8] !== void 0) {
            this._$changeProperty(p8, this[p8], options);
          }
        }
      }
    }
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        this.__controllers?.forEach((c5) => c5.hostUpdate?.());
  ...
  _$didUpdate(changedProperties) {
    this.__controllers?.forEach((c5) => c5.hostUpdated?.());
    if (!this.hasUpdated) {
  ...
  update(_changedProperties) {
    this.__reflectingProperties &&= this.__reflectingProperties.forEach((p8) => this.__propertyToAttribute(p8, this[p8]));
    this.__markUpdated();
  }
  /**
...
ReactiveElement[JSCompiler_renameProperty2("elementProperties", ReactiveElement)] = /* @__PURE__ */ new Map();
ReactiveElement[JSCompiler_renameProperty2("finalized", ReactiveElement)] = /* @__PURE__ */ new Map();
polyfillSupport?.({
  ReactiveElement
});
if (DEV_MODE) {
  ...
  ReactiveElement.disableWarning = function(warning) {
    ensureOwnWarnings(this);
    const i6 = this.enabledWarnings.indexOf(warning);
    if (i6 >= 0) {
      this.enabledWarnings.splice(i6, 1);
    }
  };
}
...
var trustedTypes3 = global3.trustedTypes;
...
var d6 = NODE_MODE3 && global3.document === void 0 ? {
  createTreeWalker() {
    return {};
  }
} : document;
...
var getTemplateHtml = (strings, type) => {
  const l8 = strings.length - 1;
  const attrNames = [];
  let html4 = type === SVG_RESULT ? "<svg>" : type === MATHML_RESULT ? "<math>" : "";
  let rawTextEndRegex;
  let regex = textEndRegex;
  for (let i6 = 0; i6 < l8; i6++) {
    const s10 = strings[i6];
    ...
    const end = regex === tagEndRegex && strings[i6 + 1].startsWith("/>") ? " " : "";
    html4 += regex === textEndRegex ? s10 + nodeMarker : attrNameEndIndex >= 0 ? (attrNames.push(attrName), s10.slice(0, attrNameEndIndex) + boundAttributeSuffix + s10.slice(attrNameEndIndex)) + marker + end : s10 + marker + (attrNameEndIndex === -2 ? i6 : end);
  }
  const htmlResult = html4 + (strings[l8] || "<?>") + (type === SVG_RESULT ? "</svg>" : type === MATHML_RESULT ? "</math>" : "");
    ...
    while ((node = walker.nextNode()) !== null && parts.length < partCount) {
      if (node.nodeType === 1) {
        ...
        if (rawTextElement.test(node.tagName)) {
          ...
          if (lastIndex > 0) {
            ...
            for (let i6 = 0; i6 < lastIndex; i6++) {
              node.append(strings2[i6], createMarker());
              walker.nextNode();
              parts.push({
                type: CHILD_PART,
                index: ++nodeIndex
        ...
        if (data === markerMatch) {
          ...
          let i6 = -1;
          while ((i6 = node.data.indexOf(marker, i6 + 1)) !== -1) {
            parts.push({
              type: COMMENT_PART,
              index: nodeIndex
            });
    ...
    for (const part of this._$parts) {
      if (part !== void 0) {
        ...
        if (part.strings !== void 0) {
          part._$setValue(values, part, i6);
          i6 += part.strings.length - 2;
        } else {
          part._$setValue(values[i6]);
        }
      }
      i6++;
    }
...
var ChildPart = class _ChildPart {
  ...
  _commitTemplateResult(result) {
    ...
    if (this._$committedValue?._$template === template2) {
      debugLogEvent2 && debugLogEvent2({
  ...
  _$clear(start = wrap(this._$startNode).nextSibling, from) {
    ...
    while (start && start !== this._$endNode) {
      const n12 = wrap(start).nextSibling;
      wrap(start).remove();
      start = n12;
    }
  }
...
var AttributePart = class {
  ...
  _$setValue(value, directiveParent = this, valueIndex, noCommit) {
    ...
    if (strings === void 0) {
      ...
      value = strings[0];
      let i6, v3;
      for (i6 = 0; i6 < strings.length - 1; i6++) {
        v3 = resolveDirective(this, values[valueIndex + i6], directiveParent, i6);
        if (v3 === noChange) {
          v3 = this._$committedValue[i6];
        }
        change ||= !isPrimitive(v3) || v3 !== this._$committedValue[i6];
        if (v3 === nothing) {
          value = nothing;
        } else if (value !== nothing) {
          value += (v3 ?? "") + strings[i6 + 1];
        }
        this._$committedValue[i6] = v3;
      }
    }
    if (change && !noCommit) {
...
function getIncludedStyles(theme) {
  ...
  if (theme.include) {
    [].concat(theme.include).forEach((includeModuleId) => {
      const includedTheme = getAllThemes().find((s10) => s10.moduleId === includeModuleId);
      if (includedTheme) {
...
var supportsAdoptingStyleSheets2 = useShadow && "adoptedStyleSheets" in Document.prototype && "replaceSync" in CSSStyleSheet.prototype && // Since spec may change, feature detect exact API we need
(() => {
  try {
...
function stylesFromModules(moduleIds) {
  ...
  const styles = [];
  for (let i6 = 0; i6 < modules2.length; i6++) {
    styles.push(...stylesFromModule(modules2[i6]));
  }
  return styles;
}
function stylesFromModule(moduleId) {
  ...
  if (m3._styles === void 0) {
    const styles = [];
    styles.push(..._stylesFromModuleImports(m3));
    const template2 = (
...
function stylesFromTemplate(template2, baseURI) {
  if (!template2._styles) {
    ...
    for (let i6 = 0; i6 < e$.length; i6++) {
      let e11 = e$[i6];
      let include = e11.getAttribute(INCLUDE_ATTR);
      if (include) {
...
function _stylesFromModuleImports(module) {
  ...
  for (let i6 = 0; i6 < p$.length; i6++) {
    let p8 = p$[i6];
    if (p8.import) {
      const importDoc = p8.import;
      const unscoped = p8.hasAttribute(SHADY_UNSCOPED_ATTR);
...
var wrap2 = window["ShadyDOM"] && window["ShadyDOM"]["noPatch"] && window["ShadyDOM"]["wrap"] ? window["ShadyDOM"]["wrap"] : window["ShadyDOM"] ? (n12) => ShadyDOM["patch"](n12) : (n12) => n12;
...
function normalize(path) {
  if (Array.isArray(path)) {
    ...
    for (let i6 = 0; i6 < path.length; i6++) {
      let args = path[i6].toString().split(".");
...
function dashToCamelCase(dash) {
  return caseMap[dash] || (caseMap[dash] = dash.indexOf("-") < 0 ? dash : dash.replace(DASH_TO_CAMEL, (m3) => m3[1].toUpperCase()));
}
  ...
  (superClass) => {
    class PropertiesChanged2 extends superClass {
      ...
      _initializeProperties() {
        for (let p8 in this.__dataHasAccessor) {
          if (this.hasOwnProperty(p8)) {
            this.__dataInstanceProps = this.__dataInstanceProps || {};
            this.__dataInstanceProps[p8] = this[p8];
            delete this[p8];
          }
        }
      }
...
while (proto) {
  ...
  for (let i6 = 0; i6 < props.length; i6++) {
    nativeProperties[props[i6]] = true;
  }
  ...
  class PropertyAccessors2 extends base {
    ...
    static createPropertiesForAttributes() {
      ...
      for (let i6 = 0; i6 < a$.length; i6++) {
        this.prototype._createPropertyAccessor(dashToCamelCase(a$[i6]));
      }
    }
    /**
     * Returns an attribute name that corresponds to the given property.
...
function wrapTemplateExtension(node) {
  ...
  if (is2 && templateExtensions[is2]) {
    ...
    node = t4.ownerDocument.createElement(is2);
...
function findTemplateNode(root2, nodeInfo) {
  ...
  if (parent) {
    for (let n12 = parent.firstChild, i6 = 0; n12; n12 = n12.nextSibling) {
      if (nodeInfo.parentIndex === i6++) {
        return n12;
      }
    }
  } else {
...
function applyEventListener(inst, node, nodeInfo) {
  if (nodeInfo.events && nodeInfo.events.length) {
    for (let j4 = 0, e$ = nodeInfo.events, e11; j4 < e$.length && (e11 = e$[j4]); j4++) {
      inst._addMethodEventListenerToNode(node, e11.name, e11.value, inst);
    }
  }
}
...
function createNodeEventHandler(context, eventName, methodName) {
  ...
  let handler = function(e11) {
    if (context[methodName]) {
      context[methodName](e11, e11.detail);
    } else {
  ...
  (superClass) => {
    class TemplateStamp2 extends superClass {
      ...
      static _parseTemplateChildNodes(root2, templateInfo, nodeInfo) {
        ...
        for (let node = root2.firstChild, parentIndex = 0, next; node; node = next) {
          ...
          if (node.nodeType === Node.TEXT_NODE) {
            let n12 = next;
            while (n12 && n12.nodeType === Node.TEXT_NODE) {
              node.textContent += n12.textContent;
              next = n12.nextSibling;
              root2.removeChild(n12);
              n12 = next;
            }
      ...
      static _parseTemplateNodeAttributes(node, templateInfo, nodeInfo) {
        ...
        for (let i6 = attrs.length - 1, a10; a10 = attrs[i6]; i6--) {
          noted = this._parseTemplateNodeAttribute(node, templateInfo, nodeInfo, a10.name, a10.value) || noted;
        }
        return noted;
      }
      /**
      ...
      _stampTemplate(template2, templateInfo) {
        ...
        dom.$ = {};
        for (let i6 = 0, l8 = nodeInfo.length, info; i6 < l8 && (info = nodeInfo[i6]); i6++) {
          let node = nodes[i6] = findTemplateNode(dom, info);
...
function ensureOwnEffectMap(model, type, cloneArrays) {
  ...
  if (!effects) {
    ...
    if (cloneArrays) {
      for (let p8 in effects) {
        let protoFx = effects[p8];
        let instFx = effects[p8] = Array(protoFx.length);
        for (let i6 = 0; i6 < protoFx.length; i6++) {
          instFx[i6] = protoFx[i6];
        }
      }
    }
  }
...
function runEffects(inst, effects, props, oldProps, hasPaths, extraArgs) {
  if (effects) {
    ...
    for (let prop in props) {
      ...
      if (fxs) {
        for (let i6 = 0, l8 = fxs.length, fx; i6 < l8 && (fx = fxs[i6]); i6++) {
...
function runComputedEffects(inst, changedProps, oldProps, hasPaths) {
  ...
  if (computeEffects) {
    if (orderedComputed) {
      ...
      const queue = [];
      for (let p8 in changedProps) {
        enqueueEffectsFor(p8, computeEffects, queue, order, hasPaths);
      }
      let info;
...
function dependencyCounts(inst) {
  ...
  const ready = [];
  let total = 0;
  for (let p8 in infoForComputed) {
    const info = infoForComputed[p8];
    total += counts[p8] = info.args.filter((a10) => !a10.literal).length + (info.dynamicFn ? 1 : 0);
  }
  for (let p8 in computedDeps) {
    if (!infoForComputed[p8]) {
      ready.push(p8);
    }
  }
  return {
...
function computeLinkedPaths(inst, path, value) {
  ...
  if (links) {
    let link;
    for (let a10 in links) {
      let b2 = links[a10];
      if (isDescendant(a10, path)) {
        link = translate(a10, b2, path);
        inst._setPendingPropertyOrPath(link, value, true, true);
      } else if (isDescendant(b2, path)) {
        link = translate(b2, a10, path);
        inst._setPendingPropertyOrPath(link, value, true, true);
      }
    }
  }
...
function addBinding(constructor, templateInfo, nodeInfo, kind, target, parts, literal) {
  ...
  for (let i6 = 0; i6 < binding.parts.length; i6++) {
    let part = binding.parts[i6];
    part.compoundIndex = i6;
...
function setupBindings(inst, templateInfo) {
  ...
  if (nodeInfoList.length) {
    for (let i6 = 0; i6 < nodeInfoList.length; i6++) {
      let info = nodeInfoList[i6];
      let node = nodeList[i6];
      let bindings = info.bindings;
      if (bindings) {
        for (let i7 = 0; i7 < bindings.length; i7++) {
          let binding = bindings[i7];
...
function addNotifyListener(node, inst, binding) {
  if (binding.listenerEvent) {
    ...
    node.addEventListener(binding.listenerEvent, function(e11) {
      handleNotification(e11, inst, binding.target, part.source, part.negate);
    });
  }
}
function createMethodEffect(model, sig, type, effectFn, methodInfo, dynamicFn) {
  ...
  for (let i6 = 0, arg; i6 < sig.args.length && (arg = sig.args[i6]); i6++) {
    if (!arg.literal) {
...
function parseArg(rawArg) {
  ...
  switch (fc) {
    case "'":
    case '"':
      a10.value = arg.slice(1, -1);
      a10.literal = true;
      break;
    case "#":
      a10.value = Number(arg);
      a10.literal = true;
      break;
  }
  if (!a10.literal) {
    a10.rootProperty = root(arg);
    a10.structured = isPath(arg);
    if (a10.structured) {
      a10.wildcard = arg.slice(-2) == ".*";
      if (a10.wildcard) {
        a10.name = arg.slice(0, -2);
      }
    }
  }
  return a10;
...
var PropertyEffects = dedupingMixin((superClass) => {
  ...
  class PropertyEffects2 extends propertyEffectsBase {
    ...
    _marshalArgs(args, path, props) {
      ...
      const values = [];
      for (let i6 = 0, l8 = args.length; i6 < l8; i6++) {
        let {
          name,
          structured,
          wildcard,
    ...
    _stampTemplate(template2, templateInfo) {
      ...
      if (!templateInfo.wasPreBound) {
        ...
        for (let n12 = dom.firstChild; n12; n12 = n12.nextSibling) {
          nodes.push(n12);
        }
      }
    ...
    static _parseBindings(text, templateInfo) {
      ...
      while ((m3 = bindingRegex.exec(text)) !== null) {
        if (m3.index > lastIndex) {
          parts.push({
            literal: text.slice(lastIndex, m3.index)
          });
        }
        let mode = m3[1][0];
  ...
  class PropertiesMixin2 extends base {
    ...
    static get observedAttributes() {
      if (!this.hasOwnProperty(JSCompiler_renameProperty("__observedAttributes", this))) {
        ...
        this.__observedAttributes = props ? Object.keys(props).map((p8) => this.prototype._addPropertyToAttributeMap(p8)) : [];
      }
...
var ElementMixin = dedupingMixin((base) => {
    ...
    if (!constructor.hasOwnProperty(JSCompiler_renameProperty("__propertyDefaults", constructor))) {
      ...
      for (let p8 in props) {
        ...
        if ("value" in info) {
          ...
          constructor.__propertyDefaults[p8] = info;
        }
      }
    }
  ...
  function processElementStyles(klass, template2, is2, baseURI) {
    if (!builtCSS) {
      ...
      for (let idx = 0; idx < linkedStyles.length; idx++) {
        let s10 = linkedStyles[idx];
        s10.textContent = klass._processStyleText(s10.textContent, baseURI);
        template2.content.insertBefore(s10, firstTemplateChild);
      }
      let templateStyleIndex = 0;
      for (let i6 = 0; i6 < stylesWithImports.length; i6++) {
        let s10 = stylesWithImports[i6];
        let templateStyle = templateStyles[templateStyleIndex];
        if (templateStyle !== s10) {
          s10 = s10.cloneNode(true);
          templateStyle.parentNode.insertBefore(s10, templateStyle);
        } else {
          templateStyleIndex++;
        }
        s10.textContent = klass._processStyleText(s10.textContent, baseURI);
    ...
    if (useAdoptedStyleSheetsWithBuiltCSS && builtCSS && supportsAdoptingStyleSheets2) {
      const styles = template2.content.querySelectorAll("style");
      if (styles) {
        let css2 = "";
        Array.from(styles).forEach((s10) => {
          css2 += s10.textContent;
  ...
  class PolymerElement2 extends polymerElementBase {
    ...
    static createObservers(observers, dynamicFns) {
      const proto2 = this.prototype;
      for (let i6 = 0; i6 < observers.length; i6++) {
        proto2._createMethodObserver(observers[i6], dynamicFns);
      }
    }
    /**
    ...
    _initializeProperties() {
      ...
      for (let p8 in p$) {
        let info = p$[p8];
        if (this._canApplyPropertyDefault(p8)) {
          let value = typeof info.value == "function" ? info.value.call(this) : info.value;
          if (this._hasAccessor(p8)) {
            this._setPendingProperty(p8, value, true);
          } else {
            this[p8] = value;
          }
        }
    ...
    */
      ...
      if (n12.attachShadow) {
        if (dom) {
          if (!n12.shadowRoot) {
            ...
            n12.shadowRoot.appendChild(dom);
            if (this.constructor._styleSheet) {
              n12.shadowRoot.adoptedStyleSheets = [this.constructor._styleSheet];
            }
          }
          if (syncInitialRender && window.ShadyDOM) {
            window.ShadyDOM.flushInitial(n12.shadowRoot);
          }
          return n12.shadowRoot;
        }
        return null;
      } else {
    ...
    static _parseTemplateContent(template2, templateInfo, nodeInfo) {
      ...
      return polymerElementBase._parseTemplateContent.call(this, template2, templateInfo, nodeInfo);
    }
    /**
...
var policy2 = window.trustedTypes && trustedTypes.createPolicy("polymer-html-literal", {
  createHTML: (s10) => s10
});
var LiteralString = class {
  ...
  constructor(strings, values) {
    ...
    const string = values.reduce((acc, v3, idx) => acc + literalValue(v3) + strings[idx + 1], strings[0]);
...
var html2 = function html3(strings, ...values) {
  assertValidTemplateStringParameters(strings, values);
  const template2 = (
    /** @type {!HTMLTemplateElement} */
    document.createElement("template")
  );
  let value = values.reduce((acc, v3, idx) => acc + htmlValue(v3) + strings[idx + 1], strings[0]);
  if (policy2) {
    value = policy2.createHTML(value);
  }
...
function microtaskFlush2() {
  ...
  for (let i6 = 0; i6 < len; i6++) {
    const cb = microtaskCallbacks2[i6];
    if (cb) {
      try {
        cb();
      } catch (e11) {
...
function updateColumnOrders(columns, scope, baseOrder) {
  ...
  columns.forEach((column) => {
    ...
    column._order = baseOrder + c5 * scope;
    c5 += 1;
  });
}
...
function uncommentAndRun(callback, args) {
  ...
  if (match) {
    try {
      ...
      console.log("vaadin-development-mode-detector: uncommentAndRun() failed", e11);
    }
  }
...
var ironList = {
  ...
  _iterateItems(fn, itemSet) {
    let pidx, vidx, rtn, i6;
    if (arguments.length === 2 && itemSet) {
      for (i6 = 0; i6 < itemSet.length; i6++) {
        pidx = itemSet[i6];
...
var IronListAdapter = class {
  constructor({
    ...
    this.scrollTarget.addEventListener("wheel", (e11) => this.__onWheel(e11));
  ...
  __afterElementsUpdated(updatedElements) {
    updatedElements.forEach((el) => {
      ...
      if (elementHeight === 0) {
        ...
        this.__placeholderHeight = Math.round(filteredHeights.reduce((a10, b2) => a10 + b2, 0) / filteredHeights.length);
      }
    });
  ...
  /** @private */
  __onWheel(e11) {
    if (e11.ctrlKey || this._hasScrolledAncestor(e11.target, e11.deltaX, e11.deltaY)) {
      return;
    }
    let deltaY = e11.deltaY;
    if (e11.deltaMode === WheelEvent.DOM_DELTA_LINE) {
      deltaY *= this._scrollLineHeight;
    } else if (e11.deltaMode === WheelEvent.DOM_DELTA_PAGE) {
    ...
    const momentum = Math.abs(e11.deltaX) + Math.abs(deltaY);
    if (this._canScroll(this.scrollTarget, e11.deltaX, deltaY)) {
      e11.preventDefault();
      this.scrollTarget.scrollTop += deltaY;
      this.scrollTarget.scrollLeft += e11.deltaX;
  ...
  __reorderElements() {
    ...
    if (delta > 0) {
      for (let i6 = 0; i6 < delta; i6++) {
        this.elementsContainer.appendChild(visibleElements[i6]);
      }
    } else if (delta < 0) {
      for (let i6 = visibleElements.length + delta; i6 < visibleElements.length; i6++) {
        this.elementsContainer.insertBefore(visibleElements[i6], visibleElements[0]);
      }
    }
    if (isSafari) {
      const {
...
var ActiveItemMixin = (superClass) => class ActiveItemMixin extends superClass {
  ...
  _onClick(e11) {
    ...
    if (!cellContentHasFocus && !this._isFocusable(e11.target) && !(e11.target instanceof HTMLLabelElement)) {
...
function compare(a10, b2) {
  a10 = normalizeEmptyValue(a10);
...
function multiSort(items, sortOrders) {
  return items.sort((a10, b2) => {
    return sortOrders.map((sortOrder) => {
      if (sortOrder.direction === "asc") {
        return compare(get3(sortOrder.path, a10), get3(sortOrder.path, b2));
      } else if (sortOrder.direction === "desc") {
        return compare(get3(sortOrder.path, b2), get3(sortOrder.path, a10));
      }
      return 0;
    }).reduce((p8, n12) => {
      return p8 !== 0 ? p8 : n12;
...
function isSyntheticClick(ev) {
  if (ev.type === "click") {
    ...
    if (!t4.nodeType || /** @type {Element} */
    t4.nodeType !== Node.ELEMENT_NODE) {
      return true;
    }
    const bcr = (
      /** @type {Element} */
...
function firstTouchAction(ev) {
  ...
  for (let i6 = 0, n12; i6 < path.length; i6++) {
    n12 = path[i6];
    if (n12[TOUCH_ACTION]) {
      ta = n12[TOUCH_ACTION];
      break;
...
function _handleNative(ev) {
  ...
  for (let i6 = 0, r7; i6 < recognizers.length; i6++) {
    r7 = recognizers[i6];
    if (gs[r7.name] && !handled[r7.name]) {
      if (r7.flow && r7.flow.start.indexOf(ev.type) > -1 && r7.reset) {
        r7.reset();
      }
    }
  }
...
function _add(node, evType, handler) {
  ...
  for (let i6 = 0, dep, gd; i6 < deps.length; i6++) {
    dep = deps[i6];
...
function _findRecognizerByEvent(evName) {
  for (let i6 = 0, r7; i6 < recognizers.length; i6++) {
    r7 = recognizers[i6];
    for (let j4 = 0, n12; j4 < r7.emits.length; j4++) {
      n12 = r7.emits[j4];
      if (n12 === evName) {
        return r7;
      }
...
register2({
   ...
   */
  mousedown(e11) {
    if (!hasLeftMouseButton(e11)) {
      return;
    }
    const t4 = _findOriginalTarget(e11);
    const self = this;
    const movefn = (e12) => {
      if (!hasLeftMouseButton(e12)) {
        downupFire("up", t4, e12);
   ...
   */
  touchstart(e11) {
    downupFire("down", _findOriginalTarget(e11), e11.changedTouches[0], e11);
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
   ...
   */
  touchend(e11) {
    downupFire("up", _findOriginalTarget(e11), e11.changedTouches[0], e11);
  }
});
...
register2({
  ...
  mousedown(e11) {
    ...
    const self = this;
    const movefn = (e12) => {
      const x2 = e12.clientX, y2 = e12.clientY;
      if (trackHasMovedEnough(self.info, x2, y2)) {
        self.info.state = self.info.started ? e12.type === "mouseup" ? "end" : "track" : "start";
    ...
    trackDocument(this.info, movefn, upfn);
    this.info.x = e11.clientX;
    this.info.y = e11.clientY;
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
...
register2({
   ...
   */
  touchend(e11) {
    trackForward(this.info, e11.changedTouches[0], e11);
  }
});
function trackForward(info, e11, preventer) {
  const dx = Math.abs(e11.clientX - info.x);
  const dy = Math.abs(e11.clientY - info.y);
  const t4 = _findOriginalTarget(preventer || e11);
  if (!t4 || canBeDisabled[
    /** @type {!HTMLElement} */
    t4.localName
  ] && t4.hasAttribute("disabled")) {
    return;
  }
  if (isNaN(dx) || isNaN(dy) || dx <= TAP_DISTANCE && dy <= TAP_DISTANCE || isSyntheticClick(e11)) {
    if (!info.prevent) {
      _fire(t4, "tap", {
        x: e11.clientX,
        y: e11.clientY,
...
var ColumnReorderingMixin = (superClass) => class ColumnReorderingMixin extends superClass {
  ...
  _onTouchStart(e11) {
    this._startTouchReorderTimeout = setTimeout(() => {
      this._onTrackStart({
        detail: {
          x: e11.touches[0].clientX,
          y: e11.touches[0].clientY
        }
      });
    }, 100);
  }
  ...
  _onTrackEvent(e11) {
    if (e11.detail.state === "start") {
      ...
      if (!this._touchDevice) {
        this._onTrackStart(e11);
      }
    } else if (e11.detail.state === "track") {
      this._onTrack(e11);
    } else if (e11.detail.state === "end") {
      this._onTrackEnd(e11);
    }
  }
  /** @private */
  _onTrackStart(e11) {
    ...
    const path = e11.composedPath && e11.composedPath();
    if (path && path.some((node) => node.hasAttribute && node.hasAttribute("draggable"))) {
      return;
    }
    const headerCell = this._cellFromPoint(e11.detail.x, e11.detail.y);
    ...
    this._updateGhostPosition(e11.detail.x, this._touchDevice ? e11.detail.y - 50 : e11.detail.y);
    this._autoScroller();
  }
  /** @private */
  _onTrack(e11) {
    ...
    const targetCell = this._cellFromPoint(e11.detail.x, e11.detail.y);
    if (!targetCell) {
      return;
    }
    const targetColumn = this._getTargetColumn(targetCell, this._draggedColumn);
    if (this._isSwapAllowed(this._draggedColumn, targetColumn) && this._isSwappableByPosition(targetColumn, e11.detail.x)) {
      ...
      for (let i6 = startIndex; i6 !== endIndex; i6 += direction) {
        this._swapColumnOrders(this._draggedColumn, levelColumnsInOrder[i6 + direction]);
      }
    }
    this._updateGhostPosition(e11.detail.x, this._touchDevice ? e11.detail.y - 50 : e11.detail.y);
    this._lastDragClientX = e11.detail.x;
  }
  /** @private */
  _onTrackEnd() {
    if (!this._draggedColumn) {
  ...
  _getColumnsInOrder(headerLevel = this._columnTree.length - 1) {
    return this._columnTree[headerLevel].filter((c5) => !c5.hidden).sort((b2, a10) => b2._order - a10._order);
  }
  /**
   * @param {number} x
   * @param {number} y
...
var ColumnResizingMixin = (superClass) => class ColumnResizingMixin extends superClass {
  ...
  ready() {
    ...
    scroller.addEventListener("touchmove", (e11) => scroller.hasAttribute("column-resizing") && e11.preventDefault());
    scroller.addEventListener("contextmenu", (e11) => e11.target.getAttribute("part") === "resize-handle" && e11.preventDefault());
    scroller.addEventListener("mousedown", (e11) => e11.target.getAttribute("part") === "resize-handle" && e11.preventDefault());
  }
  /** @private */
  _onHeaderTrack(e11) {
    const handle = e11.target;
    if (handle.getAttribute("part") === "resize-handle") {
      const cell = handle.parentElement;
      let column = cell._column;
      this.$.scroller.toggleAttribute("column-resizing", true);
      while (column.localName === "vaadin-grid-column-group") {
        column = column._childColumns.slice(0).sort((a10, b2) => a10._order - b2._order).filter((column2) => !column2.hidden).pop();
      }
      const isRTL = this.__isRTL;
      const eventX = e11.detail.x;
      ...
      columnRowCells.sort((a10, b2) => a10._column._order - b2._column._order).forEach((cell2, index, array) => {
...
var DataProviderMixin = (superClass) => class DataProviderMixin extends superClass {
  ...
  collapseItem(item) {
    if (this._isExpanded(item)) {
      this.expandedItems = this.expandedItems.filter((i6) => !this._itemsEqual(i6, item));
    }
  }
  /**
   * @param {number} index
  ...
  _getItemIndexInArray(item, array) {
    let result = -1;
    array.forEach((i6, idx) => {
      if (this._itemsEqual(i6, item)) {
        result = idx;
      }
    });
    return result;
...
var DragAndDropMixin = (superClass) => class DragAndDropMixin extends superClass {
  ...
  ready() {
    ...
    this.$.table.addEventListener("dragenter", (e11) => {
      if (this.dropMode) {
        e11.preventDefault();
        e11.stopPropagation();
      }
  ...
  _onDragStart(e11) {
    if (this.rowsDraggable) {
      ...
      if (usesDnDPolyfill) {
        e11.dataTransfer.setDragImage(row);
      } else {
        e11.dataTransfer.setDragImage(row, e11.clientX - rowRect.left, e11.clientY - rowRect.top);
      }
      let rows = [row];
      ...
      e11.dataTransfer.setData("text", this.__formatDefaultTransferData(rows));
      updateBooleanRowStates(row, {
        dragstart: rows.length > 1 ? `${rows.length}` : ""
      });
      this.style.setProperty("--_grid-drag-start-x", `${e11.clientX - rowRect.left + 20}px`);
      this.style.setProperty("--_grid-drag-start-y", `${e11.clientY - rowRect.top + 10}px`);
      requestAnimationFrame(() => {
        updateBooleanRowStates(row, {
          dragstart: false
        });
      ...
      const event = new CustomEvent("grid-dragstart", {
        detail: {
          ...
          setDragData: (type, data) => e11.dataTransfer.setData(type, data),
          setDraggedItemsCount: (count) => row.setAttribute("dragstart", count)
        }
      });
      event.originalEvent = e11;
  ...
  _onDragOver(e11) {
    if (this.dropMode) {
      ...
      if (this.__dndAutoScroll(e11.clientY)) {
        this._clearDragStyles();
        return;
      }
      let row = e11.composedPath().find((node) => node.localName === "tr");
      if (!this._flatSize || this.dropMode === DropMode.ON_GRID) {
        ...
        if (this.dropMode === DropMode.BETWEEN) {
          const dropAbove = e11.clientY - rowRect.top < rowRect.bottom - e11.clientY;
          this._dropLocation = dropAbove ? DropLocation.ABOVE : DropLocation.BELOW;
        } else if (this.dropMode === DropMode.ON_TOP_OR_BETWEEN) {
          if (e11.clientY - rowRect.top < rowRect.height / 3) {
            this._dropLocation = DropLocation.ABOVE;
          } else if (e11.clientY - rowRect.top > rowRect.height / 3 * 2) {
            this._dropLocation = DropLocation.BELOW;
          }
        }
      }
  ...
  _onDrop(e11) {
    if (this.dropMode) {
      e11.stopPropagation();
      e11.preventDefault();
      const dragData = e11.dataTransfer.types && Array.from(e11.dataTransfer.types).map((type) => {
        return {
          type,
          data: e11.dataTransfer.getData(type)
        };
      });
      this._clearDragStyles();
      const event = new CustomEvent("grid-drop", {
        bubbles: e11.bubbles,
        cancelable: e11.cancelable,
        detail: {
  ...
  __formatDefaultTransferData(rows) {
    return rows.map((row) => {
      return Array.from(row.children).filter((cell) => !cell.hidden && cell.getAttribute("part").indexOf("details-cell") === -1).sort((a10, b2) => {
        return a10._column._order > b2._column._order ? 1 : -1;
...
function arrayEquals(arr1, arr2) {
  ...
  for (let i6 = 0, l8 = arr1.length; i6 < l8; i6++) {
    if (arr1[i6] instanceof Array && arr2[i6] instanceof Array) {
      if (!arrayEquals(arr1[i6], arr2[i6])) {
        return false;
      }
    } else if (arr1[i6] !== arr2[i6]) {
      return false;
    }
  }
  return true;
...
var DynamicColumnsMixin = (superClass) => class DynamicColumnsMixin extends superClass {
  ...
  _getColumnTree() {
    ...
    let c5 = rootColumns;
    while (this._hasColumnGroups(c5)) {
      c5 = this._flattenColumnGroups(c5);
      columnTree.push(c5);
    }
    return columnTree;
  }
  ...
  _debounceUpdateColumnTree() {
    this.__updateColumnTreeDebouncer = Debouncer.debounce(this.__updateColumnTreeDebouncer, microTask2, () => this._updateColumnTree());
  }
  /** @protected */
  _updateColumnTree() {
  ...
  _addNodeObserver() {
    this._observer = new ColumnObserver(this, (_addedColumns, removedColumns) => {
      const allRemovedCells = removedColumns.flatMap((c5) => c5._allCells);
  ...
  _updateFirstAndLastColumnForRow(row) {
    Array.from(row.querySelectorAll('[part~="cell"]:not([part~="details-cell"])')).sort((a10, b2) => {
      return a10._column._order - b2._column._order;
...
var KeyboardNavigationMixin = (superClass) => class KeyboardNavigationMixin extends superClass {
  ...
  _onKeyDown(e11) {
    ...
    this._detectInteracting(e11);
    if (this.interacting && keyGroup !== "Interaction") {
      keyGroup = void 0;
    }
    if (keyGroup) {
      this[`_on${keyGroup}KeyDown`](e11, key);
    }
  }
  /** @private */
  ...
  /** @private */
  _onNavigationKeyDown(e11, key) {
    e11.preventDefault();
    const isRTL = this.__isRTL;
    const activeRow = e11.composedPath().find((el) => this.__isRow(el));
    const activeCell = e11.composedPath().find((el) => this.__isCell(el));
    let dx = 0, dy = 0;
    switch (key) {
      case "ArrowRight":
        dx = isRTL ? -1 : 1;
    ...
    if (key === forwardsKey) {
      ...
      if (this.__rowFocusMode) {
        ...
        const activeRowCells = [...activeRow.children].sort((a10, b2) => a10._order - b2._order);
  ...
  _onCellNavigation(activeCell, dx, dy) {
    ...
    if (this._focusedColumnOrder === void 0) {
      if (isCurrentCellRowDetails) {
        ...
        this._focusedColumnOrder = this._getColumns(activeRowGroup, currentRowIndex).filter((c5) => !c5.hidden)[columnIndex]._order;
      }
    }
    if (dstIsRowDetails) {
      ...
      const dstColumns = this._getColumns(activeRowGroup, dstRowIndex).filter((c5) => !c5.hidden);
      const dstSortedColumnOrders = dstColumns.map((c5) => c5._order).sort((b2, a10) => b2 - a10);
      const maxOrderedColumnIndex = dstSortedColumnOrders.length - 1;
      const orderedColumnIndex = dstSortedColumnOrders.indexOf(dstSortedColumnOrders.slice(0).sort((b2, a10) => Math.abs(b2 - this._focusedColumnOrder) - Math.abs(a10 - this._focusedColumnOrder))[0]);
      ...
      const columnIndexByOrder = dstColumns.reduce((acc, col, i6) => {
        acc[col._order] = i6;
        return acc;
      }, {});
  ...
  /** @private */
  _onInteractionKeyDown(e11, key) {
    const localTarget = e11.composedPath()[0];
    ...
    const {
      cell
    } = this._getGridEventLocation(e11);
  ...
  /** @private */
  _onTabKeyDown(e11) {
    const focusTarget = this._predictFocusStepTarget(e11.composedPath()[0], e11.shiftKey ? -1 : 1);
    if (!focusTarget) {
      return;
    }
    e11.stopPropagation();
  ...
  _onSpaceKeyDown(e11) {
    e11.preventDefault();
    const element = e11.composedPath()[0];
  ...
  /** @private */
  _onKeyUp(e11) {
    if (!/^( |SpaceBar)$/u.test(e11.key) || this.interacting) {
      return;
    }
    e11.preventDefault();
    const cell = e11.composedPath()[0];
    if (cell._content && cell._content.firstElementChild) {
      const wasNavigating = this.hasAttribute("navigating");
      cell._content.firstElementChild.dispatchEvent(new MouseEvent("click", {
        shiftKey: e11.shiftKey,
        bubbles: true,
        composed: true,
        cancelable: true
      }));
  ...
  _onFocusIn(e11) {
    ...
    const rootTarget = e11.composedPath()[0];
  ...
  _onContentFocusIn(e11) {
    ...
    if (section && (cell || row)) {
      ...
      if (cell) {
        const context = this.getEventContext(e11);
        ...
        if (isKeyboardActive() && e11.target === cell) {
          this._showTooltip(e11);
        }
      } else {
        this._focusedCell = null;
      }
    }
    this._detectFocusedItemIndex(e11);
  }
  /**
   * @private
   */
   ...
   * @private
   */
  _detectInteracting(e11) {
    const isInteracting = e11.composedPath().some((el) => el.localName === "vaadin-grid-cell-content");
    this._setInteracting(isInteracting);
    this.__updateHorizontalScrollPosition();
  }
  /** @private */
  _detectFocusedItemIndex(e11) {
    const {
      section,
      row
    } = this._getGridEventLocation(e11);
  ...
  _scrollHorizontallyToCell(dstCell) {
    ...
    for (let i6 = dstCellIndex - 1; i6 >= 0; i6--) {
      const cell = dstRow.children[i6];
    ...
    for (let i6 = dstCellIndex + 1; i6 < dstRow.children.length; i6++) {
      const cell = dstRow.children[i6];
      if (cell.hasAttribute("hidden") || this.__isDetailsCell(cell)) {
        continue;
      }
...
var RowDetailsMixin = (superClass) => class RowDetailsMixin extends superClass {
  ...
  closeItemDetails(item) {
    if (this._isDetailsOpened(item)) {
      this.detailsOpenedItems = this.detailsOpenedItems.filter((i6) => !this._itemsEqual(i6, item));
    }
  }
};
...
var ActiveMixin = (superclass) => class ActiveMixinClass extends DisabledMixin(KeyboardMixin(superclass)) {
  ...
  _onKeyDown(event) {
    ...
    if (this._shouldSetActive(event) && this._activeKeys.includes(event.key)) {
      this._setActive(true);
      document.addEventListener("keyup", (e11) => {
        if (this._activeKeys.includes(e11.key)) {
          this._setActive(false);
        }
      }, {
        once: true
...
var FocusMixin = dedupingMixin((superclass) => class FocusMixinClass extends superclass {
  ...
  /** @protected */
  ready() {
    this.addEventListener("focusin", (e11) => {
      if (this._shouldSetFocus(e11)) {
        this._setFocused(true);
      }
    });
    this.addEventListener("focusout", (e11) => {
      if (this._shouldRemoveFocus(e11)) {
...
var ScrollMixin = (superClass) => class ScrollMixin extends ResizeMixin(superClass) {
  ...
  ready() {
    ...
    this.$.items.addEventListener("focusin", (e11) => {
      const itemsIndex = e11.composedPath().indexOf(this.$.items);
      this._rowWithFocusedElement = e11.composedPath()[itemsIndex - 1];
    });
  ...
  _debounceUpdateFrozenColumn() {
    this.__debounceUpdateFrozenColumn = Debouncer.debounce(this.__debounceUpdateFrozenColumn, microTask2, () => this._updateFrozenColumn());
  }
  /** @private */
  _updateFrozenColumn() {
    if (!this._columnTree) {
    ...
    columnsRow.sort((a10, b2) => {
      return a10._order - b2._order;
    });
    let lastFrozen;
    let firstFrozenToEnd;
    for (let i6 = 0; i6 < columnsRow.length; i6++) {
      const col = columnsRow[i6];
...
var SelectionMixin = (superClass) => class SelectionMixin extends superClass {
  ...
  deselectItem(item) {
    if (this._isSelected(item)) {
      this.selectedItems = this.selectedItems.filter((i6) => !this._itemsEqual(i6, item));
    }
  }
  /**
...
var SortMixin = (superClass) => class SortMixin extends superClass {
  ...
  /** @private */
  _onSorterChanged(e11) {
    const sorter = e11.target;
    e11.stopPropagation();
    sorter._grid = this;
    this.__updateSorter(sorter, e11.detail.shiftClick, e11.detail.fromSorterClick);
    this.__applySorters();
  }
  /** @private */
  ...
  __updateSorter(sorter, shiftClick, fromSorterClick) {
    ...
    if (this.multiSort && (!this.multiSortOnShiftClick || !fromSorterClick) || this.multiSortOnShiftClick && shiftClick) {
      ...
      const otherSorters = this._sorters.filter((s10) => s10 !== sorter);
...
var GridMixin = (superClass) => class extends ArrayDataProviderMixin(DataProviderMixin(DynamicColumnsMixin(ActiveItemMixin(ScrollMixin(SelectionMixin(SortMixin(RowDetailsMixin(KeyboardNavigationMixin(A11yMixin(FilterMixin(ColumnReorderingMixin(ColumnResizingMixin(EventContextMixin(DragAndDropMixin(StylingMixin(TabindexMixin(superClass))))))))))))))))) {
  ...
  /** @private */
  _getRenderedRows() {
    return Array.from(this.$.items.children).filter((item) => !item.hidden).sort((a10, b2) => a10.index - b2.index);
  }
  /** @protected */
  ...
  _createScrollerRows(count) {
    ...
    if (this._columnTree) {
      this._columnTree[this._columnTree.length - 1].forEach((c5) => {
        if (c5.isConnected && c5._cells) {
          c5._cells = [...c5._cells];
        }
      });
    }
  ...
  __debounceUpdateHeaderFooterRowVisibility(row) {
    row.__debounceUpdateHeaderFooterRowVisibility = Debouncer.debounce(row.__debounceUpdateHeaderFooterRowVisibility, microTask2, () => this.__updateHeaderFooterRowVisibility(row));
  }
  /**
   * @param {HTMLTableRowElement} row
   * @protected
  ...
  /** @private */
  _onAnimationEnd(e11) {
    if (e11.animationName.indexOf("vaadin-grid-appear") === 0) {
      e11.stopPropagation();
      this.__tryToRecalculateColumnWidthsIfPending();
      requestAnimationFrame(() => {
        this.__scrollToPendingIndexes();
  ...
  _groupOrderChanged(order, rootColumns) {
    if (rootColumns) {
      ...
      if (_rootColumns[0] && _rootColumns[0]._order) {
        _rootColumns.sort((a10, b2) => a10._order - b2._order);
      }
...
var GridSelectionColumnBaseMixin = (superClass) => class GridSelectionColumnBaseMixin extends superClass {
   ...
   * @override
   */
  _defaultRenderer(root2, _column, {
    item,
    selected
  }) {
    let checkbox = root2.firstElementChild;
   ...
   * @private
   */
  __onSelectAllCheckedChanged(e11) {
    if (e11.target.checked === e11.target.__rendererChecked) {
      return;
    }
    if (this._indeterminate || e11.target.checked) {
      this._selectAll();
    } else {
      this._deselectAll();
    }
   ...
   * @private
   */
  __onSelectRowCheckedChanged(e11) {
    if (e11.target.checked === e11.target.__rendererChecked) {
      return;
    }
    if (e11.target.checked) {
      this._selectItem(e11.target.__item);
    } else {
      this._deselectItem(e11.target.__item);
    }
  }
  /** @private */
  __onCellTrack(event) {
  ...
  /** @private */
  _onCellKeyDown(e11) {
    const target = e11.composedPath()[0];
    if (e11.keyCode === 32 && (target === this._headerCell || this._cells.includes(target) && !this.autoSelect)) {
...
var GridSelectionColumnMixin = (superClass) => class extends GridSelectionColumnBaseMixin(superClass) {
   ...
   * @private
   */
  __arrayContains(a10, b2) {
    return Array.isArray(a10) && Array.isArray(b2) && b2.every((i6) => a10.includes(i6));
  }
  /**
  ...
  /** @private */
  __onActiveItemChanged(e11) {
    const activeItem = e11.detail.value;
    if (this.autoSelect) {
...
var GridSorterMixin = (superClass) => class GridSorterMixinClass extends superClass {
  ...
  __dispatchSorterChangedEvenIfPossible() {
    ...
    this.dispatchEvent(new CustomEvent("sorter-changed", {
      detail: {
        shiftClick: Boolean(this._shiftClick),
        fromSorterClick: Boolean(this._fromSorterClick)
      },
      bubbles: true,
      composed: true
    }));
...
var l6 = class extends o2.EventedAccessor {
  constructor(t4) {
    super(t4), this.cellPartNameGenerator = (t5, e11) => {
      let o4 = "";
      e11?.item && this.rowHighlightIds.includes(e11.item.objectId) && (o4 += " highlight");
      const i6 = this.findColumn(t5?.path);
      return i6 ? (i6.invalid && (o4 += " invalid"), i6.textWrap && (o4 += " text-wrap"), "editInfo" in i6 && i6.editInfo && i6.editInfo.rowData?.index === e11.index && (o4 += " editing"), o4) : o4;
    }, this.columnPerformanceModeEnabled = true, this.columnReorderingEnabled = true, this.columns = new V(), this.dataProvider = (t5, e11) => __async(this, null, function* () {
      const {
        store: o4
      } = this;
      if (!e11) return;
      if (!o4) return void (e11 && e11([]));
      e11(yield o4.fetchItems(t5));
    }), this.multipleSelectionEnabled = true, this.multiSortEnabled = false, this.pageSize = 50, this.rowDetailsRenderer = null, this.store = null;
  }
  get actionColumn() {
    return this.columns.find((t4) => t4.fieldName === e8.action);
  }
  get attachmentsColumn() {
    return this.columns.find((t4) => t4.fieldName === e8.attachments);
  }
  get columnMenuIsOpen() {
    return this.columns.some((t4) => t4.menuIsOpen);
  }
  get editing() {
    return this.editorColumns.some((t4) => t4.editInfo);
  }
  get editorColumns() {
    return this.columns.toArray().filter((t4) => "editable" in t4);
  }
  get fieldColumns() {
    return this.columns.toArray().filter((t4) => "field" in t4);
  }
  get filterBySelectionEnabled() {
    return !!this._get("filterBySelectionEnabled");
  }
  set filterBySelectionEnabled(t4) {
    this._set("filterBySelectionEnabled", t4);
  }
  get highlightIds() {
    return this._get("highlightIds") || new V();
  }
  set highlightIds(t4) {
    const i6 = Array.isArray(t4) ? new V(t4) : t4;
    this.multipleSelectionEnabled || i6.splice(1, i6.length - 1), this._set("highlightIds", n5(i6, this._get("highlightIds"), V));
  }
  get relationshipColumns() {
    return this.columns.toArray().filter((t4) => "relationshipId" in t4);
  }
  get rowHighlightIds() {
    return this._get("rowHighlightIds") || new V();
  }
  set rowHighlightIds(t4) {
    this._set("rowHighlightIds", n5(t4, this._get("rowHighlightIds"), V));
  }
  get size() {
    return this.filterBySelectionEnabled && !this.highlightIds.length ? 0 : this.store?.count || 0;
  }
  get state() {
    return this.store?.state ?? "disabled";
  }
  closeColumnMenus() {
    this.columns.forEach((t4) => t4.closeMenu());
  }
  sortColumn(t4, e11) {
    if (!t4) return;
    const o4 = this.findColumn(t4);
    o4 && (o4.direction = e11);
  }
  hideColumn(t4) {
    const e11 = this.findColumn(t4);
    false === e11?.hidden && (e11.hidden = true);
  }
  showColumn(t4) {
    const e11 = this.findColumn(t4);
    e11?.hidden && (e11.hidden = false);
  }
  showAllColumns() {
    this.columns.forEach((t4) => {
      t4.hidden && (t4.hidden = false);
    });
  }
  findColumn(t4) {
    const e11 = [];
    return this.columns.forEach((t5) => {
      e11.push(t5), "columns" in t5 && t5.columns?.forEach((t6) => e11.push(t6));
    }), e11.find((e12) => e12.fieldName === t4);
  }
  getRowItemAt(t4) {
    return this.store?.getLocalItemAt(t4);
  }
  refresh() {
    this.store && (this.store.reset(), this.store.load());
  }
  toggleColumnVisibility(t4) {
    const e11 = this.findColumn(t4);
    e11 && (e11.hidden = !e11.hidden);
  }
};
e([y()], l6.prototype, "actionColumn", null), e([y()], l6.prototype, "attachmentsColumn", null), e([y()], l6.prototype, "cellPartNameGenerator", void 0), e([y()], l6.prototype, "columnMenuIsOpen", null), e([y()], l6.prototype, "columnPerformanceModeEnabled", void 0), e([y()], l6.prototype, "columnReorderingEnabled", void 0), e([y()], l6.prototype, "columns", void 0), e([y()], l6.prototype, "dataProvider", void 0), e([y()], l6.prototype, "editing", null), e([y()], l6.prototype, "editorColumns", null), e([y()], l6.prototype, "fieldColumns", null), e([y()], l6.prototype, "filterBySelectionEnabled", null), e([y()], l6.prototype, "highlightIds", null), e([y()], l6.prototype, "multipleSelectionEnabled", void 0), e([y()], l6.prototype, "multiSortEnabled", void 0), e([y()], l6.prototype, "pageSize", void 0), e([y()], l6.prototype, "relationshipColumns", null), e([y()], l6.prototype, "rowHighlightIds", null), e([y()], l6.prototype, "rowDetailsRenderer", void 0), e([y({
  readOnly: true
})], l6.prototype, "size", null), e([y()], l6.prototype, "store", void 0), e([y({
  readOnly: true
})], l6.prototype, "state", null), l6 = e([a2("esri.widgets.FeatureTable.Grid.GridViewModel")], l6);
var d7 = l6;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/Grid/Grid.js
var m = "esri-grid";
var g2 = "compact column-borders";
var p4 = {
  base: m,
  content: `${m}__content`,
  grid: `${m}__grid`
...
var v2 = class extends B {
  constructor(e11, t4) {
    super(e11, t4), this._columnElements = [], this._grid = null, this.itemIdPath = null, this.messages = null, this.selectionColumnEnabled = true, this.viewModel = new d7();
  }
  initialize() {
    this.addHandles([this.columns.on("before-changes", () => this.renderNow()), this.columns.on("change", () => this.onColumnChange()), v(() => this.highlightIds, "before-add", ({
      target: e11
    }) => {
      !this.multipleSelectionEnabled && e11.length && e11.removeAll();
    }), this.rowHighlightIds.on("change", () => this.generateCellPartNames()), d2(() => this.viewModel.size, () => this._updateGridSize()), d2(() => this.viewModel.editing, () => {
      this.generateCellPartNames(), this.requestContentUpdate();
    }), d2(() => this.store?.state, (e11, t4) => {
      "ready" !== e11 || "loaded" !== t4 && "error" !== t4 || this.refreshPageCache();
    }), v(() => this._table, "scroll", () => this.viewModel.closeColumnMenus()), d2(() => this.multipleSelectionEnabled, (e11) => {
      !e11 && this.highlightIds.length > 1 && this.highlightIds.removeAll();
    })]);
  }
  destroy() {
  ...
  resetColumns() {
    this.columns.drain((e11) => !e11.destroyed && e11.destroy());
  }
  get _editInfos() {
    return this.viewModel.editorColumns.map((e11) => e11.editInfo).filter(O);
  }
  ...
  get _selectedItems() {
    ...
    return e11.toArray().map((e12) => t4?.getItemByObjectId(e12) ?? {
      objectId: e12
    });
  }
  get _table() {
  ...
  set cellPartNameGenerator(e11) {
    this.viewModel.cellPartNameGenerator = e11;
  }
  get columns() {
    return this.viewModel.columns;
  }
  set columns(e11) {
    this.viewModel.columns = e11;
  }
  get columnPerformanceModeEnabled() {
    return this.viewModel.columnPerformanceModeEnabled;
  }
  set columnPerformanceModeEnabled(e11) {
    this.viewModel.columnPerformanceModeEnabled = e11;
  }
  get columnReorderingEnabled() {
    return this.viewModel.columnReorderingEnabled;
  }
  set columnReorderingEnabled(e11) {
    this.viewModel.columnReorderingEnabled = e11;
  }
  get dataProvider() {
    return this.viewModel.dataProvider;
  }
  set dataProvider(e11) {
    this.viewModel.dataProvider = e11;
  }
  get highlightIds() {
    return this.viewModel.highlightIds;
  }
  set highlightIds(e11) {
    this.viewModel.highlightIds = e11;
  }
  get isEditingActive() {
  ...
  set multipleSelectionEnabled(e11) {
    this.viewModel.multipleSelectionEnabled = e11;
  }
  get multiSortEnabled() {
    return this.viewModel.multiSortEnabled;
  }
  set multiSortEnabled(e11) {
    this.viewModel.multiSortEnabled = e11;
  }
  get pageSize() {
    return this.viewModel.pageSize;
  }
  set pageSize(e11) {
    this.viewModel.pageSize = e11;
  }
  get rowDetailsRenderer() {
    return this.viewModel.rowDetailsRenderer;
  }
  set rowDetailsRenderer(e11) {
    this.viewModel.rowDetailsRenderer = e11;
  }
  get rowHighlightIds() {
    return this.viewModel.rowHighlightIds;
  }
  set rowHighlightIds(e11) {
    this.viewModel.rowHighlightIds = e11;
  }
  get size() {
    return this.viewModel.size;
  }
  get sortOrders() {
    return this._grid?._sorters ? this._grid._sorters.filter((e11) => !!e11 && e11.path).map(({
      direction: e11,
      path: t4
    }) => ({
      direction: e11,
  ...
  set store(e11) {
    this.viewModel.store = e11;
  }
  getColumnProps(e11, t4) {
    const {
      id: i6
    } = this, {
      autoWidth: r7,
      ...
      textAlign: m3,
      width: g4
    } = e11, p8 = `${i6}_${n12}_${t4}`, {
      renderFunction: _2,
      footerRenderFunction: v3,
      headerRenderFunction: f5
    } = e11, w2 = v3 ? (e12, t5) => v3({
      root: e12,
      column: t5
    }) : void 0, C3 = f5 ? (e12, t5) => f5({
      root: e12,
      column: t5
    }) : void 0, b2 = _2 ? (e12, t5, i7) => _2({
      root: e12,
      column: t5,
      rowData: i7
    }) : void 0;
    return {
      ...
      bind: this,
      header: c5,
      headerPartName: h3 ? "invalid" : void 0,
      path: n12,
      "text-align": m3,
      width: "number" == typeof g4 ? `${g4}px` : g4,
  ...
  clearSort() {
    let e11 = false;
    if (this._grid) {
      if (this._grid._sorters?.length && (this._grid._sorters.forEach((e12) => {
        e12._order = null, e12.direction = null;
      }), e11 = true), this.columns.length) {
        this.columns.some((e12) => !!e12.direction) && (this.columns.forEach((e12) => e12.direction = null), e11 = true);
      }
      e11 && (this.notifyChange("sortOrders"), this.scheduleRender());
    }
  }
  findColumn(e11) {
    return this.viewModel.findColumn(e11);
  }
  generateCellPartNames() {
    this._grid?.generateCellPartNames();
  }
  getRowContainingNode(e11) {
    return this._grid?._getRowContainingNode(e11);
  }
  getSlotElementByName(e11) {
    return this._grid?.shadowRoot?.querySelector(`slot[name='${e11}']`) ?? null;
  }
  hideColumn(e11) {
    this.viewModel.hideColumn(e11);
  }
  recalculateColumnWidths() {
  ...
  selectRows(e11) {
    const {
      itemIdPath: t4
    } = this, i6 = e11?.filter((e12) => !this.highlightIds.includes(e12[t4])), r7 = i6.map((e12) => e12[t4]);
    r7.length && (this.multipleSelectionEnabled || (this.highlightIds.removeAll(), r7.splice(1)), this.highlightIds.addMany(r7));
  }
  deselectRows(e11) {
    const {
      itemIdPath: t4
    } = this, i6 = e11?.map((e12) => e12[t4]) || [];
    i6.length && this.highlightIds.removeMany(i6);
  }
  showColumn(e11) {
    this.viewModel.showColumn(e11);
  }
  sort({
    path: e11,
    direction: t4
  }) {
    this.viewModel.sortColumn(e11, t4), this.notifyChange("sortOrders");
  }
  scrollToIndex(e11) {
    this._grid?.scrollToIndex(e11);
  }
  scrollToTop() {
    this.scrollToIndex(0);
  }
  ...
  scrollLeft(e11) {
    ...
    t4 && (t4.scrollLeft = e11);
  }
  toggleColumnVisibility(e11) {
    this.viewModel.toggleColumnVisibility(e11);
  }
  onColumnChange() {
    this._columnElements.forEach((e11) => {
      this._applyRenderersToColumnElement(e11);
    }), this.requestContentUpdate();
  }
  render() {
    return n3("div", {
      bind: this,
      class: this.classes(p4.base, e3.widget)
    }, n3("div", {
      bind: this,
      class: p4.content
    }, this._renderGrid()));
  ...
  _renderSelectionColumn() {
    return n3("vaadin-grid-selection-column", {
      _selectAllHidden: true,
      bind: this,
      dragSelect: true,
      frozen: true,
      hidden: !this.selectionColumnEnabled,
      selectAll: false,
      sortable: false,
      textAlign: "center"
    });
  ...
  _renderColumns() {
    return Array.from(this.columns, (e11, t4) => "columns" in e11 ? this._renderGroupColumn(e11, t4) : n3("vaadin-grid-column", __spreadValues({}, this.getColumnProps(e11, t4)))).filter(O);
  }
  _renderGroupColumn(e11, t4) {
    const i6 = this.getColumnProps(e11, t4);
    if (i6.hidden || !e11.columns) return null;
    const r7 = e11.columns.filter(({
      hidden: e12
    }) => !e12);
    return r7.length ? n3("vaadin-grid-column-group", __spreadValues({}, i6), r7.map((e12) => n3("vaadin-grid-column", __spreadValues({}, this.getColumnProps(e12, t4))))) : null;
  }
  _afterGridCreate(e11) {
    const t4 = this._grid = e11;
    t4.setAttribute("theme", g2), customElements.whenDefined("vaadin-grid").then(() => {
      this._appendStyles(), this._addGridEventListeners();
    }), t4.__updateSorter = (e12) => {
      const i6 = t4._sorters, r7 = !i6.includes(e12);
      if (e12.direction || !r7) {
        if (e12._order = null, t4.multiSort) t4._removeArrayItem(i6, e12), e12.direction && (null != e12._initialOrder ? (r7 ? i6[e12._initialOrder] = e12 : i6.splice(e12._initialOrder, 0, e12), e12._initialOrder = null) : i6.unshift(e12)), t4.__updateSortOrders();
        else if (e12.direction) {
          const r8 = i6.filter((t5) => t5 !== e12);
          t4._sorters = [e12], r8.forEach((e13) => {
            e13._order = null, e13.direction = null;
          });
        }
      }
    };
  ...
  _appendStyles() {
    const e11 = this._grid?.shadowRoot, t4 = document.createElement("style");
    e11 && (t4.textContent = `
  ...
  _afterGridUpdate(e11) {
    this._grid || (this._grid = e11);
  }
  _afterColumnCreate(e11) {
    this._columnElements.push(e11);
  }
  _afterColumnRemoved(e11) {
    const t4 = this._columnElements.indexOf(e11, 0);
    t4 > -1 && this._columnElements.splice(t4, 1);
  }
  _updateGridSize() {
    this._grid && (this._grid.size = this.size || 0, this.scheduleRender());
  }
  _addGridEventListeners() {
    const e11 = this._grid;
    n2(e11), this.addHandles([o(e11, ["click", "keydown", "pointerover", "pointerout"], (e12) => this._onGridInteraction(e12)), o(e11, "selected-items-changed", (e12) => this._onSelectedItemsChange(e12)), o(e11, "sorter-changed", () => this.notifyChange("sortOrders"))]);
  }
  _onGridInteraction(e11) {
    const t4 = this._grid;
    if (n2(t4), ("pointerover" === e11.type || "pointerout" === e11.type) && e11.relatedTarget !== t4) {
      const {
        target: t5,
        relatedTarget: i7
      } = e11;
      if (!this._isGridCellContentNode(t5) || !this._isGridCellContentNode(i7)) return;
    }
    let i6 = null;
    try {
      i6 = t4.getEventContext(e11);
    } catch (a10) {
    }
    if (!i6) return;
    const {
    ...
    if (!s10) return;
    if ("header" === s10 && "keydown" === e11.type && o4?.path) {
      const t5 = e11.key;
      _.sort.includes(t5) && this.findColumn(o4.path)?.sort();
    }
    const d8 = `cell-${e11.type}`;
    this.emit(d8, {
      type: d8,
      context: i6,
      index: n12,
  ...
  _isGridCellContentNode(e11) {
    return !!(e11 && e11 instanceof HTMLElement && "vaadin-grid-cell-content" === e11.localName);
  }
  _clearSelection() {
    this.highlightIds.removeAll();
  }
  _onSelectedItemsChange(e11) {
    const {
      highlightIds: t4,
      itemIdPath: i6
    } = this, r7 = e11.detail.value.map((e12) => e12[i6]), o4 = r7.filter((e12) => !t4.includes(e12));
    if (!this.multipleSelectionEnabled && o4.length && t4.length) t4.removeAll(), t4.add(o4[0]);
    else {
      const e12 = t4.filter((e13) => !r7.includes(e13));
      t4.removeMany(e12), t4.addMany(o4);
    }
  }
  _applyRenderersToColumnElement(e11) {
    const t4 = e11?.path, i6 = null != t4 ? this.findColumn(t4) : void 0;
    if (i6) try {
      const {
        renderFunction: t5,
        footerRenderFunction: r7,
        headerRenderFunction: o4
      } = i6;
      t5 && "renderer" in e11 && (e11.renderer = (e12, i7, r8) => t5({
        root: e12,
        column: i7,
        rowData: r8
      })), r7 && (e11.footerRenderer = (e12, t6) => r7({
        root: e12,
        column: t6
      })), o4 && (e11.headerRenderer = (e12, t6) => o4({
        root: e12,
        column: t6
      }));
    } catch (r7) {
...
e([y()], v2.prototype, "_editInfos", null), e([y()], v2.prototype, "_columnElements", void 0), e([y()], v2.prototype, "_columnRendering", null), e([y()], v2.prototype, "_selectedItems", null), e([y()], v2.prototype, "_grid", void 0), e([y()], v2.prototype, "_table", null), e([y()], v2.prototype, "cellPartNameGenerator", null), e([y()], v2.prototype, "columns", null), e([y()], v2.prototype, "columnPerformanceModeEnabled", null), e([y()], v2.prototype, "columnReorderingEnabled", null), e([y()], v2.prototype, "dataProvider", null), e([y()], v2.prototype, "highlightIds", null), e([y()], v2.prototype, "isEditingActive", null), e([y()], v2.prototype, "itemIdPath", void 0), e([y()], v2.prototype, "label", null), e([y(), e2("esri/widgets/FeatureTable/t9n/FeatureTable")], v2.prototype, "messages", void 0), e([y()], v2.prototype, "multipleSelectionEnabled", null), e([y()], v2.prototype, "multiSortEnabled", null), e([y()], v2.prototype, "pageSize", null), e([y()], v2.prototype, "rowDetailsRenderer", null), e([y()], v2.prototype, "rowHighlightIds", null), e([y()], v2.prototype, "selectionColumnEnabled", void 0), e([y()], v2.prototype, "size", null), e([y({
  readOnly: true
})], v2.prototype, "sortOrders", null), e([y()], v2.prototype, "store", null), e([y()], v2.prototype, "viewModel", void 0), v2 = e([a2("esri.widgets.FeatureTable.Grid.Grid")], v2);
var f3 = v2;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/Grid/GroupColumn.js
var e9 = class extends d5 {
  constructor(o4) {
    super(o4), this.columns = null, this.sortable = false;
  }
  initialize() {
    this._set("fieldName", `group:${this.label}`);
  }
};
e([y()], e9.prototype, "columns", void 0), e([y({
  readOnly: true
})], e9.prototype, "sortable", void 0), e9 = e([a2("esri.widgets.FeatureTable.Grid.GroupColumn")], e9);
var i5 = e9;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/FeatureStore.js
var g3 = class extends S {
  constructor(e11) {
    super(e11), this._defaultOutFields = ["*"], this._editOperationQueue = new V(), this._hasStaleCache = false, this._loaded = false, this._loadError = false, this._loading = false, this._objectIdCache = new V(), this._queryOperationQueue = new V(), this.attachmentsEnabled = false, this.count = 0, this.failures = new V(), this.filterGeometry = null, this.itemCache = new V(), this.layer = null, this.objectIds = null, this.outFields = null, this.relationshipConfig = null, this.relatedRecordsEnabled = false, this.returnGeometry = false, this.returnZ = false, this.returnM = false, this.timeExtent = null, this.where = null;
  }
  initialize() {
    this.addHandles([d2(() => [this.filterGeometry, this.layer, this.objectIds, this.relationshipConfig, this.returnGeometry, this.returnM, this.returnZ, this.timeExtent, this.where], () => this._reset()), p(() => this.attachmentsEnabled, () => this._reset()), p(() => this.relatedRecordsEnabled, () => this._reset())]);
  }
  destroy() {
  ...
  get _capabilities() {
    ...
    return e11?.effectiveCapabilities ?? e11?.capabilities;
  }
  ...
  get _layerWithAttachments() {
    const {
      _capabilities: e11,
      attachmentsEnabled: t4,
      layer: r7,
      supportsAttachments: s10
    } = this;
    if (e11 && r7 && t4 && s10) return i4(r7) ? r7 : null;
  }
  get _layerWithEditing() {
    const e11 = this.layer;
    return r3(e11) && this.supportsEditing ? e11 : null;
  }
  get _layerWithRelationships() {
    const e11 = this.layer;
    return a6(e11) && this.supportsQueryRelated ? e11 : null;
  }
  get _relatedLayer() {
  ...
  get _relatedLayerSupportsQueryRelated() {
    const {
      _relatedLayerCapabilities: e11
    } = this;
    return !!e11?.queryRelated?.supportsCount && !!e11?.queryRelated?.supportsPagination;
  }
  ...
  get canAddRelatedFeature() {
    ...
    if ("loaded" !== e11 || !t4 || !r7 || !s10) return false;
    const {
      count: i6
    } = this, {
      cardinality: o4,
    ...
    return ("one-to-one" !== o4 || !n12) && ("one-to-many" !== o4 || "origin" !== a10 || !n12);
  }
  ...
  get effectiveTimeExtent() {
    ...
    return t4 || e11 && "timeExtent" in e11 && e11.timeExtent || null;
  }
  get effectiveWhere() {
    return this.where || this.layer?.definitionExpression || "1=1";
  }
  get orderByFields() {
    return this._get("orderByFields") || [];
  }
  set orderByFields(e11) {
    const t4 = this.orderByFields;
    h(e11, t4) || (this.itemCache.removeAll(), this._hasStaleCache = true, this._set("orderByFields", e11));
  }
  get querying() {
  ...
  get relationship() {
    const {
      relationshipConfig: e11
    } = this;
    return null == e11?.relationshipId ? null : this.relationships?.find((t4) => t4.id === e11.relationshipId);
  }
  get relationshipIds() {
    return this.relationships?.map((e11) => e11.id) ?? [];
  }
  get relationships() {
  ...
  get state() {
    ...
    return !e11 || e11.destroyed ? "disabled" : r7 || e11.loadError ? "error" : "loaded" === e11.loadStatus && t4 ? "loaded" : s10 ? "loading" : "ready";
  }
  get supportsAdd() {
  ...
  get supportsAttachments() {
    ...
    return !(!e11?.data?.supportsAttachment || !e11?.operations.supportsQueryAttachments);
  }
  ...
  load() {
    return __async(this, null, function* () {
      ...
      if (!this._loading && !this._loaded && e11) {
        this._reset(), this._loading = true;
        try {
          yield e11.when(), yield this._syncLayerInfo(), this._loaded = true, this._loading = false;
        } catch (t4) {
          throw this._reset(), this._loadError = true, this._logError("store:load-error", "An error occurred."), t4;
        }
      }
    });
  }
  ...
  fetchItems(e11) {
    return __async(this, null, function* () {
      const {
        page: t4,
        pageSize: r7
      } = e11, s10 = t4 * r7, i6 = s10 + r7, {
        layer: o4,
        state: a10
      } = this;
      return o4 && "loaded" === a10 ? this._query({
        layer: o4,
        start: s10,
        num: i6,
        page: t4,
  ...
  verifyFeaturesByObjectId(e11) {
    return __async(this, null, function* () {
      const {
        layer: t4,
        state: r7
      } = this;
      if (!t4 || "loaded" !== r7) return [];
      const {
        objectIdField: s10
      } = t4, {
        features: i6
      } = yield this._verifyFeaturesByObjectId(e11);
      return e11.map((e12) => i6.some((t5) => {
        const r8 = t5.getObjectId() ?? t5.attributes[s10];
        return e12 === r8;
      }));
    });
  }
  query(e11) {
    return __async(this, null, function* () {
      ...
      return this.supportsQuery && "loaded" === t4 ? this._query(e11) : [];
    });
  }
  removeItemAt(e11) {
    return __async(this, null, function* () {
  ...
  updateItem(e11) {
    return __async(this, null, function* () {
      yield this._update(e11);
    });
  }
  deleteRowsByObjectId(e11) {
    return __async(this, null, function* () {
      const {
        _layerWithEditing: t4
      } = this;
      if (!this.supportsDelete || !t4) throw new s("store:delete-error", "Delete is not supported.");
      const r7 = e11.map((e12) => this.getItemByObjectId(e12)?.feature).filter(O);
      return this._queueEditOperation(() => t4.applyEdits({
        deleteFeatures: r7
      }));
    });
  }
  getItemByObjectId(e11) {
    const {
      itemCache: t4,
      layer: r7
    } = this;
    if (!r7) return;
    const s10 = r7.objectIdField;
    return t4.find(({
      feature: t5
    }) => !!t5 && (t5.getObjectId() ?? t5.attributes[s10]) === e11);
  }
  getItemIndexByObjectId(e11) {
    const {
      itemCache: t4,
      layer: r7
    } = this;
  ...
  getLocalItemAt(e11) {
    return this.itemCache.at(e11);
  }
  at(e11) {
    return Promise.resolve(this.itemCache.at(e11));
  }
  _reset() {
    this.itemCache.removeAll(), this.failures.removeAll(), this._editOperationQueue.removeAll(), this._queryOperationQueue.removeAll(), this._hasStaleCache = false, this._loading = false, this._loaded = false, this._loadError = false, this._set("count", 0), this._objectIdCache.removeAll();
  }
  _getIdsFromFeatures(e11, t4) {
    return e11.map((e12) => e12.getObjectId() ?? e12.attributes[t4]);
  }
  _resultsToFeatureData(e11) {
    const {
      attachments: t4,
      features: r7,
      layer: s10,
      relatedRecords: i6
    } = e11, o4 = s10.objectIdField;
    return r7.map((e12) => {
      const {
        attributes: r8
      } = e12, a10 = e12.getObjectId() ?? r8[o4], n12 = [];
      return e12.layer || e12.sourceLayer || (e12.layer = s10, e12.sourceLayer = s10), i6.forEach((e13, t5) => {
        n12.push({
          relationshipId: t5,
          count: e13[a10] ?? 0
        });
  ...
  _update(e11) {
    return __async(this, null, function* () {
      const {
        _layerWithEditing: r7
      } = this;
      if (!this.supportsUpdate || !r7) throw new s("store:update-error", "Update is not supported.");
      const {
        index: s10,
        name: i6,
        value: o4
      } = e11, u4 = yield this.at(s10);
      if (!u4?.feature) throw new s("store:update-error", "Feature with provided 'objectId' not found.");
      const {
        feature: l8
      } = u4, p8 = a(l8.attributes);
      p8[i6] = o4;
      const d8 = new d3({
        attributes: p8
      }), h3 = r7.applyEdits({
        ...
        const {
          updateFeatureResults: t4
        } = e12, r8 = t4.find((e13) => !!e13.error);
        if (r8) throw r8.error;
        return t4.length && (l8.attributes = p8), e12;
      });
      return this._queueEditOperation(() => h3);
    });
  }
  _query(e11) {
    return __async(this, null, function* () {
      ...
      return true === t4 ? (this.itemCache.removeAll(), this._syncLayerInfo().then(() => this._queryFeatureData(e11))) : (this._hasStaleCache && (yield this._syncObjectIdCache(), this._hasStaleCache = false), this._queryFeatureData(e11));
    });
  }
  _queryFeatureData(e11) {
    return __async(this, null, function* () {
      const {
        layer: t4
      } = e11;
      return this._queueQueryOperation(() => __async(this, null, function* () {
        const r7 = yield this._queryFeatures(e11), s10 = this._getIdsFromFeatures(r7, t4.objectIdField), i6 = yield this._queryAttachments(s10), o4 = yield this._queryRelatedCounts(s10);
        return this._resultsToFeatureData({
          layer: t4,
          features: r7,
          attachments: i6,
          relatedRecords: o4
  ...
  _syncLayerInfo() {
    return __async(this, null, function* () {
      yield this._syncCount(), yield this._syncObjectIdCache();
    });
  }
  _syncCount() {
    return __async(this, null, function* () {
      yield this._queryCount().then((e11) => this._set("count", e11));
    });
  }
  _syncObjectIdCache() {
    return __async(this, null, function* () {
      if (this.supportsPagination) return;
      const e11 = yield this._queryForObjectIds();
      this._objectIdCache.removeAll(), this._objectIdCache.addMany(e11);
    });
  }
  _queryCount() {
    return __async(this, null, function* () {
      const {
        _relatedLayerSupportsCacheHint: e11,
        layer: t4,
        relationshipConfig: r7,
        supportsCacheHint: s10
      } = this;
      if (!t4) return 0;
      if (r7 && this._canUseRelatedLayer) {
        const {
          objectId: t5,
          relatedLayer: s11,
          relationshipId: i7
        } = r7;
        return (yield s11.queryRelatedFeaturesCount(new d4({
          cacheHint: e11,
          relationshipId: i7,
          objectIds: [t5]
        })))[t5] ?? 0;
      ...
      const {
        effectiveTimeExtent: i6,
        effectiveWhere: o4,
        filterGeometry: a10,
        objectIds: n12
      } = this, u4 = t4.createQuery();
      return u4.geometry = a10, u4.returnGeometry = false, u4.where = o4, u4.timeExtent = i6, u4.objectIds = n12?.length ? n12 : void 0, s10 && (u4.cacheHint = true), t4.queryFeatureCount(u4);
    });
  }
  _queryRelatedCounts(e11) {
    return __async(this, null, function* () {
      const {
        _layerWithRelationships: t4,
        relationshipIds: r7,
        supportsCacheHintQueryRelated: s10
      } = this, i6 = /* @__PURE__ */ new Map();
      return t4 && e11?.length && r7.length ? (yield Promise.allSettled(r7.map((r8) => __async(this, null, function* () {
        const o4 = yield t4.queryRelatedFeaturesCount(new d4({
          cacheHint: s10,
          relationshipId: r8,
          objectIds: e11
        }));
  ...
  _queryForObjectIds() {
    const {
      effectiveTimeExtent: e11,
      effectiveWhere: t4,
      filterGeometry: r7,
      layer: s10,
      objectIds: i6,
      orderByFields: o4,
      supportsCacheHint: a10,
      supportsOrderBy: n12
    } = this;
    if (!s10) return Promise.resolve([]);
    const u4 = s10.createQuery();
    return u4.geometry = r7, u4.outFields = [s10.objectIdField], u4.returnGeometry = false, u4.where = t4, u4.timeExtent = e11, u4.objectIds = i6?.length ? i6 : void 0, n12 && (u4.orderByFields = o4), a10 && (u4.cacheHint = true), s10.queryObjectIds(u4);
  }
  _queryFeatures(e11) {
    return __async(this, null, function* () {
      const {
        relationshipConfig: t4
      } = this;
      if (t4 && this._canUseRelatedLayer) return this._queryRelatedFeatures(e11, t4);
      const {
        _effectiveReturnM: r7,
        _effectiveReturnZ: s10,
        effectiveOutFields: i6,
        effectiveTimeExtent: o4,
        effectiveWhere: a10,
        filterGeometry: n12,
        objectIds: u4,
        orderByFields: l8,
        returnGeometry: p8,
        supportsCacheHint: d8,
        supportsOrderBy: h3,
        supportsPagination: c5
      } = this, {
        layer: y2,
        start: _2,
        pageSize: f5
      } = e11, m3 = u4?.length, g4 = y2.createQuery();
      g4.returnGeometry = p8, g4.outFields = i6, g4.returnM = r7, g4.returnZ = s10, c5 ? (g4.start = _2, g4.num = f5, g4.where = a10, g4.timeExtent = o4, g4.objectIds = m3 ? u4 : void 0) : g4.objectIds = m3 ? u4 : this._getObjectIdsForPage(_2, f5 ?? 0), h3 && (g4.orderByFields = l8), n12 && (g4.geometry = n12), d8 && (g4.cacheHint = true);
      return (yield y2.queryFeatures(g4)).features;
    });
  }
  _queryRelatedFeatures(e11, t4) {
    return __async(this, null, function* () {
      const {
        _defaultOutFields: r7,
        _effectiveReturnM: s10,
        _effectiveReturnZ: i6,
        orderByFields: o4,
        returnGeometry: a10,
        supportsCacheHint: n12
      } = this, {
        layer: u4,
        start: l8,
        pageSize: p8
        ...
        relatedLayer: h3,
        relationshipId: c5
      } = t4, _2 = u4.createQuery(), f5 = new d4({
        cacheHint: n12,
        num: p8 ?? 0,
        objectIds: [d8],
        orderByFields: o4,
        ...
        returnZ: i6,
        start: l8,
        where: _2.where ?? void 0
      }), m3 = yield h3.queryRelatedFeatures(f5);
      return m3[d8]?.features || [];
    });
  }
  _verifyFeaturesByObjectId(e11) {
    return __async(this, null, function* () {
      const {
        layer: t4
      } = this;
      if (!t4 || !this.supportsQuery) throw new s("store:query-error", "Layer does not support query operation.");
      const {
        effectiveTimeExtent: r7,
        effectiveWhere: s10,
        orderByFields: i6,
        supportsCacheHint: o4,
        supportsOrderBy: n12
      } = this, u4 = t4.createQuery();
      return u4.where = s10, u4.timeExtent = r7, u4.returnGeometry = false, u4.objectIds = e11.length ? e11 : void 0, u4.outFields = [t4.objectIdField], n12 && (u4.orderByFields = i6), o4 && (u4.cacheHint = true), t4.queryFeatures(u4);
    });
  }
  _getObjectIdsForPage(e11, t4) {
    const r7 = this._objectIdCache.toArray();
    return r7.length >= e11 + t4 ? r7.slice(e11, e11 + t4) : r7.slice(e11);
  }
  _queryAttachments(e11) {
    const {
      _layerWithAttachments: t4,
      effectiveWhere: r7
    } = this;
    return t4 ? t4.queryAttachments(new c2({
      objectIds: e11,
      where: r7
    })) : Promise.resolve({});
  }
  _syncLocalCache(e11) {
    ...
    e11.forEach((e12) => {
      if (e12?.feature) {
        const {
          feature: t5
        } = e12, i6 = t5.getObjectId() ?? t5.attributes[r7];
        if (null != i6) {
          const t6 = this.getItemIndexByObjectId(i6);
          -1 === t6 ? s10.add(e12) : s10.splice(t6, 1, e12);
        }
      }
    });
  }
  _queueQueryOperation(e11) {
    return this._queryOperationQueue.push(e11), e11().then((t4) => this._queryOperationQueue.includes(e11) ? (this._syncLocalCache(t4), t4) : []).catch((t4) => {
      this._logError("store:query-error", "An error occurred.");
      const r7 = {
        error: t4,
        retry: () => {
          this.failures.remove(r7), this._queueQueryOperation(e11);
        },
        cancel: () => this.failures.remove(r7)
      };
      return this.failures.add(r7), [];
    }).then((t4) => (this._queryOperationQueue.remove(e11), t4));
  }
  _queueEditOperation(e11) {
    return this._editOperationQueue.push(e11), e11().then((t4) => (this._editOperationQueue.remove(e11), t4)).catch((t4) => {
      this._logError("store:edit-error", "An error occurred.");
      const r7 = {
        error: t4,
        retry: () => {
          this.failures.remove(r7), this._queueEditOperation(e11);
        },
        cancel: () => this.failures.remove(r7)
      };
      throw this.failures.add(r7), this._editOperationQueue.remove(e11), t4;
    });
  }
  _logError(e11, t4) {
    n.getLogger(this).error(e11, t4);
  }
};
e([y({
  readOnly: true
})], g3.prototype, "_capabilities", null), e([y()], g3.prototype, "_defaultOutFields", void 0), e([y()], g3.prototype, "_editOperationQueue", void 0), e([y()], g3.prototype, "_effectiveReturnZ", null), e([y()], g3.prototype, "_effectiveReturnM", null), e([y()], g3.prototype, "_hasStaleCache", void 0), e([y({
  readOnly: true
})], g3.prototype, "_layerWithAttachments", null), e([y({
  readOnly: true
})], g3.prototype, "_layerWithEditing", null), e([y({
  readOnly: true
})], g3.prototype, "_layerWithRelationships", null), e([y()], g3.prototype, "_loaded", void 0), e([y()], g3.prototype, "_loadError", void 0), e([y()], g3.prototype, "_loading", void 0), e([y()], g3.prototype, "_objectIdCache", void 0), e([y()], g3.prototype, "_queryOperationQueue", void 0), e([y({
  readOnly: true
})], g3.prototype, "_relatedLayer", null), e([y({
  readOnly: true
})], g3.prototype, "_relatedLayerCapabilities", null), e([y({
  readOnly: true
})], g3.prototype, "_relatedLayerSupportsCacheHint", null), e([y()], g3.prototype, "_relatedLayerSupportsQuery", null), e([y()], g3.prototype, "_relatedLayerSupportsQueryRelated", null), e([y()], g3.prototype, "_canUseRelatedLayer", null), e([y()], g3.prototype, "attachmentsEnabled", void 0), e([y()], g3.prototype, "canAddRelatedFeature", null), e([y({
  readOnly: true
})], g3.prototype, "count", void 0), e([y()], g3.prototype, "effectiveOutFields", null), e([y()], g3.prototype, "effectiveTimeExtent", null), e([y()], g3.prototype, "effectiveWhere", null), e([y({
  readOnly: true
})], g3.prototype, "failures", void 0), e([y()], g3.prototype, "filterGeometry", void 0), e([y({
  readOnly: true
})], g3.prototype, "itemCache", void 0), e([y()], g3.prototype, "layer", void 0), e([y()], g3.prototype, "objectIds", void 0), e([y()], g3.prototype, "orderByFields", null), e([y()], g3.prototype, "outFields", void 0), e([y({
  readOnly: true
})], g3.prototype, "querying", null), e([y()], g3.prototype, "relationship", null), e([y()], g3.prototype, "relationshipConfig", void 0), e([y()], g3.prototype, "relationshipIds", null), e([y()], g3.prototype, "relationships", null), e([y()], g3.prototype, "relatedRecordsEnabled", void 0), e([y()], g3.prototype, "returnGeometry", void 0), e([y()], g3.prototype, "returnZ", void 0), e([y()], g3.prototype, "returnM", void 0), e([y({
  readOnly: true
})], g3.prototype, "state", null), e([y()], g3.prototype, "supportsAdd", null), e([y()], g3.prototype, "supportsAttachments", null), e([y()], g3.prototype, "supportsCacheHint", null), e([y()], g3.prototype, "supportsCacheHintQueryRelated", null), e([y()], g3.prototype, "supportsDelete", null), e([y()], g3.prototype, "supportsEditing", null), e([y()], g3.prototype, "supportsM", null), e([y()], g3.prototype, "supportsOrderBy", null), e([y()], g3.prototype, "supportsPagination", null), e([y()], g3.prototype, "supportsQuery", null), e([y()], g3.prototype, "supportsQueryRelated", null), e([y()], g3.prototype, "supportsUpdate", null), e([y()], g3.prototype, "supportsZ", null), e([y({
  readOnly: true
})], g3.prototype, "syncing", null), e([y()], g3.prototype, "timeExtent", void 0), e([y()], g3.prototype, "where", void 0), g3 = e([a2("esri.widgets.FeatureTable.support.FeatureStore")], g3);
var b = g3;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/ColumnTemplateBase.js
var e10 = class extends f {
  constructor(o4) {
    super(o4), this.autoWidth = false, this.description = null, this.direction = null, this.flexGrow = 1, this.fieldName = null, this.formatFunction = null, this.frozen = false, this.frozenToEnd = false, this.icon = null, this.initialSortPriority = null, this.invalid = false, this.label = null, this.menuConfig = null, this.resizable = true, this.sortable = false, this.textAlign = "start", this.textWrap = false, this.type = null, this.visible = true, this.width = 200;
  }
};
e([y()], e10.prototype, "autoWidth", void 0), e([y()], e10.prototype, "description", void 0), e([y()], e10.prototype, "direction", void 0), e([y()], e10.prototype, "flexGrow", void 0), e([y({
  type: String
})], e10.prototype, "fieldName", void 0), e([y()], e10.prototype, "formatFunction", void 0), e([y()], e10.prototype, "frozen", void 0), e([y()], e10.prototype, "frozenToEnd", void 0), e([y()], e10.prototype, "icon", void 0), e([y()], e10.prototype, "initialSortPriority", void 0), e([y()], e10.prototype, "invalid", void 0), e([y()], e10.prototype, "label", void 0), e([y()], e10.prototype, "menuConfig", void 0), e([y()], e10.prototype, "resizable", void 0), e([y()], e10.prototype, "sortable", void 0), e([y()], e10.prototype, "textAlign", void 0), e([y()], e10.prototype, "textWrap", void 0), e([y({
  type: String,
  json: {
    read: false,
    write: true
  }
})], e10.prototype, "type", void 0), e([y()], e10.prototype, "visible", void 0), e([y()], e10.prototype, "width", void 0), e10 = e([a2("esri.widgets.FeatureTable.support.ColumnTemplateBase")], e10);
var p5 = e10;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/EditableColumnTemplateMixin.js
var s8 = (s10) => {
  let p8 = class extends s10 {
    constructor() {
  ...
  })], p8.prototype, "editable", void 0), e([y({
    type: String,
    json: {
      write: true
    }
  })], p8.prototype, "hint", void 0), e([y({
    types: c,
    json: {
      read: {
        source: "inputType"
  ...
  })], p8.prototype, "input", void 0), e([y()], p8.prototype, "required", void 0), p8 = e([a2("esri.widgets.FeatureTable.support.EditableColumnTemplateMixin")], p8), p8;
};

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/ColumnTemplate.js
var p6 = class extends s8(p5) {
  constructor(o4) {
    super(o4), this.type = "column";
  }
};
e([y({
  type: String,
...
})], p6.prototype, "type", void 0), p6 = e([a2("esri.widgets.FeatureTable.support.ColumnTemplate")], p6);
var m2 = p6;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/FieldColumnTemplate.js
var n10 = class extends s8(p5) {
  constructor(o4) {
    super(o4), this.domain = null, this.editableExpression = null, this.format = null, this.formatFunction = null, this.requiredExpression = null, this.sortable = true, this.type = "field", this.valueExpression = null, this.visibilityExpression = null;
  }
};
e([y({
  types: n4,
...
})], n10.prototype, "domain", void 0), e([y({
  type: String,
  json: {
    write: true
  }
}), y()], n10.prototype, "editableExpression", void 0), e([y()], n10.prototype, "format", void 0), e([y()], n10.prototype, "formatFunction", void 0), e([y({
  type: String,
  json: {
    write: true
  }
})], n10.prototype, "requiredExpression", void 0), e([y()], n10.prototype, "sortable", void 0), e([y({
  type: String,
  json: {
    read: false,
    write: true
...
})], n10.prototype, "valueExpression", void 0), e([y({
  type: String,
  json: {
    write: true
  }
})], n10.prototype, "visibilityExpression", void 0), n10 = e([a2("esri.widgets.FeatureTable.support.FieldColumnTemplate")], n10);
var l7 = n10;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/GroupColumnTemplate.js
var n11 = class extends p5 {
  constructor(e11) {
    super(e11), this.columnTemplates = null, this.type = "group";
  }
  castColumnTemplates(e11) {
    if (!e11 || !Array.isArray(e11)) return [];
    const t4 = [];
    return e11.forEach((e12) => {
      if (e12 instanceof l7 || e12 instanceof m2) t4.push(e12);
      else if (u(e12)) {
        const r7 = e12.type;
        "field" === r7 ? t4.push(new l7(e12)) : "group" === r7 ? n.getLogger(this).warn("A GroupColumnTemplate cannot contain other GroupColumn templates. Template removed from 'GroupColumnTemplate.columnTemplates'.") : "column" === r7 && t4.push(new m2(e12));
...
})], n11.prototype, "columnTemplates", void 0), e([s2("columnTemplates")], n11.prototype, "castColumnTemplates", null), e([y({
  type: String,
  json: {
    read: false,
    write: true
  }
})], n11.prototype, "type", void 0), n11 = e([a2("esri.widgets.FeatureTable.support.GroupColumnTemplate")], n11);
var u2 = n11;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/support/TableTemplate.js
var u3;
var f4 = u3 = class extends f {
  constructor(e11) {
    super(e11), this.columnTemplates = [], this.expressionInfos = null;
  }
  castColumnTemplates(e11) {
    if (!e11 || !Array.isArray(e11)) return [];
    const o4 = [];
    return e11.forEach((e12) => {
      if (e12 instanceof l7 || e12 instanceof u2 || e12 instanceof m2) o4.push(e12);
      else if (u(e12)) {
        const r7 = e12.type;
        "field" === r7 ? o4.push(new l7(e12)) : "group" === r7 ? o4.push(new u2(e12)) : "column" === r7 && o4.push(new m2(e12));
      } else n.getLogger(this).warn("Property 'type' is missing from the provided template. Template removed from 'tableTemplate.columnTemplates'.");
    }), o4;
  }
  clone() {
    return new u3({
      columnTemplates: a(this.columnTemplates),
      expressionInfos: a(this.expressionInfos)
    });
  }
};
e([y()], f4.prototype, "columnTemplates", void 0), e([s2("columnTemplates")], f4.prototype, "castColumnTemplates", null), e([y({
  type: [p3],
  json: {
    write: true
  }
})], f4.prototype, "expressionInfos", void 0), f4 = u3 = e([a2("esri.widgets.FeatureTable.support.TableTemplate")], f4);
var T3 = f4;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/FeatureTableViewModel.js
var Z3 = class extends d7 {
  constructor(e11) {
    super(e11), this._debounceRefresh = k(() => this._refresh()), this._highlights = new r(), this.actionColumnConfig = null, this.attachmentsEnabled = false, this.autoRefreshEnabled = true, this.columns = new V(), this.dataProvider = (e12, t4) => __async(this, null, function* () {
      const {
        layer: i6,
        store: s10
      } = this;
      if (!t4) return;
      if (!i6 || !s10) return void (t4 && t4([]));
      yield i6.load();
      const o4 = this._sortOrdersToLayerOrderByFields(i6, e12.sortOrders);
      s10.set({
        orderByFields: o4
      });
      const {
      ...
      if (this.filterBySelectionEnabled && !this.highlightIds.length || 1 === r7.length && -1 === r7.items[0]) return void t4([]);
      "loaded" !== s10.state && "loading" !== s10.state && (yield s10.load());
      const n12 = yield s10.fetchItems(e12);
      t4 && t4(n12);
    }), this.editingEnabled = false, this.grid = null, this.highlightEnabled = true, this.itemIdPath = "objectId", this.layer = null, this.messages = null, this.messagesCommon = null, this.messagesURIUtils = null, this.relationshipColumnConfigs = null, this.returnGeometryEnabled = false, this.returnMEnabled = false, this.returnZEnabled = false, this.selectionSource = "table", this.showRelatedTableCallback = null, this.store = null, this.tableTemplate = null, this.tableTemplateOverride = null, this.timeZone = null, this.view = null, this._onLayerRefresh = this._onLayerRefresh.bind(this), this._set("store", new b()), this._set("grid", new f3({
      itemIdPath: this.itemIdPath,
      viewModel: this
    }));
  }
  initialize() {
    const e11 = () => __async(this, null, function* () {
      this.messages = yield h2("esri/widgets/FeatureTable/t9n/FeatureTable"), this.messagesCommon = yield h2("esri/t9n/common"), this.messagesURIUtils = yield h2("esri/widgets/support/t9n/uriUtils");
    });
    e11(), this.addHandles([f2(() => {
      e11(), this._generateColumns();
    }), d2(() => [this.messages, this.messagesCommon, this.messagesURIUtils], () => {
      const e12 = this.messages;
      this.grid && (this.grid.messages = e12), this.columns.forEach((t4) => {
        t4.messages = e12, t4.messagesCommon = this.messagesCommon, t4.messagesURIUtils = this.messagesURIUtils;
      }), this._requestContentUpdate();
    }, P), v(() => this.highlightIds, "change", (e12) => this._onHighlightIdsChange(e12), {
      onListenerAdd: () => this._syncSelection(),
      onListenerRemove: () => this._highlights.removeAll()
    }), d2(() => this.attachmentsEnabled, (e12) => {
      const {
        attachmentsColumn: t4,
        columns: i6
      } = this;
      this.store.attachmentsEnabled = e12, t4 && i6.remove(t4), e12 && i6.length && i6.add(this._generateAttachmentsColumn(), this._getIndexOfFirstFrozenToEndColumn());
    }), d2(() => this._viewSelection, () => {
      this._viewSelectionReady && (this.highlightIds.items = this._viewSelection);
    }), d2(() => [this._tableHighlightsReady, this._viewSelectionReady], () => this._syncSelection()), d2(() => [this.returnGeometryEnabled, this.returnMEnabled, this.returnZEnabled], () => {
      const {
        store: e12
      } = this;
      e12.set({
        returnGeometry: this.returnGeometryEnabled,
        returnM: this.returnMEnabled,
        returnZ: this.returnZEnabled
      });
    }), d2(() => this.layer, (e12, t4) => __async(this, null, function* () {
      const i6 = this.grid;
      i6 && (i6.clearSort(), e12 && t4 && (yield this.reset())), this._drainColumns(), this.store.layer = e12, e12 && (e12.loaded ? this._onLayerLoad() : e12.load().catch(() => {
      }));
    })), d2(() => this.layer?.loaded, (e12) => e12 && this._onLayerLoad()), d2(() => this.store.state, (e12) => {
      "loaded" === e12 && (this.grid?.scrollToTop(), this.refreshCellContent());
    }), d2(() => this._effectiveTableTemplate, () => {
      this.grid?.scrollLeft(0), this.layer?.loaded && this._generateColumns();
    }), d2(() => [this.timeZone, this.view?.timeZone], () => {
      this.columns.forEach((e12) => {
        if ("field" in e12 && e12.field) {
          const {
            timeZone: t4,
            timeZoneName: i6
          } = this._getTimeZoneInfoForFieldColumn(e12.field);
          e12.set({
            timeZone: t4,
            timeZoneName: i6
          });
    ...
    }), d2(() => this.editingEnabled, (e12) => {
      this.editorColumns.forEach((t4) => t4.tableEditingEnabled = e12), this._requestContentUpdate();
    }), d2(() => this.layer?.definitionExpression, (e12, t4) => (e12 || t4) && "loaded" === this.store.state && this.reset()), d2(() => this.layer?.timeExtent, (e12, t4) => (e12 || t4) && !this.timeExtent && "loaded" === this.store.state && this.reset()), v(() => this.layer, "refresh", (e12) => this._onLayerRefresh(e12)), v(() => this.grid, ["cell-click", "cell-pointerover", "cell-pointerout", "cell-keydown"], ({
      index: e12,
      item: t4,
      native: i6,
      path: s10,
      ...
      this.emit(o4, {
        ...
        native: i6,
        type: o4,
        fieldName: s10 ?? void 0,
        objectId: r7?.getObjectId()
      });
    }), d2(() => this.actionColumnConfig, (e12) => {
      const {
        actionColumn: t4,
        columns: i6
      } = this;
      t4 ? e12 ? t4.set(e12) : i6.remove(t4) : e12 && i6.length && i6.add(this._generateActionColumn(), false !== e12.frozenToEnd ? void 0 : this._getIndexOfFirstFrozenToEndColumn());
    }), d2(() => [this.relationshipColumnConfigs?.length, this.relatedRecordsEnabled], ([e12, t4]) => {
      const {
        columns: i6,
        relationshipColumns: s10
      } = this;
      s10.length && i6.removeMany(s10), i6.length && t4 && i6.addMany(this._generateRelationshipColumns(), this._getIndexOfFirstFrozenToEndColumn());
    }), v(() => this.objectIds, "change", () => this._onObjectIdsChange(), {
      onListenerAdd: () => this._onObjectIdsChange()
    })]);
  }
  destroy() {
    this._drainColumns(), this._highlights.removeAll(), this._highlights.destroy(), this.grid?.destroy(), this.columns.destroyed || this.columns.destroy(), this.layer = null, this.view = null;
  }
  ...
  get _highlightableLayerView() {
    const e11 = this.layerView;
    return n6(e11) ? e11 : null;
  }
  get _layerWithRelationships() {
    const e11 = this.layer;
    if (!a6(e11)) return null;
    const t4 = e11.effectiveCapabilities ?? e11.capabilities;
    return t4?.queryRelated?.supportsCount && t4.queryRelated.supportsPagination ? e11 : null;
  }
  get _relationshipInfos() {
    const {
      _layerWithRelationships: e11,
      relatedRecordsEnabled: t4,
      relationships: i6,
      view: s10
    } = this, o4 = [];
    return t4 && e11?.loaded && s10?.map && i6?.length ? (i6.forEach((t5) => {
      const i7 = s5(e11, s10, t5);
      i7 && (i7.load(), o4.push({
        layer: e11,
        relatedLayer: i7,
        relationshipId: t5.id
      }));
    }), o4) : o4;
  }
  get _selectionManager() {
    ...
    return !e11 || e11.destroyed ? null : e11.selectionManager?.sources?.length ? e11.selectionManager : null;
  }
  get _selectableLayer() {
    const {
      layer: e11
    } = this;
    return e7(e11) && this._selectionManager?.sources.includes(e11) ? e11 : null;
  }
  ...
  get _viewSelection() {
    const {
      _selectableLayer: e11
    } = this;
    return e11 ? this._selectionManager?.getSelection(e11) ?? [] : [];
  }
  ...
  get activeFilters() {
    ...
    return e11 && r7.push({
      ...
      type: "selection",
      objectIds: o4.toArray()
    }) : i6.length && r7.push({
      type: "objectId",
      objectIds: i6.toArray()
    }), r7;
  }
  get activeSortOrders() {
    return this.grid?.sortOrders ? this.grid.sortOrders.map(({
      path: e11,
      direction: t4
    }) => ({
      fieldName: e11,
      direction: t4
    })).filter((e11) => e11.fieldName && e11.direction) : [];
  }
  get filterGeometry() {
    return this._get("filterGeometry");
  }
  set filterGeometry(e11) {
    this.store.filterGeometry = e11, this._set("filterGeometry", e11);
  }
  get filterBySelectionEnabled() {
    return !!this._get("filterBySelectionEnabled");
  }
  set filterBySelectionEnabled(e11) {
    const {
      objectIds: t4
    } = this, i6 = t4.length;
    e11 ? (i6 && (t4.removeAll(), this._logWarning("Selection filter has been applied with an objectID filter. Object ID filter has been removed.")), this.filterGeometry && this._logWarning("Selection filter has been applied with a geometry filter. Results may appear inconsistent"), this._syncObjectIdsWithStore(this.highlightIds.toArray())) : i6 || this._syncObjectIdsWithStore(null), this._set("filterBySelectionEnabled", e11);
  }
  get hiddenFields() {
    return this._get("hiddenFields") ?? new V();
  }
  set hiddenFields(e11) {
    this._set("hiddenFields", n5(e11, this._get("hiddenFields"), V));
  }
  get isQueryingOrSyncing() {
    const {
      store: e11
    } = this;
    return e11?.syncing || e11?.querying;
  }
  get layerView() {
    const {
      layer: e11,
    ...
    if (!e11 || !t4) return null;
    const i6 = "sublayer" === e11.type ? e11.parent : e11;
    return t4.allLayerViews.find((e12) => e12.layer === i6);
  }
  get objectIds() {
    return this._get("objectIds") ?? new V();
  }
  set objectIds(e11) {
    this._set("objectIds", n5(e11, this._get("objectIds"), V));
  }
  get relatedRecordsEnabled() {
    return !!this._get("relatedRecordsEnabled");
  }
  set relatedRecordsEnabled(e11) {
    this.store.relatedRecordsEnabled = e11, this._set("relatedRecordsEnabled", e11);
  }
  get relationship() {
    const e11 = this.relationshipConfig?.relationshipId;
    return null == e11 ? null : this.relationships?.find(({
      id: t4
    }) => t4 === e11);
  }
  get relationshipConfig() {
    return this._get("relationshipConfig");
  }
  set relationshipConfig(e11) {
    this.objectIds.removeAll(), this.filterBySelectionEnabled = false, this.store.relationshipConfig = e11, this._set("relationshipConfig", e11);
  }
  get relationships() {
    const {
      layer: e11
    } = this;
    return a6(e11) ? e11.relationships : null;
  }
  set timeExtent(e11) {
    this._set("timeExtent", e11), this.store.timeExtent = e11;
  }
  deleteSelection() {
    return __async(this, null, function* () {
      const e11 = this.highlightIds.toArray();
      if (!e11?.length) return;
      const {
        deleteFeatureResults: t4
      } = yield this.store.deleteRowsByObjectId(e11), i6 = t4.filter((e12) => !e12.error).map((e12) => e12.objectId);
      i6.length && (this.highlightIds.removeMany(i6), yield this.refresh());
    });
  }
  filterBySelection() {
    this.filterBySelectionEnabled ? this._logWarning("Property 'filterBySelectionEnabled' is already 'true'. This method has no effect.") : (t(n.getLogger(this), "`FeatureTable.filterBySelection` is deprecated in favor of 'filterBySelectionEnabled' and 'objectIds'", {
      replacement: "FeatureTable.filterBySelectionEnabled or FeatureTable.objectIds",
      version: "4.30",
      warnOnce: true
    }), this.objectIds.addMany(this.highlightIds.toArray()));
  }
  getObjectIdIndex(e11) {
    return this.store?.getItemIndexByObjectId(e11);
  }
  getValue(e11, t4) {
    const i6 = this.store.getItemByObjectId(e11);
    return i6?.feature?.attributes[t4];
  }
  refresh() {
    return __async(this, null, function* () {
      return d(this._debounceRefresh());
    });
  }
  refreshCellContent() {
    this._requestContentUpdate();
  ...
  reset() {
    return __async(this, null, function* () {
      yield this.grid?.reset();
    });
  }
  scrollToIndex(e11) {
    this.grid?.scrollToIndex(e11);
  }
  clearSelectionFilter() {
    t(n.getLogger(this), "`FeatureTable.clearSelectionFilter` is deprecated in favor of 'filterBySelectionEnabled' and 'objectIds'", {
      replacement: "FeatureTable.filterBySelectionEnabled or FeatureTable.objectIds",
      version: "4.30",
      warnOnce: true
    }), this.objectIds.removeAll();
  }
  zoomToSelection() {
    return __async(this, null, function* () {
      const {
        layer: e11,
        view: t4
      } = this, i6 = this.highlightIds.toArray();
      if (!e11 || !t4 || !i6.length) return;
      const s10 = e11.createQuery();
      s10.objectIds = i6, s10.returnGeometry = true;
      const o4 = yield e11.queryFeatures(s10);
      try {
        yield t4.goTo(o4.features);
      } catch (r7) {
        "AbortError" !== r7.name && console.error(r7);
      }
    });
  }
  ...
  _refresh() {
    return __async(this, null, function* () {
      yield this.store.refreshLayerInfo();
      const e11 = this.highlightIds.toArray();
      if (e11.length) {
        (yield this.store.verifyFeaturesByObjectId(e11)).forEach((t4, i6) => {
          t4 || this.highlightIds.remove(e11[i6]);
        });
      }
  ...
  _onLayerLoad() {
    ...
    if (!e11) return;
    const t4 = e11.capabilities.query?.maxRecordCount;
    t4 && t4 < this.pageSize && this.grid && (this.grid.pageSize = t4), this.store.load(), this._generateColumns();
  }
  _onLayerRefresh(e11) {
    this.autoRefreshEnabled && e11.dataChanged && this.refresh();
  }
  _generateColumns() {
    this._drainColumns();
    const e11 = this._effectiveTableTemplate?.columnTemplates, t4 = e11 ? this._generateColumnsFromTemplates(e11) : this._generateDefaultFieldColumns();
    t4.length && this.attachmentsEnabled && t4.push(this._generateAttachmentsColumn()), t4.length && this.relatedRecordsEnabled && this._relationshipInfos.length && t4.push(...this._generateRelationshipColumns()), this.actionColumnConfig && t4.push(this._generateActionColumn()), t4.sort((e12, t5) => e12.frozen && t5.frozen || e12.frozenToEnd && t5.frozenToEnd ? 0 : e12.frozen || t5.frozenToEnd ? -1 : 0), this.columns.addMany(t4);
  }
  _generateColumnsFromTemplates(e11) {
    const {
      editingEnabled: t4,
      _effectiveTableTemplate: i6,
      grid: s10,
      layer: o4,
      messages: r7,
      messagesCommon: n12,
      ...
      store: a10,
      timeZone: h3
    } = this, d8 = o4?.fields ?? [], m3 = [], c5 = (e12) => d8.find((t5) => e12.fieldName.toLowerCase() === t5.name?.toLowerCase());
    return e11.forEach((e12) => {
      const {
        autoWidth: d9,
        direction: g4,
      ...
      if (!O3) return void this._logWarning("Property 'type' is missing from the provided template. Skipped generating a column for this template.");
      if (y2 && b2) return void this._logWarning("Both 'frozen' and 'frozenToEnd' cannot be true for a single template. Skipped generating a column for this template.");
      const x2 = false === e12.visible;
      if ("group" === O3) {
        if (!e12.columnTemplates?.length) return void this._logWarning("Group columns must contain column templates. Skipped generating a column for this template.");
        if (!e12.label) return void this._logWarning("Group columns require a label. Skipped generating a column for this template.");
        const t5 = this._generateColumnsFromTemplates(e12.columnTemplates), i7 = x2 || this._isFieldHidden(e12.label);
        m3.push(new i5({
          autoWidth: d9,
          columns: t5,
          flexGrow: p8,
      ...
      if (!u4) return void this._logWarning("'fieldName' was missing from the provided template. Skipped generating a column for this template.");
      const A3 = x2 || this._isFieldHidden(u4);
      if ("column" === O3 && m3.push(new d5({
        autoWidth: d9,
        direction: g4,
        fieldName: u4,
        flexGrow: p8,
        ...
        const h4 = c5(e12);
        if (!h4) return void this._logWarning("A valid 'field' could not be found for the provided template. Skipped generating a column for this template.");
        const {
          editable: u5,
          required: I2
        } = e12, j4 = i6?.expressionInfos || null, {
          timeZone: O4,
          timeZoneName: x3
        } = this._getTimeZoneInfoForFieldColumn(h4);
        m3.push(new Z2({
          autoWidth: d9,
          direction: g4,
          editable: u5,
  ...
  _generateDefaultFieldColumns() {
    ...
    return i6?.fields.length ? (i6.fields.forEach((a10) => {
      if ("geometry" === a10.type) return;
      const {
        timeZone: h3,
        timeZoneName: d8
      } = this._getTimeZoneInfoForFieldColumn(a10), m3 = a10.name;
      l8.push(new Z2({
        field: a10,
        fieldName: m3,
        grid: t4,
        hidden: this._isFieldHidden(m3),
        layer: i6,
        messages: s10,
        messagesCommon: o4,
        messagesURIUtils: r7,
        store: n12,
        tableEditingEnabled: e11,
        timeZone: h3,
        timeZoneName: d8
      }));
    }), l8) : l8;
  }
  _getTimeZoneInfoForFieldColumn(e11) {
    const {
      layer: t4,
      timeZone: i6,
      view: s10
    } = this;
    return !t4 || "date" !== e11?.type && "timestamp-offset" !== e11?.type ? {
      timeZone: void 0,
      timeZoneName: void 0
    } : g(t4.preferredTimeZone || null, !!t4.datesInUnknownTimezone, i6 ?? s10?.timeZone ?? o3, E("short-time"), e11.type);
  }
  _generateAttachmentsColumn() {
    return new n8({
      hidden: this._isFieldHidden(e8.attachments),
      messages: this.messages
    });
  }
  _generateRelationshipColumns() {
    const {
      _layerWithRelationships: e11,
      _relationshipInfos: t4,
      grid: i6,
      messages: s10,
      messagesCommon: o4,
      messagesURIUtils: r7,
      relationshipColumnConfigs: n12
    } = this, l8 = [];
    if (!e11) return l8;
    const a10 = {
      grid: i6,
    ...
    return n12 ? n12.forEach((e12) => {
      const {
        relationshipId: i7
      } = e12, s11 = t4.find((e13) => e13.relationshipId === i7);
      s11 && l8.push(new a9(__spreadProps(__spreadValues(__spreadValues({}, e12), a10), {
        fieldName: `${e8.relationship}-${i7}`,
        layer: s11.relatedLayer,
        relatedLayer: s11.layer,
        relationshipId: i7,
        showRelatedTableCallback: (e13) => this._onShowRelatedTable(e13)
      })));
    }) : t4.forEach(({
      layer: e12,
      relatedLayer: t5,
      ...
      l8.push(new a9(__spreadProps(__spreadValues({}, a10), {
        fieldName: `${e8.relationship}-${i7}`,
        layer: t5,
        relatedLayer: e12,
        relationshipId: i7,
  ...
  _generateActionColumn() {
    return new a7(__spreadValues({
      hidden: this._isFieldHidden(e8.action)
    }, this.actionColumnConfig));
  }
  _sortOrdersToLayerOrderByFields(e11, t4 = []) {
    const i6 = t4.map((e12) => e12.path), s10 = t4.filter((e12, t5) => {
      const s11 = i6.indexOf(e12.path) === t5, o4 = null != e12.direction;
      return s11 && o4;
    }).map(({
      path: e12,
      direction: t5
    }) => `${e12} ${t5?.toUpperCase()}`);
    return !s10.length && !e11.objectIdField && e11.fields?.length && e11.fields[0]?.name && s10.push(`${e11.fields[0].name} ASC`), s10;
  }
  _isFieldHidden(e11) {
    const t4 = e11?.toLowerCase();
    return (this.hiddenFields ?? this._defaultHiddenFields).some((e12) => e12.toLowerCase() === t4);
  }
  _addTableHighlight(e11) {
    const {
      _highlightableLayerView: t4,
      layer: i6
    } = this;
    if (t4 && i6) {
      const s10 = this.store.getItemByObjectId(e11), o4 = s10?.feature ?? e11;
      this._highlights.add(t4.highlight(o4), `${i6.id}-${e11}`);
    }
  }
  _removeTableHighlight(e11) {
    const {
      layer: t4
    } = this;
    t4 && this._highlights.remove(`${t4.id}-${e11}`);
  }
  _syncSelection() {
    this._highlights.removeAll(), this._tableHighlightsReady ? this.highlightIds.forEach((e11) => this._addTableHighlight(e11)) : this._viewSelectionReady && (this.highlightIds.items = this._viewSelection);
  }
  _appendToViewSelection(e11) {
    const {
      _selectableLayer: t4
    } = this;
    t4 && this._selectionManager?.appendToSelection(t4, e11);
  }
  _removeFromViewSelection(e11) {
    const {
      _selectableLayer: t4
    } = this;
    t4 && this._selectionManager?.removeFromSelection(t4, e11);
  }
  _onHighlightIdsChange(e11) {
    const {
      added: t4,
      removed: i6
    } = e11;
    this._tableHighlightsReady ? (i6.forEach((e12) => this._removeTableHighlight(e12)), t4.forEach((e12) => this._addTableHighlight(e12))) : this._viewSelectionReady && (this._removeFromViewSelection(i6), this._appendToViewSelection(t4)), this.filterBySelectionEnabled && this._syncObjectIdsWithStore(this.highlightIds.toArray());
  }
  _onShowRelatedTable(e11) {
    const {
      highlightIds: t4
    } = this, {
      feature: i6,
      ...
      relatedLayer: o4,
      relationshipId: r7
    } = e11, n12 = i6.getObjectId() ?? i6.attributes[o4.objectIdField];
    if (null != n12) {
      if (t4.removeAll(), t4.add(n12), this.showRelatedTableCallback) return void this.showRelatedTableCallback(e11);
      this.emit("show-related-table", {
        layer: s10,
        relatedLayer: o4,
        relationshipId: r7,
        feature: i6
  ...
  _onObjectIdsChange() {
    const e11 = this.objectIds.toArray();
    e11.length && this.filterBySelectionEnabled && (this.filterBySelectionEnabled = false, this._logWarning("Object ID filter was applied while a selection filter was applied. Selection filter has been removed.")), this._syncObjectIdsWithStore(e11);
  }
  _syncObjectIdsWithStore(e11) {
    this.store.objectIds = e11, this.grid?.refreshPageCache();
  }
  _drainColumns() {
    this.columns.drain((e11) => !e11.destroyed && e11.destroy());
  }
  _getIndexOfFirstFrozenToEndColumn() {
    const e11 = this.columns.findIndex((e12) => e12.frozenToEnd);
    return e11 > -1 ? e11 : void 0;
  }
  _logWarning(e11) {
    n.getLogger(this).warn(e11);
  }
};
e([y()], Z3.prototype, "_defaultHiddenFields", null), e([y()], Z3.prototype, "_effectiveTableTemplate", null), e([y()], Z3.prototype, "_highlights", void 0), e([y()], Z3.prototype, "_highlightableLayerView", null), e([y({
  readOnly: true
})], Z3.prototype, "_layerWithRelationships", null), e([y()], Z3.prototype, "_relationshipInfos", null), e([y()], Z3.prototype, "_selectionManager", null), e([y()], Z3.prototype, "_selectableLayer", null), e([y()], Z3.prototype, "_tableHighlightsReady", null), e([y()], Z3.prototype, "_viewSelection", null), e([y()], Z3.prototype, "_viewSelectionReady", null), e([y()], Z3.prototype, "actionColumnConfig", void 0), e([y()], Z3.prototype, "activeFilters", null), e([y({
  readOnly: true
})], Z3.prototype, "activeSortOrders", null), e([y()], Z3.prototype, "attachmentsEnabled", void 0), e([y()], Z3.prototype, "autoRefreshEnabled", void 0), e([y({
  readOnly: true
})], Z3.prototype, "columns", void 0), e([y()], Z3.prototype, "dataProvider", void 0), e([y()], Z3.prototype, "editingEnabled", void 0), e([y()], Z3.prototype, "filterGeometry", null), e([y()], Z3.prototype, "filterBySelectionEnabled", null), e([y({
  readOnly: true
})], Z3.prototype, "grid", void 0), e([y()], Z3.prototype, "hiddenFields", null), e([y()], Z3.prototype, "highlightEnabled", void 0), e([y()], Z3.prototype, "isQueryingOrSyncing", null), e([y({
  readOnly: true
})], Z3.prototype, "itemIdPath", void 0), e([y()], Z3.prototype, "layer", void 0), e([y()], Z3.prototype, "layerView", null), e([y()], Z3.prototype, "messages", void 0), e([y(), e2("esri/t9n/common")], Z3.prototype, "messagesCommon", void 0), e([y(), e2("esri/widgets/support/t9n/uriUtils")], Z3.prototype, "messagesURIUtils", void 0), e([y()], Z3.prototype, "objectIds", null), e([y()], Z3.prototype, "relatedRecordsEnabled", null), e([y()], Z3.prototype, "relationship", null), e([y()], Z3.prototype, "relationshipColumnConfigs", void 0), e([y()], Z3.prototype, "relationshipConfig", null), e([y()], Z3.prototype, "relationships", null), e([y()], Z3.prototype, "returnGeometryEnabled", void 0), e([y()], Z3.prototype, "returnMEnabled", void 0), e([y()], Z3.prototype, "returnZEnabled", void 0), e([y()], Z3.prototype, "selectionSource", void 0), e([y()], Z3.prototype, "showRelatedTableCallback", void 0), e([y({
  readOnly: true,
  type: b
})], Z3.prototype, "store", void 0), e([y({
  type: T3
})], Z3.prototype, "tableTemplate", void 0), e([y()], Z3.prototype, "tableTemplateOverride", void 0), e([y()], Z3.prototype, "timeExtent", null), e([y()], Z3.prototype, "timeZone", void 0), e([y()], Z3.prototype, "view", void 0), Z3 = e([a2("esri.widgets.FeatureTable.FeatureTableViewModel")], Z3);
var z = Z3;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/TableMenuVisibleElements.js
var s9 = class extends S {
  constructor(e11) {
    super(e11), this.clearSelection = true, this.deleteSelection = true, this.refreshData = true, this.selectedRecordsShowAllToggle = true, this.selectedRecordsShowSelectedToggle = true, this.toggleColumns = true, this.zoomToSelection = true;
  }
};
e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "clearSelection", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "deleteSelection", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "refreshData", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "selectedRecordsShowAllToggle", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "selectedRecordsShowSelectedToggle", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "toggleColumns", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], s9.prototype, "zoomToSelection", void 0), s9 = e([a2("esri.widgets.FeatureTable.TableMenuVisibleElements")], s9);
var r5 = s9;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable/VisibleElements.js
var r6 = class extends S {
  constructor(o4) {
    super(o4), this.columnMenus = true, this.columnMenuItems = new c3(), this.close = false, this.header = true, this.layerDropdown = false, this.menu = true, this.menuItems = new r5(), this.progress = true, this.selectionColumn = true, this.tooltips = true;
  }
};
e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "columnMenus", void 0), e([y({
  type: c3,
  nonNullable: true
})], r6.prototype, "columnMenuItems", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "close", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "header", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "layerDropdown", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "menu", void 0), e([y({
  type: r5,
  nonNullable: true
})], r6.prototype, "menuItems", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "progress", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "selectionColumn", void 0), e([y({
  type: Boolean,
  nonNullable: true
})], r6.prototype, "tooltips", void 0), r6 = e([a2("esri.widgets.FeatureTable.VisibleElements")], r6);
var p7 = r6;

// ../../../node_modules/@arcgis/core/widgets/FeatureTable.js
var A2;
var R2 = "esri-feature-table";
var j3 = `${R2}__prompt`;
var k2 = {
  base: R2,
  content: `${R2}__content`,
  menuPopover: `${R2}__menu-popover`,
  layerDropdownMenu: `${R2}__layer-switcher-menu`,
  tableContainer: `${R2}__table-container`,
  tableNavigation: `${R2}__table-navigation`,
  expanded: `${R2}__expanded`,
  collapsed: `${R2}__collapsed`,
  promptContainer: j3,
  promptHeader: `${j3}__header`,
  promptHeading: `${j3}__header__heading`,
  promptMessage: `${j3}__message`,
  promptDivider: `${j3}__divider`,
  promptActions: `${j3}__actions`
};
var F = {
  ...
  refresh: "refresh",
  showAll: "selection-x",
  showSelected: "selection-filter",
  zoomToSelection: "zoom-to-object"
};
var D2 = A2 = class extends B {
  constructor(e11, i6) {
    super(e11, i6), this._columnVisibilityActions = /* @__PURE__ */ new Map(), this._prompt = null, this._showAllTablesEnabled = false, this.description = null, this.disabled = false, this.layers = null, this.menuConfig = null, this.relatedTables = new V(), this.tableParent = null, this.title = null, this.viewModel = new z(), this.visibleElements = new p7(), this.visibleElementsOverride = null, this._showDeletePrompt = this._showDeletePrompt.bind(this), this._onDeleteSelectionClick = this._onDeleteSelectionClick.bind(this);
  }
  initialize() {
    this.addHandles([d2(() => [this.viewModel.store.querying, this.viewModel.store.syncing, this.editingEnabled], () => this.scheduleRender()), d2(() => ({
      visibleElements: this._effectiveVisibleElements,
      items: this.columns.length
    }), ({
      visibleElements: e11
    }) => {
      this.columns.forEach((t4) => t4.visibleElements = e11), this.refreshCellContent();
    }, C), d2(() => this._effectiveVisibleElements.selectionColumn, (e11) => {
      this.grid && (this.grid.selectionColumnEnabled = e11);
    }, P), v(() => this.viewModel, "show-related-table", (e11) => this._onShowRelatedTable(e11)), d2(() => this.viewModel.state, (e11) => {
      "disabled" === e11 && this.relatedTables.length && this._drainRelatedTables();
    })]);
  }
  loadDependencies() {
    return r2({
      ...
      progress: () => import("./calcite-progress-K357QZ6A.js"),
      ...
      "input-time-picker": () => import("./calcite-input-time-picker-P24UGJ6Y.js"),
      "input-time-zone": () => import("./calcite-input-time-zone-Y7XVAVIH.js")
    });
  }
  destroy() {
    this._drainRelatedTables(), this._clearPrompt();
  }
  get _effectiveDescription() {
    const {
      description: e11
    } = this;
    return null != e11 ? j.sanitize("function" == typeof e11 ? e11() : e11) : void 0;
  }
  get _effectiveLayers() {
    const {
      layer: e11,
      layers: t4
    } = this, i6 = t4?.length ? t4.filter(t3) : [], l8 = i6.length ? i6 : [...this._viewLayers];
    return e11 && !l8.includes(e11) && l8.push(e11), l8;
  }
  get _effectiveTable() {
  ...
  get _effectiveTitle() {
    ...
    if (o4) return j.sanitize("function" == typeof o4 ? o4() : o4);
    if (!e11) return t4.noLayer;
    switch (i6) {
      case "disabled":
        return t4.errorLayer;
      case "ready":
      case "loading":
        return t4.loading;
      case "error":
  ...
  get _hasDefaultMenuItems() {
    return !!(this._showClearSelectionAction || this._showDeleteSelectionAction || this._showRefreshDataAction || this._showZoomToSelectionAction || this._showSelectedRecordsShowSelectedAction || this._showSelectedRecordsShowAllAction || this._showColumnsVisibilityAction);
  }
  get _shouldShowMenu() {
    const {
      header: e11,
      menu: t4
    } = this._effectiveVisibleElements;
    return !(!e11 || !t4 || !this._hasDefaultMenuItems && !this._hasCustomMenuItems);
  }
  ...
  get _showColumnsVisibilityAction() {
    ...
    return !(!(e11 && t4 && i6?.toggleColumns) || this.showRelatedTableCallback || this._showAllTablesEnabled);
  }
  ...
  get _showSelectedRecordsShowSelectedAction() {
    const e11 = this.objectIds.length, t4 = this.highlightIds.length;
    return !(!t4 || !this._effectiveVisibleElements.menuItems?.selectedRecordsShowSelectedToggle || e11 && t4 === e11 || this.relatedTables.length);
  }
  ...
  get _showZoomToSelectionAction() {
    return !(!this.view || !this.highlightIds.length || this._effectiveTable.layer?.isTable || !this._effectiveVisibleElements.menuItems?.zoomToSelection);
  }
  get _viewLayers() {
    const e11 = this.view?.map;
    if (!e11) return [];
    const t4 = /* @__PURE__ */ new Set(), i6 = (e12) => {
      t3(e12) && !t4.has(e12) && t4.add(e12);
    }, l8 = (e12) => {
      a4(e12) || "catalog-footprint" === e12.type || (s4(e12) ? (e12.layers?.forEach(i6), e12.tables?.forEach(i6)) : l3(e12) ? (e12.sublayers?.forEach(i6), e12.subtables?.forEach(i6)) : i6(e12));
    };
    return e11.allLayers.forEach(l8), e11.allTables.forEach(l8), [...t4.values()];
  }
  get actionColumnConfig() {
    return this.viewModel.actionColumnConfig;
  }
  set actionColumnConfig(e11) {
    this.viewModel.actionColumnConfig = e11;
  }
  get activeFilters() {
  ...
  set attachmentsEnabled(e11) {
    this.viewModel.attachmentsEnabled = e11;
  }
  get autoRefreshEnabled() {
    return this.viewModel.autoRefreshEnabled;
  }
  set autoRefreshEnabled(e11) {
    this.viewModel.autoRefreshEnabled = e11;
  }
  get columnPerformanceModeEnabled() {
    return this.viewModel.columnPerformanceModeEnabled;
  }
  ...
  set editingEnabled(e11) {
    this.viewModel.editingEnabled = e11;
  }
  get filterGeometry() {
    return this.viewModel.filterGeometry;
  }
  set filterGeometry(e11) {
    this.viewModel.filterGeometry = e11;
  }
  get filterBySelectionEnabled() {
    return this.viewModel.filterBySelectionEnabled;
  }
  set filterBySelectionEnabled(e11) {
    this.viewModel.filterBySelectionEnabled = e11;
  }
  get grid() {
  ...
  set hiddenFields(e11) {
    this.viewModel.hiddenFields = e11;
  }
  ...
  get isQueryingOrSyncing() {
    return this.viewModel.isQueryingOrSyncing || this.relatedTables.some((e11) => !!e11.isQueryingOrSyncing);
  }
  get label() {
    return this.messages?.widgetLabel ?? "";
  }
  ...
  set layer(e11) {
    this._drainRelatedTables(), this.viewModel.layer = e11;
  }
  get layerView() {
  ...
  set messages(e11) {
    this.viewModel.messages = e11;
  }
  get messagesCommon() {
    return this.viewModel.messagesCommon;
  }
  set messagesCommon(e11) {
    this.viewModel.messagesCommon = e11;
  }
  get messagesURIUtils() {
    return this.viewModel.messagesURIUtils;
  }
  set messagesURIUtils(e11) {
    this.viewModel.messagesURIUtils = e11;
  }
  get multipleSelectionEnabled() {
    return this.viewModel.multipleSelectionEnabled;
  }
  ...
  set relatedRecordsEnabled(e11) {
    this.viewModel.relatedRecordsEnabled = e11;
  }
  get relatedTable() {
  ...
  set relationshipColumnConfigs(e11) {
    this.viewModel.relationshipColumnConfigs = e11;
  }
  get relationshipConfig() {
    return this.viewModel.relationshipConfig;
  }
  set relationshipConfig(e11) {
    this.viewModel.relationshipConfig = e11;
  }
  get returnGeometryEnabled() {
    return this.viewModel.returnGeometryEnabled;
  }
  set returnGeometryEnabled(e11) {
    this.viewModel.returnGeometryEnabled = e11;
  }
  get returnMEnabled() {
    return this.viewModel.returnMEnabled;
  }
  set returnMEnabled(e11) {
    this.viewModel.returnMEnabled = e11;
  }
  get returnZEnabled() {
    return this.viewModel.returnZEnabled;
  }
  set returnZEnabled(e11) {
    this.viewModel.returnZEnabled = e11;
  }
  get rowHighlightIds() {
    return this.viewModel.rowHighlightIds;
  }
  ...
  set selectionSource(e11) {
    this.viewModel.selectionSource = e11;
  }
  get showRelatedTableCallback() {
    return this.viewModel.showRelatedTableCallback;
  }
  set showRelatedTableCallback(e11) {
    this.viewModel.showRelatedTableCallback = e11;
  }
  get size() {
    return this.viewModel.size;
  }
  ...
  set tableTemplate(e11) {
    this.viewModel.tableTemplate = e11;
  }
  get tableTemplateOverride() {
    return this.viewModel.tableTemplateOverride;
  }
  set tableTemplateOverride(e11) {
    this.viewModel.tableTemplateOverride = e11;
  }
  get timeExtent() {
    return this.viewModel.timeExtent;
  }
  set timeExtent(e11) {
    this.viewModel.timeExtent = e11;
  }
  get timeZone() {
  ...
  deleteSelection(e11) {
    return this.highlightIds.length ? e11 ? (this._showDeletePrompt(), this.scheduleRender(), Promise.resolve()) : this.viewModel.deleteSelection() : Promise.resolve();
  }
  filterBySelection() {
  ...
  hideColumn(e11) {
    this.grid?.hideColumn(e11);
  }
  refresh() {
    return __async(this, null, function* () {
      this.relatedTables.forEach((e11) => __async(this, null, function* () {
        return yield e11.refresh();
  ...
  showColumn(e11) {
    this.grid?.showColumn(e11);
  }
  sortColumn(e11, t4) {
    this.viewModel.sortColumn(e11, t4);
  }
  scrollToIndex(e11) {
    this.viewModel.scrollToIndex(e11);
  }
  toggleColumnVisibility(e11) {
    this.viewModel.toggleColumnVisibility(e11);
  }
  zoomToSelection() {
    this._effectiveTable.viewModel.zoomToSelection();
  }
  render() {
    const {
      _prompt: e11,
      _effectiveVisibleElements: t4,
      isQueryingOrSyncing: i6,
      menuConfig: l8,
      state: o4
    } = this;
    return n3("div", {
      bind: this,
      class: this.classes(k2.base, e3.widget)
    }, n3("calcite-panel", {
      bind: this,
      class: k2.content,
      closable: t4.close,
      description: this._effectiveDescription,
      disabled: this.disabled || "disabled" === o4,
      heading: t4.header ? this._effectiveTitle : void 0,
      loading: "loading" === o4,
      menuOpen: !!l8?.open,
      overlayPositioning: "fixed",
      onCalcitePanelClose: (e12) => {
        e12.target.closed = false, this.emit("close");
      }
    }, t4.progress ? n3("calcite-progress", {
      type: i6 ? "indeterminate" : "determinate"
    }) : null, this._showLayerDropdown ? this._renderLayerDropdown() : null, this._renderColumnVisibilityAction(), this._renderHeaderMenuActions(), this._renderRelatedTableNavigationBar(), n3("div", {
      class: k2.tableContainer
    }, this._renderTables())), e11 ? n3("calcite-scrim", null, this._renderPrompt(e11)) : null);
  }
  _renderTables() {
    const {
      _showAllTablesEnabled: e11,
      grid: t4,
      relatedTables: i6
    } = this;
    if (i6.length) {
      const l8 = i6.toArray(), o4 = 1 === l8.length, s10 = this.classes(k2.base, e11 ? k2.expanded : k2.collapsed), n12 = e11 || o4, r7 = e11 ? l8 : o4 ? [l8[0]] : l8.slice(-2);
      return n3("calcite-panel", {
        overlayPositioning: "fixed"
      }, n3("div", null, [n12 ? n3("div", {
        class: s10
      }, t4?.render()) : void 0, ...r7.map((e12) => {
        const t5 = i6.indexOf(e12);
        return n3("div", {
          class: s10,
          key: `related-${t5}`
        }, e12.render());
  ...
  _renderPrompt({
    ...
    const o4 = n3("calcite-button", {
      appearance: "solid",
      key: "prompt-primary-button",
      kind: "danger" === i6 ? "danger" : "brand",
      onclick: l8.primary.action,
      width: l8.secondary ? "half" : "full"
    }, l8.primary.label), s10 = l8.secondary ? n3("calcite-button", {
      appearance: "outline",
      key: "prompt-secondary-button",
      kind: "danger" === i6 ? "danger" : "brand",
      onclick: l8.secondary.action,
      width: "half"
    }, l8.secondary.label) : null;
    return n3("div", {
      class: `${k2.promptContainer}--${i6}`
    }, n3("div", {
      class: k2.promptHeader
    }, n3("calcite-icon", {
      icon: "exclamation-mark-triangle"
    }), n3(e4, {
      class: k2.promptHeading,
      level: 2
    }, e11)), n3("div", {
      class: k2.promptMessage
    }, t4), n3("div", {
      class: k2.promptDivider
    }), n3("div", {
      class: k2.promptActions
    }, s10, o4));
  }
  _showDeletePrompt() {
    const {
      messages: e11,
      messagesCommon: t4
    } = this, i6 = s3(e11.deleteSelectionCount, {
      count: this.highlightIds.length
    });
    this._prompt = {
      title: i6,
      message: e11.deleteRecordsRemoved,
      context: "danger",
      actions: {
        primary: {
          label: t4.delete,
          action: this._onDeleteSelectionClick
        },
        secondary: {
          label: e11.keepRecords,
  ...
  _renderHeaderMenuAction(e11) {
    ...
    if (!i6) return n3("calcite-action", {
      disabled: t4 ?? this.menuConfig?.disabled,
      icon: l8 ?? void 0,
      key: o4,
      onclick: () => s10(),
  ...
  _renderDefaultHeaderMenuActions() {
    ...
    return this._showRefreshDataAction && t4.push(this._renderHeaderMenuAction({
      icon: F.refresh,
      text: e11.refreshData,
      clickFunction: () => this.refresh()
    })), this._showDeleteSelectionAction && t4.push(this._renderHeaderMenuAction({
      icon: F.delete,
      text: e11.deleteSelection,
      clickFunction: () => this.deleteSelection(true)
    })), this._showClearSelectionAction && t4.push(this._renderHeaderMenuAction({
      icon: F.clearSelection,
      text: e11.clearSelection,
      clickFunction: () => this.highlightIds?.removeAll()
    })), this._showZoomToSelectionAction && t4.push(this._renderHeaderMenuAction({
      icon: F.zoomToSelection,
      text: e11.zoomToSelection,
      clickFunction: () => this.zoomToSelection()
    })), this._showSelectedRecordsShowSelectedAction && t4.push(this._renderHeaderMenuAction({
      icon: F.showSelected,
      text: e11.showSelected,
      clickFunction: () => {
        const {
          objectIds: e12
        } = this;
        e12.removeAll(), e12.addMany(this.highlightIds.toArray());
      }
    })), this._showSelectedRecordsShowAllAction && t4.push(this._renderHeaderMenuAction({
      icon: F.showAll,
      text: e11.showAllRecords,
      clickFunction: () => this.objectIds.removeAll()
    })), t4;
  }
  _renderCustomHeaderMenuActions() {
    return this.menuConfig?.items?.map(({
      ...
      label: l8,
      clickFunction: o4
    }) => this._renderHeaderMenuAction({
      hidden: "function" == typeof t4 ? t4() : t4,
      icon: i6,
      text: l8,
      disabled: e11,
      clickFunction: (e12) => o4(e12)
    })) ?? [];
  }
  _renderColumnVisibilityAction() {
    if (!this._showColumnsVisibilityAction) return [];
    const {
      _columnVisibilityActions: e11,
      _effectiveTable: t4,
      _effectiveVisibleElements: i6,
      id: l8,
      messages: o4
    } = this, s10 = t4.columns.toArray(), n12 = o4?.toggleColumns, r7 = `${l8}__toggle-columns-action`, a10 = [n3("calcite-action", {
      afterCreate: (t5) => e11.set(l8, t5),
      afterRemoved: () => e11.delete(l8),
      appearance: "transparent",
      bind: this,
      disabled: t4.menuConfig?.disabled,
      icon: "show-column",
      id: r7,
      slot: "header-actions-end",
      text: n12
    }, i6.tooltips ? n3("calcite-tooltip", {
      closeOnClick: true,
      overlayPositioning: "fixed",
      placement: "bottom-end",
      slot: "tooltip"
    }, n12) : null)];
    return t4.menuConfig?.disabled || a10.push(n3("calcite-popover", {
      autoClose: true,
      class: k2.menuPopover,
      label: n12,
      overlayPositioning: "fixed",
      placement: "top-end",
      pointerDisabled: true,
      referenceElement: e11.get(l8)
    }, n3("calcite-list", {
      filterEnabled: true,
      filterPlaceholder: o4.toggleColumns,
      selectionMode: "multiple"
    }, ...s10.map((e12) => {
      const i7 = "columns" in e12 && e12.columns?.length ? e12.columns.map((e13) => this._renderColumnListItem({
        column: e13,
        table: t4,
        ignoreSelect: true
      })) : void 0;
      return this._renderColumnListItem({
        column: e12,
        table: t4,
        items: i7
      });
  ...
  _renderColumnListItem(e11) {
    ...
    return n3("calcite-list-item", {
      key: `toggle-columns__item-${n12}`,
      label: s10,
      open: !(!l8?.length || r7) || void 0,
      selected: !r7,
      value: n12,
      onCalciteListItemSelect: (e12) => {
        o4 || i6.toggleColumnVisibility(e12.target.value);
      }
    }, l8);
  }
  _renderLayerDropdown() {
    const e11 = this.messages.selectALayer;
    return n3("div", {
      class: k2.layerDropdownMenu,
      key: `${this.id}-layerDropdown`,
      ...
      text: e11,
      title: e11
    }), n3("calcite-dropdown-group", {
      selectionMode: "single"
    }, this._effectiveLayers.map((e12, t4) => this._renderLayerDropdownItem(e12, t4)) ?? null)));
  }
  _renderLayerDropdownItem(e11, t4) {
    return n3("calcite-dropdown-item", {
      key: `dropdown-item-${t4}`,
      label: e11.title ?? "",
      selected: e11 === this.layer,
      value: e11.id,
  ...
  _onShowRelatedTable(e11) {
    this.showRelatedTableCallback || (this._collapseRelatedTable(this._effectiveTable, e11), this._createRelatedTable(e11));
  }
  _renderRelatedTableNavigationBar() {
    const {
      messages: e11
    } = this, t4 = e11.exitRelatedRecords;
    if (this.relatedTables.length && !this.showRelatedTableCallback) return n3("div", {
      class: k2.tableNavigation,
      key: "table-nav"
    }, n3("calcite-action", {
      icon: "move-up",
      iconFlipRtl: true,
      key: t4,
      onclick: () => this._drainRelatedTables(),
      text: t4,
      title: t4
    }), this.relatedTables.toArray().map((e12, t5) => this._renderRelatedTableNavigationAction(e12, t5)), n3("div", null, n3("calcite-label", {
      layout: "inline"
    }, e11.showAllTables, n3("calcite-switch", {
      checked: this._showAllTablesEnabled,
      onCalciteSwitchChange: (e12) => {
        const t5 = !!e12.target.checked, i6 = this.relatedTable;
        this._showAllTablesEnabled = t5, i6 && (t5 ? this._enterShowAllView(i6) : this._exitShowAllView(i6));
      }
    }))));
  }
  _renderRelatedTableNavigationAction(e11, t4) {
    const i6 = this._getLabelForRelatedTableNavigationAction(e11);
    return n3("calcite-action", {
      icon: "chevron-right",
      iconFlipRtl: true,
      key: t4,
      onclick: () => this._drainRelatedTablesAboveIndex(t4),
      text: i6,
      textEnabled: true,
      title: e11.layer?.title || ""
    });
  }
  _getLabelForRelatedTableNavigationAction(e11) {
    const t4 = e11.layer?.title;
    if (!t4) return "";
    const {
      relatedTables: i6
    } = this;
    if (i6.length <= 1) return t4;
    return i6.indexOf(e11) !== i6.length - 1 && t4.length > 20 ? `${t4.slice(0, 20)}...` : t4;
  }
  _drainRelatedTables() {
    this.relatedTables.drain((e11) => !e11.destroyed && e11.destroy()), this.set({
      _showAllTablesEnabled: false,
      multipleSelectionEnabled: true,
      tableTemplateOverride: null,
      relationshipColumnConfigs: null,
      visibleElementsOverride: null
    }), this.hiddenFields.removeMany([e8.action, e8.attachments]);
  }
  _drainRelatedTablesAboveIndex(e11) {
    const t4 = this.relatedTables, i6 = t4.filter((t5, i7) => i7 > e11);
    i6.forEach((e12) => !e12.destroyed && e12.destroy()), t4.removeMany(i6);
    const l8 = t4.at(-1);
    if (!l8?.layer || !l8?.relationship) return;
    const {
      layer: o4,
      relationship: s10
    } = l8;
    this._showAllTablesEnabled ? this._enterShowAllView(l8) : l8.set({
      multipleSelectionEnabled: true,
      tableTemplateOverride: null,
      relationshipColumnConfigs: this._getRelationshipIdsToShow(o4, s10.id),
      visibleElementsOverride: null
    }), l8.hiddenFields.removeMany([e8.action, e8.attachments]);
  }
  _getRelatedTableMenuItemConfig(e11, t4, i6) {
    return t4.fields.map(({
      alias: l8,
      name: o4
    }) => ({
      selected: o4 === i6,
      label: l8 || o4,
      clickFunction: (i7) => {
        i7.stopPropagation(), e11.tableTemplateOverride = new T3({
          columnTemplates: [this._createRelatedFieldColumnTemplate(e11, t4, o4)]
        });
      }
    }));
  }
  _createRelatedFieldColumnTemplate(e11, t4, i6) {
    return new l7({
      fieldName: i6,
      editable: false,
      menuConfig: {
        selectionMode: "single",
        icon: "chevron-down",
        items: this._getRelatedTableMenuItemConfig(e11, t4, i6)
      },
      resizable: false
    });
  }
  _enterShowAllView(e11) {
    const t4 = e11.layer;
    if (!t4) return;
    const i6 = e11 === this, {
      visibleElements: l8
    } = e11, o4 = t4.displayField || t4.objectIdField;
    e11.set({
      relationshipColumnConfigs: [],
      tableTemplateOverride: new T3({
        columnTemplates: [this._createRelatedFieldColumnTemplate(e11, t4, o4)]
      }),
      visibleElementsOverride: new p7({
        header: i6 && l8.header,
        progress: i6 && l8.progress,
        columnMenus: l8.columnMenus,
        close: l8.close,
        tooltips: l8.tooltips,
        selectionColumn: false,
        columnMenuItems: new c3({
          sortAscending: false,
          sortDescending: false
        })
      })
    }), e11.hiddenFields.addMany([e8.action, e8.attachments]);
  }
  _exitShowAllView(e11) {
    const {
      layer: t4,
      relationship: i6
    } = e11;
    t4 && null != i6?.id && (e11.set({
      relationshipColumnConfigs: this._getRelationshipIdsToShow(t4, i6.id),
      tableTemplateOverride: null,
      visibleElementsOverride: null
    }), e11.hiddenFields.removeMany([e8.action, e8.attachments]));
  }
  _collapseRelatedTable(e11, i6) {
    const {
      relatedLayer: l8,
      feature: o4,
      relationshipId: s10
    } = i6, n12 = l8.relationships?.find(({
      id: e12
    }) => e12 === s10), {
      objectIdField: r7
    } = l8, a10 = l8.displayField || n12?.keyField || r7, d8 = o4.getObjectId() ?? o4.attributes[r7], c5 = e11 === this, {
      close: p8,
      columnMenus: u4,
      header: g4,
      layerDropdown: v3,
    ...
    e11.set({
      ...
      tableTemplateOverride: new T3({
        columnTemplates: [this._createRelatedFieldColumnTemplate(e11, l8, a10)]
      }),
      visibleElementsOverride: new p7({
        header: c5 && g4,
        progress: c5 && _2,
    ...
    }), e11.hiddenFields.addMany([e8.action, e8.attachments]), e11.grid?.scrollLeft(0);
  }
  _getRelationshipIdsToShow(e11, t4) {
    return (e11.relationships ?? []).filter((e12) => !(e12.id === t4 && "one-to-one" === e12.cardinality)).map(({
      id: e12
    }) => ({
      relationshipId: e12
    }));
  }
  _createRelatedTable(e11) {
    return __async(this, null, function* () {
      const {
        editingEnabled: t4,
        relatedTables: i6,
        ...
        relatedLayer: a10,
        relationshipId: d8
      } = e11, c5 = r7.getObjectId() ?? r7.attributes[a10.objectIdField], h3 = i6.length, p8 = h3 ? i6.getItemAt(h3 - 1) : this;
      yield n12.load();
      const u4 = this.attachmentsEnabled && i4(n12), b2 = new A2({
        layer: n12,
        attachmentsEnabled: u4,
        editingEnabled: t4,
        ...
        relationshipColumnConfigs: this._getRelationshipIdsToShow(n12, d8),
        tableParent: p8,
        view: l8,
        visibleElements: new p7({
          header: false,
          progress: false
        }),
        showRelatedTableCallback: ({
          feature: e12,
          layer: t5,
          relatedLayer: i7,
          relationshipId: l9
        }) => {
          null != (e12.getObjectId() ?? e12.attributes[i7.objectIdField]) && o4.emit("show-related-table", {
            feature: e12,
            layer: t5,
            relatedLayer: i7,
            relationshipId: l9
      ...
      b2.addHandles([v(() => p8.highlightIds, "change", ({
        added: e12
      }) => {
        const t5 = e12[0];
        null != t5 && (b2.highlightIds.removeAll(), b2.relationshipConfig = {
          objectId: t5,
          relatedLayer: a10,
          relationshipId: d8
        });
        ...
        if (t5) {
          const e13 = t5.getObjectId() ?? t5.attributes[a10.objectIdField];
          null != e13 && p8.highlightIds.add(e13);
        }
      })]), this.relatedTables.add(b2), this.scheduleRender();
    });
  }
};
e([y()], D2.prototype, "_columnVisibilityActions", void 0), e([y()], D2.prototype, "_effectiveDescription", null), e([y()], D2.prototype, "_effectiveLayers", null), e([y()], D2.prototype, "_effectiveTable", null), e([y()], D2.prototype, "_effectiveTitle", null), e([y()], D2.prototype, "_effectiveVisibleElements", null), e([y()], D2.prototype, "_hasCustomMenuItems", null), e([y()], D2.prototype, "_hasDefaultMenuItems", null), e([y()], D2.prototype, "_prompt", void 0), e([y()], D2.prototype, "_shouldShowMenu", null), e([y()], D2.prototype, "_showAllTablesEnabled", void 0), e([y()], D2.prototype, "_showClearSelectionAction", null), e([y()], D2.prototype, "_showColumnsVisibilityAction", null), e([y()], D2.prototype, "_showDeleteSelectionAction", null), e([y()], D2.prototype, "_showLayerDropdown", null), e([y()], D2.prototype, "_showRefreshDataAction", null), e([y()], D2.prototype, "_showSelectedRecordsShowSelectedAction", null), e([y()], D2.prototype, "_showSelectedRecordsShowAllAction", null), e([y()], D2.prototype, "_showZoomToSelectionAction", null), e([y()], D2.prototype, "_viewLayers", null), e([y()], D2.prototype, "actionColumnConfig", null), e([y({
  readOnly: true
})], D2.prototype, "activeFilters", null), e([y({
  readOnly: true
})], D2.prototype, "activeSortOrders", null), e([y()], D2.prototype, "attachmentsEnabled", null), e([y()], D2.prototype, "autoRefreshEnabled", null), e([y()], D2.prototype, "columnPerformanceModeEnabled", null), e([y()], D2.prototype, "columnReorderingEnabled", null), e([y({
  readOnly: true
})], D2.prototype, "columns", null), e([y()], D2.prototype, "description", void 0), e([y()], D2.prototype, "disabled", void 0), e([y()], D2.prototype, "editingEnabled", null), e([y()], D2.prototype, "filterGeometry", null), e([y()], D2.prototype, "filterBySelectionEnabled", null), e([y({
  readOnly: true
})], D2.prototype, "grid", null), e([y()], D2.prototype, "hiddenFields", null), e([y()], D2.prototype, "highlightEnabled", null), e([y()], D2.prototype, "highlightIds", null), e([y()], D2.prototype, "icon", null), e([y()], D2.prototype, "isQueryingOrSyncing", null), e([y()], D2.prototype, "label", null), e([y()], D2.prototype, "layer", null), e([y()], D2.prototype, "layers", void 0), e([y()], D2.prototype, "layerView", null), e([y(), e2("esri/widgets/FeatureTable/t9n/FeatureTable")], D2.prototype, "messages", null), e([y(), e2("esri/t9n/common")], D2.prototype, "messagesCommon", null), e([y(), e2("esri/widgets/support/t9n/uriUtils")], D2.prototype, "messagesURIUtils", null), e([y()], D2.prototype, "menuConfig", void 0), e([y()], D2.prototype, "multipleSelectionEnabled", null), e([y()], D2.prototype, "multiSortEnabled", null), e([y()], D2.prototype, "objectIds", null), e([y()], D2.prototype, "pageSize", null), e([y()], D2.prototype, "relatedRecordsEnabled", null), e([y()], D2.prototype, "relatedTable", null), e([y()], D2.prototype, "relatedTables", void 0), e([y()], D2.prototype, "relationship", null), e([y()], D2.prototype, "relationshipColumnConfigs", null), e([y()], D2.prototype, "relationshipConfig", null), e([y()], D2.prototype, "returnGeometryEnabled", null), e([y()], D2.prototype, "returnMEnabled", null), e([y()], D2.prototype, "returnZEnabled", null), e([y()], D2.prototype, "rowHighlightIds", null), e([y()], D2.prototype, "selectionSource", null), e([y()], D2.prototype, "showRelatedTableCallback", null), e([y()], D2.prototype, "size", null), e([y({
  readOnly: true
})], D2.prototype, "state", null), e([y({
  constructOnly: true
})], D2.prototype, "tableParent", void 0), e([y()], D2.prototype, "tableTemplate", null), e([y()], D2.prototype, "tableTemplateOverride", null), e([y()], D2.prototype, "title", void 0), e([y()], D2.prototype, "timeExtent", null), e([y()], D2.prototype, "timeZone", null), e([y()], D2.prototype, "view", null), e([y({
  type: z
}), e5(["cell-click", "cell-pointerover", "cell-pointerout", "cell-keydown", "show-related-table"])], D2.prototype, "viewModel", void 0), e([y({
  type: p7,
  nonNullable: true
})], D2.prototype, "visibleElements", void 0), e([y({
  type: p7
})], D2.prototype, "visibleElementsOverride", void 0), D2 = A2 = e([a2("esri.widgets.FeatureTable")], D2);
var x = D2;
export {
  x as default
};
...
@vaadin/grid/src/vaadin-grid-sorter.js:
   ...
   *)
*/
//# sourceMappingURL=FeatureTable-QM5ORHKX.js.map
