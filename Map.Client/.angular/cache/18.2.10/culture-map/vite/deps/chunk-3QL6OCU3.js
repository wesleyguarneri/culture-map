...
var Q = class extends o.EventedAccessor {
  ...
  initialize() {
    this.addHandles([v(() => this.view?.map?.layers, "change", (e6) => {
      ...
      })), "2d" === e6.type ? import("./editingTools-Z27LXQLU.js") : "3d" === e6.type && (import("./editingTools-7IRQ4AHR.js"), import("./GraphicsLayerView3D-VJ5YLKWR.js")));
  ...
  _makeDrawGraphicTool2D(e6) {
    return __async(this, null, function* () {
      const t = yield this._requireModule(import("./editingTools-Z27LXQLU.js"));
  ...
  _makeDrawGraphicTool3D(e6) {
    return __async(this, null, function* () {
      const t = yield this._requireModule(import("./editingTools-7IRQ4AHR.js"));
  ...
  _setupMove3DOperation(e6, t, o2, i2, a3 = false) {
    return __async(this, null, function* () {
      const r4 = yield this._requireModule(import("./editingTools-7IRQ4AHR.js"));
      if (ne(r4)) return r4;
      const {
  ...
  _setupPointTransform3DOperation(e6, t, o2) {
    return __async(this, null, function* () {
      const i2 = "transform", {
        ...
        enableScaling: r4,
        enableZ: s3
      } = t, n6 = yield this._requireModule(import("./editingTools-7IRQ4AHR.js"));
      if (ne(n6)) return n6;
      const {
        TransformTool3D: p5,
  ...
  _setupPolyTransform3DOperation(e6, t, o2, i2 = false) {
    return __async(this, null, function* () {
      ...
      } = t, l3 = yield this._requireModule(import("./editingTools-7IRQ4AHR.js"));
      if (ne(l3)) return l3;
      const {
  ...
  _setupReshape3DOperation(e6, t, o2, i2 = false) {
    return __async(this, null, function* () {
      const a3 = "reshape", r4 = yield this._requireModule(import("./editingTools-7IRQ4AHR.js"));
      if (ne(r4)) return r4;
      const {
        ManipulatedObject3DGraphic: s3,
        ReshapeTool3D: n6
  ...
  _getGraphicMover(e6, t, o2) {
    return __async(this, null, function* () {
      const {
        ...
        highlightOptions: a3
      } = t, r4 = yield this._requireModule(import("./GraphicMover-2LKKLTSU.js"));
  ...
  _getBox(e6, t, o2) {
    return __async(this, null, function* () {
      ...
      } = t, n6 = yield this._requireModule(import("./Box-ENEKINRZ.js"));
      if (ne(n6)) return n6;
  ...
  _getReshape(e6, t, o2) {
    return __async(this, null, function* () {
      const i2 = "split" === t.reshapeOptions?.edgeOperation, a3 = "move" === t.reshapeOptions?.shapeOperation, r4 = !!t.highlightOptions?.enabled, s3 = yield this._requireModule(import("./Reshape-6DEDGW3D.js"));
...
//# sourceMappingURL=chunk-3QL6OCU3.js.map
