...
var d = class {
  ...
  addQueryGeometry(e, t) {
    const {
      queryGeometry: o3,
      queryGeometryType: i2
    } = t, n4 = pt(o3.clone(), o3, false, false, this._transform), a2 = rt(n4, i2, false, false);
...
function n3(o3, s, n4) {
  return __async(this, null, function* () {
    const p = f(o3), i2 = __spreadValues({}, n4), u2 = b.from(s), m = !u2.quantizationParameters, {
      data: f3
    } = yield f2(p, u2, new d({
      sourceSpatialReference: u2.sourceSpatialReference,
      applyTransform: m
    }), i2);
    return f3;
  });
...
//# sourceMappingURL=chunk-DBVSL4LU.js.map
