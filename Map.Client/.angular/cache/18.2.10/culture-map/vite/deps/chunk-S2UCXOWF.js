...
function d(d2, n2) {
  const c2 = d2.fragment;
  c2.include(c), c2.uniforms.add(new e2("nearFar", (e5, o5) => o5.camera.nearFar)), c2.uniforms.add(new s("depthMap", (e5, o5) => o5.depth?.attachment)), c2.uniforms.add(new e("proj", (e5, o5) => o5.camera.projectionMatrix)), c2.uniforms.add(new o2("invResolutionHeight", (e5, o5) => 1 / o5.camera.height)), c2.uniforms.add(new e("reprojectionMatrix", (e5, o5) => o5.ssr.reprojectionMatrix)), c2.code.add(o`
...
cloudsColor *= clamp(fresnelModifier.y * cloudFresnelModifier[0] - cloudFresnelModifier[1], 0.0, 1.0) * clamp((1.0 - totalFadeInOut), 0.0, 1.0);`), m.hasScreenSpaceReflections ? (v2.uniforms.add(new e("view", (e5, o5) => o5.camera.viewMatrix), new s("lastFrameColorTexture", (e5, o5) => o5.ssr.lastFrameColor?.getTexture()), new o2("fadeFactorSSR", (e5, o5) => o5.ssr.fadeFactor)), v2.code.add(o`vec3 viewDir = normalize(viewPosition);
...
//# sourceMappingURL=chunk-S2UCXOWF.js.map
