...
var Input = proxyCustomElement(class Input2 extends H {
  ...
  render() {
    ...
    const loader = h("div", {
      key: "ed9acea9dbc18f4cfc5e7095c1e2de0b1adfdf35",
      class: CSS.loader
    }, h("calcite-progress", {
      key: "58321a27c25dd848a648d2e3d5ca6dfc3f5fd649",
      label: this.messages.loading,
      type: "indeterminate"
    }));
    const inputClearButton = h("button", {
      key: "348d8dee0c032afe986b1e253c9d667256f3d9f0",
      ...
      key: "334b68a283b767c0e9bea09ccfd83d09c8c17711",
      icon: "x",
      scale: getIconScale(this.scale)
    }));
    const iconEl = h("calcite-icon", {
      key: "4ab83aa9268277a38449ebe4a6e3db4dc9badcae",
      class: CSS.inputIcon,
    ...
    const numberButtonsHorizontalUp = h("button", {
      key: "2dd700034d38581aaea39c019e626ffa1a2c1c16",
      "aria-hidden": "true",
      class: {
      ...
      key: "6ca9a7c93aa14520292ad8c800c4e099bd46f30d",
      icon: "chevron-up",
      scale: getIconScale(this.scale)
    }));
    const numberButtonsHorizontalDown = h("button", {
      key: "cdbd88ddd308bd82b6d239a83f365a2c5e226cfc",
      "aria-hidden": "true",
      class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton
      ...
      key: "f1b9cf329da9add564d690c517ddcc414c4fbfa3",
      icon: "chevron-down",
      scale: getIconScale(this.scale)
    }));
    const numberButtonsVertical = h("div", {
      key: "247efdce33568f219b1bf3bf252b8b19a74d03ea",
      class: CSS.numberButtonWrapper
    }, numberButtonsHorizontalUp, numberButtonsHorizontalDown);
    const prefixText = h("div", {
      key: "01819a850399fb20a29471861e011695bf80af97",
      class: CSS.prefix
    }, this.prefixText);
    const suffixText = h("div", {
      key: "dcc073305f3824a0eb72ef230bd217dabdb72104",
      class: CSS.suffix
    }, this.suffixText);
    ...
    const childEl = this.type !== "number" ? [h(this.childElType, {
      accept: this.accept,
      "aria-errormessage": IDS.validationMessage,
      "aria-invalid": toAriaBoolean(this.status === "invalid"),
      "aria-label": getLabelText(this),
      ...
      type: this.type,
      value: this.value
    }), this.isTextarea ? h("div", {
      class: CSS.resizeIconWrapper
    }, h("calcite-icon", {
      icon: "chevron-down",
      scale: getIconScale(this.scale)
    })) : null] : null;
    return h(Host, {
      key: "23d6092960315f172a56105b9af75ddc6497874c",
      ...
      key: "7f3644f002b7cb75d93d9c0218508b502ddcfd0b",
      class: {
        [CSS.inputWrapper]: true,
        [CSS_UTILITY.rtl]: dir === "rtl"
      },
      ref: (el) => this.inputWrapperEl = el
    }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalDown : null, this.prefixText ? prefixText : null, h("div", {
      key: "0d01898e4949a60e0853c1a72669f5c9d6c91ba5",
      class: CSS.wrapper
    }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", {
      key: "42e7adec440e417128feb9845c36d0444e6c1ae4",
      class: CSS.actionWrapper,
      ref: (el) => this.actionWrapperEl = el
    }, h("slot", {
      key: "f391b035ad9fc108d1f99c4cedf539425c20a36d",
      name: SLOTS.action
    })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalUp : null, h(HiddenFormInputSlot, {
      key: "df415df551b4a9a16565c8f554454d01aa89327e",
      component: this
...
@esri/calcite-components/dist/components/input2.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OAF7LVCG.js.map
