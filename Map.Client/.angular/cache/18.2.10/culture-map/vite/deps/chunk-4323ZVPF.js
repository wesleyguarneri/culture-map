...
var l = class {
  ...
  remove(t2) {
    const i = y(this.data, t2, this.length, this._hint);
    if (-1 !== i) return this.data.splice(i, 1), this.length = this.length - 1, t2;
  }
  removeUnordered(t2) {
    return this.removeUnorderedIndex(y(this.data, t2, this.length, this._hint));
  }
  ...
  removeUnorderedMany(t2, h = t2.length, s) {
    this.length = A(this.data, t2, this.length, h, this._hint, s), this._shrink();
  }
  front() {
...
//# sourceMappingURL=chunk-4323ZVPF.js.map
