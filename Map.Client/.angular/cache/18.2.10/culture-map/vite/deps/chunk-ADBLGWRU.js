...
var s = class extends Be {
  ...
  generateColors() {
    ...
    const e = this.getPrivate("currentPass"), s2 = this.get("colors", [this.get("baseColor", Gt.fromHex(16711680))]);
    ...
    for (let n = a; n < r; n++) if (o) s2.push(s2[n]);
      ...
      for (; l > 1; ) l -= 1;
      s2.push(Gt.fromHSL(a2, o2, l));
    }
  }
  getIndex(e) {
    const s2 = this.get("colors", []), r = this.get("saturation");
    return e >= s2.length ? (this.generateColors(), this.getIndex(e)) : null != r ? Gt.saturate(s2[e], r) : s2[e];
  }
  next() {
...
Object.defineProperty(s, "className", {
  ...
  configurable: true,
  writable: true,
  value: Be.classNames.concat([s.className])
});

export {
  s
};
//# sourceMappingURL=chunk-ADBLGWRU.js.map
