  ...
  for (var f2 = 0; f2 < e2.length; f2++) {
    ...
    if ("string" != typeof i2 && !Array.isArray(i2)) {
      for (const e3 in i2) if ("default" !== e3 && !(e3 in r)) {
        ...
        f3 && Object.defineProperty(r, e3, f3.get ? f3 : {
          enumerable: true,
          get: () => i2[e3]
        });
      }
...
f = n, i = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, a = function(r = {}) {
  ...
  var l, v = {
    ...
    Instance: function(r2, e3) {
      this.exports = function(r3) {
        ...
        for (var f3, i2 = new Uint8Array(123), a3 = 25; a3 >= 0; --a3) i2[48 + a3] = 52 + a3, i2[65 + a3] = a3, i2[97 + a3] = 26 + a3;
        function n3(r4, e5, f4) {
          for (var a4, n4, t4 = 0, b4 = e5, o4 = f4.length, k3 = e5 + (3 * o4 >> 2) - ("=" == f4[o4 - 2]) - ("=" == f4[o4 - 1]); t4 < o4; t4 += 4) a4 = i2[f4.charCodeAt(t4 + 1)], n4 = i2[f4.charCodeAt(t4 + 2)], r4[b4++] = i2[f4.charCodeAt(t4)] << 2 | a4 >> 4, b4 < k3 && (r4[b4++] = a4 << 4 | n4 >> 2), b4 < k3 && (r4[b4++] = n4 << 6 | i2[f4.charCodeAt(t4 + 3)]);
        }
        function t3(r4) {
        ...
        function v2(r4) {
                          ...
                          b: {
                            o: {
                              if ((r5 |= 0) >>> 0 <= 244) {
                                ...
                                for (f4 = k3[3720 + (re(u3) << 2) >> 2], a5 = (-8 & k3[f4 + 4 >> 2]) - b5 | 0, e5 = f4; (r5 = k3[e5 + 16 >> 2]) || (r5 = k3[e5 + 20 >> 2]); ) a5 = (i4 = (e5 = (-8 & k3[r5 + 4 >> 2]) - b5 | 0) >>> 0 < a5 >>> 0) ? e5 : a5, f4 = i4 ? r5 : f4, e5 = r5;
                                if (o5 = k3[f4 + 24 >> 2], (0 | (i4 = k3[f4 + 12 >> 2])) != (0 | f4)) {
                                  r5 = k3[f4 + 8 >> 2], k3[r5 + 12 >> 2] = i4, k3[i4 + 8 >> 2] = r5;
                                  break e;
                                }
                                if (!(r5 = k3[(e5 = f4 + 20 | 0) >> 2])) {
                                  if (!(r5 = k3[f4 + 16 >> 2])) break b;
                                  e5 = f4 + 16 | 0;
                                }
                              ...
                              if (b5 = -1, !(r5 >>> 0 > 4294967231) && (b5 = -8 & (r5 = r5 + 11 | 0), u3 = k3[855])) {
                                ...
                                k: {
                                  u: {
                                    if (e5 = k3[3720 + (t4 << 2) >> 2]) for (r5 = 0, f4 = b5 << (31 != (0 | t4) ? 25 - (t4 >>> 1 | 0) : 0); ; ) {
                                      if (!((n5 = (-8 & k3[e5 + 4 >> 2]) - b5 | 0) >>> 0 >= a5 >>> 0 || (i4 = e5, a5 = n5))) {
                                        a5 = 0, r5 = e5;
                                        break u;
                                      }
                                      if (n5 = k3[e5 + 20 >> 2], e5 = k3[16 + ((f4 >>> 29 & 4) + e5 | 0) >> 2], r5 = n5 ? (0 | n5) == (0 | e5) ? r5 : n5 : r5, f4 <<= 1, !e5) break;
                                    }
                                    else r5 = 0;
                                    if (!(r5 | i4)) {
                                      if (i4 = 0, !(r5 = (0 - (r5 = 2 << t4) | r5) & u3)) break o;
                            ...
                            if (r5 = 0, a5 = b5 + 47 | 0, k3[972] ? f4 = k3[974] : (k3[975] = -1, k3[976] = -1, k3[973] = 4096, k3[974] = 4096, k3[972] = s3 + 12 & -16 ^ 1431655768, k3[977] = 0, k3[965] = 0, f4 = 4096), (e5 = (t4 = a5 + f4 | 0) & (n5 = 0 - f4 | 0)) >>> 0 <= b5 >>> 0) break r;
                            if ((i4 = k3[964]) && i4 >>> 0 < (u3 = (f4 = k3[962]) + e5 | 0) >>> 0 | f4 >>> 0 >= u3 >>> 0) break r;
                            o: {
                              if (!(4 & v3[3860])) {
                                k: {
                                  u: {
                                    c: {
                                      s: {
                                        if (i4 = k3[860]) for (r5 = 3864; ; ) {
                                          if ((f4 = k3[r5 >> 2]) >>> 0 <= i4 >>> 0 & i4 >>> 0 < f4 + k3[r5 + 4 >> 2] >>> 0) break s;
                                          if (!(r5 = k3[r5 + 8 >> 2])) break;
                                        }
                                        if (-1 == (0 | (f4 = Dr(0)))) break k;
                                        if (t4 = e5, (r5 = (i4 = k3[973]) - 1 | 0) & f4 && (t4 = (e5 - f4 | 0) + (r5 + f4 & 0 - i4) | 0), t4 >>> 0 <= b5 >>> 0) break k;
                                        if ((i4 = k3[964]) && i4 >>> 0 < (n5 = (r5 = k3[962]) + t4 | 0) >>> 0 | r5 >>> 0 >= n5 >>> 0) break k;
                                        if ((0 | f4) != (0 | (r5 = Dr(t4)))) break c;
                                        break o;
                                      }
                                      if ((0 | (f4 = Dr(t4 = n5 & t4 - o5))) == (k3[r5 >> 2] + k3[r5 + 4 >> 2] | 0)) break u;
                                      r5 = f4;
                                    }
                                    if (-1 == (0 | r5)) break k;
                                    if (b5 + 48 >>> 0 <= t4 >>> 0) {
                                    ...
                                    if (-1 == (0 | Dr(f4 = (f4 = k3[974]) + (a5 - t4 | 0) & 0 - f4))) break k;
                                    t4 = f4 + t4 | 0, f4 = r5;
                                    break o;
                                  }
                                  if (-1 != (0 | f4)) break o;
                              ...
                              if (-1 == (0 | (f4 = Dr(e5))) | -1 == (0 | (r5 = Dr(0))) | r5 >>> 0 <= f4 >>> 0) break i;
                              if ((t4 = r5 - f4 | 0) >>> 0 <= b5 + 40 >>> 0) break i;
                            }
                            r5 = k3[962] + t4 | 0, k3[962] = r5, r5 >>> 0 > h2[963] && (k3[963] = r5);
                            o: {
                              if (a5 = k3[860]) {
                                for (r5 = 3864; ; ) {
                                  if (((i4 = k3[r5 >> 2]) + (e5 = k3[r5 + 4 >> 2]) | 0) == (0 | f4)) break o;
                                  if (!(r5 = k3[r5 + 8 >> 2])) break;
                                }
                                break n;
                              }
                            ...
                            if (8 & k3[r5 + 12 >> 2] | f4 >>> 0 <= a5 >>> 0 | i4 >>> 0 > a5 >>> 0) break n;
                      ...
                      n: {
                        t: {
                          b: {
                            for (; ; ) {
                              if ((0 | e5) != k3[r5 >> 2]) {
                                if (r5 = k3[r5 + 8 >> 2]) continue;
                                break b;
                              }
                              break;
                            }
                            if (!(8 & v3[r5 + 12 | 0])) break t;
                          }
                          for (r5 = 3864; !((e5 = k3[r5 >> 2]) >>> 0 <= a5 >>> 0 && (n5 = e5 + k3[r5 + 4 >> 2] | 0) >>> 0 > a5 >>> 0); ) r5 = k3[r5 + 8 >> 2];
                          ...
                          if (r5 = 31, n5 >>> 0 <= 16777215 && (r5 = 62 + ((n5 >>> 38 - (r5 = E2(n5 >>> 8 | 0)) & 1) - (r5 << 1) | 0) | 0), k3[a5 + 28 >> 2] = r5, k3[a5 + 16 >> 2] = 0, k3[a5 + 20 >> 2] = 0, e5 = 3720 + (r5 << 2) | 0, (i4 = k3[855]) & (f4 = 1 << r5)) {
                            for (r5 = n5 << (31 != (0 | r5) ? 25 - (r5 >>> 1 | 0) : 0), i4 = k3[e5 >> 2]; ; ) {
                              if ((0 | n5) == (-8 & k3[(e5 = i4) + 4 >> 2])) break n;
                              if (f4 = r5 >>> 29 | 0, r5 <<= 1, !(i4 = k3[16 + (f4 = (4 & f4) + e5 | 0) >> 2])) break;
                            }
                            k3[f4 + 16 >> 2] = a5;
                          } else k3[855] = f4 | i4, k3[e5 >> 2] = a5;
                          ...
                          if (k3[859] != (0 | a5)) {
                            if (1 == (3 & (f4 = k3[a5 + 4 >> 2]))) {
                              ...
                              b: if (f4 >>> 0 <= 255) {
                                ...
                                b5 = k3[a5 + 24 >> 2];
                                o: if ((0 | a5) == (0 | (r5 = k3[a5 + 12 >> 2]))) {
                                  k: {
                                    if (!(f4 = k3[(e5 = a5 + 20 | 0) >> 2])) {
                                      if (!(f4 = k3[a5 + 16 >> 2])) break k;
                                      e5 = a5 + 16 | 0;
                                    }
                                  ...
                                  r5 = 0;
                                } else e5 = k3[a5 + 8 >> 2], k3[e5 + 12 >> 2] = r5, k3[r5 + 8 >> 2] = e5;
                                if (b5) {
                                  f4 = k3[a5 + 28 >> 2];
                                  o: {
                                    if (k3[(e5 = 3720 + (f4 << 2) | 0) >> 2] == (0 | a5)) {
                                      if (k3[e5 >> 2] = r5, r5) break o;
                                      A3 = 3420, l3 = k3[855] & Vr(f4), k3[A3 >> 2] = l3;
                                      break b;
                                    }
                                    if (k3[b5 + (k3[b5 + 16 >> 2] == (0 | a5) ? 16 : 20) >> 2] = r5, !r5) break b;
                                  }
                            ...
                            if (k3[a5 + 4 >> 2] = -2 & f4, k3[o5 + 4 >> 2] = 1 | t4, k3[t4 + o5 >> 2] = t4, t4 >>> 0 <= 255) e5 = 3456 + (-8 & t4) | 0, (f4 = k3[854]) & (r5 = 1 << (t4 >>> 3)) ? r5 = k3[e5 + 8 >> 2] : (k3[854] = r5 | f4, r5 = e5), k3[e5 + 8 >> 2] = o5, k3[r5 + 12 >> 2] = o5, k3[o5 + 12 >> 2] = e5, k3[o5 + 8 >> 2] = r5;
                            else {
                              ...
                              b: {
                                if ((i4 = k3[855]) & (r5 = 1 << f4)) {
                                  for (f4 = t4 << (31 != (0 | f4) ? 25 - (f4 >>> 1 | 0) : 0), r5 = k3[e5 >> 2]; ; ) {
                                    if (e5 = r5, (-8 & k3[r5 + 4 >> 2]) == (0 | t4)) break b;
                                    if (i4 = f4 >>> 29 | 0, f4 <<= 1, !(r5 = k3[16 + (i4 = (4 & i4) + r5 | 0) >> 2])) break;
                                  }
                                  k3[i4 + 16 >> 2] = o5;
                                } else k3[855] = r5 | i4, k3[e5 >> 2] = o5;
                                k3[o5 + 24 >> 2] = e5, k3[o5 + 12 >> 2] = o5, k3[o5 + 8 >> 2] = o5;
                                break t;
                              }
                              r5 = k3[e5 + 8 >> 2], k3[r5 + 12 >> 2] = o5, k3[e5 + 8 >> 2] = o5, k3[o5 + 24 >> 2] = 0, k3[o5 + 12 >> 2] = e5, k3[o5 + 8 >> 2] = r5;
                            }
                          } else k3[859] = o5, r5 = k3[856] + t4 | 0, k3[856] = r5, k3[o5 + 4 >> 2] = 1 | r5, k3[r5 + o5 >> 2] = r5;
                        } else k3[860] = o5, r5 = k3[857] + t4 | 0, k3[857] = r5, k3[o5 + 4 >> 2] = 1 | r5;
                        r5 = u3 + 8 | 0;
                        break r;
                      }
                ...
                f: if (t4) {
                  ...
                  i: {
                    if (k3[(r5 = 3720 + (e5 << 2) | 0) >> 2] == (0 | i4)) {
                      if (k3[r5 >> 2] = f4, f4) break i;
                      u3 = Vr(e5) & u3, k3[855] = u3;
                      break f;
                    }
                    if (k3[t4 + (k3[t4 + 16 >> 2] == (0 | i4) ? 16 : 20) >> 2] = f4, !f4) break f;
                  }
                  k3[f4 + 24 >> 2] = t4, (r5 = k3[i4 + 16 >> 2]) && (k3[f4 + 16 >> 2] = r5, k3[r5 + 24 >> 2] = f4), (r5 = k3[i4 + 20 >> 2]) && (k3[f4 + 20 >> 2] = r5, k3[r5 + 24 >> 2] = f4);
                }
                f: if (a5 >>> 0 <= 15) r5 = a5 + b5 | 0, k3[i4 + 4 >> 2] = 3 | r5, k3[4 + (r5 = r5 + i4 | 0) >> 2] = 1 | k3[r5 + 4 >> 2];
                else if (k3[i4 + 4 >> 2] = 3 | b5, k3[4 + (n5 = i4 + b5 | 0) >> 2] = 1 | a5, k3[a5 + n5 >> 2] = a5, a5 >>> 0 <= 255) e5 = 3456 + (-8 & a5) | 0, (f4 = k3[854]) & (r5 = 1 << (a5 >>> 3)) ? r5 = k3[e5 + 8 >> 2] : (k3[854] = r5 | f4, r5 = e5), k3[e5 + 8 >> 2] = n5, k3[r5 + 12 >> 2] = n5, k3[n5 + 12 >> 2] = e5, k3[n5 + 8 >> 2] = r5;
                else {
                  ...
                  i: {
                    if ((f4 = 1 << r5) & u3) {
                      for (r5 = a5 << (31 != (0 | r5) ? 25 - (r5 >>> 1 | 0) : 0), b5 = k3[e5 >> 2]; ; ) {
                        if ((-8 & k3[(e5 = b5) + 4 >> 2]) == (0 | a5)) break i;
                        if (f4 = r5 >>> 29 | 0, r5 <<= 1, !(b5 = k3[16 + (f4 = (4 & f4) + e5 | 0) >> 2])) break;
                      }
                      k3[f4 + 16 >> 2] = n5;
              ...
              e: if (o5) {
                ...
                f: {
                  if (k3[(r5 = 3720 + (e5 << 2) | 0) >> 2] == (0 | f4)) {
                    if (k3[r5 >> 2] = i4, i4) break f;
                    A3 = 3420, l3 = Vr(e5) & u3, k3[A3 >> 2] = l3;
                    break e;
                  }
                  if (k3[o5 + (k3[o5 + 16 >> 2] == (0 | f4) ? 16 : 20) >> 2] = i4, !i4) break e;
                }
          ...
          function H2(r5, e5) {
            ...
            r: {
              e: {
                f: if ((0 | p3) != (0 | C3) && (o5 = (f4 = w2[p3 + 32 >> 2]) <= (n5 = w2[E3 + 32 >> 2]) ? f4 : n5, n5 = w2[C3 + 32 >> 2], !(o5 > ((a5 = w2[R3 + 32 >> 2]) <= n5 ? n5 : a5)))) {
                  i: {
                  ...
                  i: if ((a5 = w2[A3 + 28 >> 2]) > n5 | a5 == n5 & w2[g3 + 32 >> 2] <= w2[A3 + 32 >> 2]) {
                    if (!((s3 = w2[d3 + 28 >> 2]) > a5) & (!(w2[A3 + 32 >> 2] <= w2[d3 + 32 >> 2]) | a5 != s3)) {
                      if (f4 = dr2(i4, g3, A3), a5 = dr2(i4, d3, A3), n5 = w2[g3 + 28 >> 2], (o5 = (f4 = (t4 = m2(f4 - a5) < m2(0)) ? m2(-f4) : f4) < m2(0) ? m2(0) : f4) <= (a5 = (f4 = t4 ? a5 : m2(-a5)) < m2(0) ? m2(0) : f4)) {
                        if (c3 = w2[d3 + 28 >> 2], f4 = m2(m2(n5 + c3) * m2(0.5)), a5 == m2(0)) break i;
                        f4 = m2(m2(m2(c3 - n5) * m2(o5 / m2(o5 + a5))) + n5);
                      } else f4 = w2[d3 + 28 >> 2], f4 = m2(m2(m2(n5 - f4) * m2(a5 / m2(o5 + a5))) + f4);
                    } else {
                      if (f4 = m2(0), o5 = m2(a5 - n5), h3 = m2(n5 - w2[i4 + 28 >> 2]), (P3 = m2(o5 + h3)) > m2(0) && (f4 = w2[((t4 = o5 > h3) ? i4 : A3) + 32 >> 2], f4 = m2(m2(m2(f4 - w2[(t4 ? A3 : i4) + 32 >> 2]) * m2((t4 ? h3 : o5) / P3)) + m2(w2[g3 + 32 >> 2] - f4))), s3 = m2(s3 - a5), (h3 = m2(o5 + s3)) > m2(0) && (c3 = w2[((t4 = o5 < s3) ? g3 : d3) + 32 >> 2], c3 = m2(m2(m2(c3 - w2[(t4 ? d3 : g3) + 32 >> 2]) * m2((t4 ? o5 : s3) / h3)) + m2(w2[A3 + 32 >> 2] - c3))), (s3 = (f4 = (t4 = m2(f4 + c3) < m2(0)) ? m2(-f4) : f4) < m2(0) ? m2(0) : f4) <= (c3 = (f4 = t4 ? m2(-c3) : c3) < m2(0) ? m2(0) : f4)) {
                        if (f4 = m2(m2(n5 + a5) * m2(0.5)), c3 == m2(0)) break i;
                        f4 = m2(m2(o5 * m2(s3 / m2(s3 + c3))) + n5);
                        break i;
                      }
                      f4 = m2(m2(m2(n5 - a5) * m2(c3 / m2(s3 + c3))) + a5);
                    }
                  } else f4 = m2(m2(n5 + a5) * m2(0.5));
                  ...
                  i: {
                    a: if ((a5 = w2[i4 + 32 >> 2]) > n5 | a5 == n5 & w2[g3 + 28 >> 2] <= w2[i4 + 28 >> 2]) {
                  ...
                  i: {
                    if (n5 < (f4 = w2[t4 + 28 >> 2])) a5 = w2[t4 + 32 >> 2];
                    else {
                      if (f4 != n5) break i;
                      if (!((a5 = w2[t4 + 32 >> 2]) >= w2[u3 + 88 >> 2])) break i;
                    }
                    w2[u3 + 88 >> 2] = a5, w2[u3 + 84 >> 2] = f4, n5 = f4;
                  }
                  (f4 = c3 = w2[(i4 = p3) + 28 >> 2]) < (a5 = w2[C3 + 28 >> 2]) || f4 == a5 && w2[i4 + 32 >> 2] <= w2[C3 + 32 >> 2] || (f4 = a5, i4 = C3);
                  i: {
                    if (f4 < n5) o5 = w2[i4 + 32 >> 2];
                    else {
                      if (f4 != n5) break i;
                      if (!((o5 = w2[i4 + 32 >> 2]) <= w2[u3 + 88 >> 2])) break i;
                    }
                  ...
                  if (!(n5 == c3 & w2[u3 + 88 >> 2] == w2[p3 + 32 >> 2]) & (a5 != n5 | w2[u3 + 88 >> 2] != w2[C3 + 32 >> 2])) {
                    i: {
                      ...
                      if ((0 | (i4 = k3[r5 + 72 >> 2])) == (0 | R3)) {
                        ...
                        if (v3[e5 + 15 | 0] && (t4 = 0, (i4 = X2(k3[k3[k3[k3[k3[e5 + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2], k3[A3 + 12 >> 2])) && $2(k3[e5 >> 2]) && (k3[e5 >> 2] = i4, b4[e5 + 15 | 0] = 0, k3[i4 + 24 >> 2] = e5, t4 = k3[k3[k3[e5 + 4 >> 2] + 4 >> 2] >> 2]), e5 = t4), !e5) break r;
                      ...
                      if (dr2(E3, i4, u3 + 56 | 0) >= m2(0)) {
                        if (b4[e5 + 14 | 0] = 1, b4[k3[k3[k3[e5 + 4 >> 2] + 4 >> 2] >> 2] + 14 | 0] = 1, !er2(k3[S3 + 4 >> 2])) break r;
                        t4 = k3[S3 + 16 >> 2], i4 = k3[r5 + 72 >> 2], w2[t4 + 28 >> 2] = w2[i4 + 28 >> 2], w2[t4 + 32 >> 2] = w2[i4 + 32 >> 2];
                      } else i4 = k3[r5 + 72 >> 2];
                      if (!(dr2(R3, i4, u3 + 56 | 0) <= m2(0))) break f;
                      if (b4[U3 + 14 | 0] = 1, b4[e5 + 14 | 0] = 1, !er2(k3[M3 + 4 >> 2])) break r;
                    ...
                    if (i4 = k3[S3 + 16 >> 2], w2[i4 + 28 >> 2] = w2[u3 + 84 >> 2], w2[i4 + 32 >> 2] = w2[u3 + 88 >> 2], t4 = ar2(k3[r5 + 68 >> 2], i4), i4 = k3[S3 + 16 >> 2], k3[i4 + 36 >> 2] = t4, 2147483647 == (0 | t4)) break e;
          ...
          function W2(r5, e5, f4, i4, a5, n5) {
            ...
            if ((s3 = k3[544]) || (s3 = T2(16), k3[544] = s3), k3[s3 + 8 >> 2] = n5, k3[s3 + 4 >> 2] = 0, k3[s3 + 12 >> 2] = i4, k3[s3 >> 2] = a5, (s3 = k3[545]) || ((a5 = T2(1900)) ? (k3[a5 + 100 >> 2] = 12, k3[a5 + 96 >> 2] = 13, k3[a5 + 92 >> 2] = 14, k3[a5 + 88 >> 2] = 15, o4[a5 + 80 >> 1] = 0, k3[a5 + 52 >> 2] = 0, k3[a5 + 56 >> 2] = 100130, k3[a5 + 16 >> 2] = 0, k3[a5 + 20 >> 2] = 0, k3[a5 >> 2] = 0, k3[a5 + 1896 >> 2] = 0, k3[a5 + 1736 >> 2] = 10, k3[a5 + 1732 >> 2] = 11, k3[a5 + 1728 >> 2] = 6, k3[a5 + 1724 >> 2] = 5, k3[a5 + 1720 >> 2] = 4, k3[a5 + 1716 >> 2] = 3, k3[a5 + 104 >> 2] = 16, k3[a5 + 76 >> 2] = 17, k3[a5 + 12 >> 2] = 18, k3[a5 + 24 >> 2] = 0) : a5 = 0, k3[545] = a5, hr2(a5, 100107, 31), hr2(k3[545], 100100, 32), hr2(k3[545], 100102, 33), hr2(k3[545], 100105, 34), hr2(k3[545], 100103, 35), hr2(k3[545], 100104, 36), k3[k3[545] + 56 >> 2] = 100130, a5 = k3[545], w2[a5 + 16 >> 2] = 0, w2[a5 + 24 >> 2] = 1, w2[a5 + 20 >> 2] = 0, s3 = k3[545]), a5 = 0, n5 = k3[544], k3[s3 >> 2] && or2(s3, 0), k3[s3 + 112 >> 2] = 0, k3[s3 >> 2] = 1, b4[s3 + 108 | 0] = 0, k3[s3 + 1896 >> 2] = n5, k3[s3 + 8 >> 2] = 0, (0 | f4) > 0) for (n5 = 0; ; ) {
              ...
              if (t4 = k3[545], 2 != k3[t4 >> 2] && or2(t4, 2), k3[t4 >> 2] = 1, a5 = a5 + M3 | 0, (0 | (n5 = n5 + 1 | 0)) == (0 | f4)) break;
            }
                  ...
                  if (r5) {
                    if (11 != (0 | (e5 = k3[c3 + 1732 >> 2]))) {
                      if (r5 = k3[c3 + 1896 >> 2], k3[978] = 0, C2(0 | e5, 100902, 0 | r5), r5 = k3[978], k3[978] = 0, e5 = -1, r5 && (i4 = k3[979])) {
                        if (!(e5 = Or(k3[r5 >> 2], u3, t4))) break e;
                        F2 = i4;
                      }
                      if (r5 = F2, 1 == (0 | e5)) continue;
                      break r;
                    }
                        ...
                        i: {
                          if (!v3[c3 + 60 | 0]) {
                            ...
                            if (16 != k3[c3 + 104 >> 2]) {
                              ...
                              if (r5 = F2, 1 == (0 | e5)) continue;
                              if (r5 = k3[c3 + 104 >> 2], k3[978] = 0, S2(0 | r5, 0 | n5), r5 = k3[978], k3[978] = 0, e5 = -1, !r5) break f;
                              if (!(i4 = k3[979])) break f;
                              if (e5 = Or(k3[r5 >> 2], u3, t4)) break i;
                              break e;
                            }
                          }
          ...
          function x2(r5, e5, f4, i4, a5, n5) {
            ...
            r: if (2146435072 & ~t4) {
              ...
              e: {
                ...
                if ((0 | l3) <= 0) i4 = l3, t4 = o5, c3 = m3;
                else for (c3 = m3, i4 = l3; ; ) {
                  ...
                  if (i4 = k3[w3 + 44 >> 2] - s3 | 0, k3[w3 + 44 >> 2] = i4, o5 = t4, !((0 | i4) > 0)) break;
                }
                if ((0 | i4) < 0) for (R3 = 1 + ((d3 + 25 >>> 0) / 9 | 0) | 0, E3 = 102 == (0 | M3); ; ) {
                  if (h3 = (0 | (i4 = 0 - i4 | 0)) >= 9 ? 9 : i4, t4 >>> 0 <= c3 >>> 0) o5 = k3[c3 >> 2];
                  else {
                  ...
                  if (i4 = h3 + k3[w3 + 44 >> 2] | 0, k3[w3 + 44 >> 2] = i4, c3 = (!o5 << 2) + c3 | 0, t4 = t4 - (o5 = E3 ? m3 : c3) >> 2 > (0 | R3) ? o5 + (R3 << 2) | 0 : t4, !((0 | i4) < 0)) break;
                }
                if (i4 = 0, !(t4 >>> 0 <= c3 >>> 0 || (i4 = p2(m3 - c3 >> 2, 9), o5 = 10, (s3 = k3[c3 >> 2]) >>> 0 < 10))) for (; i4 = i4 + 1 | 0, s3 >>> 0 >= (o5 = p2(o5, 10)) >>> 0; ) ;
                if ((0 | (o5 = (d3 - (102 != (0 | M3) ? i4 : 0) | 0) - (103 == (0 | M3) & !!(0 | d3)) | 0)) < (p2(t4 - m3 >> 2, 9) - 9 | 0)) {
                  ...
                  if (!(!(h3 = (E3 = k3[l3 >> 2]) - p2(o5, y3 = (E3 >>> 0) / (o5 >>> 0) | 0) | 0) & (0 | (s3 = R3 - 4092 | 0)) == (0 | t4)) && (!(1 & y3) && (e5 = 9007199254740992, !(1 & b4[R3 - 4100 | 0]) | 1e9 != (0 | o5) | c3 >>> 0 >= l3 >>> 0) || (e5 = 9007199254740994), C3 = (0 | t4) == (0 | s3) ? 1 : 1.5, C3 = (s3 = o5 >>> 1 | 0) >>> 0 > h3 >>> 0 ? 0.5 : (0 | s3) == (0 | h3) ? C3 : 1.5, 45 != v3[0 | P3] | U3 || (C3 = -C3, e5 = -e5), s3 = E3 - h3 | 0, k3[l3 >> 2] = s3, e5 + C3 != e5)) {
                    if (i4 = o5 + s3 | 0, k3[l3 >> 2] = i4, i4 >>> 0 >= 1e9) for (; k3[l3 >> 2] = 0, (l3 = l3 - 4 | 0) >>> 0 < c3 >>> 0 && (k3[(c3 = c3 - 4 | 0) >> 2] = 0), i4 = k3[l3 >> 2] + 1 | 0, k3[l3 >> 2] = i4, i4 >>> 0 > 999999999; ) ;
                    if (i4 = p2(m3 - c3 >> 2, 9), o5 = 10, !((s3 = k3[c3 >> 2]) >>> 0 < 10)) for (; i4 = i4 + 1 | 0, s3 >>> 0 >= (o5 = p2(o5, 10)) >>> 0; ) ;
                  }
                ...
                if (E3 = 1 + (!!(0 | y3) + d3 | 0) | 0, 70 != (0 | (o5 = -33 & n5))) {
                  if ((S3 - (t4 = Ur(((t4 = i4 >> 31) ^ i4) - t4 | 0, 0, S3)) | 0) <= 1) for (; b4[0 | (t4 = t4 - 1 | 0)] = 48, (S3 - t4 | 0) < 2; ) ;
                  if (b4[0 | (R3 = t4 - 2 | 0)] = n5, b4[t4 - 1 | 0] = (0 | i4) < 0 ? 45 : 43, (0 | (t4 = S3 - R3 | 0)) > (2147483647 ^ E3)) break r;
                } else {
                  if ((2147483647 ^ E3) < (0 | i4)) break r;
                  t4 = (0 | i4) > 0 ? i4 : 0;
                }
                if ((0 | (i4 = t4 + E3 | 0)) > (2147483647 ^ I3)) break r;
                    ...
                    a: {
                      if (70 == (0 | o5)) {
                        for (i4 = 8 | (n5 = w3 + 16 | 0), l3 = 9 | n5, c3 = o5 = c3 >>> 0 > m3 >>> 0 ? m3 : c3; ; ) {
                          t4 = Ur(k3[c3 >> 2], 0, l3);
                          n: if ((0 | o5) == (0 | c3)) (0 | t4) == (0 | l3) && (b4[w3 + 24 | 0] = 48, t4 = i4);
                          else {
                            if (w3 + 16 >>> 0 >= t4 >>> 0) break n;
                            for (; b4[0 | (t4 = t4 - 1 | 0)] = 48, w3 + 16 >>> 0 < t4 >>> 0; ) ;
                          }
                          if (Ir(r5, t4, l3 - t4 | 0), !(m3 >>> 0 >= (c3 = c3 + 4 | 0) >>> 0)) break;
                        }
                        if (y3 && Ir(r5, 1069, 1), (0 | d3) <= 0 | c3 >>> 0 >= s3 >>> 0) break a;
                        for (; ; ) {
                          if ((t4 = Ur(k3[c3 >> 2], 0, l3)) >>> 0 > w3 + 16 >>> 0) for (; b4[0 | (t4 = t4 - 1 | 0)] = 48, w3 + 16 >>> 0 < t4 >>> 0; ) ;
                          if (Ir(r5, t4, (0 | d3) >= 9 ? 9 : d3), t4 = d3 - 9 | 0, s3 >>> 0 <= (c3 = c3 + 4 | 0) >>> 0) break i;
                          if (i4 = (0 | d3) > 9, d3 = t4, !i4) break;
                        }
                        break i;
                      }
                      n: if (!((0 | d3) < 0)) for (m3 = c3 >>> 0 < s3 >>> 0 ? s3 : c3 + 4 | 0, i4 = 8 | (n5 = w3 + 16 | 0), s3 = 9 | n5, o5 = c3; ; ) {
                        (0 | s3) == (0 | (t4 = Ur(k3[o5 >> 2], 0, s3))) && (b4[w3 + 24 | 0] = 48, t4 = i4);
                        t: if ((0 | o5) == (0 | c3)) Ir(r5, t4, 1), t4 = t4 + 1 | 0, l3 | d3 && Ir(r5, 1069, 1);
                        else {
                          if (w3 + 16 >>> 0 >= t4 >>> 0) break t;
                          for (; b4[0 | (t4 = t4 - 1 | 0)] = 48, w3 + 16 >>> 0 < t4 >>> 0; ) ;
                        }
                        if (Ir(r5, t4, (0 | (n5 = s3 - t4 | 0)) < (0 | d3) ? n5 : d3), d3 = d3 - n5 | 0, m3 >>> 0 <= (o5 = o5 + 4 | 0) >>> 0) break n;
                        if (!((0 | d3) >= 0)) break;
                      }
            ...
            } else xr(r5, 32, f4, t4 = I3 + 3 | 0, -65537 & a5), Ir(r5, P3, I3), i4 = 32 & n5, Ir(r5, e5 != e5 ? i4 ? 1053 : 1061 : i4 ? 1057 : 1065, 3), xr(r5, 32, f4, t4, 8192 ^ a5), h3 = (0 | f4) < (0 | t4) ? t4 : f4;
                        ...
                        t: {
                          b: {
                            o: {
                              if (u3 = v3[0 | (t4 = e5)]) for (; ; ) {
                                k: {
                                  ...
                                  u: if (42 != (0 | u3)) {
                                    ...
                                    } else e5 = b4[0 | u3], u3 = l3 + 3 | 0, C3 = 1, r5 ? e5 = k3[(e5 << 3) + P3 >> 2] : (k3[(e5 << 2) + M3 >> 2] = 10, e5 = 0);
                                    if (k3[c3 + 76 >> 2] = u3, g3 = e5, (0 | e5) >= 0) break u;
                                    g3 = 0 - e5 | 0, d3 |= 8192;
                                  }
                                  if (t4 = 0, A3 = -1, 46 == v3[0 | u3]) {
                                    if (42 != v3[u3 + 1 | 0]) k3[c3 + 76 >> 2] = u3 + 1, A3 = Qr(c3 + 76 | 0), e5 = k3[c3 + 76 >> 2], I3 = 1;
                                    else {
                                      if (e5 = u3 + 2 | 0, 36 != v3[u3 + 3 | 0] | b4[u3 + 2 | 0] - 48 >>> 0 >= 10) {
                                        if (C3) break o;
                                        r5 ? (u3 = k3[f4 >> 2], k3[f4 >> 2] = u3 + 4, A3 = k3[u3 >> 2]) : A3 = 0;
                                      } else e5 = b4[0 | e5], r5 ? A3 = k3[(e5 << 3) + P3 >> 2] : (k3[(e5 << 2) + M3 >> 2] = 10, A3 = 0), e5 = u3 + 4 | 0;
                                      k3[c3 + 76 >> 2] = e5, I3 = (0 | A3) >= 0;
                                    }
                                  } else e5 = u3, I3 = 0;
                                  for (; ; ) {
                                    if (S3 = t4, l3 = 28, h3 = e5, (u3 = b4[0 | e5]) - 123 >>> 0 < 4294967238) break f;
                                    if (e5 = e5 + 1 | 0, !((t4 = v3[1071 + (u3 + p2(t4, 58) | 0) | 0]) - 1 >>> 0 < 8)) break;
                                  }
                                  k3[c3 + 76 >> 2] = e5;
                                  u: if (27 == (0 | t4)) {
                                    if ((0 | m3) >= 0) break f;
                                    if (t4 = 0, !r5) continue n;
                                  } else {
                                    if (!t4) break f;
                                    if ((0 | m3) >= 0) {
                                      if (!r5) {
                                  ...
                                  u: {
                                    c: {
                                      s: {
                                                  ...
                                                  w: {
                                                    y: {
                                                      p: {
                                                        ...
                                                        if (e5 = E3, (s3 = k3[c3 + 64 >> 2]) | (u3 = k3[c3 + 68 >> 2])) for (F3 = 32 & t4; b4[0 | (e5 = e5 - 1 | 0)] = F3 | v3[1600 + (15 & s3) | 0], S3 = !u3 & s3 >>> 0 > 15 | !!(0 | u3), h3 = u3, u3 = u3 >>> 4 | 0, s3 = (15 & h3) << 28 | s3 >>> 4, S3; ) ;
                                                        if (s3 = e5, !(k3[c3 + 64 >> 2] | k3[c3 + 68 >> 2]) | !(8 & d3)) break h;
                                                        R3 = 1024 + (t4 >>> 4 | 0) | 0, m3 = 2;
                                                        break h;
                                                      }
                                                      if (e5 = E3, u3 = t4 = k3[c3 + 68 >> 2], t4 | (s3 = k3[c3 + 64 >> 2])) for (; b4[0 | (e5 = e5 - 1 | 0)] = 7 & s3 | 48, h3 = !u3 & s3 >>> 0 > 7 | !!(0 | u3), u3 = (t4 = u3) >>> 3 | 0, s3 = (7 & t4) << 29 | s3 >>> 3, h3; ) ;
                                        ...
                                        if (xr(r5, 32, g3, t4, d3), t4) for (l3 = 0, u3 = k3[c3 + 64 >> 2]; ; ) {
                                          if (!(s3 = k3[u3 >> 2])) break s;
                                          if ((l3 = (s3 = gr2(A3 = c3 + 4 | 0, s3)) + l3 | 0) >>> 0 > t4 >>> 0) break s;
                                          if (Ir(r5, A3, s3), u3 = u3 + 4 | 0, !(t4 >>> 0 > l3 >>> 0)) break;
                                        }
                                        else t4 = 0;
                                      }
                                    ...
                                    if ((0 | A3) < 0 & I3) break i;
                                    if (l3 = 61, (0 | (t4 = 0 | ke[0 | n5](r5, y2[c3 + 64 >> 3], g3, A3, d3, t4))) >= 0) continue n;
                                    break f;
                                  }
                              ...
                              for (t4 = 1; ; ) {
                                if (r5 = k3[(t4 << 2) + a5 >> 2]) {
                                  if (Ar2((t4 << 3) + i4 | 0, r5, f4), w3 = 1, 10 != (0 | (t4 = t4 + 1 | 0))) continue;
                                  break r;
                                }
                                break;
                              }
          ...
          function O2(r5) {
            ...
            r: {
              if (e5 = k3[r5 + 8 >> 2], (0 | (f4 = k3[e5 + 64 >> 2])) != (0 | (u3 = e5 - -64 | 0))) for (; ; ) {
                ...
                if (k3[a5 + 12 >> 2] == (0 | e5)) {
                  if ((0 | e5) != (0 | a5) && (i4 = (0 | i4) != (0 | a5) & k3[i4 + 4 >> 2] != (0 | a5) ? i4 : k3[i4 >> 2], !$2(a5))) break r;
                  if (f4 = (0 | e5) == (0 | i4) | k3[i4 + 4 >> 2] == (0 | e5) ? k3[i4 >> 2] : i4, !$2(e5)) break r;
                } else f4 = i4;
                if ((0 | f4) == (0 | u3)) break;
              }
              ...
              e: if (d3) {
                ...
                f: {
                  i: {
                    ...
                    if (B2 = E3 = B2 - 400 | 0, i4 = T2(4 + (e5 = (C3 = k3[d3 + 12 >> 2]) << 2) | 0), k3[d3 + 8 >> 2] = i4, B2 = E3 + 400 | 0, i4) {
                      if ((a5 = (e5 + i4 | 0) - 4 | 0) >>> 0 >= i4 >>> 0) for (e5 = k3[d3 + 4 >> 2], f4 = i4; k3[f4 >> 2] = e5, e5 = e5 + 4 | 0, a5 >>> 0 >= (f4 = f4 + 4 | 0) >>> 0; ) ;
                      for (k3[E3 + 4 >> 2] = a5, k3[E3 >> 2] = i4, v4 = 8 | E3, R3 = 2016473283, n5 = E3; ; ) {
                        if ((u3 = k3[v4 - 4 >> 2]) >>> 0 > (o5 = k3[n5 >> 2]) + 40 >>> 0) for (; ; ) {
                          for (R3 = p2(R3, 1539415821) + 1 | 0, y3 = k3[(e5 = ((R3 >>> 0) % (1 + (u3 - o5 >> 2) >>> 0) << 2) + o5 | 0) >> 2], k3[e5 >> 2] = k3[o5 >> 2], k3[o5 >> 2] = y3, e5 = u3 + 4 | 0, f4 = o5 - 4 | 0; ; ) {
                            ...
                            a: if (!(c3 < (A3 = w2[h3 + 28 >> 2]))) for (; ; ) {
                              ...
                              if (f4 = e5 + 4 | 0, a5 = e5, s3 = k3[e5 + 4 >> 2], g3 = k3[s3 >> 2], A3 > (c3 = w2[g3 + 28 >> 2])) break;
                            }
                            v4 = k3[(e5 = i4 - 4 | 0) >> 2], g3 = k3[v4 >> 2];
                            a: if (!(A3 < (c3 = w2[g3 + 28 >> 2]))) for (; ; ) {
                              if (!(!(w2[h3 + 32 >> 2] <= w2[g3 + 32 >> 2]) | c3 != A3)) break a;
                              if (i4 = e5, v4 = k3[(e5 = e5 - 4 | 0) >> 2], g3 = k3[v4 >> 2], A3 < (c3 = w2[g3 + 28 >> 2])) break;
                            }
                            if (k3[f4 >> 2] = v4, k3[e5 >> 2] = s3, !(e5 >>> 0 > f4 >>> 0)) break;
                          }
                          if (v4 = k3[f4 >> 2], k3[f4 >> 2] = s3, k3[e5 >> 2] = v4, (f4 - o5 | 0) < (u3 - e5 | 0) ? (e5 = i4, f4 = u3, u3 = a5) : (e5 = o5, f4 = a5, o5 = i4), k3[n5 + 4 >> 2] = f4, k3[n5 >> 2] = e5, n5 = n5 + 8 | 0, !(o5 + 40 >>> 0 < u3 >>> 0)) break;
                        }
                        if (v4 = n5, (s3 = o5 + 4 | 0) >>> 0 <= u3 >>> 0) for (; ; ) {
                          ...
                          a: if (!(o5 >>> 0 >= (e5 = f4 = s3) >>> 0)) for (; ; ) {
                            ...
                            if (k3[f4 >> 2] = a5, f4 = e5, !(o5 >>> 0 < e5 >>> 0)) break;
                          }
                      ...
                      if (k3[d3 + 20 >> 2] = 1, k3[d3 + 16 >> 2] = C3, C3 = k3[d3 >> 2], (0 | (n5 = k3[C3 + 8 >> 2])) > 0) for (h3 = k3[C3 + 4 >> 2], y3 = k3[C3 >> 2], e5 = n5; ; ) {
                        for (a5 = e5, d3 = h3 + ((s3 = k3[y3 + (e5 << 2) >> 2]) << 3) | 0, f4 = e5; (0 | n5) <= (0 | (e5 = f4 << 1)) || (o5 = k3[h3 + (k3[y3 + ((i4 = 1 | e5) << 2) >> 2] << 3) >> 2], c3 = w2[o5 + 28 >> 2], u3 = k3[h3 + (k3[y3 + (e5 << 2) >> 2] << 3) >> 2], !(c3 < (A3 = w2[u3 + 28 >> 2])) & (!(w2[o5 + 32 >> 2] <= w2[u3 + 32 >> 2]) | c3 != A3) || (e5 = i4)), !((0 | e5) > (0 | n5) || (v4 = k3[d3 >> 2], c3 = w2[v4 + 28 >> 2], o5 = k3[y3 + (e5 << 2) >> 2], i4 = k3[(u3 = h3 + (o5 << 3) | 0) >> 2], c3 < (A3 = w2[i4 + 28 >> 2]) | c3 == A3 & w2[v4 + 32 >> 2] <= w2[i4 + 32 >> 2])); ) k3[y3 + (f4 << 2) >> 2] = o5, k3[u3 + 4 >> 2] = f4, f4 = e5;
                        if (k3[y3 + (f4 << 2) >> 2] = s3, k3[d3 + 4 >> 2] = f4, e5 = a5 - 1 | 0, !((0 | a5) > 1)) break;
                      }
                      k3[C3 + 20 >> 2] = 1, f4 = 1;
                    } else f4 = 0;
                    if (f4) break f;
                ...
                if ((e5 = T2(20)) && (k3[e5 + 16 >> 2] = 9, k3[e5 + 12 >> 2] = r5, k3[e5 >> 2] = 0, k3[e5 + 8 >> 2] = e5, k3[e5 + 4 >> 2] = e5), k3[r5 + 64 >> 2] = e5, !e5) break r;
                if (Sr(r5, m2(-3999999973526325e22)), Sr(r5, m2(3999999973526325e22)), e5 = Cr(k3[r5 + 68 >> 2])) for (; ; ) {
                  f: if (f4 = Pr(k3[r5 + 68 >> 2])) for (; ; ) {
                    if (w2[f4 + 28 >> 2] != w2[e5 + 28 >> 2] | w2[f4 + 32 >> 2] != w2[e5 + 32 >> 2]) break f;
                    if (a5 = k3[Cr(k3[r5 + 68 >> 2]) + 8 >> 2], i4 = k3[e5 + 8 >> 2], k3[t4 + 24 >> 2] = 0, k3[t4 + 28 >> 2] = 0, k3[t4 + 16 >> 2] = 0, k3[t4 + 20 >> 2] = 0, k3[t4 + 8 >> 2] = 0, k3[t4 + 12 >> 2] = 0, k3[t4 >> 2] = 1056964608, k3[t4 + 4 >> 2] = 1056964608, f4 = k3[i4 + 16 >> 2], k3[t4 + 16 >> 2] = k3[f4 + 12 >> 2], k3[t4 + 20 >> 2] = k3[k3[a5 + 16 >> 2] + 12 >> 2], w2[t4 + 36 >> 2] = w2[f4 + 16 >> 2], w2[t4 + 40 >> 2] = w2[f4 + 20 >> 2], w2[t4 + 44 >> 2] = w2[f4 + 24 >> 2], k3[f4 + 12 >> 2] = 0, n5 = f4 + 12 | 0, 10 == (0 | (f4 = k3[r5 + 1736 >> 2])) ? ke[k3[r5 + 76 >> 2]](t4 + 36 | 0, t4 + 16 | 0, t4, n5) : ke[0 | f4](t4 + 36 | 0, t4 + 16 | 0, t4, n5, k3[r5 + 1896 >> 2]), k3[n5 >> 2] || (k3[n5 >> 2] = k3[t4 + 16 >> 2]), !ir2(i4, a5)) break r;
                    if (!(f4 = Pr(k3[r5 + 68 >> 2]))) break;
                  }
                  if (D2(r5, e5), !(e5 = Cr(k3[r5 + 68 >> 2]))) break;
                }
                ...
                if (Y2(e5), Yr(k3[r5 + 68 >> 2]), I3 = 1, e5 = k3[r5 + 8 >> 2], (0 | (r5 = k3[e5 + 40 >> 2])) != (0 | (f4 = e5 + 40 | 0))) for (; ; ) {
          ...
          function D2(r5, e5) {
            ...
            r: {
              e: {
                f: {
                  for (; ; ) {
                    if (i4 = k3[f4 + 24 >> 2]) break f;
                    if ((0 | a5) == (0 | (f4 = k3[f4 + 8 >> 2]))) break;
                  }
                  ...
                  if (i4 = k3[a5 >> 2], a5 = k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2], o5 = k3[a5 >> 2], n5 = k3[i4 >> 2], dr2(k3[k3[n5 + 4 >> 2] + 16 >> 2], e5, k3[n5 + 16 >> 2]) == m2(0)) {
                    ...
                    if (a5 = k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2], o5 = k3[a5 >> 2], n5 = k3[o5 + 4 >> 2], f4 = k3[n5 + 8 >> 2], v3[a5 + 15 | 0]) {
                      if (k3[o5 + 24 >> 2] = 0, Nr(k3[a5 + 4 >> 2]), Y2(a5), !$2(n5)) break r;
                  ...
                  if (u3 = v3[i4 + 12 | 0], o5 = k3[o5 + 4 >> 2], s3 = k3[o5 + 16 >> 2], t4 = w2[s3 + 28 >> 2], A3 = k3[k3[n5 + 4 >> 2] + 16 >> 2], f4 = i4, t4 < (c3 = w2[A3 + 28 >> 2]) || t4 == c3 && (f4 = i4, w2[s3 + 32 >> 2] <= w2[A3 + 32 >> 2]) || (f4 = a5), u3 | v3[f4 + 15 | 0]) {
                    i: {
                      if ((0 | i4) == (0 | f4)) {
                        if (a5 = X2(k3[k3[e5 + 8 >> 2] + 4 >> 2], k3[n5 + 12 >> 2])) break i;
                        break r;
                      }
                      if (!(a5 = X2(k3[k3[o5 + 8 >> 2] + 4 >> 2], k3[e5 + 8 >> 2]))) break r;
                      a5 = k3[a5 + 4 >> 2];
                    }
                    if (v3[f4 + 15 | 0]) {
                      if ($2(k3[f4 >> 2])) {
                    ...
                    if (!(f4 = T2(16))) break r;
                    if (k3[f4 >> 2] = a5, i4 = Wr(k3[r5 + 64 >> 2], k3[i4 + 4 >> 2], f4), k3[f4 + 4 >> 2] = i4, !i4) break r;
                ...
                if (v3[i4 + 15 | 0]) {
                  if (!(e5 = X2(k3[k3[k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2], k3[f4 + 12 >> 2]))) break r;
                  if (!$2(k3[i4 >> 2])) break r;
                  if (k3[i4 >> 2] = e5, b4[i4 + 15 | 0] = 0, k3[e5 + 24 >> 2] = i4, !(i4 = k3[k3[k3[i4 + 4 >> 2] + 4 >> 2] >> 2])) break r;
                }
                if (e5 = k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2], f4 = k3[e5 >> 2], e5 = wr2(r5, e5, 0), (0 | f4) != (0 | (a5 = k3[e5 + 8 >> 2]))) q2(r5, i4, a5, f4, f4, 1);
                else {
                  if (a5 = k3[i4 >> 2], s3 = k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2], o5 = k3[s3 >> 2], k3[k3[a5 + 4 >> 2] + 16 >> 2] != k3[k3[o5 + 4 >> 2] + 16 >> 2] && H2(r5, i4), A3 = 1, n5 = k3[r5 + 72 >> 2], t4 = w2[n5 + 28 >> 2], u3 = k3[a5 + 16 >> 2], !(t4 != w2[u3 + 28 >> 2] | w2[u3 + 32 >> 2] != w2[n5 + 32 >> 2])) {
                    if (!ir2(k3[k3[f4 + 4 >> 2] + 12 >> 2], a5)) break r;
                    for (f4 = k3[k3[i4 >> 2] + 16 >> 2]; i4 = k3[k3[k3[i4 + 4 >> 2] + 4 >> 2] >> 2], n5 = k3[i4 >> 2], (0 | f4) == k3[n5 + 16 >> 2]; ) ;
                    if (v3[i4 + 15 | 0]) {
                      if (!(f4 = X2(k3[k3[k3[k3[k3[i4 + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2], k3[n5 + 12 >> 2]))) break r;
                      if (!$2(k3[i4 >> 2])) break r;
                      if (k3[i4 >> 2] = f4, b4[i4 + 15 | 0] = 0, k3[f4 + 24 >> 2] = i4, !(i4 = k3[k3[k3[i4 + 4 >> 2] + 4 >> 2] >> 2])) break r;
                    }
                  ...
                  if (f4 = k3[a5 + 16 >> 2], !((c3 = w2[f4 + 28 >> 2]) > t4) & (!(w2[u3 + 32 >> 2] <= w2[f4 + 32 >> 2]) | t4 != c3) || (a5 = k3[k3[o5 + 4 >> 2] + 12 >> 2]), !(e5 = X2(k3[k3[e5 + 8 >> 2] + 4 >> 2], a5))) break r;
          ...
          function G2(r5) {
            ...
            r: if (P3 = y3 == m2(0) & p3 == m2(0) & g3 == m2(0)) {
              ...
              if (f4 = 2, i4 = (b5 = n5 > c3) << 2, A3 = b5, t4 = e5 + 56 | 0, A3 = m2(w2[(b5 = e5 + 68 | 0) + i4 >> 2] - w2[t4 + i4 >> 2]) < o5 ? 2 : A3, w2[(i4 = A3 << 2) + t4 >> 2] >= w2[i4 + b5 >> 2]) k3[e5 + 8 >> 2] = 0, k3[e5 + 12 >> 2] = 0;
              else {
            ...
            if (b5 = e5 + 8 | 0, i4 = (p3 < m2(0) ? m2(-p3) : p3) > (y3 < m2(0) ? m2(-y3) : y3), n5 = w2[b5 + (i4 << 2) >> 2], f4 = r5 + 28 | 0, e5 = (g3 < m2(0) ? m2(-g3) : g3) > (n5 < m2(0) ? m2(-n5) : n5) ? 2 : i4, k3[f4 + (i4 = e5 << 2) >> 2] = 0, k3[(t4 = (3 != (0 | (t4 = e5 + 1 | 0)) ? t4 : 0) << 2) + f4 >> 2] = 1065353216, k3[(e5 = (e5 + 2 >>> 0) % 3 << 2) + f4 >> 2] = 0, k3[(f4 = r5 + 40 | 0) + i4 >> 2] = 0, i4 = w2[i4 + b5 >> 2] > m2(0), w2[f4 + t4 >> 2] = m2(i4 ? -0 : 0), w2[e5 + f4 >> 2] = m2(i4 ? 1 : -1), !(i4 = (0 | l3) == (0 | u3))) for (f4 = u3; e5 = k3[f4 + 20 >> 2], k3[f4 + 28 >> 2] = k3[f4 + 16 >> 2], k3[f4 + 32 >> 2] = e5, (0 | l3) != (0 | (f4 = k3[f4 >> 2])); ) ;
            if (P3 && (0 | (e5 = k3[l3 + 40 >> 2])) != (0 | (b5 = l3 + 40 | 0))) {
              for (n5 = m2(0); ; ) {
                ...
                if ((0 | b5) == (0 | (e5 = k3[e5 >> 2]))) break;
              }
              if (n5 < m2(0)) {
                if (!i4) for (; w2[u3 + 32 >> 2] = -w2[u3 + 32 >> 2], (0 | (u3 = k3[u3 >> 2])) != (0 | l3); ) ;
              ...
              if (!f4) {
                for (; ; ) {
                  if (!(v3[c3 + 20 | 0] | !v3[c3 + 21 | 0])) {
                    if (t4 = k3[c3 + 8 >> 2], v3[r5 + 80 | 0]) e5 = 1, f4 = 1;
                    else {
                      ...
                      r: if (v3[i4 + 21 | 0]) for (; ; ) {
                        ...
                        if (b4[e5 + 20 | 0] = 1, k3[e5 + 16 >> 2] = a5, n5 = n5 + 1 | 0, a5 = e5, f4 = k3[f4 + 8 >> 2], i4 = k3[f4 + 20 >> 2], !v3[i4 + 21 | 0]) break;
                      }
                      i4 = k3[t4 + 4 >> 2], a5 = k3[i4 + 20 >> 2];
                      r: {
                        e: if (!v3[a5 + 21 | 0] | v3[a5 + 20 | 0]) {
                          if (h3 = t4, !e5) break r;
                        } else for (f4 = e5; ; ) {
                          if (b4[(e5 = a5) + 20 | 0] = 1, k3[e5 + 16 >> 2] = f4, n5 = n5 + 1 | 0, h3 = k3[i4 + 12 >> 2], i4 = k3[h3 + 4 >> 2], a5 = k3[i4 + 20 >> 2], !v3[a5 + 21 | 0]) break e;
                          if (f4 = e5, v3[a5 + 20 | 0]) break;
                        }
                      ...
                      r: if (v3[f4 + 21 | 0]) for (; ; ) {
                        ...
                        if (b4[e5 + 20 | 0] = 1, k3[e5 + 16 >> 2] = i4, a5 = a5 + 1 | 0, i4 = e5, u3 = k3[u3 + 8 >> 2], f4 = k3[u3 + 20 >> 2], !v3[f4 + 21 | 0]) break;
                      }
                      ...
                      r: {
                        e: if (!v3[n5 + 21 | 0] | v3[n5 + 20 | 0]) {
                          ...
                          if (b4[(e5 = n5) + 20 | 0] = 1, k3[e5 + 16 >> 2] = f4, a5 = a5 + 1 | 0, s3 = k3[i4 + 12 >> 2], i4 = k3[s3 + 4 >> 2], n5 = k3[i4 + 20 >> 2], !v3[n5 + 21 | 0]) break e;
                      ...
                      r: if (v3[f4 + 21 | 0]) for (; ; ) {
                        ...
                        if (b4[e5 + 20 | 0] = 1, k3[e5 + 16 >> 2] = i4, n5 = n5 + 1 | 0, i4 = e5, u3 = k3[u3 + 8 >> 2], f4 = k3[u3 + 20 >> 2], !v3[f4 + 21 | 0]) break;
                      }
                      ...
                      r: {
                        e: if (!v3[a5 + 21 | 0] | v3[a5 + 20 | 0]) {
                          ...
                          if (b4[(e5 = a5) + 20 | 0] = 1, k3[e5 + 16 >> 2] = f4, n5 = n5 + 1 | 0, l3 = k3[i4 + 12 >> 2], i4 = k3[l3 + 4 >> 2], a5 = k3[i4 + 20 >> 2], !v3[a5 + 21 | 0]) break e;
                          if (f4 = e5, v3[a5 + 20 | 0]) break;
                        }
                        for (; b4[e5 + 20 | 0] = 0, e5 = k3[e5 + 16 >> 2]; ) ;
                      }
          ...
          function Y2(r5) {
            ...
            r: if (r5 |= 0) {
              ...
              e: if (!(1 & e5)) {
                if (!(2 & e5)) break r;
                if ((i4 = i4 - (e5 = k3[i4 >> 2]) | 0) >>> 0 < h2[858]) break r;
                r5 = r5 + e5 | 0;
                f: {
                  i: {
                    if (k3[859] != (0 | i4)) {
                ...
                if (b5) {
                  ...
                  f: {
                    if (k3[(a5 = 3720 + (f4 << 2) | 0) >> 2] == (0 | i4)) {
                      if (k3[a5 >> 2] = e5, e5) break f;
                      o5 = 3420, u3 = k3[855] & Vr(f4), k3[o5 >> 2] = u3;
                      break e;
                    }
                    if (k3[b5 + (k3[b5 + 16 >> 2] == (0 | i4) ? 16 : 20) >> 2] = e5, !e5) break e;
                  }
                  ...
                  f: {
                    i: {
                      a: {
                        if (!(2 & e5)) {
                          if (k3[860] == (0 | n5)) {
                            if (k3[860] = i4, r5 = k3[857] + r5 | 0, k3[857] = r5, k3[i4 + 4 >> 2] = 1 | r5, k3[859] != (0 | i4)) break r;
                            return k3[856] = 0, void (k3[859] = 0);
                          }
                          if (k3[859] == (0 | n5)) return k3[859] = i4, r5 = k3[856] + r5 | 0, k3[856] = r5, k3[i4 + 4 >> 2] = 1 | r5, void (k3[r5 + i4 >> 2] = r5);
                    ...
                    if (b5) {
                      ...
                      i: {
                        if (k3[(a5 = 3720 + (f4 << 2) | 0) >> 2] == (0 | n5)) {
                          if (k3[a5 >> 2] = e5, e5) break i;
                          o5 = 3420, u3 = k3[855] & Vr(f4), k3[o5 >> 2] = u3;
                          break f;
                        }
                        if (k3[b5 + (k3[b5 + 16 >> 2] == (0 | n5) ? 16 : 20) >> 2] = e5, !e5) break f;
                      }
                      k3[e5 + 24 >> 2] = b5, (f4 = k3[n5 + 16 >> 2]) && (k3[e5 + 16 >> 2] = f4, k3[f4 + 24 >> 2] = e5), (f4 = k3[n5 + 20 >> 2]) && (k3[e5 + 20 >> 2] = f4, k3[f4 + 24 >> 2] = e5);
                    }
                  }
                  if (k3[i4 + 4 >> 2] = 1 | r5, k3[r5 + i4 >> 2] = r5, k3[859] == (0 | i4)) return void (k3[856] = r5);
                }
                if (r5 >>> 0 <= 255) return e5 = 3456 + (-8 & r5) | 0, (f4 = k3[854]) & (r5 = 1 << (r5 >>> 3)) ? r5 = k3[e5 + 8 >> 2] : (k3[854] = r5 | f4, r5 = e5), k3[e5 + 8 >> 2] = i4, k3[r5 + 12 >> 2] = i4, k3[i4 + 12 >> 2] = e5, void (k3[i4 + 8 >> 2] = r5);
                  ...
                  f: {
                    if ((a5 = k3[855]) & (t4 = 1 << f4)) {
                      for (f4 = r5 << (31 != (0 | f4) ? 25 - (f4 >>> 1 | 0) : 0), e5 = k3[e5 >> 2]; ; ) {
                        if (a5 = e5, (-8 & k3[e5 + 4 >> 2]) == (0 | r5)) break f;
                        if (t4 = f4 >>> 29 | 0, f4 <<= 1, !(e5 = k3[16 + (t4 = e5 + (4 & t4) | 0) >> 2])) break;
                      }
                      k3[t4 + 16 >> 2] = i4, k3[i4 + 24 >> 2] = a5;
                    } else k3[855] = a5 | t4, k3[e5 >> 2] = i4, k3[i4 + 24 >> 2] = e5;
                  ...
                  i: {
                    a: {
                      if ((0 | (r5 = r5 - f4 | 0)) != k3[859]) {
                        if (f4 >>> 0 <= 255) {
                          if ((0 | (i4 = k3[r5 + 8 >> 2])) != (0 | (a5 = k3[r5 + 12 >> 2]))) break a;
                ...
                if (b5) {
                  ...
                  f: {
                    if (k3[(a5 = 3720 + (i4 << 2) | 0) >> 2] == (0 | r5)) {
                      if (k3[a5 >> 2] = f4, f4) break f;
                      o5 = 3420, u3 = k3[855] & Vr(i4), k3[o5 >> 2] = u3;
                      break e;
                    }
                    if (k3[b5 + (k3[b5 + 16 >> 2] == (0 | r5) ? 16 : 20) >> 2] = f4, !f4) break e;
                  }
                ...
                f: {
                  i: {
                    a: {
                      if (!(2 & (f4 = k3[n5 + 4 >> 2]))) {
                        if (k3[860] == (0 | n5)) {
                          if (k3[860] = r5, e5 = k3[857] + e5 | 0, k3[857] = e5, k3[r5 + 4 >> 2] = 1 | e5, k3[859] != (0 | r5)) break r;
                          return k3[856] = 0, void (k3[859] = 0);
                        }
                        if (k3[859] == (0 | n5)) return k3[859] = r5, e5 = k3[856] + e5 | 0, k3[856] = e5, k3[r5 + 4 >> 2] = 1 | e5, void (k3[r5 + e5 >> 2] = e5);
                  ...
                  if (b5) {
                    ...
                    i: {
                      if (k3[(a5 = 3720 + (i4 << 2) | 0) >> 2] == (0 | n5)) {
                        if (k3[a5 >> 2] = f4, f4) break i;
                        o5 = 3420, u3 = k3[855] & Vr(i4), k3[o5 >> 2] = u3;
                        break f;
                      }
                      if (k3[b5 + (k3[b5 + 16 >> 2] == (0 | n5) ? 16 : 20) >> 2] = f4, !f4) break f;
                    }
                    k3[f4 + 24 >> 2] = b5, (i4 = k3[n5 + 16 >> 2]) && (k3[f4 + 16 >> 2] = i4, k3[i4 + 24 >> 2] = f4), (i4 = k3[n5 + 20 >> 2]) && (k3[f4 + 20 >> 2] = i4, k3[i4 + 24 >> 2] = f4);
                  }
                }
                if (k3[r5 + 4 >> 2] = 1 | e5, k3[r5 + e5 >> 2] = e5, k3[859] == (0 | r5)) return void (k3[856] = e5);
              }
              if (e5 >>> 0 <= 255) return f4 = 3456 + (-8 & e5) | 0, (i4 = k3[854]) & (e5 = 1 << (e5 >>> 3)) ? e5 = k3[f4 + 8 >> 2] : (k3[854] = e5 | i4, e5 = f4), k3[f4 + 8 >> 2] = r5, k3[e5 + 12 >> 2] = r5, k3[r5 + 12 >> 2] = f4, void (k3[r5 + 8 >> 2] = e5);
              ...
              e: {
                if ((a5 = k3[855]) & (t4 = 1 << i4)) {
                  for (i4 = e5 << (31 != (0 | i4) ? 25 - (i4 >>> 1 | 0) : 0), f4 = k3[f4 >> 2]; ; ) {
                    if (a5 = f4, (-8 & k3[f4 + 4 >> 2]) == (0 | e5)) break e;
                    if (t4 = i4 >>> 29 | 0, i4 <<= 1, !(f4 = k3[16 + (t4 = f4 + (4 & t4) | 0) >> 2])) break;
                  }
                  k3[t4 + 16 >> 2] = r5, k3[r5 + 24 >> 2] = a5;
                } else k3[855] = a5 | t4, k3[f4 >> 2] = r5, k3[r5 + 24 >> 2] = f4;
          ...
          function J2(r5) {
            ...
            r: {
              e: if (!((0 | (d3 = k3[r5 + 112 >> 2])) < 3)) {
                if (p3 = 116 + ((M3 = d3 << 4) + r5 | 0) | 0, g3 = w2[r5 + 124 >> 2], E3 = w2[r5 + 120 >> 2], t4 = w2[r5 + 24 >> 2], C3 = w2[r5 + 116 >> 2], u3 = w2[r5 + 16 >> 2], b5 = w2[r5 + 20 >> 2], !(u3 != m2(0) | b5 != m2(0)) & t4 == m2(0)) for (f4 = r5 + 148 | 0, t4 = m2(0), b5 = m2(0), u3 = m2(0), i4 = A3 = m2(w2[(e5 = r5 + 132 | 0) >> 2] - C3), a5 = l3 = m2(w2[r5 + 136 >> 2] - E3), h3 = n5 = m2(w2[r5 + 140 >> 2] - g3); R3 = m2(w2[e5 + 20 >> 2] - E3), I3 = m2(w2[f4 >> 2] - C3), S3 = m2(m2(i4 * R3) - m2(I3 * a5)), y3 = m2(w2[e5 + 24 >> 2] - g3), a5 = m2(m2(a5 * y3) - m2(R3 * h3)), i4 = m2(m2(h3 * I3) - m2(y3 * i4)), m2(m2(S3 * t4) + m2(m2(a5 * u3) + m2(b5 * i4))) >= m2(0) ? (t4 = m2(t4 + S3), b5 = m2(b5 + i4), a5 = m2(u3 + a5)) : (t4 = m2(t4 - S3), b5 = m2(b5 - i4), a5 = m2(u3 - a5)), u3 = a5, i4 = I3, a5 = R3, h3 = y3, p3 >>> 0 > (f4 = (e5 = f4) + 16 | 0) >>> 0; ) ;
                else A3 = m2(w2[r5 + 132 >> 2] - C3), l3 = m2(w2[r5 + 136 >> 2] - E3), n5 = m2(w2[r5 + 140 >> 2] - g3);
                for (f4 = r5 + 148 | 0, e5 = c3 = r5 + 132 | 0; ; ) {
                  ...
                  f: if ((i4 = m2(y3 + m2(m2(m2(m2(h3 * n5) - m2(l3 * i4)) * u3) + m2(b5 * m2(m2(i4 * A3) - m2(n5 * a5)))))) != m2(0)) {
                    if (i4 > m2(0)) {
                ...
                if (s3) {
                  ...
                  } else if (!(c3 >>> 0 >= p3 >>> 0)) for (; 5 == (0 | (e5 = k3[r5 + 1724 >> 2])) ? ke[k3[r5 + 96 >> 2]](k3[c3 + 12 >> 2]) : ke[0 | e5](k3[c3 + 12 >> 2], k3[r5 + 1896 >> 2]), p3 >>> 0 > (c3 = c3 + 16 | 0) >>> 0; ) ;
            ...
            r: {
              ...
              e: {
                if (!(!(u3 < (t4 = w2[n5 + 28 >> 2])) & (!(w2[a5 + 32 >> 2] <= w2[n5 + 32 >> 2]) | u3 != t4))) {
                  if (dr2(k3[k3[v4 + 4 >> 2] + 16 >> 2], a5, n5) > m2(0)) break e;
                  ...
                  if (o5 = k3[r5 + 68 >> 2], (0 | (n5 = k3[a5 + 36 >> 2])) >= 0) {
                    if (d3 = k3[o5 >> 2], c3 = k3[d3 >> 2], s3 = k3[d3 + 4 >> 2], e5 = k3[4 + (g3 = s3 + (n5 << 3) | 0) >> 2], y3 = k3[d3 + 8 >> 2], p3 = k3[c3 + (y3 << 2) >> 2], k3[c3 + (e5 << 2) >> 2] = p3, C3 = i4 = (p3 << 3) + s3 | 0, k3[i4 + 4 >> 2] = e5, E3 = y3 - 1 | 0, k3[d3 + 8 >> 2] = E3, (0 | e5) < (0 | y3)) {
                      f: {
                        if ((0 | e5) < 2 || (f4 = k3[(k3[c3 + (e5 << 1 & -4) >> 2] << 3) + s3 >> 2], t4 = w2[f4 + 28 >> 2], h3 = k3[i4 >> 2], t4 < (u3 = w2[h3 + 28 >> 2]) || !(!(w2[f4 + 32 >> 2] <= w2[h3 + 32 >> 2]) | u3 != t4))) for (R3 = (p3 << 3) + s3 | 0; ; ) {
                        ...
                        for (; ; ) {
                          ...
                          if (k3[c3 + (e5 << 2) >> 2] = o5, k3[a5 + 4 >> 2] = e5, i4 = e5 >>> 0 > 3, e5 = f4, !i4) break;
                        }
                      }
                    ...
                    f: if (!((0 | (e5 = k3[o5 + 12 >> 2])) <= 0)) for (n5 = k3[o5 + 8 >> 2] - 4 | 0; ; ) {
                      ...
                      if (f4 = e5 - 1 | 0, k3[o5 + 12 >> 2] = f4, i4 = (0 | e5) > 1, e5 = f4, !i4) break;
                    }
                  }
                  return yr2(r5, k3[k3[v4 + 4 >> 2] + 12 >> 2], A3), 1;
                }
                if (!(dr2(k3[k3[A3 + 4 >> 2] + 16 >> 2], n5, a5) < m2(0))) {
                  if (i4 = 1, b4[e5 + 14 | 0] = 1, b4[k3[k3[k3[e5 + 4 >> 2] + 4 >> 2] >> 2] + 14 | 0] = 1, !er2(k3[A3 + 4 >> 2])) break r;
          ...
          function V2(r5, e5) {
            ...
            r: if (3 & o5) {
              t4 = i4 + a5 | 0;
              e: if (i4 >>> 0 >= n5 >>> 0) {
                if ((f4 = i4 - n5 | 0) >>> 0 < 16) break e;
                k3[a5 + 4 >> 2] = 1 & o5 | n5 | 2, k3[4 + (i4 = a5 + n5 | 0) >> 2] = 3 | f4, k3[t4 + 4 >> 2] = 1 | k3[t4 + 4 >> 2], Z2(i4, f4);
              } else if (k3[860] != (0 | t4)) {
                if (k3[859] != (0 | t4)) {
                  if (2 & (b5 = k3[t4 + 4 >> 2])) break r;
                  if ((u3 = i4 + (-8 & b5) | 0) >>> 0 < n5 >>> 0) break r;
                  s3 = u3 - n5 | 0;
                  f: if (b5 >>> 0 <= 255) {
                    ...
                    c3 = k3[t4 + 24 >> 2];
                    i: if ((0 | t4) == (0 | (i4 = k3[t4 + 12 >> 2]))) {
                      a: {
                        if (!(b5 = k3[(f4 = t4 + 20 | 0) >> 2])) {
                          if (!(b5 = k3[t4 + 16 >> 2])) break a;
                          f4 = t4 + 16 | 0;
                        }
                      ...
                      i4 = 0;
                    } else f4 = k3[t4 + 8 >> 2], k3[f4 + 12 >> 2] = i4, k3[i4 + 8 >> 2] = f4;
                    if (c3) {
                      f4 = k3[t4 + 28 >> 2];
                      i: {
                        if (k3[(b5 = 3720 + (f4 << 2) | 0) >> 2] == (0 | t4)) {
                          if (k3[b5 >> 2] = i4, i4) break i;
                          l3 = 3420, v4 = k3[855] & Vr(f4), k3[l3 >> 2] = v4;
                          break f;
                        }
                        if (k3[(k3[c3 + 16 >> 2] == (0 | t4) ? 16 : 20) + c3 >> 2] = i4, !i4) break f;
                      }
                  ...
                  if ((i4 = i4 + k3[856] | 0) >>> 0 < n5 >>> 0) break r;
                ...
                if ((i4 = i4 + k3[857] | 0) >>> 0 <= n5 >>> 0) break r;
                k3[a5 + 4 >> 2] = 1 & o5 | n5 | 2, i4 = i4 - n5 | 0, k3[4 + (f4 = a5 + n5 | 0) >> 2] = 1 | i4, k3[857] = i4, k3[860] = f4;
              }
              f4 = a5;
            } else {
              if (n5 >>> 0 < 256) break r;
              if (i4 >>> 0 >= n5 + 4 >>> 0 && (f4 = a5, i4 - n5 >>> 0 <= k3[974] << 1 >>> 0)) break r;
              f4 = 0;
            }
          ...
          function z2(r5, e5) {
            ...
            for (i4 = k3[k3[k3[e5 + 4 >> 2] + 8 >> 2] >> 2]; ; ) {
              r: {
                if (v3[i4 + 14 | 0]) for (; i4 = k3[k3[k3[(e5 = i4) + 4 >> 2] + 8 >> 2] >> 2], v3[i4 + 14 | 0]; ) ;
                e: {
                  f: {
                    i: {
                      a: {
                        ...
                        n: if ((0 | e5) != k3[k3[t4 + 4 >> 2] + 16 >> 2]) {
                          ...
                          t: {
                            if (!(!(u3 < (s3 = w2[o5 + 28 >> 2])) & (!(w2[e5 + 32 >> 2] <= w2[o5 + 32 >> 2]) | u3 != s3))) {
                              ...
                              if (b4[f4 + 14 | 0] = 1, b4[k3[k3[k3[f4 + 4 >> 2] + 4 >> 2] >> 2] + 14 | 0] = 1, !(e5 = er2(a5))) break e;
                            ...
                            if (b4[c3 + 14 | 0] = 1, b4[f4 + 14 | 0] = 1, !(e5 = er2(n5))) break r;
                            if (!ir2(k3[a5 + 12 >> 2], k3[n5 + 4 >> 2])) break r;
                            e5 = k3[e5 + 4 >> 2];
                          }
                          if (b4[k3[e5 + 20 >> 2] + 21 | 0] = v3[f4 + 12 | 0], v3[i4 + 15 | 0]) {
                            if (k3[k3[i4 >> 2] + 24 >> 2] = 0, Nr(k3[i4 + 4 >> 2]), Y2(i4), !$2(t4)) break r;
                            i4 = k3[k3[k3[f4 + 4 >> 2] + 8 >> 2] >> 2], t4 = k3[i4 >> 2], e5 = f4;
                          } else if (v3[f4 + 15 | 0]) {
                            if (k3[k3[f4 >> 2] + 24 >> 2] = 0, Nr(k3[f4 + 4 >> 2]), Y2(f4), !$2(a5)) break r;
                            e5 = k3[k3[k3[i4 + 4 >> 2] + 4 >> 2] >> 2], a5 = k3[e5 >> 2];
                          } else e5 = f4;
                        } else e5 = f4;
                        if (k3[a5 + 16 >> 2] == k3[t4 + 16 >> 2]) break f;
                        if (f4 = k3[k3[a5 + 4 >> 2] + 16 >> 2], n5 = k3[k3[t4 + 4 >> 2] + 16 >> 2], v3[i4 + 15 | 0] | v3[e5 + 15 | 0] | (0 | f4) == (0 | n5)) break i;
                        if ((0 | (o5 = f4)) != (0 | (f4 = k3[r5 + 72 >> 2])) & (0 | f4) != (0 | n5)) break i;
                        if (!H2(r5, e5)) break f;
                      }
                      return;
                    }
                  ...
                  if (k3[a5 + 16 >> 2] != k3[t4 + 16 >> 2]) continue;
                  if (n5 = k3[a5 + 4 >> 2], f4 = k3[t4 + 4 >> 2], k3[n5 + 16 >> 2] != k3[f4 + 16 >> 2]) continue;
                  if (k3[t4 + 28 >> 2] = k3[t4 + 28 >> 2] + k3[a5 + 28 >> 2], k3[f4 + 28 >> 2] = k3[f4 + 28 >> 2] + k3[n5 + 28 >> 2], k3[k3[e5 >> 2] + 24 >> 2] = 0, Nr(k3[e5 + 4 >> 2]), Y2(e5), !$2(a5)) break r;
          ...
          function K2(r5) {
            ...
            if ((0 | (e5 = k3[r5 + 40 >> 2])) != (0 | (o5 = r5 + 40 | 0))) for (; ; ) {
              if (r5 = k3[e5 >> 2], v3[e5 + 21 | 0]) {
                for (e5 = e5 + 8 | 0; e5 = k3[e5 >> 2], i4 = k3[k3[e5 + 4 >> 2] + 16 >> 2], a5 = w2[i4 + 28 >> 2], f4 = k3[e5 + 16 >> 2], !(!(a5 < (n5 = w2[f4 + 28 >> 2])) & (!(w2[i4 + 32 >> 2] <= w2[f4 + 32 >> 2]) | a5 != n5)); ) e5 = k3[e5 + 8 >> 2] + 4 | 0;
                for (; !(!(a5 > n5) & (!(w2[f4 + 32 >> 2] <= w2[i4 + 32 >> 2]) | a5 != n5)); ) e5 = k3[e5 + 12 >> 2], f4 = k3[e5 + 16 >> 2], n5 = w2[f4 + 28 >> 2], i4 = k3[k3[e5 + 4 >> 2] + 16 >> 2], a5 = w2[i4 + 28 >> 2];
                r: {
                  if ((0 | (i4 = k3[k3[e5 + 8 >> 2] + 4 >> 2])) != k3[e5 + 12 >> 2]) for (; ; ) {
                    if (f4 = k3[k3[e5 + 4 >> 2] + 16 >> 2], a5 = w2[f4 + 28 >> 2], t4 = k3[i4 + 16 >> 2], !(a5 < (n5 = w2[t4 + 28 >> 2])) & (!(w2[f4 + 32 >> 2] <= w2[t4 + 32 >> 2]) | a5 != n5)) {
                      e: if (k3[i4 + 12 >> 2] != (0 | e5)) for (; ; ) {
                        ...
                        if ((0 | (e5 = k3[e5 + 4 >> 2])) == k3[i4 + 12 >> 2]) break;
                      }
                      e5 = k3[e5 + 12 >> 2];
                    } else {
                      e: if ((0 | (f4 = k3[i4 + 12 >> 2])) != (0 | e5)) for (t4 = i4 + 12 | 0; ; ) {
                        if (b5 = k3[k3[f4 + 4 >> 2] + 16 >> 2], a5 = w2[b5 + 28 >> 2], u3 = k3[f4 + 16 >> 2], !(a5 < (n5 = w2[u3 + 28 >> 2]) | a5 == n5 & w2[b5 + 32 >> 2] <= w2[u3 + 32 >> 2])) {
                          if (!(dr2(k3[i4 + 16 >> 2], k3[k3[i4 + 4 >> 2] + 16 >> 2], b5) <= m2(0))) break e;
                          f4 = k3[t4 >> 2];
                        }
                        if (i4 = X2(f4, i4), f4 = 0, !i4) break r;
                        if (t4 = (i4 = k3[i4 + 4 >> 2]) + 12 | 0, (0 | (f4 = k3[i4 + 12 >> 2])) == (0 | e5)) break;
                      }
                      i4 = k3[k3[i4 + 8 >> 2] + 4 >> 2];
                    }
                    if (k3[e5 + 12 >> 2] == (0 | i4)) break;
                  }
                  if (f4 = k3[i4 + 12 >> 2], k3[f4 + 12 >> 2] != (0 | e5)) for (; ; ) {
                    if (i4 = X2(f4, i4), f4 = 0, !i4) break r;
                    if (i4 = k3[i4 + 4 >> 2], f4 = k3[i4 + 12 >> 2], k3[f4 + 12 >> 2] == (0 | e5)) break;
                  }
                  f4 = 1;
                }
                if (!f4) return 0;
              }
              if ((0 | o5) == (0 | (e5 = r5))) break;
            }
            return 1;
          }
          function q2(r5, e5, f4, i4, a5, n5) {
            ...
            r: {
              for (; ; ) {
                ...
                if (k3[t4 >> 2] = o5, u3 = Wr(k3[r5 + 64 >> 2], k3[e5 + 4 >> 2], t4), k3[t4 + 4 >> 2] = u3, !u3) break r;
                if (b4[t4 + 13 | 0] = 0, b4[t4 + 14 | 0] = 0, b4[t4 + 15 | 0] = 0, k3[o5 + 24 >> 2] = t4, (0 | i4) == (0 | (f4 = k3[f4 + 8 >> 2]))) break;
              }
              if (f4 = k3[k3[k3[e5 + 4 >> 2] + 8 >> 2] >> 2], o5 = k3[k3[f4 >> 2] + 4 >> 2], a5 = a5 || k3[o5 + 8 >> 2], k3[o5 + 16 >> 2] == k3[a5 + 16 >> 2]) {
                if (k3[o5 + 8 >> 2] != (0 | a5)) {
                  if (!ir2(k3[k3[o5 + 4 >> 2] + 12 >> 2], o5)) break r;
                  if (!ir2(k3[k3[a5 + 4 >> 2] + 12 >> 2], o5)) break r;
                }
                i4 = (a5 = k3[e5 + 8 >> 2]) - (u3 = k3[o5 + 28 >> 2]) | 0, k3[f4 + 8 >> 2] = i4;
                e: {
                  f: switch (k3[r5 + 56 >> 2] - 100130 | 0) {
                    case 4:
                ...
                if (b4[f4 + 12 | 0] = t4, b4[e5 + 14 | 0] = 1, u3 = k3[k3[k3[f4 + 4 >> 2] + 8 >> 2] >> 2], i4 = k3[k3[u3 >> 2] + 4 >> 2], k3[i4 + 16 >> 2] == k3[o5 + 16 >> 2]) for (a5 = f4 + 4 | 0; ; ) {
                  ...
                  if (b4[e5 + 12 | 0] = u3, b4[f4 + 14 | 0] = 1, N2(r5, f4) && (k3[t4 + 28 >> 2] = k3[t4 + 28 >> 2] + k3[o5 + 28 >> 2], i4 = k3[t4 + 4 >> 2], k3[i4 + 28 >> 2] = k3[i4 + 28 >> 2] + k3[k3[o5 + 4 >> 2] + 28 >> 2], k3[k3[f4 >> 2] + 24 >> 2] = 0, Nr(k3[a5 >> 2]), Y2(f4), !$2(o5))) break r;
                  if (a5 = e5 + 4 | 0, u3 = k3[k3[k3[(f4 = e5) + 4 >> 2] + 8 >> 2] >> 2], i4 = k3[k3[u3 >> 2] + 4 >> 2], o5 = t4, k3[i4 + 16 >> 2] != k3[t4 + 16 >> 2]) break;
                }
                else e5 = f4;
              }
          ...
          function $2(r5) {
            ...
            if ((0 | (e5 = k3[a5 + 8 >> 2])) != (0 | a5)) f4 = k3[k3[a5 + 4 >> 2] + 12 >> 2], k3[k3[r5 + 20 >> 2] + 8 >> 2] = f4, k3[k3[a5 + 16 >> 2] + 8 >> 2] = e5, i4 = k3[f4 + 8 >> 2], k3[k3[e5 + 4 >> 2] + 12 >> 2] = f4, k3[k3[i4 + 4 >> 2] + 12 >> 2] = a5, k3[a5 + 8 >> 2] = i4, k3[f4 + 8 >> 2] = e5;
            else {
          ...
          function rr2(r5, e5, f4) {
            var i4 = 0, a5 = 0;
            if (f4 >>> 0 >= 512) _2(0 | r5, 0 | e5, 0 | f4);
            else {
              i4 = r5 + f4 | 0;
              r: if (3 & (r5 ^ e5)) {
                if (i4 >>> 0 < 4) f4 = r5;
                else if ((a5 = i4 - 4 | 0) >>> 0 < r5 >>> 0) f4 = r5;
                else for (f4 = r5; b4[0 | f4] = v3[0 | e5], b4[f4 + 1 | 0] = v3[e5 + 1 | 0], b4[f4 + 2 | 0] = v3[e5 + 2 | 0], b4[f4 + 3 | 0] = v3[e5 + 3 | 0], e5 = e5 + 4 | 0, a5 >>> 0 >= (f4 = f4 + 4 | 0) >>> 0; ) ;
              } else {
                e: if (3 & r5) {
                  if (f4) for (f4 = r5; ; ) {
                    if (b4[0 | f4] = v3[0 | e5], e5 = e5 + 1 | 0, !(3 & (f4 = f4 + 1 | 0))) break e;
                    if (!(f4 >>> 0 < i4 >>> 0)) break;
                  }
                  else f4 = r5;
                } else f4 = r5;
                if (!((r5 = -4 & i4) >>> 0 < 64 || (a5 = r5 + -64 | 0) >>> 0 < f4 >>> 0)) for (; k3[f4 >> 2] = k3[e5 >> 2], k3[f4 + 4 >> 2] = k3[e5 + 4 >> 2], k3[f4 + 8 >> 2] = k3[e5 + 8 >> 2], k3[f4 + 12 >> 2] = k3[e5 + 12 >> 2], k3[f4 + 16 >> 2] = k3[e5 + 16 >> 2], k3[f4 + 20 >> 2] = k3[e5 + 20 >> 2], k3[f4 + 24 >> 2] = k3[e5 + 24 >> 2], k3[f4 + 28 >> 2] = k3[e5 + 28 >> 2], k3[f4 + 32 >> 2] = k3[e5 + 32 >> 2], k3[f4 + 36 >> 2] = k3[e5 + 36 >> 2], k3[f4 + 40 >> 2] = k3[e5 + 40 >> 2], k3[f4 + 44 >> 2] = k3[e5 + 44 >> 2], k3[f4 + 48 >> 2] = k3[e5 + 48 >> 2], k3[f4 + 52 >> 2] = k3[e5 + 52 >> 2], k3[f4 + 56 >> 2] = k3[e5 + 56 >> 2], k3[f4 + 60 >> 2] = k3[e5 + 60 >> 2], e5 = e5 - -64 | 0, a5 >>> 0 >= (f4 = f4 - -64 | 0) >>> 0; ) ;
                if (r5 >>> 0 <= f4 >>> 0) break r;
                for (; k3[f4 >> 2] = k3[e5 >> 2], e5 = e5 + 4 | 0, r5 >>> 0 > (f4 = f4 + 4 | 0) >>> 0; ) ;
              }
              if (f4 >>> 0 < i4 >>> 0) for (; b4[0 | f4] = v3[0 | e5], e5 = e5 + 1 | 0, (0 | i4) != (0 | (f4 = f4 + 1 | 0)); ) ;
            }
          }
          function er2(r5) {
            var e5 = 0, f4 = 0, i4 = 0, a5 = 0, n5 = 0, t4 = 0;
          ...
          function fr2(r5) {
            var e5 = 0, f4 = 0, i4 = 0, a5 = 0, n5 = 0, t4 = 0, b5 = 0, o5 = 0, u3 = 0;
            if ((0 | (a5 = k3[40 + (r5 |= 0) >> 2])) != (0 | (b5 = r5 + 40 | 0))) for (; ; ) {
              if (u3 = k3[a5 >> 2], !v3[a5 + 21 | 0]) {
                for (o5 = k3[a5 + 8 >> 2], r5 = k3[o5 + 12 >> 2]; ; ) {
                  if (k3[r5 + 20 >> 2] = 0, t4 = k3[r5 + 12 >> 2], e5 = k3[r5 + 4 >> 2], !k3[e5 + 20 >> 2]) {
                    if (i4 = k3[r5 + 16 >> 2], (0 | (f4 = k3[r5 + 8 >> 2])) != (0 | r5)) k3[i4 + 8 >> 2] = f4, i4 = k3[e5 + 12 >> 2], n5 = k3[i4 + 8 >> 2], k3[k3[f4 + 4 >> 2] + 12 >> 2] = i4, k3[k3[n5 + 4 >> 2] + 12 >> 2] = r5, k3[r5 + 8 >> 2] = n5, k3[i4 + 8 >> 2] = f4;
                    else {
                      for (e5 = f4 = k3[i4 + 8 >> 2]; k3[e5 + 16 >> 2] = 0, (0 | f4) != (0 | (e5 = k3[e5 + 8 >> 2])); ) ;
                      e5 = k3[i4 >> 2], f4 = k3[i4 + 4 >> 2], k3[e5 + 4 >> 2] = f4, k3[f4 >> 2] = e5, Y2(i4), e5 = k3[r5 + 4 >> 2];
                    }
                    if (i4 = k3[e5 + 16 >> 2], (0 | (f4 = k3[e5 + 8 >> 2])) != (0 | e5)) k3[i4 + 8 >> 2] = f4, i4 = k3[k3[e5 + 4 >> 2] + 12 >> 2], n5 = k3[i4 + 8 >> 2], k3[k3[f4 + 4 >> 2] + 12 >> 2] = i4, k3[k3[n5 + 4 >> 2] + 12 >> 2] = e5, k3[e5 + 8 >> 2] = n5, k3[i4 + 8 >> 2] = f4;
                    else {
                      for (e5 = f4 = k3[i4 + 8 >> 2]; k3[e5 + 16 >> 2] = 0, (0 | f4) != (0 | (e5 = k3[e5 + 8 >> 2])); ) ;
                      e5 = k3[i4 >> 2], f4 = k3[i4 + 4 >> 2], k3[e5 + 4 >> 2] = f4, k3[f4 >> 2] = e5, Y2(i4), e5 = k3[r5 + 4 >> 2];
                    }
          ...
          function ar2(r5, e5) {
              ...
              r: {
                ...
                if (n5 = k3[f4 + 4 >> 2], a5 = r5, (e5 = k3[f4 + 16 >> 2]) && (k3[f4 + 16 >> 2] = k3[4 + (n5 + (e5 << 3) | 0) >> 2], a5 = e5), t4 = k3[f4 >> 2], k3[t4 + (r5 << 2) >> 2] = a5, k3[(b5 = n5 + (a5 << 3) | 0) >> 2] = i4, k3[b5 + 4 >> 2] = r5, k3[f4 + 20 >> 2]) {
                  e: if (r5 >>> 0 < 2) e5 = r5;
                    ...
                    if (k3[(r5 << 2) + t4 >> 2] = f4, k3[u3 + 4 >> 2] = r5, !((r5 = e5) >>> 0 > 1)) break;
                  }
            ...
            if (i4 = (f4 = k3[r5 + 12 >> 2]) + 1 | 0, k3[r5 + 12 >> 2] = i4, a5 = k3[r5 + 4 >> 2], (0 | (n5 = i4)) < (0 | (i4 = k3[r5 + 16 >> 2]))) i4 = a5;
            else if (k3[r5 + 16 >> 2] = i4 << 1, i4 = V2(a5, i4 << 3), k3[r5 + 4 >> 2] = i4, !i4) return k3[r5 + 4 >> 2] = a5, 2147483647;
          ...
          function nr2(r5) {
            ...
            r: {
              if (!(i4 = T2(24)) || !n5 | !t4) {
                if (n5 && Y2(n5), t4 && Y2(t4), !i4) break r;
                return Y2(i4), 0;
              }
          ...
          function tr2(r5) {
            ...
            if ((e5 = T2(128)) && (k3[e5 + 8 >> 2] = 0, k3[e5 + 12 >> 2] = 0, f4 = e5 + 40 | 0, k3[e5 + 44 >> 2] = f4, k3[e5 + 48 >> 2] = 0, k3[e5 + 52 >> 2] = 0, k3[e5 + 40 >> 2] = f4, o4[e5 + 54 >> 1] = 0, o4[e5 + 56 >> 1] = 0, o4[e5 + 58 >> 1] = 0, o4[e5 + 60 >> 1] = 0, k3[e5 + 72 >> 2] = 0, k3[e5 + 76 >> 2] = 0, f4 = e5 + 96 | 0, k3[e5 + 68 >> 2] = f4, i4 = e5 - -64 | 0, k3[e5 + 64 >> 2] = i4, k3[e5 + 80 >> 2] = 0, k3[e5 + 84 >> 2] = 0, k3[e5 + 88 >> 2] = 0, k3[e5 + 92 >> 2] = 0, k3[e5 + 104 >> 2] = 0, k3[e5 + 108 >> 2] = 0, k3[e5 + 100 >> 2] = i4, k3[e5 + 96 >> 2] = f4, k3[e5 + 112 >> 2] = 0, k3[e5 + 116 >> 2] = 0, k3[e5 + 120 >> 2] = 0, k3[e5 + 124 >> 2] = 0, k3[e5 >> 2] = e5, k3[e5 + 4 >> 2] = e5), k3[r5 + 8 >> 2] = e5, !e5) return 0;
            r: {
              if ((0 | (e5 = k3[r5 + 112 >> 2])) > 0) for (a5 = 116 + ((e5 << 4) + r5 | 0) | 0, f4 = r5 + 116 | 0, e5 = k3[r5 + 4 >> 2]; ; ) {
                n5 = k3[f4 + 12 >> 2];
                e: {
                  if (!e5) {
                    if (i4 = 0, !(e5 = nr2(k3[r5 + 8 >> 2]))) break r;
                ...
                if (i4 = k3[e5 + 16 >> 2], k3[i4 + 12 >> 2] = n5, w2[i4 + 16 >> 2] = w2[f4 >> 2], t4 = w2[f4 + 4 >> 2], k3[i4 + 24 >> 2] = 0, w2[i4 + 20 >> 2] = t4, k3[e5 + 28 >> 2] = 1, k3[k3[e5 + 4 >> 2] + 28 >> 2] = -1, k3[r5 + 4 >> 2] = e5, !(a5 >>> 0 > (f4 = f4 + 16 | 0) >>> 0)) break;
              }
          ...
          function br2(r5, e5, f4) {
            ...
            r: if (v3[f4 + 21 | 0]) for (; ; ) {
              ...
              if (b4[f4 + 20 | 0] = 1, e5 = k3[k3[e5 + 12 >> 2] + 4 >> 2], 5 == (0 | (f4 = k3[r5 + 1724 >> 2])) ? ke[k3[r5 + 96 >> 2]](k3[k3[e5 + 16 >> 2] + 12 >> 2]) : ke[0 | f4](k3[k3[e5 + 16 >> 2] + 12 >> 2], k3[r5 + 1896 >> 2]), f4 = k3[e5 + 20 >> 2], !v3[f4 + 21 | 0] | v3[f4 + 20 | 0]) break r;
              if (b4[f4 + 20 | 0] = 1, e5 = k3[e5 + 8 >> 2], 5 == (0 | (f4 = k3[r5 + 1724 >> 2])) ? ke[k3[r5 + 96 >> 2]](k3[k3[k3[e5 + 4 >> 2] + 16 >> 2] + 12 >> 2]) : ke[0 | f4](k3[k3[k3[e5 + 4 >> 2] + 16 >> 2] + 12 >> 2], k3[r5 + 1896 >> 2]), f4 = k3[e5 + 20 >> 2], !v3[f4 + 21 | 0]) break;
            }
            6 == (0 | (e5 = k3[r5 + 1728 >> 2])) ? ke[k3[r5 + 100 >> 2]]() : ke[0 | e5](k3[r5 + 1896 >> 2]);
          }
          function or2(r5, e5) {
            ...
            if ((0 | (f4 = k3[(r5 |= 0) >> 2])) != (0 | e5)) for (; ; ) {
              r: if (e5 >>> 0 > f4 >>> 0) {
                ...
                if (11 == (0 | (f4 = k3[r5 + 1732 >> 2])) ? ke[k3[r5 + 12 >> 2]](100152) : ke[0 | f4](100152, k3[r5 + 1896 >> 2]), 1 != k3[r5 >> 2] && or2(r5, 1), k3[r5 >> 2] = 2, k3[r5 + 4 >> 2] = 0, f4 = 2, k3[r5 + 112 >> 2] <= 0) break r;
                b4[r5 + 108 | 0] = 1;
              } else {
                e: switch (f4 - 1 | 0) {
                  case 1:
          ...
          function kr2(r5, e5) {
                ...
                f: {
                  for (; ; ) {
                    ...
                    if (b4[f4 + 20 | 0] = 1, k3[f4 + 16 >> 2] = i4, a5 = k3[k3[a5 + 12 >> 2] + 4 >> 2], i4 = k3[a5 + 20 >> 2], v3[i4 + 21 | 0]) {
                      if (v3[i4 + 20 | 0]) break f;
                      if (b4[i4 + 20 | 0] = 1, k3[i4 + 16 >> 2] = f4, n5 = n5 + 2 | 0, a5 = k3[a5 + 8 >> 2], f4 = k3[a5 + 20 >> 2], v3[f4 + 21 | 0]) continue;
                      break r;
                    }
                    break;
                  }
                ...
                f: {
                  for (; ; ) {
                    if (b4[f4 + 20 | 0] = 1, k3[f4 + 16 >> 2] = i4, e5 = k3[t4 + 12 >> 2], t4 = k3[e5 + 4 >> 2], i4 = k3[t4 + 20 >> 2], v3[i4 + 21 | 0]) {
                      if (v3[i4 + 20 | 0]) break f;
                      if (b4[i4 + 20 | 0] = 1, k3[i4 + 16 >> 2] = f4, o5 = o5 + 2 | 0, e5 = k3[k3[t4 + 8 >> 2] + 4 >> 2], t4 = k3[e5 + 4 >> 2], f4 = k3[t4 + 20 >> 2], !v3[f4 + 21 | 0]) break r;
            ...
            if (k3[r5 + 4 >> 2] = e5, i4) for (; b4[i4 + 20 | 0] = 0, i4 = k3[i4 + 16 >> 2]; ) ;
          }
            ...
            r: {
              e: {
                f: {
                  ...
                  if (a5 = 31 & (i4 = 63 & n5), i4 >>> 0 >= 32 ? (i4 = 0, b5 = e5 >>> a5 | 0) : (i4 = e5 >>> a5 | 0, b5 = ((1 << a5) - 1 & e5) << 32 - a5 | r5 >>> a5), a5 = 31 & (t4 &= 63), t4 >>> 0 >= 32 ? (e5 = r5 << a5, r5 = 0) : (e5 = (1 << a5) - 1 & r5 >>> 32 - a5 | e5 << a5, r5 <<= a5), n5) for (c3 = -1 == (0 | (t4 = f4 - 1 | 0)) ? -1 : 0; o5 = i4 << 1 | b5 >>> 31, b5 = (i4 = b5 << 1 | e5 >>> 31) - (k4 = f4 & (a5 = c3 - (o5 + (i4 >>> 0 > t4 >>> 0) | 0) >> 31)) | 0, i4 = o5 - (i4 >>> 0 < k4 >>> 0) | 0, e5 = e5 << 1 | r5 >>> 31, r5 = u3 | r5 << 1, u3 = 1 & a5, n5 = n5 - 1 | 0; ) ;
              ...
              e: {
                ...
                f: {
                  if (i4) i4 = e5;
                    ...
                    if ((0 | (a5 = k3[n5 + 12 >> 2])) == (0 | t4)) break f;
                    if ((0 | a5) < 0) {
                      i4 = e5;
                      break e;
                    }
                    if (b5 = a5 - ((u3 = (b5 = k3[e5 + 4 >> 2]) >>> 0 < a5 >>> 0) ? b5 : 0) | 0, k3[(i4 = (u3 << 3) + e5 | 0) >> 2] = b5 + k3[i4 >> 2], k3[(e5 = (u3 ? 12 : 4) + e5 | 0) >> 2] = k3[e5 >> 2] - b5, t4 = t4 - a5 | 0, e5 = i4, o5 = o5 - u3 | 0, (a5 = 0 | I2(k3[r5 + 60 >> 2], 0 | e5, 0 | o5, n5 + 12 | 0)) ? (k3[806] = a5, a5 = -1) : a5 = 0, a5) break;
                  }
                  if (-1 != (0 | t4)) break e;
                }
          ...
          function sr2(r5) {
            ...
            if (a5 = k3[r5 + 4 >> 2], f4 = k3[r5 >> 2], i4 = k3[f4 + 4 >> 2], v4 = k3[(e5 = a5 + (i4 << 3) | 0) >> 2], !((0 | (n5 = k3[r5 + 8 >> 2])) <= 0) && (c3 = k3[(n5 << 2) + f4 >> 2], k3[f4 + 4 >> 2] = c3, k3[4 + (s3 = (c3 << 3) + a5 | 0) >> 2] = 1, k3[e5 >> 2] = 0, k3[e5 + 4 >> 2] = k3[r5 + 16 >> 2], A3 = n5 - 1 | 0, k3[r5 + 8 >> 2] = A3, k3[r5 + 16 >> 2] = i4, 1 != (0 | n5))) {
              for (e5 = 1; (0 | A3) <= (0 | (r5 = e5 << 1)) || (t4 = k3[(k3[((i4 = 1 | r5) << 2) + f4 >> 2] << 3) + a5 >> 2], b5 = w2[t4 + 28 >> 2], o5 = k3[(k3[(r5 << 2) + f4 >> 2] << 3) + a5 >> 2], !(b5 < (u3 = w2[o5 + 28 >> 2])) & (!(w2[t4 + 32 >> 2] <= w2[o5 + 32 >> 2]) | b5 != u3) || (r5 = i4)), !((0 | r5) >= (0 | n5) || (i4 = k3[s3 >> 2], b5 = w2[i4 + 28 >> 2], t4 = k3[(r5 << 2) + f4 >> 2], l3 = k3[(o5 = (t4 << 3) + a5 | 0) >> 2], b5 < (u3 = w2[l3 + 28 >> 2]) | b5 == u3 & w2[i4 + 32 >> 2] <= w2[l3 + 32 >> 2])); ) k3[(e5 << 2) + f4 >> 2] = t4, k3[o5 + 4 >> 2] = e5, e5 = r5;
          ...
          function vr2(r5, e5, f4) {
            var i4 = 0, a5 = 0;
            if (f4 && (b4[0 | r5] = e5, b4[(i4 = r5 + f4 | 0) - 1 | 0] = e5, !(f4 >>> 0 < 3 || (b4[r5 + 2 | 0] = e5, b4[r5 + 1 | 0] = e5, b4[i4 - 3 | 0] = e5, b4[i4 - 2 | 0] = e5, f4 >>> 0 < 7 || (b4[r5 + 3 | 0] = e5, b4[i4 - 4 | 0] = e5, f4 >>> 0 < 9 || (a5 = (i4 = 0 - r5 & 3) + r5 | 0, r5 = p2(255 & e5, 16843009), k3[a5 >> 2] = r5, k3[(e5 = (f4 = f4 - i4 & -4) + a5 | 0) - 4 >> 2] = r5, f4 >>> 0 < 9 || (k3[a5 + 8 >> 2] = r5, k3[a5 + 4 >> 2] = r5, k3[e5 - 8 >> 2] = r5, k3[e5 - 12 >> 2] = r5, f4 >>> 0 < 25 || (k3[a5 + 24 >> 2] = r5, k3[a5 + 20 >> 2] = r5, k3[a5 + 16 >> 2] = r5, k3[a5 + 12 >> 2] = r5, k3[e5 - 16 >> 2] = r5, k3[e5 - 20 >> 2] = r5, k3[e5 - 24 >> 2] = r5, k3[e5 - 28 >> 2] = r5, (f4 = f4 - (e5 = 4 & a5 | 24) | 0) >>> 0 < 32)))))))) for (r5 = Hr(r5, 0, 1, 1), i4 = Q2, e5 = e5 + a5 | 0; k3[e5 + 24 >> 2] = r5, k3[e5 + 28 >> 2] = i4, k3[e5 + 16 >> 2] = r5, k3[e5 + 20 >> 2] = i4, k3[e5 + 8 >> 2] = r5, k3[e5 + 12 >> 2] = i4, k3[e5 >> 2] = r5, k3[e5 + 4 >> 2] = i4, e5 = e5 + 32 | 0, (f4 = f4 - 32 | 0) >>> 0 > 31; ) ;
          }
            ...
            r: {
              e: {
                if (!(!(o5 = (i4 = w2[e5 + 28 >> 2]) > (b5 = w2[r5 + 28 >> 2])) & (!(w2[r5 + 32 >> 2] <= w2[e5 + 32 >> 2]) | i4 != b5))) {
                  if ((t4 = w2[f4 + 28 >> 2]) > i4 | i4 == t4 & w2[e5 + 32 >> 2] <= w2[f4 + 32 >> 2]) break r;
                  if (a5 = 1, o5) break e;
                }
            ...
            r: {
              if ((0 | e5) != (0 | f4)) for (; ; ) {
                if (b4[e5 + 15 | 0] = 0, t4 = k3[e5 + 4 >> 2], n5 = k3[k3[t4 + 8 >> 2] >> 2], a5 = k3[n5 >> 2], k3[a5 + 16 >> 2] != k3[i4 + 16 >> 2]) {
                  if (!v3[n5 + 15 | 0]) return r5 = v3[e5 + 12 | 0], f4 = k3[i4 + 20 >> 2], k3[f4 + 8 >> 2] = i4, b4[f4 + 21 | 0] = r5, k3[i4 + 24 >> 2] = 0, Nr(t4), Y2(e5), i4;
                  if (!(a5 = X2(k3[k3[i4 + 8 >> 2] + 4 >> 2], k3[a5 + 4 >> 2]))) break r;
                  if (!$2(k3[n5 >> 2])) break r;
                  k3[n5 >> 2] = a5, b4[n5 + 15 | 0] = 0, k3[a5 + 24 >> 2] = n5;
                }
                if (k3[i4 + 8 >> 2] != (0 | a5)) {
                  if (!ir2(k3[k3[a5 + 4 >> 2] + 12 >> 2], a5)) break r;
                  if (!ir2(i4, a5)) break r;
                }
                if (a5 = v3[e5 + 12 | 0], i4 = k3[e5 >> 2], t4 = k3[i4 + 20 >> 2], k3[t4 + 8 >> 2] = i4, b4[t4 + 21 | 0] = a5, k3[i4 + 24 >> 2] = 0, Nr(k3[e5 + 4 >> 2]), Y2(e5), i4 = k3[n5 >> 2], (0 | f4) == (0 | (e5 = n5))) break;
              }
              return i4;
            }
            Kr(r5 + 1740 | 0, 1), l2();
          ...
          function pr2(r5, e5) {
            r5 |= 0;
            var f4 = 0, i4 = 0, a5 = 0;
            if ((0 | (f4 = k3[40 + (e5 |= 0) >> 2])) != (0 | (i4 = e5 + 40 | 0))) for (; ; ) {
              if (v3[f4 + 21 | 0]) {
            ...
            if (B2 = i4 = B2 - 208 | 0, k3[i4 + 204 >> 2] = e5, vr2(e5 = i4 + 160 | 0, 0, 40), k3[i4 + 200 >> 2] = k3[i4 + 204 >> 2], !((0 | j2(0, r5, i4 + 200 | 0, i4 + 80 | 0, e5, f4)) < 0)) {
              ...
              r: {
                e: {
                  if (k3[416]) {
                    if (k3[408]) break e;
                  } else k3[416] = 80, k3[411] = 0, k3[408] = 0, k3[409] = 0, n5 = k3[415], k3[415] = i4;
                  if (jr(1616)) break r;
                }
          ...
          function Cr(r5) {
            ...
            if (!(e5 = k3[r5 + 12 >> 2])) return sr2(k3[r5 >> 2]);
            if (i4 = k3[r5 + 8 >> 2], a5 = k3[k3[(i4 + (e5 << 2) | 0) - 4 >> 2] >> 2], f4 = k3[r5 >> 2], k3[f4 + 8 >> 2] && (n5 = k3[k3[f4 + 4 >> 2] + (k3[k3[f4 >> 2] + 4 >> 2] << 3) >> 2], !(!((t4 = w2[n5 + 28 >> 2]) < (b5 = w2[a5 + 28 >> 2])) & (!(w2[n5 + 32 >> 2] <= w2[a5 + 32 >> 2]) | t4 != b5)))) return sr2(f4);
            for (f4 = i4 - 8 | 0, i4 = ((0 | e5) > 0 ? 1 : e5) - 1 | 0; ; ) {
              if ((0 | e5) < 2) return k3[r5 + 12 >> 2] = i4, a5;
          ...
          function Rr(r5, e5, f4) {
            ...
            var i4 = 0, a5 = 0, n5 = 0, t4 = 0;
            n5 = 1;
            r: if ((0 | (i4 = k3[64 + (r5 |= 0) >> 2])) != (0 | (a5 = r5 - -64 | 0))) {
              if (t4 = 0 - e5 | 0, !f4) {
                for (; ; ) if (r5 = v3[k3[i4 + 20 >> 2] + 21 | 0], k3[i4 + 28 >> 2] = (0 | r5) != v3[k3[k3[i4 + 4 >> 2] + 20 >> 2] + 21 | 0] ? r5 ? e5 : t4 : 0, (0 | a5) == (0 | (i4 = k3[i4 >> 2]))) break r;
              }
              for (; ; ) {
                ...
                } else k3[i4 + 28 >> 2] = f4 ? e5 : t4;
                if ((0 | a5) == (0 | (i4 = r5))) break;
              }
            }
            return 0 | n5;
          }
          function Ir(r5, e5, f4) {
            ...
            if (!(32 & v3[0 | r5])) r: {
              ...
              if (i4 - (a5 = k3[r5 + 20 >> 2]) >>> 0 < f4 >>> 0) ke[k3[r5 + 36 >> 2]](r5, e5, f4);
              else {
                e: {
                  f: if (!(!f4 | k3[r5 + 80 >> 2] < 0)) {
                    for (i4 = f4; ; ) {
                      if (10 != v3[(n5 = e5 + i4 | 0) - 1 | 0]) {
                        if (i4 = i4 - 1 | 0) continue;
                        break f;
                      }
                      break;
                    }
                    if (ke[k3[r5 + 36 >> 2]](r5, e5, i4) >>> 0 < i4 >>> 0) break r;
          ...
          function Mr(r5) {
            var e5 = 0, f4 = 0, i4 = 0;
            if ((0 | (e5 = k3[40 + (r5 |= 0) >> 2])) != (0 | (f4 = r5 + 40 | 0))) for (; i4 = k3[e5 >> 2], Y2(e5), (0 | f4) != (0 | (e5 = i4)); ) ;
            if ((0 | (e5 = k3[r5 >> 2])) != (0 | r5)) for (; i4 = k3[e5 >> 2], Y2(e5), (0 | (e5 = i4)) != (0 | r5); ) ;
            if ((0 | (e5 = k3[r5 + 64 >> 2])) != (0 | (f4 = r5 - -64 | 0))) for (; i4 = k3[e5 >> 2], Y2(e5), (0 | f4) != (0 | (e5 = i4)); ) ;
            Y2(r5);
          }
          function Pr(r5) {
            var e5 = 0, f4 = m2(0), i4 = m2(0);
            if (!(e5 = k3[r5 + 12 >> 2])) return r5 = k3[r5 >> 2], k3[k3[r5 + 4 >> 2] + (k3[k3[r5 >> 2] + 4 >> 2] << 3) >> 2];
            e5 = k3[k3[(k3[r5 + 8 >> 2] + (e5 << 2) | 0) - 4 >> 2] >> 2], r5 = k3[r5 >> 2];
            r: {
              if (k3[r5 + 8 >> 2]) {
                if (r5 = k3[k3[r5 + 4 >> 2] + (k3[k3[r5 >> 2] + 4 >> 2] << 3) >> 2], (f4 = w2[r5 + 28 >> 2]) < (i4 = w2[e5 + 28 >> 2])) break r;
                if (f4 == i4 && w2[r5 + 32 >> 2] <= w2[e5 + 32 >> 2]) break r;
              }
              r5 = e5;
            }
            return r5;
          ...
          function Ur(r5, e5, f4) {
            var i4 = 0, a5 = 0, n5 = 0, t4 = 0;
            if (e5) for (; n5 = f4 = f4 - 1 | 0, t4 = (a5 = r5) - Hr(r5 = ur2(r5, e5, 10), i4 = Q2, 10, 0) | 48, b4[0 | n5] = t4, a5 = e5 >>> 0 > 9, e5 = i4, a5; ) ;
            if (r5) for (; e5 = (r5 >>> 0) / 10 | 0, b4[0 | (f4 = f4 - 1 | 0)] = r5 - p2(e5, 10) | 48, i4 = r5 >>> 0 > 9, r5 = e5, i4; ) ;
            return f4;
          }
          function Br(r5, e5, f4, i4) {
            var a5 = 0, n5 = 0, t4 = 0;
            if (n5 = k3[980] + 1 | 0, k3[980] = n5, k3[r5 >> 2] = n5, i4) for (; ; ) {
              if (!k3[(a5 = (t4 << 3) + f4 | 0) >> 2]) return k3[a5 >> 2] = n5, k3[a5 + 4 >> 2] = e5, k3[a5 + 8 >> 2] = 0, F2 = i4, f4;
              if ((0 | (t4 = t4 + 1 | 0)) == (0 | i4)) break;
            }
          ...
          function Fr(r5, e5) {
            ...
            if (A2(+r5), i4 = 0 | u2(1), a5 = 0 | u2(0), 2047 != (0 | (f4 = i4 >>> 20 & 2047))) {
              if (!f4) return 0 == r5 ? f4 = 0 : (r5 = Fr(18446744073709552e3 * r5, e5), f4 = k3[e5 >> 2] + -64 | 0), k3[e5 >> 2] = f4, r5;
          ...
          function Qr(r5) {
            var e5 = 0, f4 = 0, i4 = 0;
            if (b4[k3[r5 >> 2]] - 48 >>> 0 >= 10) return 0;
          ...
          function xr(r5, e5, f4, i4, a5) {
            ...
            if (B2 = n5 = B2 - 256 | 0, !(73728 & a5 | (0 | f4) <= (0 | i4))) {
              if (vr2(n5, 255 & e5, (f4 = (i4 = f4 - i4 | 0) >>> 0 < 256) ? i4 : 256), !f4) for (; Ir(r5, n5, 256), (i4 = i4 - 256 | 0) >>> 0 > 255; ) ;
              Ir(r5, n5, i4);
            }
            B2 = n5 + 256 | 0;
          }
          ...
          function Or(r5, e5, f4) {
            var i4 = 0, a5 = 0, n5 = 0;
            r: if (f4) for (; ; ) {
              if (!(n5 = k3[(a5 = (i4 << 3) + e5 | 0) >> 2])) break r;
              if ((0 | r5) == (0 | n5)) return k3[a5 + 4 >> 2];
              if ((0 | (i4 = i4 + 1 | 0)) == (0 | f4)) break;
            }
            return 0;
          }
          function Dr(r5) {
            ...
            r: {
              if (!((r5 = (e5 = k3[440]) + (f4 = r5 + 7 & -8) | 0) >>> 0 <= e5 >>> 0 && f4)) {
                if (r5 >>> 0 <= ue() << 16 >>> 0) break r;
                if (0 | P2(0 | r5)) break r;
              }
              return k3[806] = 48, -1;
            }
            return k3[440] = r5, e5;
          ...
          function Lr(r5, e5) {
            r5 |= 0, e5 |= 0;
            var f4 = m2(0), i4 = m2(0);
            if ((f4 = w2[r5 + 28 >> 2]) < (i4 = w2[e5 + 28 >> 2])) r5 = 1;
            else {
              if (f4 != i4) return 0;
  ...
  function d(r2) {
    for (var e3 = atob(r2), f3 = new Uint8Array(e3.length), i2 = 0; i2 < e3.length; ++i2) f3[i2] = e3.charCodeAt(i2);
    return f3;
  }
  function h(r2) {
    if (j(r2)) return d(r2.slice(x.length));
  }
  ...
  l = a2.wasmMemory ? a2.wasmMemory : new v.Memory({
    initial: g / 65536,
    maximum: 32768
  }), m(), g = l.buffer.byteLength;
  var E = [], C = [], R = [];
  function I() {
    if (a2.preRun) for ("function" == typeof a2.preRun && (a2.preRun = [a2.preRun]); a2.preRun.length; ) P(a2.preRun.shift());
    Z(E);
  }
  function S() {
    Z(C);
  ...
  function M() {
    if (a2.postRun) for ("function" == typeof a2.postRun && (a2.postRun = [a2.postRun]); a2.postRun.length; ) U(a2.postRun.shift());
    Z(R);
  }
  function P(r2) {
    E.unshift(r2);
  ...
  function O(r2) {
    if (r2 == W && c) return new Uint8Array(c);
    var e3 = h(r2);
    if (e3) return e3;
    if (o2) return o2(r2);
  ...
  function D(r2) {
    return c || j(r2) || !t2 && !b2 || "function" != typeof fetch ? Promise.resolve().then(() => O(r2)) : fetch(r2, {
  ...
  function L(r2, e3, f3, i2) {
    return r2 || "function" != typeof v.instantiateStreaming || j(e3) || "function" != typeof fetch ? G(e3, f3, i2) : fetch(e3, {
      credentials: "same-origin"
    }).then((r3) => v.instantiateStreaming(r3, f3).then(i2, function(r4) {
  ...
  var J, N = () => {
    ...
    for (var i2 = e3 + f3, a3 = e3; r2[a3] && !(a3 >= i2); ) ++a3;
    if (a3 - e3 > 16 && r2.buffer && X) return X.decode(r2.subarray(e3, a3));
    for (var n3 = ""; e3 < a3; ) {
      var t3 = r2[e3++];
      if (128 & t3) {
        var b3 = 63 & r2[e3++];
        if (192 != (224 & t3)) {
          var o3 = 63 & r2[e3++];
          if ((t3 = 224 == (240 & t3) ? (15 & t3) << 12 | b3 << 6 | o3 : (7 & t3) << 18 | b3 << 12 | o3 << 6 | 63 & r2[e3++]) < 65536) n3 += String.fromCharCode(t3);
          else {
            var k2 = t3 - 65536;
            n3 += String.fromCharCode(55296 | k2 >> 10, 56320 | 1023 & k2);
          }
        } else n3 += String.fromCharCode((31 & t3) << 6 | b3);
    ...
    d: (r2, e3, f3, i2) => {
      for (var a3 = 0, n3 = 0; n3 < f3; n3++) {
        ...
        e3 += 8;
        for (var o3 = 0; o3 < b3; o3++) er(r2, w[t3 + o3]);
        a3 += b3;
      }
      return y[i2 >> 2] = a3, 0;
    },
...
//# sourceMappingURL=libtess-asm-6H5Q4LPD.js.map
