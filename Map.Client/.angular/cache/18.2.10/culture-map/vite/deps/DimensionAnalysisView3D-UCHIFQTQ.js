...
function w3(t9, o5, a7) {
  ...
  let s6;
  if (o5 === t2.Horizontal) s6 = m3(t9.elevationAlignedStartPoint, t9.elevationAlignedEndPoint);
  else {
    const {
      startRenderSpace: e12,
      endRenderSpace: n7
    } = t9.dimensionSegment;
...
function z4(e12) {
  const {
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: n7,
    dimension: {
      offset: r8,
      measureType: i3,
      orientation: o5
...
function C2({
  ...
  if (null == t9 || null == n7) return null;
  const l8 = V3(d5?.directSegment ?? new m(), {
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: n7
  }, a7), c5 = d5?.primaryOffsetAxis ?? n2();
  B(c5, {
    measureType: i3,
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: n7,
    directSegment: l8,
    orientation: o5,
    renderCoordsHelper: a7
  });
  const m5 = d5?.dimensionSegment ?? new m();
  return G3({
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: n7
  }) && i3 === t2.Vertical ? (r3(m5.startRenderSpace, l8.startRenderSpace), r3(m5.endRenderSpace, l8.endRenderSpace)) : Y(m5, {
    offsetAxis: c5,
    offset: r8,
    relativeToSegment: l8,
    renderCoordsHelper: a7
  }), {
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: n7,
    directSegment: l8,
    dimensionSegment: m5,
    primaryOffsetAxis: c5,
    spatialReference: a7.spatialReference
  };
}
function U(e12, t9, n7, r8) {
...
function k(t9, n7, r8, i3) {
  switch (n7) {
    ...
    case t2.Vertical: {
      const {
        elevationAlignedStartPoint: o5,
        elevationAlignedEndPoint: a7,
        dimension: s6,
        geometry: d5
      } = r8;
      let l8;
      ...
      const [c5, m5] = l8 ? [o5, a7] : [a7, o5], u7 = x(m5, q4);
...
var q4 = e6(0, 0, 0, null);
function I2(e12, t9, n7, r8) {
  const {
    directSegment: i3
  } = n7, o5 = B(c.get(), {
    measureType: t9,
    directSegment: i3,
    renderCoordsHelper: r8
  }), a7 = Y(L, {
    offsetAxis: o5,
    offset: 0,
    relativeToSegment: i3,
    renderCoordsHelper: r8
  }).eval(0.5, c.get()), s6 = K(c.get(), e12, a7);
...
function B(n7, r8) {
  const {
    measureType: i3,
    elevationAlignedStartPoint: a7,
    elevationAlignedEndPoint: d5,
    directSegment: {
      startRenderSpace: u7,
      endRenderSpace: f9
    },
    directSegment: v4,
    renderCoordsHelper: y3
  } = r8, E4 = v4.eval(0.5, c.get()), j6 = y3.worldUpAtPosition(E4, c.get()), x3 = y3.worldBasisAtPosition(E4, n3.Y, c.get());
  switch (i3) {
    case t2.Horizontal:
      r3(n7, j6);
      break;
    case t2.Vertical:
      P2(u7, j6) < P2(f9, j6) ? K(n7, f9, u7) : K(n7, u7, f9), _2(n7, n7, j6), _2(n7, n7, j6);
      break;
    case t2.Direct: {
      ...
      if (G3({
        elevationAlignedStartPoint: a7,
        elevationAlignedEndPoint: d5
      })) p2(F2, -h2(e12), j6), O2(n7, x3, F2);
      else {
        const r9 = K(c.get(), f9, u7), i4 = _2(c.get(), r9, j6);
        _2(i4, i4, r9), p2(F2, h2(e12), r9), O2(n7, i4, F2);
      }
      break;
    }
  }
  return H(n7, l3) ? r3(n7, x3) : z(n7, n7);
}
var F2 = e5();
function G3({
  elevationAlignedStartPoint: e12,
  elevationAlignedEndPoint: t9
}) {
...
function Y(e12, t9) {
  const {
    ...
    relativeToSegment: a7,
    renderCoordsHelper: s6
  } = t9, l8 = r8 / s6.unitInMeters, [c5, m5] = J(i3, o5, n7, l8);
  return q(e12.startRenderSpace, a7.startRenderSpace, n7, c5), q(e12.endRenderSpace, a7.endRenderSpace, n7, m5), e12;
}
...
function $(e12) {
  const {
    elevationAlignedStartPoint: t9,
    elevationAlignedEndPoint: r8
  } = e12;
  if (null == t9 || null == r8) return false;
  const i3 = m2(t9, r8);
...
var g5 = class extends S {
  ...
  initialize() {
    const t9 = g(() => this.analysisViewData.computations, ({
      computation: t10
    }) => this._watchComputation(t10));
...
e3([y({
  constructOnly: true
})], g5.prototype, "analysisViewData", void 0), e3([y({
  constructOnly: true
})], g5.prototype, "view", void 0), e3([y()], g5.prototype, "analysis", null), e3([y()], g5.prototype, "_defaultUnit", null), g5 = e3([a("esri.views.3d.analysis.Dimension.DimensionController")], g5);
...
var He = class {
  ...
  forEachMeasureTypeManipulator(e12) {
    for (const r8 of r4) e12(this.manipulatorForMeasureType(r8), r8);
  }
...
var Me = class extends ee {
  constructor(t9, r8) {
    ...
    super({
      view: t9,
      renderObjects: i3,
      metadata: r8.metadata,
      available: false,
      grabCursor: "crosshair",
      radius: e11,
      collisionPriority: 1
    }), this._themeHandle = d2(() => ({
      color: u3.toUnitRGBA(n5(t9.effectiveTheme))
    }), (e12) => n7.setParameters(e12));
  }
  destroy() {
...
function Pe(e12, t9) {
  const r8 = [r2(-0.5, 0, 0), r2(0.5, 0, 0)], n7 = gt(t9.unfocusedMaterial, r8.map((e13) => g2(n2(), e13, u6))), i3 = n7.instantiate({
    material: t9.focusedMaterial
  });
  return new ee(__spreadValues({
    view: e12,
    renderObjects: [new e9(n7, t3.Unfocused | t3.Selected | tt), new e9(i3, t3.Focused | tt)],
    collisionType: {
      type: "line",
      paths: [r8]
    },
    radius: $e(t9.lineSizePt) / 2,
    metadata: t9.metadata,
    available: false
  }, b2));
}
var Ce = class extends ee {
  constructor(t9, {
    ...
    super({
      ...
      lineSizePt: r8,
      material: n7
    }, this._themeHandle = d2(() => u3.toUnitRGBA(n5(t9.effectiveTheme)), (e12) => {
      this._options.calloutColor = e12, et(this, Te(__spreadProps(__spreadValues({}, this._options), {
  ...
  update({
    ...
    this._options.lineSizePt = e12, this._options.material = t9, et(this, Te(__spreadProps(__spreadValues({}, this._options), {
      metadata: this.metadata
    })));
  }
  destroy() {
...
function Te({
  ...
  return {
    calloutLength: 0.25 * p3 * l6 * u2(t9) + p8,
    calloutColor: e12,
    calloutWidth: C3,
    customStateMask: tt,
    discScale: a6,
...
function Oe(e12, t9) {
  const r8 = [r2(-0.5, 0, 0), r2(0.5, 0, 0)], n7 = gt(t9.thinOffsetManipulatorMaterial, r8), i3 = gt(t9.unfocusedMaterial, r8.map((e13) => g2(n2(), e13, u6))), o5 = i3.instantiate({
    material: t9.focusedMaterial
  });
  return new ee(__spreadValues({
    view: e12,
    renderObjects: [new e9(i3, t3.Unfocused | tt), new e9(o5, t3.Focused | tt), new e9(n7, tt)],
    collisionType: {
      type: "line",
      paths: [r8]
    },
...
function Ue(e12, {
  ...
  const a7 = t9 ? "startPoint" : "endPoint", s6 = p5(e12, (e13, t10, s7, c5) => {
    ...
    s7 = s7.next(m5).next(h6(n7, [a7, "measureType", "orientation"])).next(d5), t10.next(m5).next(z3(o5)).next(...l8).next((e14) => {
      const t11 = x(e14.mapEnd, new _());
      i3("startPoint" === a7 ? {
        startPoint: t11
      } : {
        endPoint: t11
...
function Re(e12, {
  ...
  return [p5(e12, (e13, n7, i3) => {
    if (!_4(t9) || !e13.selected) return;
    const {
      geometry: o5,
      dimension: a7
    } = t9, s6 = q3(e13);
    n7.next(s6).next(ke(r8, a7, o5.dimensionSegment, o5.primaryOffsetAxis)), i3.next(s6).next(h6(a7, ["offset"]));
  })];
}
function ze(e12, {
  computation: t9,
...
function De(e12, t9, r8) {
  ...
  if (90 === i3.orientation || 270 === i3.orientation) return i3.orientation = 0, void e12.stopPropagation();
  if (null == o5) return;
  const {
    renderCoordsHelper: a7
  } = r8, s6 = C2(__spreadProps(__spreadValues({}, z4(t9)), {
    orientation: 90
  }), a7), c5 = C2(__spreadProps(__spreadValues({}, z4(t9)), {
    orientation: 270
  }), a7);
  if (null == s6 || null == c5) return;
  const m5 = W(s6, a7), l8 = W(c5, a7), d5 = Ee(o5, r8), u7 = a2.shortestSignedDiff(d5, m5), p10 = a2.shortestSignedDiff(d5, l8);
...
function _e(e12) {
  ...
  const {
    ...
    dimension: c5,
    geometry: m5
  } = r8, l8 = n2(), d5 = Je(n2(), m5, m5.directSegment, s6), p10 = Ke(c.get(), {
    forHeading: n7,
    geometry: m5,
    renderCoordsHelper: s6
  }), f9 = j3(d5, p10, E()), g10 = n7 ? c5.orientation ?? W(m5, a7.renderCoordsHelper) : c5.orientation ?? 0;
  o5.next(O5(a7, f9)).next((e13) => {
    "start" === e13.action && r3(l8, e13.renderStart);
    const t10 = F(f9), r9 = w(l8, e13.renderEnd, d5, t10);
    let o6 = g10 - M(r9);
    n7 || (o6 = Fe(o6)), c5.orientation = o6;
...
function Le(e12, {
  computation: t9,
  manipulatorMeasureType: n7,
  view: i3
}) {
  let o5 = t2.Direct, a7 = 0, s6 = 0;
  return [e12.events.on("grab-changed", (r8) => {
    if ("start" !== r8.action || !_4(t9)) return;
    const {
      dimension: c5,
      geometry: m5
    } = t9;
    o5 = c5.measureType, a7 = c5.offset, s6 = c5.orientation;
    const l8 = r3(c.get(), e12.renderLocation);
    c5.measureType = n7, c5.offset = I2(l8, n7, m5, i3.renderCoordsHelper), c5.orientation = 0;
  }), p5(e12, (e13, r8, c5) => {
    if (!_4(t9)) return;
    const {
      geometry: m5,
      ...
      renderCoordsHelper: d5
    } = i3, u7 = k(ot, n7, t9, d5), p10 = B(c.get(), {
      measureType: n7,
      directSegment: m5.directSegment,
      renderCoordsHelper: d5
    }), f9 = q3(e13);
    r8.next(f9).next(ke(i3, l8, u7, p10)), c5.next(f9).next((e14) => (l8.measureType = o5, l8.offset = a7, l8.orientation = s6, e14));
  })];
}
function ke(e12, t9, r8, n7) {
  ...
  let c5, m5 = 0;
  const l8 = new w2();
  return l8.next(O5(e12, o5)).next((r9) => {
    "start" === r9.action && (m5 = V2(a7, r9.renderStart));
    const n8 = (V2(a7, r9.renderEnd) - m5) * e12.renderCoordsHelper.unitInMeters;
    t9.offset = s6 + n8, c5 = r9;
  }), (e13) => (l8.execute(e13), c5);
}
function Ee(e12, t9) {
  const {
    directSegment: r8
  } = e12, {
    renderCoordsHelper: n7
  } = t9, i3 = K2(c.get(), e12, n7), o5 = N3(c.get(), e12), a7 = _2(c.get(), o5, i3), {
    viewForward: s6
  } = t9.state.camera;
...
function Ie(e12, t9, r8) {
  const {
    dimensionSegment: n7,
    primaryOffsetAxis: i3
  } = t9, o5 = Q(rt, t9), a7 = G(o5, l3) ? o3(it) : O4(o5, i3, l3, it), s6 = Math.max(s(o5), s5 / r8.unitInMeters);
...
function Ne(e12, t9, r8, {
  ...
  const {
    ...
    primaryOffsetAxis: a7
  } = o5, s6 = g2(Ve, a7, i3.offset >= 0 ? 1 : -1), c5 = Ke(We, {
    forHeading: n7,
    geometry: o5,
    renderCoordsHelper: r8
  });
  _2(c5, c5, s6);
  const m5 = O4(s6, c5, l3, it);
  e12.modelTransform = m5, e12.renderLocation = Je(rt, o5, o5.dimensionSegment, r8);
}
var Ve = n2();
var We = n2();
function qe(e12, t9, r8, n7) {
  const {
    geometry: i3
  } = t9, o5 = k(ot, r8, t9, n7), a7 = B(rt, {
    measureType: r8,
    directSegment: i3.directSegment,
    renderCoordsHelper: n7
  }), s6 = K(nt, o5.endRenderSpace, o5.startRenderSpace), c5 = O4(s6, a7, l3, it), l8 = s(s6);
  f2(c5, c5, o2(nt, l8, l8, l8)), e12.modelTransform = c5, e12.renderLocation = o5.eval(0.5, nt);
}
function Je(e12, t9, r8, n7) {
  const {
    startRenderSpace: i3,
    endRenderSpace: o5
  } = r8, a7 = Qe(t9, n7) ? i3 : o5;
  return r3(e12, a7);
}
function Ke(e12, {
  forHeading: t9,
  ...
  return t9 ? K2(e12, r8, n7) : Q(e12, r8, {
    invert: true
  });
}
function Qe(e12, t9) {
...
function et(e12, t9) {
  const r8 = t9.material ?? new g3({
    transparent: true,
    writeDepth: false,
    textureId: t9.texture?.id,
    renderOccluded: h4.Opaque,
    isDecoration: true
  }), n7 = t9.focusMultiplier ?? j4.focusMultiplier, i3 = t9.calloutLength ?? j4.calloutLength, o5 = j4.discRadius * (t9.discScale ?? 1), a7 = o5 * n7, s6 = (e13, t10) => {
  ...
  }, c5 = t9.calloutWidth ?? j4.calloutWidth, m5 = new z2({
    width: c5,
    color: t9.calloutColor,
    renderOccluded: h4.OccludeAndTransparent,
    isDecoration: true
  }), l8 = gt(m5, [[0, 0, 0], [i3 - o5, 0, 0]]), d5 = gt(m5, [[0, 0, 0], [i3 - a7, 0, 0]]), u7 = t9.customStateMask ?? u5.None;
  e12.collisionType = {
    type: "disc",
    direction: [0, 0, 1],
    offset: [i3, 0, 0]
  }, e12.focusMultiplier = n7, e12.metadata = t9.metadata, e12.radius = o5, e12.renderObjects = [new e9(s6(o5, r8), t3.Unfocused | u7), new e9(l8, t3.Unfocused | u7), new e9(s6(a7, r8), t3.Focused | u7), new e9(d5, t3.Focused | u7)];
}
var tt = u5.Custom1;
var rt = n2();
var nt = n2();
...
function p9(e12, t9) {
  return {
    enabled: t9.effectiveFeatureEnabled,
    elevationAlignedStartPoint: e12.elevationAlignedStartPoint,
    elevationAlignedEndPoint: e12.elevationAlignedEndPoint,
    geometry: e12.geometry
  };
}
function f8(e12, s6) {
  if ($(e12)) return P4.Direct;
  if (!e12.enabled) return null;
  const {
    geometry: u7
  } = e12;
  if (null == u7 || G(u7.directSegment.startRenderSpace, u7.directSegment.endRenderSpace)) return null;
  const {
    camera: p10
  } = s6.state, f9 = K2(c.get(), u7, s6.renderCoordsHelper), g10 = N3(c.get(), u7), S4 = g2(c.get(), f9, P2(g10, f9)), v4 = e4(c.get(), g10, S4), y3 = v(v4), A2 = v(S4), {
    startRenderSpace: R4,
    endRenderSpace: j6
  } = u7.directSegment, z5 = Math.max(p10.computeScreenPixelSizeAt(R4) * d4, p10.computeScreenPixelSizeAt(j6) * d4) ** 2;
  return y3 < z5 ? P4.Vertical : A2 < z5 ? P4.Horizontal : null;
}
function g7(e12, t9, {
  constraint: n7,
  view: i3
  ...
  const {
    ...
    startRenderSpace: s6,
    endRenderSpace: l8
  } = o5.directSegment, c5 = r8.fromRenderCoords(s6, new _({
    spatialReference: a7
  })), d5 = r8.fromRenderCoords(l8, new _({
    spatialReference: a7
  }));
  let m5;
  m5 = "start" === t9 ? {
...
function S2(t9, n7, i3) {
  const {
    constraint: o5,
    elevationAlignedStartPoint: r8,
    elevationAlignedEndPoint: a7,
    unconstrainedGeometry: l8,
    view: c5
  } = i3, {
    dimension: d5,
    previousConstraint: m5,
    preConstraintProperties: u7
  } = t9;
  if (null == r8 || null == a7) return;
  const p10 = () => {
    "startPoint" in n7 ? d5.startPoint = n7.startPoint : "endPoint" in n7 && (d5.endPoint = n7.endPoint);
  };
  if (null == o5) p10(), null != m5 && null != u7 && (d5.measureType = u7.measureType, d5.orientation = u7.orientation);
  else switch (d5.measureType = t2.Direct, o5) {
    case P4.Horizontal:
    ...
    case P4.Vertical:
      ...
      break;
    case P4.Direct:
      o5 !== m5 && null != u7 && (d5.orientation = u7.orientation), p10();
  }
...
var gt2 = class extends S {
  constructor(t9) {
    super(t9), this._stagedDimension = null, this._computationManipulators = /* @__PURE__ */ new Map(), this._computationHandles = new r(), this._orientationManipulatorTexture = null, this._updatingHandles = new h3(), this._getSnappingContext = t5((t10) => new e10({
      elevationInfo: {
        mode: "absolute-height",
        offset: 0
      },
      pointer: t10,
      editGeometryOperations: new E2(new p4("point", P3(true, false, this.view.spatialReference)), this.view.state.viewingMode),
      visualizer: new R3()
    }));
    const {
      view: i3
    ...
    this._snappingManagerResult = a4(i3), this.addHandles(this._snappingManagerResult), this._unfocusedOffsetManipulatorMaterial = this._createOffsetManipulatorMaterial(), this._focusedOffsetManipulatorMaterial = this._createOffsetManipulatorMaterial(), this._thinOffsetManipulatorMaterial = this._createOffsetManipulatorMaterial(), this._thinOffsetManipulatorMaterial.setParameters({
      stipplePattern: h5(2)
    }), this._constraintSnappingIndicator = new f4({
      view: i3,
      attached: true,
      width: 1,
      renderOccluded: h4.OccludeAndTransparent,
    ...
    this._stagedStartIndicator = new d3({
      view: i3,
      attached: false,
      elevationInfo: {
        mode: "absolute-height",
      ...
      spatialReference: t9.view.renderCoordsHelper.spatialReference,
      color: a7,
      size: 2 * e11,
      outlineSize: 0,
      renderOccluded: h4.OccludeAndTransparent,
  ...
  initialize() {
    ...
    this._snappingOperation = new p7({
      view: t9
    });
    const i3 = !t9._stage?.renderView.renderingContext.driverTest.svgPremultipliesAlpha.result;
    this._orientationManipulatorMaterial = new g3({
      transparent: true,
      writeDepth: false,
      renderOccluded: h4.Opaque,
      isDecoration: true
    }), this.addHandles(d2(() => ({
      accentColor: n5(t9.effectiveTheme),
      contrastColor: c3(t9.effectiveTheme)
    }), ({
      accentColor: a8,
      contrastColor: n7
    }) => {
      const s6 = this._orientationManipulatorTexture, o5 = l4(t9.textures, {
        accentColor: a8,
        contrastColor: n7,
        preMultiplyAlpha: i3
      });
      this._orientationManipulatorMaterial.setParameters({
        textureId: o5.texture.id
      }), this._orientationManipulatorTexture = o5, s6?.release();
      ...
      this._unfocusedOffsetManipulatorMaterial.setParameters({
        ...
        color: r8
      }), this._constraintSnappingIndicator.color = r8;
    }, P));
    const a7 = g(() => this.analysisViewData.computations, ({
      computation: t10
    }) => this._createManipulators(t10));
    this.addHandles(l2(a7)), this.addHandles([d2(() => ({
      stagedPoint: this._snappingOperation.stagedPoint,
      stagedComputation: this._stagedComputation
    }), ({
      stagedPoint: t10,
      stagedComputation: e12
    }) => {
      if (null == e12 || null == t10) return;
      const i4 = x(t10, new _());
      this._applyPointUpdate(e12, {
        endPoint: i4
      });
    }, C), d2(() => ({
      ...
      const {
        stagedDimension: i4,
        selectedComputation: a8,
        firstGrabbedManipulator: n7
      } = t10;
      if (i4 === e12?.stagedDimension && n7 === e12?.firstGrabbedManipulator) {
        for (const s6 of [a8, e12?.selectedComputation]) if (null != s6) {
          const e13 = this._computationManipulators.get(s6);
          null != e13 && this._updateManipulators(s6, e13, t10);
        }
      } else for (const [s6, o5] of this._computationManipulators) this._updateManipulators(s6, o5, t10);
      ...
      if (null != t10) {
        ...
        } = this._computationManipulators.get(t10);
  ...
  destroy() {
    this._snappingOperation = u(this._snappingOperation), this._computationHandles.destroy(), this._constraintSnappingIndicator.destroy(), this._stagedStartIndicator.destroy(), this._orientationManipulatorTexture?.release();
  }
  get updating() {
  ...
  get _activeComputation() {
    ...
    const {
      selectedComputation: t9
    } = this.analysisViewData;
    return this.hasGrabbedManipulators && null != t9 ? t9 : null;
  }
  get _stagedComputation() {
    const t9 = this._stagedDimension, e12 = this.analysisViewData.computations.at(-1)?.computation;
    ...
    return [p(() => this.analysisViewData.selectedComputation, (t9) => {
      ...
      if (null != t9 && null == e12) {
        ...
        switch (n7.previousConstraint) {
          case P4.Horizontal:
            n7.preConstraintProperties = {
              measureType: t2.Horizontal,
              orientation: 0
            };
            break;
          case P4.Vertical:
            n7.preConstraintProperties = {
              measureType: t2.Vertical,
              orientation: 0
            };
            break;
          case P4.Direct:
            n7.preConstraintProperties = {
              measureType: t2.Direct,
              orientation: a7
            };
            break;
          default:
  ...
  get _snappingIndicatorHandles() {
    ...
    return [d2(() => ({
      ...
      stagedComputation: e12,
      activeComputation: i3
    }) => {
      const a7 = this._constraintSnappingIndicator;
      if (this.removeHandles(t9), null != i3) {
        if (i3 === e12) a7.attached = true;
        else {
          const {
            start: e13,
            end: n7
          } = this._computationManipulators.get(i3), s6 = () => {
      ...
      return null != t10 ? {
        geometry: t10.geometry,
        constraint: t10.previousConstraint
      } : {};
    }, ({
      geometry: t10,
      constraint: e12
      ...
      null != t10 && null != e12 && e12 !== P4.Direct ? (i3.visible = true, i3.setGeometryFromSegment(t10.directSegment)) : i3.visible = false;
    })];
  }
  removeStaged() {
  ...
  _onUnstagedClick({
    ...
    if ("mouse" === e12) {
      const i3 = this._getSnappingContext(e12);
      n7 = this._snappingManager.update({
        point: t9,
        context: i3
      });
    }
    const s6 = new u4({
      startPoint: x(n7, new _()),
      endPoint: null,
      measureType: t2.Horizontal
    });
  ...
  _onStagedClick({
    ...
    if ("mouse" === e12) {
      ...
      a7 = this._snappingManager.update({
        point: t9,
        context: i4
      });
    }
    const n7 = x(a7, new _());
    this._applyPointUpdate(i3, {
      endPoint: n7
  ...
  _createManipulators(t9) {
    const e12 = this._setupPointManipulator(t9, {
      isStart: true
    }), a7 = this._setupPointManipulator(t9, {
      isStart: false
    }), n7 = this._setupOffsetManipulator(t9), s6 = this._setupHeadingManipulator(t9), o5 = this._setupRotationManipulator(t9), r8 = this._setupMeasureTypeManipulator(t9, t2.Direct), p10 = this._setupMeasureTypeManipulator(t9, t2.Horizontal), l8 = this._setupMeasureTypeManipulator(t9, t2.Vertical), u7 = new He({
      start: e12,
      end: a7,
      offset: n7,
      heading: s6,
    ...
    return this._setupComputationToManipulatorsSync(t9, u7), this._computationManipulators.set(t9, u7), this.manipulators.addMany(u7.values()), {
      manipulators: u7,
      remove: () => {
        this._computationHandles.remove(t9), this._computationManipulators.delete(t9);
        for (const t10 of u7.values()) this.manipulators.remove(t10);
      }
    };
  }
  _setupComputationToManipulatorsSync(t9, e12) {
    this._computationHandles.add([d2(() => t9.geometry, () => this._updateManipulators(t9, e12), __spreadProps(__spreadValues({}, A), {
      equals: j
    }))], t9);
  }
  _setupPointManipulator(t9, e12) {
    const {
      ...
      isStart: e12.isStart,
      createSnappingPipelineStep: (t10) => f5({
        snappingContext: this._getSnappingContext(t10),
        snappingManager: this._snappingManager,
        updatingHandles: this._updatingHandles
      }),
      dimension: a7,
      onUpdate: (e13) => this._applyPointUpdate(t9, e13),
      view: i3
    });
  ...
  _setupMeasureTypeManipulator(t9, e12) {
    const {
      ...
      computation: t9,
      manipulatorMeasureType: e12,
      view: i3
    });
    return this._computationHandles.add(n7, t9), a7;
  }
  _updateManipulators(t9, e12, a7 = {
    stagedDimension: this._stagedDimension,
    selectedComputation: this.analysisViewData.selectedComputation,
    firstGrabbedManipulator: this.firstGrabbedManipulator
  }) {
    const {
      stagedDimension: n7,
      selectedComputation: s6,
      firstGrabbedManipulator: o5
    } = a7, {
      start: r8,
      end: p10,
      offset: l8,
    ...
    if (!m5) return;
    null != this._computeConstraint(t9) ? e12.forEachMeasureTypeManipulator((t10) => t10.available = false) : e12.manipulatorForMeasureType(h9.measureType).available = false;
    for (const _6 of [u7, d5]) h9.measureType === t2.Direct && 0 !== h9.offset || (_6.available = false);
    G3(t9) ? d5.available = false : u7.available = false;
    const {
      geometry: g10
    } = t9;
    r8.renderLocation = g10.directSegment.startRenderSpace, p10.renderLocation = g10.directSegment.endRenderSpace;
    const {
      renderCoordsHelper: f9
    } = this.view;
    Ie(l8, g10, f9), u7.available && Ge(u7, t9, f9), d5.available && Be(d5, t9, f9), e12.forEachMeasureTypeManipulator((e13, i3) => {
      e13.available && qe(e13, t9, i3, f9);
    });
  }
  _updateManipulatorStyle(t9) {
    const e12 = Ze(t9), i3 = $e(t9), a7 = {
      lineSizePt: t9,
      material: this._orientationManipulatorMaterial
    };
    for (const {
      ...
      heading: s6,
      rotation: o5
    } of this._computationManipulators.values()) n7.radius = i3 / 2, s6.update(a7), o5.update(a7);
    this._unfocusedOffsetManipulatorMaterial.setParameters({
      width: e12
    }), this._focusedOffsetManipulatorMaterial.setParameters({
      width: i3
  ...
  _applyPointUpdate(t9, e12) {
    ...
    if (null == n7) return;
    const s6 = this._computeConstraint(__spreadProps(__spreadValues({}, a7), {
      geometry: n7
    }));
    S2(t9, e12, __spreadProps(__spreadValues({}, a7), {
      constraint: s6,
      unconstrainedGeometry: n7,
      view: i3
    })), t9 === this._stagedComputation && this._updateStagedDimensionOffset(t9);
  }
  _updateStagedDimensionOffset(t9) {
    if (null == t9.geometry) return;
    t9.geometry.directSegment.eval(0.5, ft);
    const e12 = this.view.state.camera.computeScreenPixelSizeAt(ft);
    t9.dimension.offset = h7 * e12;
  }
  _computeConstraint(t9) {
    return f8(p9(t9, this._snappingManager.options), this.view);
  }
...
e3([y({
  constructOnly: true
})], gt2.prototype, "analysis", void 0), e3([y({
  constructOnly: true
})], gt2.prototype, "analysisViewData", void 0), e3([y({
  constructOnly: true
})], gt2.prototype, "manipulators", void 0), e3([y({
  constructOnly: true
})], gt2.prototype, "parentTool", void 0), e3([y({
  constructOnly: true,
  nonNullable: true
})], gt2.prototype, "view", void 0), e3([y({
  readOnly: true
})], gt2.prototype, "updating", null), e3([y()], gt2.prototype, "firstGrabbedManipulator", null), e3([y()], gt2.prototype, "hasGrabbedManipulators", null), e3([y()], gt2.prototype, "snappingOptions", null), e3([y()], gt2.prototype, "_stagedDimension", void 0), e3([y()], gt2.prototype, "_activeComputation", null), e3([y()], gt2.prototype, "_stagedComputation", null), gt2 = e3([a("esri.views.3d.analysis.Dimension.LengthDimensionSubTool")], gt2);
var ft = n2();
...
var S3 = class extends o4 {
  constructor(e12) {
    super(e12), this.automaticManipulatorSelection = false, this.removeIncompleteOnCancel = false, this._pointerMoveTimerMs = g6, this._prevPointerMoveTimeout = null;
  }
  initialize() {
    this._intersector = t6(this.view.state.viewingMode), this._lengthDimensionSubTool = new gt2({
      analysis: this.analysis,
      analysisViewData: this.analysisViewData,
      manipulators: this.manipulators,
      parentTool: this,
      view: this.view
    }), this.addHandles([l2(this._lengthDimensionSubTool), e2(() => this._clearPointerMoveTimeout()), d2(() => this.state, (e12) => {
      e12 === g8.Created && this.finishToolCreation();
  ...
  get state() {
    return this.analysis.dimensions.some((e12) => "length" === e12.type) ? null != this._activeSubTool ? g8.Creating : g8.Created : g8.Ready;
  }
  get updating() {
    ...
    switch (e12.type) {
      ...
      case "key-down":
        if (p6.cancel === e12.key) {
          if (null != this._activeSubTool && this._activeSubTool.removeStaged()) return void e12.stopPropagation();
          this.active || (this.selectedDimension = null);
        } else p6.delete.includes(e12.key) && this._deleteKeyHandler();
    }
  }
  onActivate() {
  ...
  _clickHandler(e12) {
    if (this.hasFocusedManipulators) return void e12.stopPropagation();
    if (null == this._activeSubTool) return;
    const t9 = this._intersectScreen(e12);
    null != t9 && (this.selectedDimension = this._activeSubTool.onClick({
      mapPoint: t9,
      pointerType: e12.pointerType
    }), e12.stopPropagation());
  }
  ...
  _pointerMoveHandler(e12) {
    ...
    const t9 = this._intersectScreen(e12);
    null != t9 && this._activeSubTool.onPointerMove({
      mapPoint: t9,
      pointerType: e12.pointerType
    });
  }
  ...
  _intersectScreen(e12) {
    ...
    return i3.getIntersectionPoint(o5) ? this.view.renderCoordsHelper.fromRenderCoords(o5, new _({
...
e3([y({
  constructOnly: true
})], S3.prototype, "view", void 0), e3([y({
  constructOnly: true
})], S3.prototype, "analysis", void 0), e3([y({
  readOnly: true
})], S3.prototype, "state", null), e3([y({
  readOnly: true
})], S3.prototype, "updating", null), e3([y({
  readOnly: true
})], S3.prototype, "cursor", null), e3([y({
  constructOnly: true
})], S3.prototype, "analysisViewData", void 0), e3([y()], S3.prototype, "selectedDimension", null), e3([y()], S3.prototype, "automaticManipulatorSelection", void 0), e3([y()], S3.prototype, "_activeSubTool", void 0), e3([y()], S3.prototype, "_lengthDimensionSubTool", void 0), S3 = e3([a("esri.views.3d.analysis.Dimension.DimensionTool")], S3);
...
var n6 = class extends a3 {
  ...
  setGeometryFromSegment(t9, r8) {
    ...
    this.transform = q2(h8, i3), this._normal = r8;
    const {
      points: a7
    } = t9.createRenderGeometry(i3, this.view.renderCoordsHelper);
    this.geometry = [a7];
  }
  get renderOccluded() {
  ...
  set renderOccluded(e12) {
    this._renderOccluded = e12, null != this._material && this._material.setParameters({
      renderOccluded: e12
    });
  }
  get geometry() {
  ...
  set width(e12) {
    this._width = e12, null != this._material && this._material.setParameters({
      width: e12
    });
  }
  get color() {
  ...
  set color(e12) {
    this._color = t4(e12), null != this._material && this._material.setParameters({
      color: this._color
    });
  }
  get placement() {
  ...
  set placement(e12) {
    this._placement = e12, null != this._material && this._material.setParameters({
  ...
  set markerPrimitive(e12) {
    this._markerPrimitive = e12, null != this._material && this._material.setParameters({
      markerPrimitive: e12
    });
  }
  createExternalResources() {
    this._hasExternalMaterial || (this._material = new O3({
      width: this._width,
      color: this._color,
      placement: this._placement,
...
var b5 = class {
  set visible(e12) {
    for (const t9 of this._visualElements.values()) t9.attached = e12;
  }
  constructor(s6) {
    ...
    const d5 = s6.visible, c5 = {
      ...
      fontSize: h9,
      textColor: u7,
      textBackgroundColor: b7
    } = i3.style;
    this._visualElements = new E3({
      marker: new n6(c5, s6.markerMaterial),
      dimension: new f4(c5, s6.dimensionLineMaterial),
      startOffset: new f4(c5, s6.offsetLineMaterial),
      endOffset: new f4(c5, s6.offsetLineMaterial),
      dimensionSmall: new f4(c5, s6.smallDimensionLineMaterial),
      startOffsetSmall: new f4(c5, s6.smallOffsetLineMaterial),
      endOffsetSmall: new f4(c5, s6.smallOffsetLineMaterial),
      label: new f6({
        view: m5,
        attached: d5,
        distance: 0,
        ...
        fontSize: u2(h9),
        textColor: u7.clone(),
        backgroundColor: b7.clone(),
        isDecoration: f9
      })
    }), this._handles.add([d2(() => o5.geometry, (e12) => {
      ...
      equals: j
    })), d2(() => o5.length, (e12) => this._updateLabelContent(e12), P)]);
  }
  destroy() {
    this.destroyed = true, this._handles = u(this._handles);
    for (const e12 of this._visualElements.values()) e12.destroy();
  }
  get testInfo() {
  }
  _updateLines(e12) {
    const t9 = U(y2, b3.Start, e12.directSegment, e12.dimensionSegment), s6 = U(_5, b3.End, e12.directSegment, e12.dimensionSegment), i3 = this._visualElements;
  ...
  updateCameraDependentElements(e12, t9, s6) {
    ...
    if (null == t9) {
      for (const e13 of i3.values()) e13.visible = false;
      return;
    }
    const n7 = e12.computeScreenPixelSizeAt(t9.dimensionSegment.eval(0.5, w5)), l8 = X2(t9, n7), o5 = l8 < (u2(s6.lineSize) * k2) ** 2, m5 = !o5;
    ...
    const r8 = u2(s6.fontSize) * U2, {
      label: u7
    } = i3;
    if (u7.visible = l8 >= r8 ** 2, !u7.visible) return;
    const {
      dimensionSegment: S4,
      primaryOffsetAxis: g10
    } = t9, {
      offset: p10
    } = this.computation.dimension, v4 = (Math.sign(p10) >= 0 ? 1 : -1) * O7(s6) * n7;
    M2(this._labelSegment, S4, g10, v4), u7.updateLabelPosition();
  }
  ...
  _updateLabelContent(e12) {
    ...
    null != e12 && null != this._messages ? t9.text = g4(this._messages, e12, e12.unit) : t9.text = "";
  }
};
function O7(e12) {
  return 1.5 * u2(e12.fontSize) + x2 + u2(e12.lineSize / 2);
}
var y2 = new m();
var _5 = new m();
var w5 = n2();
...
var b6 = class extends S {
  ...
  initialize() {
    ...
    this._markerMaterial = new O3({
      width: 1,
      anchor: s3.Tip,
      color: _3,
      placement: "begin-end",
      worldSpace: true,
      hideOnShortSegments: true,
      hasTip: true,
      renderOccluded: h4.OccludeAndTransparent,
      markerPrimitive: "triangle",
      isDecoration: e12
    }), this._dimensionLineMaterial = new z2({
      width: 1,
      color: _3,
      renderOccluded: h4.OccludeAndTransparent,
      markerParameters: this._markerMaterial.parameters,
      isDecoration: e12
    }), this._offsetLineMaterial = new z2({
      width: 1,
      color: _3,
      renderOccluded: h4.OccludeAndTransparent,
      stipplePattern: h5(5),
      isDecoration: e12
    }), this._smallDimensionLineMaterial = new z2({
      width: 1,
      color: _3,
      renderOccluded: h4.OccludeAndTransparent,
      isDecoration: e12
    }), this._smallOffsetLineMaterial = new z2({
      width: 1,
      color: _3,
      renderOccluded: h4.OccludeAndTransparent,
      stipplePattern: h5(5),
    ...
    for (const i3 of this._lineMaterials()) this.view._stage.add(i3), this.addHandles(e2(() => {
      this.view._stage?.remove(i3);
    }));
    const s6 = g(() => this.analysisViewData.computations, ({
      computation: e13
    }) => this._createVisualization(e13));
    this._dimensionVisualizations = s6, this.addHandles([l2(s6), d2(() => u3.toUnitRGBA(this.analysis.style.color), (e13) => {
      for (const i3 of this._lineMaterials()) i3.setParameters({
        color: e13
      });
      ...
      for (const {
        visualization: s7
      } of this._dimensionVisualizations) s7.updateCameraDependentElements(e13, s7.computation.geometry, i3), s7.updateLabelStyle(i3);
    }), d2(() => this.visible, (e13) => {
      for (const {
        visualization: i3
      } of this._dimensionVisualizations) i3.visible = e13;
    })]), this.addHandles([f(() => this._updateMessageBundle()), p(() => !this.loadingMessages, () => {
      for (const {
        visualization: e13
      } of this._dimensionVisualizations) e13.updateUnitsMessages(this._messages);
  ...
  _updateMessageBundle() {
    return __async(this, null, function* () {
      ...
      try {
        this._messages = yield h("esri/core/t9n/Units");
      } finally {
...
function D2(e12) {
  const {
    ...
    lineSize: s6,
    textColor: t9,
    textBackgroundColor: a7
  } = e12.style;
  return {
    fontSize: i3,
    lineSize: s6,
    textBackgroundColor: a7.clone(),
    textColor: t9.clone()
  };
}
e3([y({
  constructOnly: true
})], b6.prototype, "analysisViewData", void 0), e3([y({
  constructOnly: true,
  nonNullable: true
})], b6.prototype, "view", void 0), e3([y({
  constructOnly: true
})], b6.prototype, "isDecoration", void 0), e3([y()], b6.prototype, "analysis", null), e3([y()], b6.prototype, "visible", null), e3([y()], b6.prototype, "loadingMessages", void 0), b6 = e3([a("esri.views.3d.analysis.Dimension.DimensionVisualization")], b6);
...
e3([y({
  constructOnly: true,
  nonNullable: true
})], t8.prototype, "dimension", void 0), e3([y()], t8.prototype, "length", void 0), t8 = e3([a("esri.views.analysis.LengthDimensionResult")], t8);
var c4 = t8;
...
e3([y({
  constructOnly: true,
  nonNullable: true
})], l7.prototype, "result", void 0), e3([y({
  constructOnly: true,
  nonNullable: true
})], l7.prototype, "projectAndAlignPoint", void 0), e3([y()], l7.prototype, "dimension", null), e3([y()], l7.prototype, "length", null), e3([y()], l7.prototype, "geometry", void 0), e3([y()], l7.prototype, "unconstrainedGeometry", void 0), e3([y()], l7.prototype, "elevationAlignedStartPoint", void 0), e3([y()], l7.prototype, "elevationAlignedEndPoint", void 0), e3([y()], l7.prototype, "preConstraintProperties", void 0), e3([y()], l7.prototype, "previousConstraint", void 0), l7 = e3([a("esri.views.3d.analysis.Dimension.LengthDimensionComputation")], l7);
...
var r7 = (r8) => {
  ...
  return e3([y({
    constructOnly: true
  })], i3.prototype, "view", void 0), e3([y({
    constructOnly: true,
    nonNullable: true
  })], i3.prototype, "analysis", void 0), e3([y()], i3.prototype, "tool", void 0), e3([y({
    readOnly: true
  })], i3.prototype, "results", null), e3([y()], i3.prototype, "selectedDimension", void 0), e3([y()], i3.prototype, "interactive", void 0), e3([y()], i3.prototype, "visible", void 0), i3 = e3([a("esri.views.analysis.DimensionAnalysisView")], i3), i3;
};

// ../../../node_modules/@arcgis/core/views/3d/analysis/DimensionAnalysisView3D.js
var g9 = class extends r7(s4(S)) {
  constructor(i3) {
  ...
  initialize() {
    this._projectAndAlignPoint = (i4) => {
      ...
      const {
        spatialReference: s6,
        elevationProvider: t9
      } = this.view, e12 = r6(i4, s6, t9);
    ...
    this.computations = i3, this.addHandles([a5(this, S3), l2(i3)]), this._analysisVisualization = new b6({
      analysisViewData: this,
      view: this.view,
      isDecoration: !this.parent
    }), this._analysisController = new g5({
      analysisViewData: this,
      view: this.view
    });
  }
  destroy() {
    this._placementTask = e(this._placementTask), this._analysisVisualization = u(this._analysisVisualization), v2(this);
  }
  get updating() {
  ...
  get selectedComputation() {
    const {
      selectedDimension: i3
    } = this;
    return null == i3 ? null : this._dimensionsToComputations.get(i3);
  }
  get testInfo() {
  }
  createLengthDimensions(i3) {
    return __async(this, null, function* () {
      return this.selectedDimension = null, this._placementTask = e(this._placementTask), this._placementTask = l5(this, i3), this._placementTask.promise;
    });
  }
  _createComputation(i3) {
    const {
      _dimensionsToComputations: s6
    } = this, t9 = new l7({
      dimension: i3,
    ...
    return s6.set(i3, t9), {
      computation: t9,
      remove: () => this._removeComputation(t9)
    };
  }
...
e3([y({
  readOnly: true
})], g9.prototype, "type", void 0), e3([y()], g9.prototype, "tool", void 0), e3([y()], g9.prototype, "updating", null), e3([y({
  readOnly: true
})], g9.prototype, "results", null), e3([y()], g9.prototype, "computations", void 0), e3([y()], g9.prototype, "selectedDimension", void 0), e3([y()], g9.prototype, "selectedComputation", null), e3([y()], g9.prototype, "_analysisVisualization", void 0), e3([y()], g9.prototype, "_analysisController", void 0), e3([y()], g9.prototype, "_dimensionsToComputations", void 0), e3([y()], g9.prototype, "_placementTask", void 0), g9 = e3([a("esri.views.3d.analysis.DimensionAnalysisView3D")], g9);
var v3 = g9;
export {
  v3 as default
};
//# sourceMappingURL=DimensionAnalysisView3D-UCHIFQTQ.js.map
