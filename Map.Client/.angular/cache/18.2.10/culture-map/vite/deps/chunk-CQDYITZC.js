...
function f(...e3) {
  ...
  for (let t3 = 0; t3 < e3.length; t3++) {
    const r2 = e3[t3], i = typeof r2;
    if ("string" === i) n2.push(r2);
    else if (Array.isArray(r2)) n2.push.apply(n2, r2);
    else if ("object" === i) for (const e4 in r2) r2[e4] && n2.push(e4);
  }
  const r = n2.join(" ");
  return t.release(n2), r;
}
var m = (() => {
  const e3 = /* @__PURE__ */ new Map(), t3 = new ResizeObserver((t4) => {
    t2();
    for (const n2 of t4) e3.get(n2.target)?.(n2);
  }), a = (n2, i, o3) => (e3.set(n2, i), t3.observe(n2, o3), e(() => {
    t3.unobserve(n2), e3.delete(n2);
  }));
  return (e4, t4, s) => {
    let c2 = null;
    return o([d(() => "function" == typeof e4 ? e4() : e4, (e5) => {
      c2?.remove(), e5 && (c2 = a(e5, t4, s));
    }, A), e(() => c2?.remove())]);
  };
})();
function g(e3) {
  const t3 = e3?.closest("[dir]");
  return null !== t3 && t3 instanceof HTMLElement && "rtl" === t3.dir || "rtl" === document.dir;
}
function v(e3) {
  const t3 = "data-node-ref";
  this[e3.getAttribute(t3)] = null;
}
function b(e3) {
  const t3 = "data-node-ref";
  this[e3.getAttribute(t3)] = e3;
}
var w = ["dd", "dl", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "sub", "sup", ...["animate", "animatetransform", "circle", "clippath", "defs", "ellipse", "g", "image", "line", "lineargradient", "marker", "mask", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "svg", "switch", "symbol", "text", "textpath", "tspan", "use"]];
var y = w.reduce((e3, t3) => (e3[t3] = [], e3), {});
var E = ["align", "alink", "alt", "bgcolor", "border", "cellpadding", "cellspacing", "class", "color", "cols", "colspan", "coords", "d", "dir", "face", "height", "hspace", "ismap", "lang", "marginheight", "marginwidth", "multiple", "nohref", "noresize", "noshade", "nowrap", "ref", "rel", "rev", "rows", "rowspan", "scrolling", "shape", "span", "summary", "tabindex", "title", "usemap", "valign", "value", "vlink", "vspace", "width"];
var j = new Sanitizer({
  whiteList: y,
  onTagAttr: (e3, t3, n2) => {
    const r = `${t3}="${n2}"`;
    if (E.includes(t3)) return r;
  },
  stripIgnoreTag: true,
  stripIgnoreTagBody: ["script", "style"]
}, true);
function A2(e3, t3) {
  const n2 = e3.getBoundingClientRect(), r = t3.getBoundingClientRect(), i = n2.top + n2.height, o3 = r.top + r.height, s = n2.top, a = r.top;
  (i > o3 || s < a) && e3.scrollIntoView({
    block: "end"
  });
}
function k(e3) {
...
function T(e3) {
  return Object.values(e3).includes(true);
}
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-CQDYITZC.js.map
