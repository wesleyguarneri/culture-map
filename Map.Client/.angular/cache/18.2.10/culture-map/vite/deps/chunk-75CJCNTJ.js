...
var g2 = class extends Ae {
  constructor(e2, t, s) {
    super(s), Object.defineProperty(this, "component", {
      ...
      writable: true,
      value: void 0
    }), this.dataContext = t, this.component = e2, this._settings.visible = true, this._checkDirty();
  }
  markDirty() {
...
var _ = class extends si {
  ...
  _afterNew() {
    super._afterNew(), this._data.incrementRef(), this._updateFields(), this._disposers.push(this.data.events.onAll((e2) => {
      ...
      if (this.markDirtyValues(), this._markDirtyGroup(), this._dataChanged = true, "clear" === e2.type) w(t, (e3) => {
        e3.dispose();
  ...
  _updateFields() {
    this.valueFields && (this._valueFields = [], this._valueFieldsF = {}, w(this.valueFields, (e2) => {
      this.get(e2 + "Field") && (this._valueFields.push(e2), this._valueFieldsF[e2] = {
        fieldKey: e2 + "Field",
        workingKey: e2 + "Working"
      });
...
Object.defineProperty(_, "className", {
  ...
  configurable: true,
  writable: true,
  value: si.classNames.concat([_.className])
});
var y2 = {
  millisecond: 1,
  second: 1e3,
...
var D = class extends _ {
  ...
  _calculateAggregates(e2, t) {
    ...
    w(s, (e3) => {
      ...
      if (t < this.dataItems.length - 1) {
        ...
        if (e3) {
          let t2 = e3.get(s2);
          e3.setRaw(p, t2 - c[_2]), e3.setRaw(f, (t2 - c[_2]) / c[_2] * 100), e3.setRaw(b2, t2 - h[_2]), e3.setRaw(g3, (t2 - h[_2]) / h[_2] * 100);
        }
      }
      e2 > 0 && e2--, delete c[s2];
      for (let t2 = e2; t2 < y3; t2++) {
        ...
        if (e3) {
          let t3 = e3.get(s2);
          null == c[s2] && (c[s2] = t3), null != t3 && (e3.setRaw(p, t3 - c[_2]), e3.setRaw(f, (t3 - c[_2]) / c[_2] * 100), e3.setRaw(b2, t3 - h[_2]), e3.setRaw(g3, (t3 - h[_2]) / h[_2] * 100), c[s2] = t3);
        }
      }
    }), w(s, (e3) => {
    ...
    if (this._valuesDirty && e2 && e2.length > 0 && w(e2, (e3) => {
      ...
      w(e3.target._entities, (i) => {
        ...
        if (e3.customFunction) e3.customFunction.call(this, i, t, s, a);
          ...
          let l, n2;
          l = e3.logarithmic ? (Math.log(a) * Math.LOG10E - Math.log(t) * Math.LOG10E) / (Math.log(s) * Math.LOG10E - Math.log(t) * Math.LOG10E) : (a - t) / (s - t), !g(a) || g(l) && Math.abs(l) != 1 / 0 || (l = 0.5), g(e3.min) ? n2 = e3.min + (e3.max - e3.min) * l : e3.min instanceof Gt ? n2 = Gt.interpolate(l, e3.min, e3.max) : e3.min instanceof e && (n2 = Jt(l, e3.min, e3.max)), i.set(e3.key, n2);
          const o = i.states;
          if (o) {
  ...
  _positionBullets(e2) {
    e2.bullets && w(e2.bullets, (e3) => {
      ...
      e3.get("dynamic") && (t && (t._markDirtyKey("fill"), t.markDirtySize()), t instanceof si && t.walkChildren((e4) => {
        e4._markDirtyKey("fill"), e4.markDirtySize(), e4 instanceof ai && e4.text.markDirtyText();
      })), t instanceof ai && t.get("populateText") && t.text.markDirtyText();
    });
  }
  _hideBullets(e2) {
    e2.bullets && w(e2.bullets, (e3) => {
  ...
  _sequencedShowHide(t, s) {
    return n(this, void 0, void 0, function* () {
      if (this.get("sequencedInterpolation")) if (g(s) || (s = this.get("interpolationDuration", 0)), s > 0) {
      ...
      } else yield Promise.all(y(this.dataItems, (e2) => t ? this.showDataItem(e2, 0) : this.hideDataItem(e2, 0)));
    });
  }
...
Object.defineProperty(D, "className", {
  ...
  configurable: true,
  writable: true,
  value: _.classNames.concat([D.className])
});
...
Object.defineProperty(N2, "className", {
  enumerable: true,
  configurable: true,
  writable: true,
  value: "Chart"
}), Object.defineProperty(N2, "classNames", {
  enumerable: true,
  configurable: true,
  writable: true,
  value: si.classNames.concat([N2.className])
});
...
Object.defineProperty(R, "className", {
  ...
  configurable: true,
  writable: true,
  value: N2.classNames.concat([R.className])
});
...
Object.defineProperty(U, "className", {
  ...
  configurable: true,
  writable: true,
  value: P.classNames.concat([U.className])
});
...
//# sourceMappingURL=chunk-75CJCNTJ.js.map
