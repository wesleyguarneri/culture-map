...
function r12() {
  return Promise.all([import("./webglDeps-2R44VPRP.js"), import("./mapViewDeps-3V6OODPD.js")]);
}
var a6 = () => r12().then(() => import("./TileLayerView2D-ZO5O5ZWG.js"));
var t11 = () => r12().then(() => import("./FeatureLayerView2D-TWBKQSUZ.js"));
var i7 = {
  "base-dynamic": () => r12().then(() => import("./BaseDynamicLayerView2D-2GP43R4C.js")),
  "base-tile": a6,
  "bing-maps": a6,
  catalog: () => r12().then(() => import("./CatalogLayerView2D-L2S7I4LY.js")),
  "catalog-dynamic-group": () => r12().then(() => import("./CatalogDynamicGroupLayerView2D-2FNZGC4U.js")),
  "catalog-footprint": () => r12().then(() => import("./CatalogFootprintLayerView2D-RXPKNH3Z.js")),
  csv: t11,
  "geo-rss": () => r12().then(() => import("./GeoRSSLayerView2D-TXSQMAIB.js")),
  feature: t11,
  geojson: t11,
  graphics: () => r12().then(() => import("./GraphicsLayerView2D-KEMZVRU3.js")),
  group: () => r12().then(() => import("./GroupLayerView2D-SLKJIOLE.js")),
  imagery: () => r12().then(() => import("./ImageryLayerView2D-H6P7K6JL.js")),
  "imagery-tile": () => r12().then(() => import("./ImageryTileLayerView2D-UWJ65L34.js")),
  kml: () => r12().then(() => import("./KMLLayerView2D-JE6I3OMP.js")),
  "knowledge-graph": () => r12().then(() => import("./KnowledgeGraphLayerView2D-HBNIQBWP.js")),
  "link-chart": () => r12().then(() => import("./KnowledgeGraphLayerView2D-HBNIQBWP.js")),
  "knowledge-graph-sublayer": t11,
  "map-image": () => r12().then(() => import("./MapImageLayerView2D-E6LDZIE6.js")),
  "map-notes": () => r12().then(() => import("./MapNotesLayerView2D-6DIP464R.js")),
  media: () => r12().then(() => import("./MediaLayerView2D-RGO3UCSQ.js")),
  "ogc-feature": () => r12().then(() => import("./OGCFeatureLayerView2D-HPUUJFM6.js")),
  "open-street-map": a6,
  "oriented-imagery": t11,
  route: () => r12().then(() => import("./RouteLayerView2D-6VPASO7V.js")),
  stream: () => r12().then(() => import("./StreamLayerView2D-ANB4UZVG.js")),
  "subtype-group": () => r12().then(() => import("./SubtypeGroupLayerView2D-UEEXYCP6.js")),
  tile: a6,
  "vector-tile": () => r12().then(() => import("./VectorTileLayerView2D-EX45EJXB.js")),
  video: () => r12().then(() => import("./VideoLayerView2D-FLPFBNJS.js")),
  wcs: () => r12().then(() => import("./ImageryTileLayerView2D-UWJ65L34.js")),
  "web-tile": a6,
  wfs: t11,
  wms: () => r12().then(() => import("./WMSLayerView2D-UU6DU4AA.js")),
  wmts: () => r12().then(() => import("./WMTSLayerView2D-YETCZDA5.js")),
  "line-of-sight": null,
  "base-elevation": null,
  "building-scene": null,
  dimension: null,
...
function K2() {
  return __async(this, null, function* () {
    const [, {
      ...
      MagnifierView2D: s16,
      Stage: a13
    }] = yield Promise.all([import("./webglDeps-2R44VPRP.js"), import("./mapViewDeps-3V6OODPD.js")]);
...
//# sourceMappingURL=chunk-JALG5M2J.js.map
