...
function c5(e7, n7, r2) {
  return __async(this, null, function* () {
    const {
      ...
      loadGLTFMesh: i5
    } = yield h(import("./loadGLTFMesh-AYPLBJCZ.js"), r2), a7 = yield f3(o4, r2);
    s2(r2);
    const c7 = i5(new _({
      x: 0,
      y: 0,
...
var X3 = H2 = class extends m.LoadableMixin(n2(n3)) {
  ...
  toBinaryGLTF(e7) {
    return __async(this, null, function* () {
      const [{
        toBinaryGLTF: t4
      }] = yield Promise.all([import("./gltfexport-UBW3SCB5.js"), this.load(e7)]);
  ...
  static createFromGLTF(e7, t4, r2) {
    return __async(this, null, function* () {
      ...
      const {
        loadGLTFMesh: o4
      } = yield h(import("./loadGLTFMesh-AYPLBJCZ.js"), r2);
...
//# sourceMappingURL=chunk-EUVN3KSV.js.map
