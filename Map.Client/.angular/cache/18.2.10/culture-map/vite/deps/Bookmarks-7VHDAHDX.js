...
var w2 = class extends s3(B) {
  ...
  loadDependencies() {
    return r({
      ...
      "chip-group": () => import("./calcite-chip-group-QN5YPGYX.js"),
      chip: () => import("./calcite-chip-2PD2DVVA.js"),
      fab: () => import("./calcite-fab-VZTSBDHO.js"),
      ...
      table: () => import("./calcite-table-YLRMJQXI.js"),
      "table-cell": () => import("./calcite-table-cell-U2MYPLO7.js"),
      "table-header": () => import("./calcite-table-header-RHVGXSUH.js"),
      "table-row": () => import("./calcite-table-row-2OMSX6WH.js")
    });
  }
  get defaultCreateOptions() {
...
//# sourceMappingURL=Bookmarks-7VHDAHDX.js.map
