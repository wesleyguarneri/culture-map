...
function e2() {
  return n3 || (n3 = new Promise((t) => import("./i3s-BOUBALHG.js").then((t2) => t2.i).then(({
    default: e3
  }) => {
    const n4 = e3({
      locateFile: i2,
...
function d(e3) {
  return __async(this, null, function* () {
    ...
    }] = yield Promise.all([import("./projectBuffer-E6G6C6FZ.js"), import("./projection-YNP6SETI.js")]);
    yield p2(l3, u2);
    const d2 = [0, 0, 0];
    ...
    if ("georeferenced" === f3.type && null == f3.origin) {
      ...
      const e4 = "georeferenced" === f3.type ? i.fromJSON(f3) : a.fromJSON(f3), {
        project: r2
      } = yield import("./projection-HELGP6D4.js"), i4 = r2({
        positions: a2,
        transform: s ? {
          localMatrix: s
        } : void 0,
...
//# sourceMappingURL=chunk-VERD3NGR.js.map
