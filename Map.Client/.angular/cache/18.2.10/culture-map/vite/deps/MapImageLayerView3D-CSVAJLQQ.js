...
var p = class extends i(N) {
  constructor() {
    super(...arguments), this.type = "map-image-3d";
  }
  initialize() {
    this._updatingHandles.add(() => this.exportImageVersion, () => this._updatingHandles.addPromise(this.refreshDebounced())), this._popupHighlightHelper = new _({
...
p = e([a("esri.views.3d.layers.MapImageLayerView3D")], p);
var a2 = p;
export {
  a2 as default
};
//# sourceMappingURL=MapImageLayerView3D-CSVAJLQQ.js.map
