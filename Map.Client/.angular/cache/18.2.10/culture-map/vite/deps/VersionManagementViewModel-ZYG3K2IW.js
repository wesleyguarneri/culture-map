...
var w = class extends u(m) {
  ...
  createVersion(e3) {
    return __async(this, null, function* () {
      const [{
        ...
        default: r4
      }] = yield Promise.all([import("./createVersion-57ETTNGT.js"), import("./CreateVersionParameters-2FQ4KPS6.js")]), s8 = r4.from(e3);
  ...
  deleteVersion(e3) {
    return __async(this, null, function* () {
      const [{
        ...
        default: r4
      }] = yield Promise.all([import("./deleteVersion-4EQHZFZV.js"), import("./DeleteVersionParameters-TARU6I7V.js")]);
      let s8;
  ...
  getVersionInfoExtended(e3) {
    return __async(this, null, function* () {
      const {
        getVersion: t9
      } = yield import("./getVersion-25J7HRWY.js");
  ...
  getVersionInfos() {
    return __async(this, arguments, function* (e3 = {}) {
      const [{
        ...
        default: r4
      }] = yield Promise.all([import("./getVersionInfos-PQRYLZ4X.js"), import("./GetVersionInfosParameters-N2WECKQQ.js")]), s8 = r4.from(e3);
      return t9(this.url, s8);
    });
  }
  reconcile(_0) {
    return __async(this, arguments, function* (e3, t9 = {}) {
      const [{
        ...
        default: s8
      }] = yield Promise.all([import("./reconcile-DTGLCI6B.js"), import("./ReconcileParameters-BEOWHFGJ.js")]), i4 = s8.from(t9);
  ...
  post(e3) {
    return __async(this, null, function* () {
      const [{
        ...
        default: r4
      }] = yield Promise.all([import("./post-NGWI3S6F.js"), import("./PostParameters-2EYL3NOM.js")]), s8 = r4.from({
        sessionId: t2
      });
  ...
  alterVersion(e3, t9) {
    return __async(this, null, function* () {
      const [{
        ...
        default: s8
      }] = yield Promise.all([import("./alterVersion-CA4H35IS.js"), import("./AlterVersionParameters-LERFFGP3.js")]), i4 = s8.from(t9);
  ...
  startReadingWithResult(e3) {
    return __async(this, null, function* () {
      const {
        startReading: t9
      } = yield import("./startReading-EJFPULKY.js"), r4 = yield t9(this.url, e3.guid, t2);
      if (r4.success) {
  ...
  stopReadingWithResult(e3) {
    return __async(this, null, function* () {
      const {
        stopReading: t9
      } = yield import("./stopReading-O4JAOBYO.js"), r4 = yield t9(this.url, e3.guid, t2);
  ...
  startEditingWithResult(e3) {
    return __async(this, null, function* () {
      const {
        startEditing: t9
      } = yield import("./startEditing-XKV3KOEY.js"), r4 = yield t9(this.url, e3.guid, t2);
      if (r4.success) {
  ...
  stopEditingWithResult(e3, t9) {
    return __async(this, null, function* () {
      if (t9) {
        ...
        if (t10?.stack?.canRedo()) {
          const [{
            ...
            default: s9
          }] = yield Promise.all([import("./deleteForwardEdits-Y3ZOVLSK.js"), import("./DeleteForwardEditsParameters-C4OZBO6U.js")]), i4 = yield r5(this.url, e3.guid, new s9({
            sessionId: t2,
            moment: t10.moment
          }));
      ...
      const {
        stopEditing: r4
      } = yield import("./stopEditing-BU655OQS.js"), s8 = yield r4(this.url, e3.guid, t2, t9);
      if (s8.success) {
...
//# sourceMappingURL=VersionManagementViewModel-ZYG3K2IW.js.map
