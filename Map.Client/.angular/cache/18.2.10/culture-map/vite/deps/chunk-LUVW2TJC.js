...
var G = class extends m {
  ...
  uploadAssets(e3, t2) {
    return __async(this, null, function* () {
      const {
        uploadAssets: r2
      } = yield import("./uploadAssets-QEN5GVC5.js");
      return r2(e3, {
        layer: this.layer,
    ...
    return __async(this, null, function* () {
      ...
      for (const i4 of t2) {
        ...
        if (a3(t3)) s4.push(e4);
          ...
          } = yield import("./convertMeshVertexSpace-67JWITLA.js"), n3 = yield r3(e4, new i({
...
//# sourceMappingURL=chunk-LUVW2TJC.js.map
