...
function n8() {
  return __async(this, null, function* () {
    const {
      Marked: a6
    } = yield import("./marked.esm-Y7R3BPA2.js"), n9 = (e14) => `<span style="text-decoration:line-through;">${e14}</span>`, l5 = (e14, t7, a7) => `<a${null != e14 ? ` href="${e14}"` : ""}${null != t7 ? ` title="${t7}"` : ""} target="_blank">${a7 ?? ""}</a>`, r6 = () => "", o4 = {};
...
var H = class extends B {
  ...
  loadDependencies() {
    return r3({
      ...
      "combobox-item-group": () => import("./calcite-combobox-item-group-CVNWWY2G.js"),
      icon: () => import("./calcite-icon-FE3MORNT.js"),
      input: () => import("./calcite-input-WHALBGAT.js"),
      "input-date-picker": () => import("./calcite-input-date-picker-DUUVK6UX.js"),
      "input-message": () => import("./calcite-input-message-AOJVWC6Z.js"),
      ...
      "text-area": () => import("./calcite-text-area-IS3LN7DA.js")
    });
  }
  destroy() {
...
//# sourceMappingURL=chunk-D3G6ZNV7.js.map
