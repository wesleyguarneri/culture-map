...
var ComboboxItem = proxyCustomElement(class ComboboxItem2 extends H {
  constructor() {
    ...
    this.filterTextMatchPattern = void 0;
    this.guid = guid();
    this.icon = void 0;
  ...
  // --------------------------------------------------------------------------
  renderIcon(iconPath) {
    return this.icon ? h("calcite-icon", {
      class: {
  ...
  render() {
    ...
    const defaultIcon = isSingleSelect ? void 0 : "check";
    const headingText = heading || textLabel;
    const iconPath = disabled ? void 0 : defaultIcon;
    ...
    return h(Host, {
      key: "484c17421421afe7739dc37cc3edb46c2fd0e083",
      "aria-hidden": "true",
      "aria-label": itemLabel
    }, h(InteractiveContainer, {
      key: "71135810fa4af5e17b668d13af219c7575085a9e",
      disabled
    }, h("div", {
      key: "2db3e68f23449032b1ac5957a9376a68815e03c5",
      class: {
        [CSS.container]: true,
      ...
      key: "153f7e8af6cb925630fb08fc5cfcf4a8df48ad2a",
      class: classes,
      id: this.guid,
      onClick: this.itemClickHandler
    }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), h("div", {
      key: "4d9bbd0bc113dc2196e3141a84f6137e7d48b95e",
      class: CSS.centerContent
    }, h("div", {
      key: "d531d42c8af37b9fbdbda7457e88f4688427911b",
      class: CSS.title
    }, this.renderTextContent(headingText)), this.description ? h("div", {
      class: CSS.description
    }, this.renderTextContent(this.description)) : null), this.shortHeading ? h("div", {
      class: CSS.shortText
    }, this.renderTextContent(this.shortHeading)) : null, h("slot", {
      key: "f4c71258fff023a30662c7105e1a7492edafa14a",
  ...
  static get style() {
    return CalciteComboboxItemStyle0;
  }
...
@esri/calcite-components/dist/components/combobox-item.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TXGX3G6I.js.map
