...
function m(a, e2, m2) {
  ...
  return [{
    ...
    path: [{
      ...
      command: "L",
      values: [m2 ? o2 : 0.875 * o2, n2]
    }, {
      command: "L",
      values: [m2 ? p2 - 0.5 * o2 : l2, L2 - 0.5 * s2]
    }, {
      command: "L",
      values: [p2 - 0.5 * o2, L2 - 0.5 * s2]
    }, {
      command: "Z",
      values: []
    }]
    ...
    path: [{
      ...
      command: "L",
      values: [o2, e2 ? n2 : 0.125 * s2]
    }, {
      command: "L",
      values: [p2 - 0.5 * o2, e2 ? L2 - 0.5 * s2 : s2]
    }, {
      command: "L",
      values: [p2 - 0.5 * o2, L2 - 0.5 * s2]
    }, {
    ...
    path: [{
      ...
      command: "L",
      values: [m2 ? p2 - 0.5 * o2 : l2, e2 ? L2 - 0.5 * s2 : s2]
    }, {
      command: "L",
      values: [p2 - 0.5 * o2, e2 ? L2 - 0.5 * s2 : s2]
    }, {
...
function c(a) {
  ...
  return [{
    ...
    path: [{
      command: "M",
      values: [p2, 0.7 * e2 * 0.5]
    }, {
      command: "L",
      values: [0.3 * e2, 0.7 * e2]
    }, {
      command: "L",
      values: [0.3 * e2, 0.7 * e2 + m2]
    }, {
      command: "L",
      values: [p2, 0.7 * e2 + m2 - 0.7 * e2 * 0.5]
    }, {
      command: "Z",
      values: []
    }]
...
//# sourceMappingURL=chunk-GXX7GUFH.js.map
