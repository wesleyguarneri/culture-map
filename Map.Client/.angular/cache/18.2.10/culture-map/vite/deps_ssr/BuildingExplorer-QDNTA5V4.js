...
import {
  ...
  f as f2,
  i
} from "./chunk-X5CMRZBP.js";
import "./chunk-XQ74BGQA.js";
import "./chunk-5O46LCZR.js";
import "./chunk-QMJ2OQSU.js";
import "./chunk-VENH3UKS.js";
import "./chunk-AS4KZK4Y.js";
import "./chunk-N2GJ34YR.js";
...
var n5 = (e12) => (n14) => {
  ...
  return n14.sublayers.find((e13) => e13.modelName?.toLowerCase() === l8) ?? null;
};
var l = n5("fullmodel");
var t = n5(e6);
function o2(e12) {
...
function u(e12, n14) {
  ...
  if (null == t4 || !t4) return null;
  const o7 = r(e12, t4), u6 = /* @__PURE__ */ new Map();
  for (const r3 of l8.mostFrequentValues ?? []) "number" == typeof r3 && u6.set(r3, null != o7 ? o7.getName(r3) : String(r3));
  return {
    fieldName: t4,
    fieldValueMap: u6
  };
...
function r(e12, n14) {
  for (const l8 of e12.allSublayers.items) {
    const e13 = "building-component" === l8.type ? l8.getFieldDomain?.(n14) : null;
    if (e13 && "coded-value" === e13.type) return e13;
  }
  return null;
}
function s3(e12, n14) {
  const l8 = e12.summaryStatistics?.fields ?? [], t4 = n14.toLowerCase();
  return l8.find((e13) => e13.modelName?.toLowerCase() === t4) ?? null;
}
...
e([y({
  nonNullable: true
})], n6.prototype, "id", void 0), e([y()], n6.prototype, "parent", void 0), e([y({
  nonNullable: true,
  readOnly: true
})], n6.prototype, "children", void 0), e([y({
  nonNullable: true,
  readOnly: true
})], n6.prototype, "layers", void 0), e([y({
  nonNullable: true
})], n6.prototype, "level", void 0), e([y({
  nonNullable: true
})], n6.prototype, "collapsed", void 0), e([y({
  readOnly: true
})], n6.prototype, "hasChildren", null), e([y({
  readOnly: true
})], n6.prototype, "isRoot", null), e([y({
  readOnly: true
})], n6.prototype, "isLeaf", null), e([y({
  readOnly: true
})], n6.prototype, "isDiscipline", null), e([y({
  readOnly: true
})], n6.prototype, "visible", null), e([y({
  readOnly: true
})], n6.prototype, "title", null), n6 = e([a("esri.widgets.BuildingExplorer.support.LayerTreeNode")], n6);

// ../../../node_modules/@arcgis/core/widgets/BuildingExplorer/support/layerUtils.js
function a3() {
  let a9 = new AbortController();
  return (r3) => __async(this, null, function* () {
    a9.abort(), a9 = new AbortController();
    const i5 = {
      signal: a9.signal
    }, l8 = r3.toArray().map((t4) => o3(t4, i5));
    yield Promise.all(l8), s(i5);
  });
}
function o3(a9, o7) {
  return __async(this, null, function* () {
    yield a9.load(o7), yield a9.loadAll(), s(o7), a9.summaryStatistics && (yield a9.summaryStatistics.load(o7));
  });
}
...
var p = class extends S {
  ...
  _updateLayerTree() {
    this.root.destroy(), this._set("root", new n6({
      collapsed: false
    }));
  ...
  _addNodeForLayer(e12, s6, t4, r3) {
    ...
    if (null == o7 || e12.isEmpty) return;
    const i5 = `${s6.id}/${o7}`;
    let a9 = t4.get(i5);
    a9 || (a9 = new n6({
      id: o7,
      level: s6.level + 1
    }), t4.set(i5, a9)), a9.layers.push(e12), s6.children.push(a9), this._addNodesForSublayers(e12, a9, t4, r3);
  }
  ...
  _onLayersChange() {
    return __async(this, null, function* () {
      if (this._set("state", "loading"), 0 !== this.layers.length) try {
        yield this._loadLayers(this.layers), this._updateLayerTree(), this._set("state", "ready");
      } catch (e12) {
...
e([y({
  readOnly: true
})], p.prototype, "root", void 0), e([y({
  type: V,
  nonNullable: true
})], p.prototype, "layers", null), e([y({
  readOnly: true,
  nonNullable: true
})], p.prototype, "state", void 0), p = e([a("esri.widgets.BuildingExplorer.BuildingDisciplinesViewModel")], p);
var y2 = p;
...
function n7(l8) {
  let n14 = null;
  for (const e12 of l8) n14 = null != n14 ? Math.min(n14, e12) : e12;
  return n14;
}
function e7(l8) {
  let n14 = null;
  for (const e12 of l8) n14 = null != n14 ? Math.max(n14, e12) : e12;
  return n14;
}
function t2(l8, n14) {
...
function o4(l8, n14) {
  if (0 === n14.length) return l8;
  if (l8 === 1 / 0) return n14[n14.length - 1];
  if (l8 === -1 / 0) return n14[0];
...
var y3 = class extends S {
  ...
  set value(e12) {
    if ("ready" !== this.state) return void (this._valueBeforeReady = e12);
    if (e12 === this.value) return;
  ...
  set allowedValues(e12) {
    null == e12 ? this._clearOverride("allowedValues") : this._override("allowedValues", e12);
    const t4 = t2(this.value, this);
    null != t4 && (this.value = t4);
  }
  get hasNext() {
  ...
  get _valueIndex() {
    return w(this.allowedValues, this.value);
  }
  select(e12) {
    if ("ready" !== this.state) return void (this._valueBeforeReady = e12);
  ...
  next() {
    ...
    if ("ready" === e12 || null == this._valueBeforeReady) {
      if (0 !== t4.length) return l8 ? void (s6 && (this.value = t4[a9 + 1])) : (this.enabled = true, void (this.value = t4[0]));
    } else this._valueBeforeReady++;
  }
  previous() {
    const {
      state: e12,
    ...
    if ("ready" === e12 || null == this._valueBeforeReady) {
      if (0 !== t4.length) return l8 ? void (s6 && (this.value = t4[a9 - 1])) : (this.enabled = true, void (this.value = t4[t4.length - 1]));
    } else this._valueBeforeReady++;
  }
  getValueLabel(e12) {
  ...
  _onLayersChange() {
    return __async(this, null, function* () {
      if (this._set("state", "loading"), this._domainInfo = l2([]), 0 !== this.layers.length) try {
        yield this._loadLayers(this.layers), this._setup();
      } catch (e12) {
        b(e12) || this._set("state", "failed");
      }
    });
...
e([y({
  value: false,
  nonNullable: true
})], y3.prototype, "enabled", null), e([y({
  nonNullable: true
})], y3.prototype, "value", null), e([y({
  readOnly: true
})], y3.prototype, "min", null), e([y({
  readOnly: true
})], y3.prototype, "max", null), e([y()], y3.prototype, "allowedValues", null), e([y({
  readOnly: true
})], y3.prototype, "hasNext", null), e([y({
  readOnly: true
})], y3.prototype, "hasPrevious", null), e([y({
  type: V,
  nonNullable: true
})], y3.prototype, "layers", null), e([y({
  nonNullable: true
})], y3.prototype, "state", void 0), e([y()], y3.prototype, "_valueBeforeReady", void 0), e([y({
  readOnly: true
})], y3.prototype, "_valueIndex", null), e([y()], y3.prototype, "_domainInfo", void 0), y3 = e([a("esri.widgets.BuildingExplorer.BuildingNumericFilterViewModel")], y3);
var v2 = y3;
...
function f3(t4, n14) {
  for (const r3 of t4.items) for (const t5 of r3.filters.items) {
    if (!l3(t5)) continue;
    const r4 = n14(t5);
...
function u2(t4, n14) {
  const r3 = n14.length;
  if (null == t4 || t4.length !== r3) return false;
  for (let i5 = 0; i5 < r3; ++i5) {
    const r4 = n14.at(i5).toJSON(), o7 = t4.at(i5).toJSON();
    if (r4.id = "", o7.id = "", JSON.stringify(r4) !== JSON.stringify(o7)) return false;
  }
  return true;
}
function c3(t4) {
...
var n8 = class extends v2 {
  constructor() {
    super(...arguments), this._levelFieldName = null, this._parseValueFromFilter = (e12) => {
      ...
      for (const {
        filterMode: t4,
        filterExpression: r3
      } of e12.filterBlocks?.items ?? []) {
        if (null == r3) continue;
        let e13 = null;
        if ("solid" === t4.type ? e13 = l8.exec(r3) : "x-ray" === t4.type && (e13 = s6.exec(r3)), e13) return parseInt(e13[1], 10);
      }
      return null;
    };
  }
  get filterExpressions() {
    return this.enabled && this._levelFieldName ? {
  ...
  _setup() {
    ...
    const s6 = l8 ?? f3(this.layers, this._parseValueFromFilter);
    null != s6 ? this.select(s6) : (this.enabled = false, this.value = this._firstValue);
  }
};
e([y({
  readOnly: true
})], n8.prototype, "filterExpressions", null), e([y()], n8.prototype, "_levelFieldName", void 0), e([y({
  readOnly: true
})], n8.prototype, "_firstValue", null), n8 = e([a("esri.widgets.BuildingExplorer.BuildingLevel")], n8);
var u3 = n8;

// ../../../node_modules/@arcgis/core/widgets/BuildingExplorer/BuildingPhase.js
var a5 = "demolishedphase";
var d3 = "createdphase";
var n9 = class extends v2 {
  constructor() {
    super(...arguments), this._createdPhaseFieldName = null, this._demolishedPhaseFieldName = null, this._parseValueFromFilter = (e12) => {
      ...
      for (const {
        ...
        if (e13) return parseInt(e13[1], 10);
      }
      return null;
    };
  }
  ...
  _setup() {
    ...
    if (this._set("state", "ready"), this._valueBeforeReady = null, this.allowedValues.length > 0) {
      const e13 = s6 ?? f3(this.layers, this._parseValueFromFilter);
...
e([y({
  readOnly: true
})], n9.prototype, "filterExpressions", null), e([y()], n9.prototype, "_createdPhaseFieldName", void 0), e([y()], n9.prototype, "_demolishedPhaseFieldName", void 0), e([y({
  readOnly: true
})], n9.prototype, "_lastValue", null), n9 = e([a("esri.widgets.BuildingExplorer.BuildingPhase")], n9);
var h = n9;
...
var w3 = class extends S {
  ...
  initialize() {
    this.addHandles([this.layers.on("change", () => this._onLayersChange()), d(() => ({
      state: this.state,
      layers: this.layers,
      filter: this._filter
    }), ({
  ...
  get _filter() {
    ...
    return null != r3 && t4.push(r3), 0 === t4.length ? null : new f2({
      id: e8(),
  ...
  _onLayersChange() {
    return __async(this, null, function* () {
      ...
      if (this.level.layers = e12, this.phase.layers = e12, this.disciplines.layers = e12, 0 !== e12.length) {
        ...
        try {
          yield this._loadLayers(e12), yield Promise.all([w2(() => "ready" === this.level.state), w2(() => "ready" === this.phase.state), w2(() => "ready" === this.disciplines.state)]), e12.forEach(o2), this._set("state", "ready");
        } catch (s6) {
...
e([y({
  value: null
})], w3.prototype, "view", void 0), e([y()], w3.prototype, "isSupported", null), e([y({
  type: V,
  nonNullable: true
})], w3.prototype, "layers", null), e([y({
  readOnly: true
})], w3.prototype, "state", void 0), e([y({
  readOnly: true,
  type: u3
})], w3.prototype, "level", void 0), e([y({
  readOnly: true,
  type: h
})], w3.prototype, "phase", void 0), e([y({
  readOnly: true,
  type: y2
})], w3.prototype, "disciplines", void 0), e([y()], w3.prototype, "_filter", null), w3 = e([a("esri.widgets.BuildingExplorer.BuildingExplorerViewModel")], w3);
var L = w3;
...
var n10 = {
  base: e9,
  panelError: `${e9}__panel--error`,
  loadingContainer: `${e9}__loading-container`,
  content: `${e9}__content`,
  section: `${e9}__section`,
  levels: `${e9}__levels`,
  phases: `${e9}__phases`,
  disciplines: `${e9}__disciplines`
};
...
var p3 = "esri-building-disciplines-tree-node";
var b3 = {
  base: p3,
  root: `${p3}--root`,
  leaf: `${p3}--leaf`,
  label: `${p3}__label`,
  checkbox: `${p3}__checkbox`,
  checkboxChecked: `${p3}__checkbox--checked`,
  checkboxIndeterminate: `${p3}__checkbox--indeterminate`,
  collapseToggle: `${p3}__collapse-toggle`,
  collapseToggleCollapsed: `${p3}__collapse-toggle--collapsed`,
  children: `${p3}__children`,
  level: (e12) => `${p3}--level-${e12}`
};
var u4 = h2 = class extends B {
  constructor(e12) {
    super(e12), this.messages = g2, this.toggleSiblingsVisibility = false, this._childWidgets = [], this._updateChildWidgets = () => {
      this._destroyChildWidgets(), this._childWidgets = this.node.children.toArray().reverse().map((e13) => new h2({
        node: e13,
  ...
  initialize() {
    this.addHandles([v(() => this.node.children, "after-changes", this._updateChildWidgets, {
      onListenerAdd: this._updateChildWidgets,
      onListenerRemove: this._updateChildWidgets
    }), d(() => [this.messages, this.toggleSiblingsVisibility], this._updateChildWidgets, P)]);
  }
  destroy() {
  ...
  render() {
    ...
    return e12.isDiscipline && i5 ? n3("div", {
      key: `${e12.id}-empty`
    }) : n3("div", {
      "aria-expanded": e12.collapsed ? "false" : "true",
      bind: this,
      class: this.classes(b3.base, b3.level(e12.level), {
        [b3.root]: s6,
        [b3.leaf]: i5
      }),
      key: e12.id,
      ...
      role: "treeitem",
      tabIndex: i5 ? void 0 : 0
    }, n3("label", {
      bind: this,
      class: b3.label,
      onclick: this._onCheckboxToggle
    }, this._renderCollapseToggle(), this._renderCheckbox(), n3("span", null, e12.title)), this._renderChildren(e12));
  }
  _renderCheckbox() {
    const e12 = this.node.visible, s6 = true === e12, i5 = null === e12, t4 = s6 ? this.messages?.hideSublayer : this.messages?.showSublayer;
    return n3("button", {
      "aria-checked": s6 ? "true" : "false",
      "aria-label": t4,
      bind: this,
      class: this.classes(b3.checkbox, {
        [b3.checkboxChecked]: s6,
        [i2.checkMark]: s6,
        [b3.checkboxIndeterminate]: i5,
        [i2.minus]: i5
      }),
      onclick: this._onCheckboxToggle,
      role: "checkbox",
  ...
  _renderCollapseToggle() {
    if (!this.node.hasChildren) return null;
    const e12 = this.node.collapsed, s6 = e12 ? this.messages?.expand : this.messages?.collapse;
    return n3("div", {
      "aria-label": s6,
      bind: this,
      class: this.classes(b3.collapseToggle, i2.right, {
        [b3.collapseToggleCollapsed]: e12
      }),
  ...
  _renderChildren(e12) {
    return !e12.hasChildren || e12.collapsed ? null : n3("div", {
      class: b3.children
    }, this._childWidgets.map((e13) => e13.render()));
  }
  _onKeydown(e12) {
    switch (e12.key) {
      case "Space":
      case "Enter":
        if (!e12.target.classList.contains(b3.base)) return;
        e12.stopPropagation(), this.node.toggleVisibility();
        break;
      case "ArrowLeft":
        e12.stopPropagation(), this.node.toggleCollapsed(!g(this.container));
        break;
      case "ArrowRight":
        e12.stopPropagation(), this.node.toggleCollapsed(g(this.container));
    }
...
e([y({
  type: n6
})], u4.prototype, "node", void 0), e([y()], u4.prototype, "messages", void 0), e([y({
  nonNullable: true
})], u4.prototype, "toggleSiblingsVisibility", void 0), e([y()], u4.prototype, "_childWidgets", void 0), u4 = h2 = e([a("esri.widgets.BuildingExplorer.BuildingDisciplinesTree.BuildingDisciplinesNode")], u4);
var _ = u4;
...
var a6 = class extends B {
  ...
  render() {
    const {
      vm: s6
    } = this, i5 = this.toggleSiblingsVisibility, e12 = this.messages ?? l4;
    return n3("div", {
      class: p4.base,
      role: "tree"
    }, s6.root.children.toArray().reverse().map((s7) => n3(_, {
      messages: e12,
      node: s7,
      toggleSiblingsVisibility: i5
    })));
  }
};
...
var v3 = 100;
var h3 = 40;
var c5 = Object.freeze(Object.defineProperty({
  __proto__: null,
  alphaLevelDependencyFactor: l5,
  alphaSpreadFactor: t3,
  levelHeightDefault: i3,
  levelHoveredExtraHeight: e10,
  levelHoveredExtraWidth: a7,
  levelWidthConstant: h3,
  levelWidthMax: n11,
  levelWidthMin: d4,
  levelWidthNominator: v3,
  levelsMarginFactor: o6,
  levelsPadding: s5,
  levelsPointerAdjustment: r2
}, Symbol.toStringTag, {
  value: "Module"
}));
...
var n12 = {
  container: e11,
  noLevel: `${e11}--no-level`,
  animateLevel: `${e11}--animate-level`,
  levelsContainer: `${e11}__levels-container`,
  innerLevelsContainer: `${e11}__inner-levels-container`,
  labelContainer: `${e11}__label-container`,
  arrowUp: `${e11}__arrow-up`,
  arrowDown: `${e11}__arrow-down`
};
...
var p5 = class extends B {
  ...
  render() {
    ...
    if (null == this.level) return n3("div", {
      class: c6.empty,
      title: e12.selectLevel
    }, e12.selectLevel);
    const t4 = e12.clearLevel;
    return n3("div", {
      "aria-label": t4,
      bind: this,
      class: this.classes(c6.base, {
        [c6.active]: this.active,
        [c6.hover]: this.hovering
      }),
      onclick: this.onClear,
      title: t4
    }, n3("span", null, this.level), n3("button", {
      bind: this,
      class: this.classes(c6.clearButton, i2.close),
...
e([y()], p5.prototype, "level", void 0), e([y({
  nonNullable: true
})], p5.prototype, "active", void 0), e([y({
  nonNullable: true
})], p5.prototype, "hovering", void 0), e([y()], p5.prototype, "messages", void 0), e([y({
  nonNullable: true
})], p5.prototype, "onClear", void 0), p5 = e([a("esri.widgets.BuildingExplorer.BuildingLevelPicker.Label")], p5);
...
var h4 = class extends B {
  ...
  render() {
    return n3("div", {
      bind: this,
      class: this.classes(n13.container, {
        [n13.active]: this.active,
        [n13.hover]: this.hovering
      }),
      key: this,
      styles: {
  ...
  _renderBase() {
    ...
    return n3("div", {
      class: n13.base,
      styles: {
        width: `${Math.round(t4)}px`,
        height: `${Math.round(t4)}px`
      }
    }, n3("button", {
      afterCreate: b2,
      ...
      styles: {
        width: `${Math.round(e12)}px`,
        height: `${Math.round(e12)}px`
      },
      tabIndex: -1,
      title: this.label ?? "",
      type: "button"
...
e([y({
  nonNullable: true
})], h4.prototype, "level", void 0), e([y({
  nonNullable: true
})], h4.prototype, "active", void 0), e([y({
  nonNullable: true
})], h4.prototype, "hovering", void 0), e([y({
  nonNullable: true
})], h4.prototype, "width", void 0), e([y({
  nonNullable: true
})], h4.prototype, "height", void 0), e([y({
  nonNullable: true
})], h4.prototype, "onSelect", void 0), e([y({
  nonNullable: true
})], h4.prototype, "onFocus", void 0), e([y({
  nonNullable: true
})], h4.prototype, "onBlur", void 0), h4 = e([a("esri.widgets.BuildingExplorer.BuildingLevelPicker.LevelItem")], h4);
...
var H2 = class extends B {
  constructor(e12, t4) {
    super(e12, t4), this._levelHandlesKey = "levelHandles", this._levelEventHandlesKey = "levelEventHandles", this._levelWidgets = [], this._labelWidget = new p5({
      onClear: () => this.vm.clear()
    }), this._hoveredLevel = null, this._expandedLevelsHeight = void 0, this._normalizedPointerPosition = 0, this._hovering = false, this._containerPosTop = null, this._levelsContainer = null, this._onPointerUp = () => {
      if (window.getSelection()?.removeAllRanges(), null == this._hoveredLevel) return;
      const {
        vm: e13
      } = this;
      ...
      if (!this._hovering) return false;
      if (window.getSelection()?.removeAllRanges(), null != this._containerPosTop) {
  ...
  get _levelWidth() {
    const {
      levelWidthNominator: e12,
      levelWidthConstant: t4
    } = c5, i5 = e12 / Math.sqrt(this._numLevels) + t4;
  ...
  render() {
    ...
    return n3("div", {
      bind: this,
      class: this.classes(e4.widget, n12.container, {
        [n12.animateLevel]: !this._hovering,
        [n12.noLevel]: e12 < 2
      }),
      key: this,
      onkeydown: this._onKeyDown
    }, this._renderLabelContainer(), n3("div", {
      afterCreate: b2,
      bind: this,
      class: n12.levelsContainer,
      ...
      class: n12.innerLevelsContainer,
      styles: {
        height: `${l8}px`,
        margin: s5 - this._expandedLevelsMargin + "px 0 0 0"
      }
    }, t4)));
  }
  _renderLabelContainer() {
    ...
    return n3("div", {
      class: n12.labelContainer,
      tabIndex: 0
    }, n3("button", {
      "aria-label": s6,
      bind: this,
      class: n12.arrowUp,
      disabled: !this.vm.hasNext,
      onclick: this._onArrowUpClick,
      title: s6,
      type: "button"
    }), this._labelWidget.render(), n3("button", {
      "aria-label": t4,
      bind: this,
      class: n12.arrowDown,
      disabled: !this.vm.hasPrevious,
  ...
  _updateComponents() {
    ...
    this._levelWidgets.forEach((s7) => {
      ...
      s7.label = null != i5 ? i5 : e12.currentLevel?.replace("{{level}}", String(s7.level)), s7.active = s7.level === t4, s7.hovering = s7.level === this._hoveredLevel;
    }), this._labelWidget.level = s6, this._labelWidget.active = s6 === t4, this._labelWidget.hovering = null != this._hoveredLevel;
  }
  _createLevelWidgets() {
    this._levelWidgets.forEach((e12) => e12.destroy()), this._levelWidgets = this._levels.map((e12) => new h4({
      level: e12,
      onSelect: () => this._onLevelToggle(e12)
    })), this.removeHandles(this._levelHandlesKey), this.addHandles([d(() => {
      const {
        vm: e12
      } = this;
      return [this.messages, e12?.value, e12?.enabled, this._hoveredLevel, this._hovering];
...
e([y()], H2.prototype, "vm", void 0), e([y()], H2.prototype, "messages", void 0), e([y()], H2.prototype, "_levelWidgets", void 0), e([y()], H2.prototype, "_labelWidget", void 0), e([y()], H2.prototype, "_hoveredLevel", void 0), e([y()], H2.prototype, "_levels", null), e([y()], H2.prototype, "_numLevels", null), e([y({
  readOnly: true
})], H2.prototype, "_levelsHeight", null), e([y()], H2.prototype, "_expandedLevelsHeight", void 0), e([y({
  readOnly: true
})], H2.prototype, "_expandedLevelsMargin", null), e([y({
  readOnly: true
})], H2.prototype, "_levelWidth", null), e([y({
  readOnly: true
})], H2.prototype, "_levelHeight", null), e([y({
  readOnly: true
})], H2.prototype, "_gaussianFactor", null), e([y({
  readOnly: true
})], H2.prototype, "_levelClosestToPointer", null), e([y({
  type: Number,
  range: {
    min: 0,
    max: 1
  }
})], H2.prototype, "_normalizedPointerPosition", void 0), e([y()], H2.prototype, "_hovering", void 0), e([y()], H2.prototype, "_containerPosTop", void 0), e([y()], H2.prototype, "_levelsContainer", void 0), H2 = e([a("esri.widgets.BuildingExplorer.BuildingLevelPicker.BuildingLevelPicker")], H2);
var x = H2;
...
var u5 = {
  container: `${c7}`,
  phasesContainer: `${c7}__phases-container`,
  phase: `${c7}__phase`,
  phaseActive: `${c7}__phase--active`,
  phaseCurrent: `${c7}__phase--current`,
  divider: `${c7}__divider`,
  dividerActive: `${c7}__divider--active`,
  arrowLeft: `${c7}__arrow-left`,
  arrowRight: `${c7}__arrow-right`
};
var p6 = class extends B {
  constructor(e12, s6) {
    super(e12, s6), this._phasesContainer = null, this._shouldScrollCurrentPhaseIntoView = true, this._shouldFocusCurrentPhase = false, this._onKeyDown = (e13) => {
      ...
      if (this.destroyed || null == e13) return;
  ...
  render() {
    if (this._phases.length < 2) return n3("div", {
      key: "no-phases"
    });
    const {
      vm: e12,
    ...
    return n3("div", {
      class: this.classes(e4.widget, u5.container),
      key: this,
      onkeydown: this._onKeyDown
    }, n3("button", {
      "aria-label": r3,
      class: i5 ? u5.arrowRight : u5.arrowLeft,
      disabled: !e12.hasPrevious,
      onclick: this._onArrowLeftClick,
      title: r3,
      type: "button"
    }), n3("div", {
      afterCreate: this._onPhasesContainerAfterCreate,
      class: u5.phasesContainer
    }, this._renderPhaseButtons()), n3("button", {
      "aria-label": o7,
      class: i5 ? u5.arrowLeft : u5.arrowRight,
      disabled: !e12.hasNext,
  ...
  _renderPhaseButtons() {
    ...
    for (let r3 = 0; r3 < e12.length; ++r3) {
      const o7 = e12[r3], i5 = {
        phase: o7,
        active: null != s6 && o7 <= s6,
        current: null != s6 && o7 === s6
      };
  ...
  _renderPhaseButton({
    ...
    const {
      vm: r3
    } = this, o7 = r3.getValueLabel(e12);
    return n3("button", {
      "aria-label": o7,
      class: this.classes(u5.phase, {
        [u5.phaseActive]: s6,
        [u5.phaseCurrent]: t4
      }),
      key: `phase-${e12}`,
      onclick: () => r3.select(e12),
      title: o7,
      type: "button"
    }, e12);
  }
  _renderDivider({
    ...
    return n3("div", {
      class: this.classes(u5.divider, {
        [u5.dividerActive]: s6
      }),
      key: `phase-divider-${e12}`
    });
  }
};
e([y({
  nonNullable: true
})], p6.prototype, "vm", void 0), e([y()], p6.prototype, "messages", void 0), e([y()], p6.prototype, "_phases", null), e([y()], p6.prototype, "_currentPhase", null), e([y()], p6.prototype, "_phasesContainer", void 0), p6 = e([a("esri.widgets.BuildingExplorer.BuildingPhasePicker.BuildingPhasePicker")], p6);
var d5 = p6;
...
var y4 = class extends B {
  constructor(e12, s6) {
    super(e12, s6), this._defaultViewModel = new L(), this.viewModel = this._defaultViewModel, this.visibleElements = __spreadValues({}, v4), this.headingLevel = 3, this.messages = null, this.messagesCommon = null, this.toggleSiblingsVisibility = false;
  }
  destroy() {
  ...
  _castVisibleElements(e12) {
    return __spreadValues(__spreadValues({}, v4), e12);
  }
  get icon() {
    return "organization";
  }
  ...
  render() {
    ...
    return n3("div", {
      ...
      class: f(e4.widget, n10.base, e4.panel, {
        [e4.widgetDisabled]: s6
      }),
      key: this
    }, this._renderContent());
  }
  _renderContent() {
    ...
    if (!e12.isSupported) return n3("p", {
      class: n10.panelError
    }, s6.unsupported);
    if (!e12.layers.length) return n3("p", {
      class: n10.panelError
    }, s6.noData);
    switch (e12.state) {
      case "loading":
      ...
      case "ready":
        return n3("div", {
          class: n10.content,
          key: "content"
        }, this._renderLevelPickerSection(), this._renderPhasePickerSection(), this._renderDisciplinesSection());
      case "failed":
        return n3("p", {
          class: n10.panelError
        }, s6.failed);
  ...
  _renderLoadingIndicator() {
    ...
    return n3("div", {
      "aria-label": e12,
      class: n10.loadingContainer,
      key: "loading-container",
      role: "presentation",
      title: e12
    }, n3("span", {
      "aria-hidden": "true",
      class: f(i2.loadingIndicator, e4.rotating)
    }));
  }
  _renderLevelPickerSection() {
    const e12 = this.viewModel.level, s6 = "ready" === e12.state, i5 = e12.allowedValues.length > 1;
    if (!this.visibleElements.levels || !s6 || !i5) return null;
    const t4 = this.messages?.level;
    return n3("div", {
      class: f(n10.section, n10.levels),
      key: "levels"
    }, n3(e5, {
  ...
  _renderPhasePickerSection() {
    ...
    if (!this.visibleElements.phases || !s6 || !i5) return null;
    const t4 = this.messages.phase;
    return n3("div", {
      class: f(n10.section, n10.phases),
      key: "phases"
    }, n3(e5, {
      level: this.headingLevel
    }, t4.title), n3(d5, {
  ...
  _renderDisciplinesSection() {
    ...
    if (!this.visibleElements.disciplines || !s6 || !i5) return null;
    const t4 = this.messages?.disciplines;
    return n3("div", {
      class: f(n10.section, n10.disciplines),
      key: "disciplines"
    }, n3(e5, {
      level: this.headingLevel
    }, t4.title), n3(c4, {
...
e([y({
  type: L
})], y4.prototype, "viewModel", void 0), e([y()], y4.prototype, "view", null), e([y()], y4.prototype, "layers", null), e([y()], y4.prototype, "visibleElements", void 0), e([s2("visibleElements")], y4.prototype, "_castVisibleElements", null), e([y()], y4.prototype, "headingLevel", void 0), e([y()], y4.prototype, "icon", null), e([y()], y4.prototype, "label", null), e([y(), e2("esri/widgets/BuildingExplorer/t9n/BuildingExplorer")], y4.prototype, "messages", void 0), e([y(), e2("esri/t9n/common")], y4.prototype, "messagesCommon", void 0), e([y({
  nonNullable: true
})], y4.prototype, "toggleSiblingsVisibility", void 0), e([y()], y4.prototype, "uiStrings", void 0), y4 = e([a("esri.widgets.BuildingExplorer")], y4);
var w4 = y4;
export {
  w4 as default
};
//# sourceMappingURL=BuildingExplorer-QDNTA5V4.js.map
