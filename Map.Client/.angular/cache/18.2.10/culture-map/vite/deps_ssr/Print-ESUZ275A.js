    ...
    switch (e9) {
      ...
      case "feature-record-set-layer":
        ...
        if ("layerDefinition" in t6) {
          const e10 = new (0, (yield import("./FeatureLayer-IUH5F6QB.js")).default)(), {
            layerDefinition: a11,
            featureSet: n4
          } = t6;
          return e10.read({
...
var h = j5 = class extends f {
  ...
  fetchResultMapImageLayer() {
    return __async(this, null, function* () {
      ...
      return new (0, (yield import("./MapImageLayer-MEFIS76D.js")).default)({
        url: s10
      });
    });
  }
...
//# sourceMappingURL=Print-ESUZ275A.js.map
