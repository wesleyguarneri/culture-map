...
function s(t, r2, i2, s2) {
  if ("point" === t.type) {
    const {
      x: n,
      y: e2
    } = t, o = s2 ? s2[0] : n, a3 = s2 ? s2[1] : e2, m3 = t.clone(), l3 = (n - o) * r2 + o, x3 = (e2 - a3) * i2 + a3;
  ...
  if ("extent" === t.type) {
    const {
      ...
      ymin: o,
      ymax: a3
    } = t, m3 = s2 ? s2[0] : (n + e2) / 2, l3 = s2 ? s2[1] : (a3 + o) / 2, x3 = t.clone();
...
//# sourceMappingURL=chunk-4VYDNFW7.js.map
