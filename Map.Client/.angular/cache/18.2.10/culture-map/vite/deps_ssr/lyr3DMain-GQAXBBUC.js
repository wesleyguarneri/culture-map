...
r = a, t = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, n = function(e = {}) {
  ...
  var C = [], F = [], W = [];
  function E() {
    if (a2.preRun) for ("function" == typeof a2.preRun && (a2.preRun = [a2.preRun]); a2.preRun.length; ) j(a2.preRun.shift());
    N(C);
  }
  function P() {
    N(F);
  ...
  function S() {
    if (a2.postRun) for ("function" == typeof a2.postRun && (a2.postRun = [a2.postRun]); a2.postRun.length; ) O(a2.postRun.shift());
    N(W);
  }
  function j(e2) {
    C.unshift(e2);
  ...
  function Y(e2) {
    if (e2 == H && c) return new Uint8Array(c);
    throw "both async and sync fetching of the wasm failed";
  }
  function V(e2) {
    return !c && u && "function" == typeof fetch ? fetch(e2, {
  ...
  function B(e2, r3, t2, n3) {
    return e2 || "function" != typeof WebAssembly.instantiateStreaming || U(r3) || "function" != typeof fetch ? z(r3, t2, n3) : fetch(r3, {
      credentials: "same-origin"
  ...
  function G(e2) {
    this.excPtr = e2, this.ptr = e2 - 24, this.set_type = function(e3) {
      ...
      if (ft(this.get_type())) return y[this.excPtr >> 2];
  ...
  var K, Q, ee, re = {}, te = {}, ne = {}, ae = (e2) => {
    ...
    function n3(r4) {
      ...
      for (var a4 = 0; a4 < e2.length; ++a4) pe(e2[a4], n4[a4]);
    }
    ...
    oe([e2], a3, function(e3) {
      return t2.forEach((r4, t3) => {
        ...
        name: r3.name,
        fromWireType: (e4) => {
          for (var r4 = new Array(n3), a4 = 0; a4 < n3; ++a4) r4[a4] = t2[a4].read(e4);
          return i3(e4), r4;
        },
        toWireType: (e4, a4) => {
          if (n3 !== a4.length) throw new TypeError(`Incorrect number of tuple elements for ${r3.name}: expected=${n3}, actual=${a4.length}`);
          for (var u2 = o4(), s2 = 0; s2 < n3; ++s2) t2[s2].write(u2, a4[s2]);
          return null !== e4 && e4.push(i3, u2), u2;
        },
        argPackAdvance: me,
        readValueFromPointer: Z,
        destructorFunction: i3
      }];
    });
  }, ue = {}, se = (e2) => {
    var r3 = ue[e2];
    ...
    oe([e2], o4, (e3) => {
      ...
      return a3.forEach((r4, t3) => {
        ...
        o5[n4] = {
          read: (e4) => i3.fromWireType(u2(s2, e4)),
          write: (e4, r5) => {
            var t4 = [];
        ...
        fromWireType: (e4) => {
          var r4 = {};
          for (var t3 in o5) r4[t3] = o5[t3].read(e4);
          return n3(e4), r4;
        },
        toWireType: (e4, r4) => {
          for (var a4 in o5) if (!(a4 in r4)) throw new TypeError(`Missing field: "${a4}"`);
          var i3 = t2();
          for (a4 in o5) o5[a4].write(i3, r4[a4]);
    ...
    for (var r3 = "", t2 = e2; p[t2]; ) r3 += Q[p[t2++]];
    return r3;
  }, de = (e2) => {
    throw new ee(e2);
  };
  ...
  var we = new ye(), _e = (e2) => {
    ...
    for (var e2 = 0, r3 = we.reserved; r3 < we.allocated.length; ++r3) void 0 !== we.allocated[r3] && ++e2;
    return e2;
  }, Ae = () => {
    we.allocated.push({
      value: void 0
      ...
      value: false
    }), we.reserved = we.allocated.length, a2.count_emval_handles = be;
  }, Te = {
    toValue: (e2) => (e2 || de("Cannot use deleted val. handle = " + e2), we.get(e2).value),
    toHandle: (e2) => {
      switch (e2) {
        case void 0:
          return 1;
    ...
    pe(e2, {
      ...
      toWireType: (e3, r4) => Te.toHandle(r4),
      argPackAdvance: me,
      readValueFromPointer: Z,
      destructorFunction: null
    });
  ...
  function je(e2, r3, t2, n3, a3, o4) {
    ...
    for (var u2 = null !== r3[1] && null !== t2, s2 = false, l2 = 1; l2 < r3.length; ++l2) if (null !== r3[l2] && void 0 === r3[l2].destructorFunction) {
      s2 = true;
      break;
    }
    ...
    return function() {
      ...
      for (var o5 = 0; o5 < f2; ++o5) d2[o5] = r3[o5 + 2].toWireType(p2, arguments[o5]), h2.push(d2[o5]);
      function i4(e3) {
        if (s2) X(p2);
        else for (var n4 = u2 ? 1 : 2; n4 < r3.length; n4++) {
  ...
  var xe, Oe = (e2, r3, t2) => {
    ...
    for (var t2 = [], n3 = 0; n3 < e2; n3++) t2.push(y[r3 + 4 * n3 >> 2]);
    return t2;
  }, Re = (e2, r3, t2) => {
  ...
  var ze, Be = (e2, r3) => {
    ...
    pe(e2, {
      name: r3,
      fromWireType: o4,
      toWireType: u2 ? function(e3, r4) {
        return s2(r4, this.name), r4 >>> 0;
      } : function(e3, r4) {
        return s2(r4, this.name), r4;
      },
      argPackAdvance: me,
      readValueFromPointer: Je(r3, t2, 0 !== n3),
      destructorFunction: null
    });
  }, Ze = (e2, r3, t2) => {
  ...
  var Qe = (e2, r3, t2, n3) => {
    ...
    for (var n3 = r3 + t2, a3 = r3; e2[a3] && !(a3 >= n3); ) ++a3;
    if (a3 - r3 > 16 && e2.buffer && tr) return tr.decode(e2.subarray(r3, a3));
    for (var o4 = ""; r3 < a3; ) {
      var i3 = e2[r3++];
      if (128 & i3) {
        var u2 = 63 & e2[r3++];
        if (192 != (224 & i3)) {
          var s2 = 63 & e2[r3++];
          if ((i3 = 224 == (240 & i3) ? (15 & i3) << 12 | u2 << 6 | s2 : (7 & i3) << 18 | u2 << 12 | s2 << 6 | 63 & e2[r3++]) < 65536) o4 += String.fromCharCode(i3);
          else {
            var l2 = i3 - 65536;
    ...
    pe(e2, {
      ...
      fromWireType(e3) {
        ...
        if (t2) for (var o4 = a3, i3 = 0; i3 <= n3; ++i3) {
          ...
          var l2 = new Array(n3);
          for (i3 = 0; i3 < n3; ++i3) l2[i3] = String.fromCharCode(p[a3 + i3]);
          r4 = l2.join("");
        }
        return ut(e3), r4;
      },
      toWireType(e3, r4) {
        ...
        if (y[o4 >> 2] = n3, t2 && a3) er(r4, i3, n3 + 1);
        ...
        else for (u2 = 0; u2 < n3; ++u2) p[i3 + u2] = r4[u2];
    ...
    for (var t2 = e2, n3 = t2 >> 1, a3 = n3 + r3 / 2; !(n3 >= a3) && v[n3]; ) ++n3;
    if ((t2 = n3 << 1) - e2 > 32 && ir) return ir.decode(p.subarray(e2, t2));
    ...
    for (var n3 = r3, a3 = n3 + t2 - 4, o4 = 0; o4 < e2.length; ++o4) {
      var i3 = e2.charCodeAt(o4);
      if (i3 >= 55296 && i3 <= 57343 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & e2.charCodeAt(++o4)), g[r3 >> 2] = i3, (r3 += 4) + 4 > a3) break;
    }
    ...
    var n3, a3, o4, i3, u2;
    t2 = fe(t2), 2 === r3 ? (n3 = ur, a3 = sr, i3 = lr, o4 = () => v, u2 = 1) : 4 === r3 && (n3 = cr, a3 = fr, i3 = dr, o4 = () => y, u2 = 2), pe(e2, {
      name: t2,
      fromWireType: (e3) => {
    ...
    J[e2] = {
      name: fe(r3),
      rawConstructor: Ye(t2, n3),
      rawDestructor: Ye(a3, o4),
      elements: []
    };
    ...
    if (!Rr.strings) {
      ...
      for (var r3 in Dr) void 0 === Dr[r3] ? delete e2[r3] : e2[r3] = Dr[r3];
      var t2 = [];
    ...
    for (var t2 = 0; t2 < e2.length; ++t2) h[0 | r3++] = e2.charCodeAt(t2);
    h[0 | r3] = 0;
  }, kr = (e2, r3) => {
    var t2 = 0;
  ...
  var Lr, Nr = (e2, r3) => {
    ...
    var v2 = {
      ...
      "%B": (e3) => c2[e3.tm_mon],
      "%C": (e3) => d2((e3.tm_year + 1900) / 100 | 0, 2),
      "%d": (e3) => d2(e3.tm_mday, 2),
      "%e": (e3) => f2(e3.tm_mday, 2, " "),
      "%g": (e3) => m2(e3).toString().substring(2),
      "%G": (e3) => m2(e3),
      "%H": (e3) => d2(e3.tm_hour, 2),
      "%I": (e3) => {
        var r4 = e3.tm_hour;
        return 0 == r4 ? r4 = 12 : r4 > 12 && (r4 -= 12), d2(r4, 2);
      },
      "%j": (e3) => d2(e3.tm_mday + Ur(Ir(e3.tm_year + 1900) ? Yr : Vr, e3.tm_mon - 1), 3),
      "%m": (e3) => d2(e3.tm_mon + 1, 2),
      "%M": (e3) => d2(e3.tm_min, 2),
      "%n": () => "\n",
    ...
    for (var s2 in i3 = i3.replace(/%%/g, "\0\0"), v2) i3.includes(s2) && (i3 = i3.replace(new RegExp(s2, "g"), v2[s2](o4)));
    var w2 = Br(i3 = i3.replace(/\0\0/g, "%"));
    ...
    var t2 = e2.slice(0, 1), n3 = e2.slice(1), a3 = {
      i: 127,
      p: 127,
      j: 126,
      f: 125,
    ...
    for (var o4 = 0; o4 < n3.length; ++o4) r3.push(a3[n3[o4]]);
    "v" == t2 ? r3.push(0) : r3.push(1, a3[t2]);
  }, Kr = (e2, r3) => {
    if ("function" == typeof WebAssembly.Function) return new WebAssembly.Function(Xr(r3), e2);
    var t2 = [1];
    Zr(r3, t2);
    ...
    return new WebAssembly.Instance(a3, {
      e: {
        f: e2
      }
    }).exports.f;
  }, Qr = (e2, r3) => {
    if (Lr) for (var t2 = e2; t2 < e2 + r3; t2++) {
      var n3 = He(t2);
      n3 && Lr.set(n3, t2);
    }
  }, et = (e2) => (Lr || (Lr = /* @__PURE__ */ new WeakMap(), Qr(0, xe.length)), Lr.get(e2) || 0), rt = [], tt = () => {
    if (rt.length) return rt.pop();
    try {
      xe.grow(1);
    } catch (d2) {
      if (!(d2 instanceof RangeError)) throw d2;
    ...
    try {
      ...
      if (!(d2 instanceof TypeError)) throw d2;
      var a3 = Kr(e2, r3);
      nt(n3, a3);
    }
  ...
  var ot = {
    ...
    x: Hr,
    v: qr
  }, it = L(), ut = a2._free = (e2) => (ut = a2._free = it.H)(e2), st = a2._malloc = (e2) => (st = a2._malloc = it.I)(e2), lt = (e2) => (lt = it.J)(e2);
...
//# sourceMappingURL=lyr3DMain-GQAXBBUC.js.map
