...
function getNormalizer(mode) {
  return __async(this, null, function* () {
    ...
    const {
      normalize
    } = yield import("./time-zones-Y2PU5QSA.js");
    return normalize;
  });
}
function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
  return __async(this, null, function* () {
    if (mode === "name") {
      const {
        groupByName
      } = yield import("./index2-OGTU2A5Y.js");
    ...
    if (mode === "region") {
      const [{
        ...
        getCountry,
        global: globalLabel
      }] = yield Promise.all([import("./index3-5XRARTA3.js"), import("./region-C7GUNRGA.js")]);
    ...
    const [{
      ...
      DateEngine
    }] = yield Promise.all([import("./index4-NWOGVTCI.js"), import("./index5-YWGPY53X.js")]);
...
@esri/calcite-components/dist/components/calcite-input-time-zone.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-input-time-zone-ZCNAEBP3.js.map
