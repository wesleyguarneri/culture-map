...
var Action = proxyCustomElement(class Action2 extends H {
  ...
  renderIconContainer() {
    ...
    const calciteLoaderNode = loading ? h("calcite-loader", {
      inline: true,
      label: this.messages.loading,
      scale: loaderScale
    }) : null;
    const calciteIconNode = icon ? h("calcite-icon", {
      class: {
        [CSS.indicatorWithIcon]: indicator
      },
      flipRtl: iconFlipRtl,
      icon,
    ...
    const slotContainerNode = h("div", {
      class: {
        [CSS.slotContainer]: true,
        [CSS.slotContainerHidden]: loading
      }
    }, h("slot", null));
    return hasIconToDisplay ? h("div", {
      "aria-hidden": "true",
      class: CSS.iconContainer,
      key: "icon-container"
    }, iconNode, slotContainerNode) : null;
  }
  render() {
    const {
      active,
    ...
    return h(Host, {
      key: "3b459307dcb6f8d373e70cd5c7a45d122565a70e"
    }, h(InteractiveContainer, {
      key: "3a81f1fb62a66f1dbd608f095ed90f2d47a9daf6",
      disabled
    }, h("button", {
    ...
    }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && h("div", {
      class: CSS.indicatorWithoutIcon,
      key: "indicator-no-icon"
    })), h("slot", {
      key: "983989711d64076eca866c1928f9c777331fcba4",
      name: SLOTS.tooltip,
...
@esri/calcite-components/dist/components/action.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LC2LO3MD.js.map
