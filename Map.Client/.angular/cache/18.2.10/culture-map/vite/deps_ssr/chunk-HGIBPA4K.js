...
import {
  calciteSize48
} from "./chunk-TWK3L43N.js";
import {
  defineCustomElement as defineCustomElement4
} from "./chunk-P2SYZAU6.js";
import {
  CSS,
...
var Combobox = proxyCustomElement(class Combobox2 extends H {
  constructor() {
    ...
    this.setMaxScrollerHeight = () => __async(this, null, function* () {
      const {
        listContainerEl,
        open,
        referenceEl
    ...
    this.refreshSelectionDisplay = () => __async(this, null, function* () {
  ...
  renderListBoxOptions() {
    return this.filteredItems.map((item) => h("li", {
  ...
  renderSelectedOrPlaceholderIcon() {
    ...
    return this.showingInlineIcon && h("span", {
      class: "icon-start",
      key: "selected-placeholder-icon"
    }, h("calcite-icon", {
      class: {
  ...
  render() {
    ...
    return h(Host, {
      key: "f1671f542a84291771bcd4096557300397e67138",
      onClick: this.comboboxFocusHandler
    }, h(InteractiveContainer, {
      key: "d176f33343ad19474922e3274f28deae9c0a4fd9",
      disabled: this.disabled
    }, h("div", {
      key: "f93285d693a11fb8cec1ed8d1b93b2f66c7ab2dd",
      "aria-live": "polite",
      class: {
        wrapper: true,
    ...
    }, this.renderSelectedOrPlaceholderIcon(), h("div", {
      class: {
        "grid-input": true,
    ...
    }, !singleSelectionMode && !singleSelectionDisplay && this.renderChips(), !singleSelectionMode && !allSelectionDisplay && [this.renderSelectedIndicatorChip(), this.renderSelectedIndicatorChipCompact(), this.renderAllSelectedIndicatorChip(), this.renderAllSelectedIndicatorChipCompact()], h("label", {
      key: "a5cf9dddce6a299fb7a42721f6c5e02ae754ea6e",
      class: "screen-readers-only",
      htmlFor: `${inputUidPrefix}${guid2}`,
      id: `${labelUidPrefix}${guid2}`
    }, label), this.renderInput()), !readOnly && isClearable ? h(XButton, {
      disabled: this.disabled,
      key: "close-button",
      label: this.messages.clear,
      scale: this.scale
    }) : null, !readOnly && this.renderChevronIcon()), h("ul", {
      key: "6c0673c3b470c0a2a84b25cb8a90074db7548741",
      "aria-labelledby": `${labelUidPrefix}${guid2}`,
      "aria-multiselectable": "true",
      class: "screen-readers-only",
      id: `${listboxUidPrefix}${guid2}`,
      role: "listbox",
      tabIndex: -1
    }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), h(HiddenFormInputSlot, {
      key: "140469ee4ef16d89edb506b133b4316e8a9d7277",
      component: this
...
@esri/calcite-components/dist/components/combobox.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HGIBPA4K.js.map
