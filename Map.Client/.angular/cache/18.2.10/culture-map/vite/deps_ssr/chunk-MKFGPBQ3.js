...
function r(e2, r2, n3) {
  return {
    identifier: String.fromCharCode.apply(null, new Uint8Array(e2, n3 + o.identifierOffset, o.identifierLength)),
    version: r2.getUint16(n3 + o.versionOffset, t),
    checksum: r2.getUint32(n3 + o.checksumOffset, t)
  };
}
var n2 = {
  sizeLo: 0,
...
function i(e2, o2) {
  return {
    sizeLo: e2.getUint32(o2 + n2.sizeLo, t),
    sizeHi: e2.getUint32(o2 + n2.sizeHi, t),
    minX: e2.getFloat64(o2 + n2.minX, t),
    minY: e2.getFloat64(o2 + n2.minY, t),
    minZ: e2.getFloat64(o2 + n2.minZ, t),
    maxX: e2.getFloat64(o2 + n2.maxX, t),
    maxY: e2.getFloat64(o2 + n2.maxY, t),
    maxZ: e2.getFloat64(o2 + n2.maxZ, t),
    errorX: e2.getFloat64(o2 + n2.errorX, t),
    errorY: e2.getFloat64(o2 + n2.errorY, t),
    errorZ: e2.getFloat64(o2 + n2.errorZ, t),
    count: e2.getUint32(o2 + n2.count, t),
    reserved: e2.getUint32(o2 + n2.reserved, t)
  };
}
function c(t2) {
...
function a2(e2, o2) {
  return {
    sizeLo: e2.getUint32(o2 + l.sizeLo, t),
    sizeHi: e2.getUint32(o2 + l.sizeHi, t),
    count: e2.getUint32(o2 + l.count, t),
    colorMapCount: e2.getUint16(o2 + l.colorMapCount, t),
    lookupMethod: e2.getUint8(o2 + l.lookupMethod),
    compressionMethod: e2.getUint8(o2 + l.compressionMethod)
  };
}
function u(t2) {
...
function h(e2, o2) {
  return {
    sizeLo: e2.getUint32(o2 + f.sizeLo, t),
    sizeHi: e2.getUint32(o2 + f.sizeHi, t),
    count: e2.getUint32(o2 + f.count, t),
    scaleFactor: e2.getUint16(o2 + f.scaleFactor, t),
    bitsPerPoint: e2.getUint8(o2 + f.bitsPerPoint),
    reserved: e2.getUint8(o2 + f.reserved)
  };
}
function w(t2) {
  const n3 = new DataView(t2, 0);
...
function b(n3, r2, o2) {
  const i2 = null != r2.header ? s3(n3, r2.header) : {
    byteOffset: 0,
    byteCount: 0,
    fields: {
      count: o2
  ...
  for (let s4 = 0; s4 < r2.ordering.length; s4++) {
    ...
    if (o3.count = i2.fields.count ?? 0, "String" === o3.valueType) {
      if (o3.byteOffset = a4, o3.byteCount = i2.fields[n4 + "ByteCount"], "UTF-8" !== o3.encoding) throw new s("unsupported-encoding", "Unsupported String encoding.", {
        encoding: o3.encoding
      });
      if (o3.timeEncoding && "ECMA_ISO8601" !== o3.timeEncoding) throw new s("unsupported-time-encoding", "Unsupported time encoding.", {
        timeEncoding: o3.timeEncoding
      });
    } else {
      if (!O(o3.valueType)) throw new s("unsupported-value-type", "Unsupported binary valueType", {
        valueType: o3.valueType
      });
      {
...
function y(t2, n3, r2) {
 ...
 expected: ${t2}, actual: ${n3})`), n3 < t2) throw new s("buffer-too-small", "Binary buffer is too small", {
    expectedSize: t2,
    actualSize: n3
  });
}
function g(e2) {
  return {
    ...
    isLegacy: false,
    color: null != e2.color,
    normal: null != e2.normal,
    uv0: null != e2.uv0,
    uvRegion: null != e2.uvRegion,
    featureIndex: null != e2.faceRange && null != e2.featureId
  };
}
function w2(e2, t2) {
  ...
  const o2 = {
    isDraco: false,
    header: n3,
    byteOffset: n3.byteCount,
    byteCount: 0,
    vertexAttributes: {}
  }, i2 = n3.fields, u3 = null != i2.vertexCount ? i2.vertexCount : i2.count;
  for (const s4 of t2.ordering) {
    if (!t2.vertexAttributes[s4]) continue;
    const e3 = __spreadProps(__spreadValues({}, t2.vertexAttributes[s4]), {
      byteOffset: r2,
      count: u3
    }), n4 = C[s4] || "_" + s4;
  ...
  if (t2.faces && a4) {
    ...
    for (const e3 of t2.ordering) {
      ...
      const n4 = __spreadProps(__spreadValues({}, t2.faces[e3]), {
        byteOffset: r2,
        count: a4
      });
  ...
  if (t2.featureAttributes && t2.featureAttributeOrder && c3) {
    ...
    for (const e3 of t2.featureAttributeOrder) {
      ...
      const n4 = __spreadProps(__spreadValues({}, t2.featureAttributes[e3]), {
        byteOffset: r2,
        count: c3
      });
...
var A = {
  Float32: (e2, t2) => new DataView(e2, 0).getFloat32(t2, true),
  Float64: (e2, t2) => new DataView(e2, 0).getFloat64(t2, true),
  UInt8: (e2, t2) => new DataView(e2, 0).getUint8(t2),
  Int8: (e2, t2) => new DataView(e2, 0).getInt8(t2),
  UInt16: (e2, t2) => new DataView(e2, 0).getUint16(t2, true),
  Int16: (e2, t2) => new DataView(e2, 0).getInt16(t2, true),
  UInt32: (e2, t2) => new DataView(e2, 0).getUint32(t2, true),
  Int32: (e2, t2) => new DataView(e2, 0).getInt32(t2, true)
};
function O(e2) {
...
//# sourceMappingURL=chunk-MKFGPBQ3.js.map
