...
function n5(n8, o7) {
  const t8 = -n8[0], c5 = -n8[1], f3 = -n8[2], i3 = o7[3], s2 = o7[7], u4 = o7[11], e11 = o7[15];
  o7[0] += i3 * t8, o7[1] += i3 * c5, o7[2] += i3 * f3, o7[4] += s2 * t8, o7[5] += s2 * c5, o7[6] += s2 * f3, o7[8] += u4 * t8, o7[9] += u4 * c5, o7[10] += u4 * f3, o7[12] += e11 * t8, o7[13] += e11 * c5, o7[14] += e11 * f3;
}
function o3(n8, o7) {
  const t8 = n8[0], c5 = n8[1], f3 = n8[2];
  o7[12] += t8 * o7[0] + c5 * o7[4] + f3 * o7[8], o7[13] += t8 * o7[1] + c5 * o7[5] + f3 * o7[9], o7[14] += t8 * o7[2] + c5 * o7[6] + f3 * o7[10], o7[14] += t8 * o7[3] + c5 * o7[7] + f3 * o7[11];
}
...
h3.shader = new t5(A2, () => import("./EdgeShader.glsl-SSZFAL32.js"));
...
e([r6({
  count: p.COUNT
})], r9.prototype, "type", void 0), e([r6()], r9.prototype, "hasSlicePlane", void 0), e([r6()], r9.prototype, "silhouette", void 0), e([r6()], r9.prototype, "legacy", void 0), e([r6()], r9.prototype, "doublePrecisionRequiresObfuscation", void 0), e([r6()], r9.prototype, "multipassEnabled", void 0), e([r6()], r9.prototype, "cullAboveGround", void 0), e([r6()], r9.prototype, "spherical", void 0), e([r6({
  constValue: false
})], r9.prototype, "occlusionPass", void 0), e([r6({
  constValue: a2.Compressed
})], r9.prototype, "normalType", void 0);
...
var b2 = class _b {
  constructor(e11, t8, s2) {
    this._rctx = e11, this._techniques = t8, this._configuration = new r9(), this.refCount = 0, this._renderables = /* @__PURE__ */ new Set(), this._sortedRenderables = {
      [A.TRANSPARENT]: {
        [A.TRANSPARENT]: new l(),
        [A.OPAQUE]: new l()
      },
    ...
    }, this._renderablesDirty = false, this._drawParameters = new e10(), this._settings = __spreadValues(__spreadValues({}, f), s2), this.key = _b.getKey(this._settings.type, this._settings.hasSlicePlane, this._settings.legacy);
    const i3 = this._settings.strokesTexture.variants;
    this.writerSettings = {
      variants: i3,
      reducedPrecision: t6.TESTS_DISABLE_OPTIMIZATIONS
  ...
  updateTechnique(e11, r11) {
    return this._configuration.multipassEnabled = !!e11.multipassEnabled, this._configuration.cullAboveGround = !!e11.multipassTerrain.cullAboveGround, this._configuration.silhouette = r11, this._technique = this._techniques.releaseAndAcquire(h3, this._configuration, this._technique), this._technique;
  }
  ...
  _bindDraw(e11, r11, i3, a6) {
    ...
    if (d) {
      ...
      const e12 = new e8(r11.transform.position), i4 = u2(T2, s(T2, r11.transform.rotationScale));
      ...
      const d2 = a6.camera.viewInverseTransposeMatrix;
      o(this._drawParameters.slicePlaneLocalOrigin, d2[3], d2[7], d2[11]);
    }
    e11.bindDraw(this._drawParameters, a6, i3);
  }
  _sortRenderables() {
...
function n6(e11) {
  const n8 = 4, u4 = a5.resolution, l5 = u4 / 2, p2 = new Uint8Array(n8 * u4 * u4), h4 = n8 * u4 * l5, m2 = a5.amplitude, f3 = 2 * m2, S4 = n8 * u4, d = Math.log2(u4) + 1, E3 = a5.strokes.length;
  let R2 = (d - 1) * E3 * S4;
  for (const {
    distance: r11,
    pressure: s2
    ...
    for (let r12 = 0; r12 < d; r12++) {
      ...
      for (let r13 = 0; r13 < a5.resolution; r13++) {
        ...
        o2(s3, p2, l6), o2(o7, p2, l6 + h4), l6 += n8;
      }
      l6 -= S4 * (E3 + 1);
    }
    R2 += S4;
  }
  const g2 = new c2(e11, new e6(u4), p2);
  return new c3(u4, f3, m2, E3, g2);
}
function o5(t8, e11) {
  if (!t8) return null;
  const r11 = t8.length / 2, s2 = u3 * r11, n8 = new Array(r11);
  let o7 = 0;
  const c5 = e11 === i.PRESSURE;
  for (let i3 = 0; i3 < t8.length; i3 += 2) {
    const e12 = (t8[i3] + t8[i3 + 1]) / 2;
    n8[o7++] = c5 ? Math.min(s2, 1 - (1 - e12) * l4) : Math.min(s2, e12 * l4);
  }
  return n8;
}
var i;
...
function r10(e11) {
  ...
  for (const o7 of e11) {
    ...
    if (c4(o7)) {
      if (null == r11) r11 = e12;
      else if (r11 !== e12) return p.Mixed;
    }
  }
  return r11 ?? p.Mixed;
}
function o6(t8) {
  ...
  for (const {
    ...
    if (o7.color[3] * o7.opacity < 1) return A.TRANSPARENT;
    r11 = A.OPAQUE;
  }
  return r11;
}
function n7(t8) {
  ...
  for (const {
    ...
    switch (o7.objectTransparency) {
      ...
      case A.OPAQUE:
        if (o7.opacity < 1) return A.TRANSPARENT;
    }
    r11 = A.OPAQUE;
  }
  return r11;
...
function f2(e11, t8, r11, o7) {
  for (let n8 = 0; n8 < e11.length; n8++) {
    const i3 = e11[n8].index, c5 = t8[n8], f3 = t8[n8 + 1];
    if (o7) for (let e12 = c5; e12 < f3; e12++) {
      const t9 = o7[e12];
      r11.set(t9, i3);
    }
    else for (let e12 = c5; e12 < f3; e12++) r11.set(e12, i3);
  }
}
...
var ne = class extends S {
  constructor(e11) {
    ...
    for (let r11 = 0; r11 < 4; r11++) t8.sideness.set(r11, 0, 0 === r11 || 3 === r11 ? 0 : 1), t8.sideness.set(r11, 1, 0 === r11 || 1 === r11 ? 0 : 1);
    this._verticesBufferObject = c.createVertex(e11.rctx, F.STATIC_DRAW, t8.buffer);
  }
  initialize() {
    this._worker = new a3(this.schedule), this._componentColorManager = new r8(this.rctx, 3);
  }
  destroy() {
    this.destroyed || (this._objectEntries.forEach((e11) => this._discardObjectEntry(e11)), this._objectEntries.clear(), this._pendingDeletions.forEach((e11) => this._discardObjectEntry(e11)), this._pendingDeletions.clear(), this._strokesTexture = r(this._strokesTexture), this._componentColorManager = u(this._componentColorManager), this._workerAbort.abort(), this._worker.destroy(), this._verticesBufferObject.dispose(), this._renderers.clear(), this._updatingHandles.destroy(), this._set("schedule", we));
  }
  get updating() {
  ...
  addComponentObject(e11, t8, r11, s2, n8, i3, o7) {
    return __async(this, null, function* () {
      if (this.hasObject(e11)) return this._getObjectMemoryUsage(e11);
      let a6;
      const c5 = new ae(null, new Promise((e12) => a6 = e12), e11.obb.center, e11.obb.radius);
      this._objectEntries.set(e11, c5);
      const l5 = yield this._updatingHandles.addPromise(this._addComponentGeometry(e11.transform, c5, t8, r11, s2, n8, i3, o7));
      return this.setNeedsRender(), a6(), l5;
    });
  }
  addOrUpdateObject3D(e11, t8, r11, s2) {
    return __async(this, null, function* () {
      if (this.destroyed) return void n.getLogger(this).warn("Attempt to add an object to a destroyed instance");
      const i3 = new AbortController();
      let o7;
      const a6 = e11.boundingVolumeWorldSpace.bounds, l5 = new ae(i3, new Promise((e12) => o7 = e12), V(a6), N(a6)), d = this._objectEntries.get(e11);
      d && (this._pendingDeletions.has(e11) ? this._discardObjectEntry(d) : this._pendingDeletions.set(e11, d)), this._objectEntries.set(e11, l5);
      try {
        const n8 = new Array();
        if (r11.mergeGeometries && e11.geometries.length > 1 && oe(e11)) n8.push(this._addObjectMergedGeometries(e11, l5, t8, r11, s2));
        else for (const i4 of e11.geometries) i4.material.supportsEdges && n8.push(this._addGeometry(e11, l5, i4, t8[0], r11, s2));
        yield this._updatingHandles.addPromise(Promise.all(n8)), this._removePendingDeletion(e11);
      } catch (h4) {
        b(h4) ? this._discardObjectEntry(l5) : this._removePendingDeletion(e11);
      } finally {
        this.setNeedsRender(), o7();
      }
    });
  }
  removeObject(e11) {
  ...
  _getObjectEntry(e11) {
    return __async(this, null, function* () {
      ...
      return yield t8.loaded, null == t8.loaded ? null : t8;
    });
  }
  fastUpdateObject3DEdgesTransform(e11) {
    ...
    if (0 === r11.length || 0 === s2.length) return true;
    if (s2.length > 1) return false;
    const [n8] = s2, i3 = n8.transform;
    if (!(i3 instanceof de)) return false;
    const [o7] = r11;
    if (o7.localOrigin !== i3.origin.origin) return false;
    const a6 = e3(), c5 = this._computeModelTransformWithLocalOrigin(e11, o7, a6);
    return n8.transform = new de(a6, c5), this.setNeedsRender(), true;
  }
  _discardObjectEntry(e11) {
    e11 && (e11.abort?.abort(), e11.renderables.length && (e11.renderables.forEach((e12) => this._removeRenderable(e12)), this.setNeedsRender()), e11.loaded = null);
  }
  hasObject(e11) {
    return this._objectEntries.has(e11);
  }
  updateAllComponentOpacities(e11, t8) {
    return __async(this, null, function* () {
      const r11 = yield this._updatingHandles.addPromise(this._getObjectEntry(e11));
      if (null == r11) return;
      ...
      r11.renderables.forEach((e12) => {
        ...
        for (let r12 = 0; r12 < t9; r12++) {
          const t10 = s2(r12), n8 = e12.components.meta[r12], i3 = n8.index;
          n8.material.opacity = t10, e12.components.buffer.textureBuffer.setDataElement(i3, 1, 3, 255 * t10);
        }
        this._updateTransparency(e12);
      }), this.setNeedsRender();
    });
  }
  _getObjectMemoryUsage(e11) {
    return __async(this, null, function* () {
      const t8 = yield this._getObjectEntry(e11);
      return t8 ? t8.renderables.reduce((e12, t9) => e12 + t9.statistics.gpuMemoryUsage, 0) : 0;
    });
  }
  updateAllComponentMaterials(e11, t8, r11, s2) {
    return __async(this, null, function* () {
      const n8 = e11 instanceof O2, i3 = !!r11.hasSlicePlane, o7 = r10(t8), a6 = b2.getKey(o7, i3, n8), c5 = yield this._updatingHandles.addPromise(this._getObjectEntry(e11));
      null != c5 && (c5.renderables.forEach((e12) => {
        if (a6 !== e12.rendererKey) {
          const t9 = this._renderers.get(e12.rendererKey), r12 = this._acquireRenderer(o7, i3, n8);
          t9.removeRenderable(e12), --t9.refCount, e12.rendererKey = a6, r12.addRenderable(e12);
        }
        for (let r12 = 0; r12 < t8.length; r12++) e12.components.meta[r12].material = t8[r12];
        s2 && me(e12.components), this._updateTransparency(e12);
      }), this.setNeedsRender());
    });
  }
  updateAllVerticalOffsets(e11, t8) {
    return __async(this, null, function* () {
      const r11 = yield this._updatingHandles.addPromise(this._getObjectEntry(e11));
      null != r11 && this._updateAllVerticalOffsets(r11, t8);
    });
  }
  _updateAllVerticalOffsets(e11, t8) {
    e11.renderables.forEach((e12) => {
      const r11 = e12.components.meta;
      for (let s2 = 0; s2 < r11.length; s2++) e12.components.meta[s2].verticalOffset = t8?.[s2] ?? 0;
      me(e12.components);
    }), this.setNeedsRender();
  }
  updateObjectVisibility(e11, t8) {
    return __async(this, null, function* () {
      const r11 = yield this._updatingHandles.addPromise(this._getObjectEntry(e11));
  ...
  render(e11, t8) {
    ...
    if (this._renderers.forEach((r12) => {
      if (0 === r12.refCount) return this._renderers.delete(r12.key), void r12.dispose();
      let s3 = true, n9 = true;
      r12.forEachRenderable((t9) => {
        t9.visible && (i3 += t9.statistics.averageEdgeLength, o7++, s3 && t9.regular && (r12.updateTechnique(e11, false), s3 = false), n9 && t9.silhouette && (r12.updateTechnique(e11, true), n9 = false));
      }, t8);
    }), this._componentColorManager.garbageCollect(), this._componentColorManager.updateTextures(), 0 === o7) return;
    const a6 = new a4(40 * i3 / o7, t8);
    o(s2, r11[3], r11[7], r11[11]), n8.set(s2), r2(a6.transformWorldFromViewTH, n8.high), r2(a6.transformWorldFromViewTL, n8.low), n4(a6.transformViewFromCameraRelativeRS, e11.camera.viewMatrix), u2(Oe, a6.transformViewFromCameraRelativeRS), s(a6.transformNormalViewFromGlobal, Oe), a6.transformProjFromView = e11.camera.projectionMatrix, this._updateObjectCameraDistances(e11), this._renderers.forEach((t9) => {
      ge(t9, e11, a6), fe(t9, e11, a6);
    });
  }
  ...
  _createComponentBuffers(e11) {
    ...
    for (let n8 = 0; n8 < e11.length; n8++) {
      const s3 = e11[n8], i3 = r11.acquireIndex();
      t8.push({
        index: i3,
        verticalOffset: 0,
        material: s3
    ...
    const s2 = new ce(r11, t8);
    return me(s2), s2;
  }
  _extractEdges(e11, t8, r11, s2, n8, i3, o7 = i3.length) {
    return o7 < se && (n8 = true), this._worker.process({
      data: r11,
      indices: i3,
      indicesLength: o7,
      writerSettings: t8,
  ...
  _createRenderable(e11, t8, r11, s2, n8) {
    const i3 = (t9) => new le(new r7(this.rctx, r3, {
      vertices: S2,
      instances: t9 === x.REGULAR ? w3.glLayout : N2.glLayout
    }, {
      vertices: this._verticesBufferObject,
      instances: c.createVertex(this.rctx, F.STATIC_DRAW, t9 === x.REGULAR ? e11.regular.instancesData.buffer : e11.silhouette.instancesData.buffer)
    }), t9 === x.REGULAR ? e11.regular.lodInfo : e11.silhouette.lodInfo), o7 = e11.regular.lodInfo.lengths.length > 0 ? i3(x.REGULAR) : null, a6 = e11.silhouette.lodInfo.lengths.length > 0 ? i3(x.SILHOUETTE) : null, c5 = (o7?.vao.usedMemory ?? 0) + (a6?.vao.usedMemory ?? 0);
    return new he(o7, a6, {
      gpuMemoryUsage: c5,
      externalMemoryUsage: n8,
      averageEdgeLength: e11.averageEdgeLength
    }, r11, o6(t8.meta), n7(t8.meta), t8, s2);
  }
  _addGeometry(e11, t8, r11, s2, n8, i3) {
    return __async(this, null, function* () {
      if (r11.edgeIndicesLength <= 0) return;
      const o7 = r11.attributes.get(e5.POSITION), a6 = e3(), c5 = this._computeModelTransformWithLocalOrigin(e11, r11, a6), l5 = new je(o7, a6, c5);
      return this._addPositionData(t8, l5, r11.edgeIndicesLength, s2, n8, i3);
    });
  }
  _addPositionData(e11, t8, r11, s2, n8, i3 = false) {
    return __async(this, null, function* () {
      if (null == e11.loaded) return;
      const o7 = this._createComponentBuffers([s2]);
      if (null == o7) return;
      const a6 = this._acquireRenderer(s2.type, !!n8.hasSlicePlane, true), {
        modelTransform: c5,
        origin: l5
      } = t8, d = t8.position.indices, h4 = t8.position, u4 = h4.data.length / h4.size, m2 = E2.createBuffer(u4);
      for (let p2 = 0; p2 < u4; p2++) m2.position.set(p2, 0, h4.data[p2 * h4.size]), m2.position.set(p2, 1, h4.data[p2 * h4.size + 1]), m2.position.set(p2, 2, h4.data[p2 * h4.size + 2]);
      f2(o7.meta, [0, m2.componentIndex.count], m2.componentIndex);
      const g2 = yield this._updatingHandles.addPromise(this._extractEdges(e11.abort?.signal || this._workerAbort.signal, a6.writerSettings, m2, false, i3, d, r11));
      if (null == e11.loaded) return;
      const f3 = this._createRenderable(g2, o7, new de(c5, l5), a6.key, false);
      e11.renderables.push(f3), a6.addRenderable(f3), this._gpuMemoryUsage += f3.statistics.gpuMemoryUsage;
    });
  }
  _addComponentGeometry(e11, t8, r11, s2, n8, i3, o7, a6) {
    return __async(this, null, function* () {
      if (null == t8.loaded) return 0;
      const c5 = this._createComponentBuffers(i3);
      if (null == c5) return 0;
      const l5 = r10(i3), d = this._acquireRenderer(l5, o7.hasSlicePlane || false, false), h4 = E2.createBuffer(r11.length / 3);
      t4(h4.position.typedBuffer, r11, h4.position.typedBufferStride, 3), f2(c5.meta, n8, h4.componentIndex, s2);
      const u4 = true, m2 = d.writerSettings, g2 = yield this._updatingHandles.addPromise(this._extractEdges(this._workerAbort.signal, m2, h4, u4, false, s2));
      if (null == t8.loaded) return 0;
      const f3 = this._createRenderable(g2, c5, e11, d.key, true);
      return t8.renderables.push(f3), d.addRenderable(f3), this._updateAllVerticalOffsets(t8, a6), f3.statistics.gpuMemoryUsage;
    });
  }
  _addObjectMergedGeometries(e11, t8, r11, s2, n8) {
    return __async(this, null, function* () {
      const i3 = /* @__PURE__ */ new Map();
      let o7 = 0, a6 = 0, c5 = null;
      const l5 = e11.geometries.filter((e12) => {
        if (e12.edgeIndicesLength <= 0 || !e12.material.supportsEdges) return false;
        !c5 && e12.localOrigin && (c5 = e12);
        const t9 = e12.attributes.get(e5.POSITION);
        return a6 += t9.data.length / t9.size, o7 += e12.edgeIndicesLength, true;
      });
      if (0 === l5.length) return;
      const d = a6 >= 65536 ? Uint32Array : Uint16Array, h4 = o7 ? new d(o7) : null, u4 = [];
      let m2 = 0;
      l5.forEach((e12) => {
        const t9 = e12.attributes.get(e5.POSITION), r12 = t9.indices;
        let s3 = i3.get(t9.data);
        if (null == s3) {
          s3 = u4.length / 3;
          for (let e13 = 0; e13 < t9.data.length; e13 += t9.size) u4.push(t9.data[e13]), u4.push(t9.data[e13 + 1]), u4.push(t9.data[e13 + 2]);
          i3.set(t9.data, s3);
        }
        for (let n9 = 0; n9 < e12.edgeIndicesLength; n9++) h4[m2++] = s3 + r12[n9];
      });
      const g2 = c5 || e11.geometries[0], f3 = e3(), _3 = this._computeModelTransformWithLocalOrigin(e11, g2, f3);
      for (let p2 = 0; p2 < e11.geometries.length; p2++) e11.geometries[p2].localOrigin = _3.origin;
      const b3 = new je(new t3(u4, h4, 3), f3, _3);
      yield this._updatingHandles.addPromise(this._addPositionData(t8, b3, h4.length, r11[0], s2, n8));
    });
  }
  _acquireRenderer(e11, t8, r11) {
    const s2 = b2.getKey(e11, t8, r11);
    let n8 = this._renderers.get(s2);
    return null == this._strokesTexture && (this._strokesTexture = n6(this.rctx)), n8 || (n8 = new b2(this.rctx, this.techniques, {
      type: e11,
      hasSlicePlane: t8,
      strokesTexture: this._strokesTexture,
      legacy: r11,
      spherical: this.viewingMode === l2.Global
    }), this._renderers.set(s2, n8)), ++n8.refCount, n8;
  }
  _removeRenderable(e11) {
    ...
    if (t8) {
      ...
      for (const t9 of e11.components.meta) e11.components.buffer.releaseIndex(t9.index);
    }
  }
  _updateObjectCameraDistances(e11) {
    const t8 = e11.camera.eye, r11 = e11.camera.viewForward, s2 = n2(), n8 = (e12) => {
      K(s2, e12.center, t8);
      const n9 = P(s2, r11), i3 = e12.radius, o7 = n9 < -i3 ? 1 / 0 : n9 < i3 ? 0 : n9 - i3;
      e12.renderables.forEach((e13) => e13.distanceToCamera = o7);
    };
...
function ie(e11) {
  e11?.vao && (e11.vao.vertexBuffers.instances.dispose(), e11.vao.disposeVAOOnly(), e11.vao = null);
}
function oe(e11) {
  let t8 = null, s2 = null;
  for (const n8 of e11.geometries) {
    if (n8.material.supportsEdges) {
      if (t8) {
        if (!h(t8, n8.transformation)) return false;
      } else t8 = n8.transformation;
      if (s2 || null == n8.localOrigin) {
        if (null != s2?.localOrigin && null != n8.localOrigin && s2.localOrigin.id !== n8.localOrigin.id) return false;
      } else s2 = n8;
    }
  }
  return true;
...
e([y({
  constructOnly: true
})], ne.prototype, "rctx", void 0), e([y({
  constructOnly: true
})], ne.prototype, "renderSR", void 0), e([y({
  constructOnly: true
})], ne.prototype, "viewingMode", void 0), e([y({
  constructOnly: true
})], ne.prototype, "techniques", void 0), e([y({
  constructOnly: true
})], ne.prototype, "setNeedsRender", void 0), e([y({
  constructOnly: true
})], ne.prototype, "schedule", void 0), e([y({
  readOnly: true
})], ne.prototype, "_updatingHandles", void 0), e([y({
  readOnly: true
})], ne.prototype, "updating", null), ne = e([a("esri.views.3d.webgl-engine.lib.edgeRendering.EdgeView")], ne);
var ae = class {
  constructor(e11, t8, r11, s2) {
    this.abort = e11, this.radius = s2, this.renderables = new Array();
    const n8 = e11 ? w2(e11.signal, () => e11.abort()) : null;
    this.loaded = t8, this.loaded.then(() => {
      null != this.loaded && (this.loaded = true), this.abort = null, n8?.remove();
    }), this.center = t2(r11);
  }
};
var ce = class {
...
var he = class {
  constructor(e11, t8, r11, s2, n8, i3, o7, a6) {
    this.regular = e11, this.silhouette = t8, this.statistics = r11, this.transform = s2, this.edgeTransparency = n8, this.objectTransparency = i3, this.components = o7, this.rendererKey = a6, this.distanceToCamera = 0, this.visible = true;
  }
};
...
function me(e11) {
  const {
    meta: t8,
    buffer: r11
  } = e11, s2 = new Uint8Array(4);
  for (let n8 = 0; n8 < t8.length; n8++) {
    const e12 = t8[n8].material, o7 = t8[n8].index, a6 = e2(Math.round(e12.size * m), 0, 255), c5 = e2(e12.extensionLength, -g, 255 - g) + g, l5 = 255 * e12.opacity, d = e12.color, h4 = 255 * d[0], u4 = 255 * d[1], m2 = 255 * d[2], g2 = 255 * d[3];
    r11.textureBuffer.setData(o7, 0, h4, u4, m2, g2), r11.textureBuffer.setData(o7, 1, a6, c5, e12.type, l5), C(t8[n8].verticalOffset, s2), r11.textureBuffer.setData(o7, 2, s2[0], s2[1], s2[2], s2[3]);
  }
}
function ge(e11, t8, r11) {
  const s2 = e11.bindRegularEdges(r11, t8), n8 = r11.transparency, i3 = t8.camera.perScreenPixelRatio;
  e11.forEachRenderable((n9) => {
    if (!pe(n9) || !n9.visible) return;
    const o7 = ye(n9.regular.lod.lengths, n9.distanceToCamera, i3);
    e11.renderRegularEdges(s2, n9, r11, t8, o7);
  }, n8);
}
function fe(e11, t8, r11) {
  const s2 = e11.bindSilhouetteEdges(r11, t8), n8 = r11.transparency, i3 = t8.camera.perScreenPixelRatio;
  e11.forEachRenderable((n9) => {
    if (!be(n9) || !n9.visible) return;
    const o7 = ye(n9.silhouette.lod.lengths, n9.distanceToCamera, i3);
    e11.renderSilhouetteEdges(s2, n9, r11, t8, o7);
  }, n8);
}
function pe(e11) {
...
function ye(e11, t8, r11) {
  const n8 = t8 * r11, i3 = w(e11, n8, true);
  return -1 === i3 ? n8 < e11[0] ? e11.length : 0 : e11.length - i3;
}
var je = class {
...
var Oe = e4();
var we = () => Promise.reject();
export {
  ne as EdgeView,
  de as LegacyTransform,
  ue as RegularRenderable,
  he as Renderable,
  _e as SilhouetteRenderable
};
//# sourceMappingURL=EdgeView-MWK5GSDA.js.map
