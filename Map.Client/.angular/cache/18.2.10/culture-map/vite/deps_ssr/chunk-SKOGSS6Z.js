...
var i = class _i {
  constructor(i2, e, s, r) {
    this.computedX = 0, this.computedY = 0, this.center = t(i2, e), this.centerT = n(), this.halfWidth = s / 2, this.halfHeight = r / 2, this.width = s, this.height = r;
  }
  get x() {
...
//# sourceMappingURL=chunk-SKOGSS6Z.js.map
