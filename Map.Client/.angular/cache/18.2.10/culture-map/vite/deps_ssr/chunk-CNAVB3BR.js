...
var Button = proxyCustomElement(class Button2 extends H {
  ...
  render() {
    ...
    const loaderNode = this.loading ? h("div", {
      class: CSS.buttonLoader
    }, h("calcite-loader", {
    ...
    const iconStartEl = h("calcite-icon", {
      key: "f1036c0a1bf5740fe63806e3559ea66fac29b726",
      class: {
        [CSS.icon]: true,
        [CSS.iconStart]: true
      },
    ...
    const iconEndEl = h("calcite-icon", {
      key: "d2c22ecf9ca23426b4c4a3b42d623f35ee988a44",
      class: {
        [CSS.icon]: true,
        [CSS.iconEnd]: true
      },
    ...
    const contentEl = h("span", {
      key: "d1803021f5fa106c9e296402ec0a1498ecdf36c7",
      class: CSS.content,
      ref: (el) => this.contentEl = el
    }, h("slot", {
      key: "d2f729c16f9c803ffa109b68d58a22a4383dd426"
    }));
    return h(InteractiveContainer, {
      key: "2757c795d29f812cf11def4df108837b9971dcdb",
      disabled: this.disabled
    }, h(Tag, {
      key: "e67a4882c8a0c13d6b5f98bc8c5b53c10ba36e3e",
      ...
      download: childElType === "a" ? this.download === true || this.download === "" ? "" : this.download || null : null,
  ...
  updateHasContent() {
    ...
    this.hasContent = this.el.childNodes.length === 1 && this.el.childNodes[0]?.nodeName === "#text" ? this.el.textContent?.trim().length > 0 : slottedContent;
  }
...
@esri/calcite-components/dist/components/button.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CNAVB3BR.js.map
