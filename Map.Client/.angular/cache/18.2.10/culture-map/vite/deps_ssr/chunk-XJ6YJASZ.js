  ...
  return __async(this, null, function* () {
    switch (e.type) {
      case "web-style": {
        ...
        } = yield import("./previewWebStyleSymbol-Q4MJV32K.js");
        return l3(e, V, t2);
      }
      case "label-3d":
      case "line-3d":
      ...
      case "polygon-3d": {
        const {
          previewSymbol3D: l3
        } = yield import("./previewSymbol3D-XO4GYCA4.js");
        return l3(e, t2);
      }
      case "simple-marker":
      case "simple-line":
      ...
      case "text": {
        const {
          previewSymbol2D: l3
        } = yield import("./previewSymbol2D-7O2WB6VH.js");
        return l3(e, t2);
      }
      case "cim": {
        const {
          previewCIMSymbol: l3
        } = yield import("./previewCIMSymbol-2F4RQOSS.js");
        return l3(e, t2);
      }
      default:
        return;
...
function L2(t2, l3) {
  return __async(this, null, function* () {
    ...
    const {
      ...
      getAllSizes: y3,
      getRotationAngle: d2
    } = yield import("./visualVariableUtils-ZQZWRVTQ.js"), m2 = [], b3 = [], g4 = [], w2 = [];
...
//# sourceMappingURL=chunk-XJ6YJASZ.js.map
