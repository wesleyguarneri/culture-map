...
var c2 = 0.2;
var m = class extends At(l(y2)) {
  constructor() {
    super(...arguments), this.type = "integrated-mesh-3d", this._elevationContext = "im", this._isIntegratedMesh = true, this._supportsLabeling = false, this._needsNormals = !has("disable-feature:im-shading"), this.drapeTargetType = t2.WithoutRasterImage;
  }
  get i3slayer() {
    return this.layer;
  }
...
e([y()], m.prototype, "layer", void 0), e([y()], m.prototype, "i3slayer", null), e([y(t)], m.prototype, "updatingProgress", void 0), e([y()], m.prototype, "updatingProgressValue", null), e([y()], m.prototype, "lodFactor", null), e([y({
  readOnly: true
})], m.prototype, "progressiveLoadFactor", null), e([y({
  readOnly: true
})], m.prototype, "visibleAtCurrentScale", null), m = e([a("esri.views.3d.layers.IntegratedMeshLayerView3D")], m);
var u = m;
export {
  u as default
};
//# sourceMappingURL=IntegratedMeshLayerView3D-RGQDDQ5R.js.map
