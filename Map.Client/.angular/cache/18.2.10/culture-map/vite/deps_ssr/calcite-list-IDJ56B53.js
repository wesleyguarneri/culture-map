...
import {
  filter
} from "./chunk-5QYK5IUJ.js";
import {
  getListItemChildren,
  updateListItemChildren
} from "./chunk-72CDHG7W.js";
import {
  MAX_COLUMNS
...
function connectSortableComponent(component) {
  ...
  component.sortable = Sortable.create(component.el, __spreadProps(__spreadValues(__spreadValues(__spreadValues({
    dataIdAttr
  }, CSS), !!draggable && {
    draggable
  }), !!group && {
...
var Stack = proxyCustomElement(class Stack2 extends H {
  ...
  render() {
    return h(Host, {
      key: "97f052828720d715fd3b11a4b0e77fa085127796"
    }, h("div", {
      key: "5351cc20a8a437763894fef35ecc7a7240cb7c46",
...
var Filter = proxyCustomElement(class Filter2 extends H {
  ...
  render() {
    ...
    return h(InteractiveContainer, {
      ...
      key: "1f2ef99156489719dd2f938bc5ce8a05185866bf",
      class: CSS3.container
    }, h("label", {
      key: "6fe8c6cf73f554908be38299263d23380a4ed089"
    }, h("calcite-input", {
      key: "6765e00d208d6898221540769865d84aa1c64974",
      clearable: true,
      disabled,
      icon: ICONS.search,
...
var List = proxyCustomElement(class List2 extends H {
  ...
  render() {
    ...
    return h(InteractiveContainer, {
      ...
      key: "5e99dc8b479c35609c5f0318723b3da84ec23ef4",
      class: CSS4.container
    }, this.dragEnabled ? h("span", {
      "aria-live": "assertive",
      class: CSS4.assistiveText
    }, this.assistiveText) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", {
      class: CSS4.scrim,
      loading
    }) : null, h("table", {
      key: "a31ba050d3141351e491141365e8244ed3ca5303",
      "aria-busy": toAriaBoolean(loading),
      "aria-label": label || "",
      class: CSS4.table,
      onKeyDown: this.handleListKeydown,
      role: "treegrid"
    }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? h("thead", {
      class: CSS4.sticky
    }, h("tr", null, h("th", {
      colSpan: MAX_COLUMNS
    }, h("calcite-stack", {
      ...
      name: SLOTS2.filterActionsStart,
  ...
  renderItemAriaLive() {
    ...
    return !parentListEl ? h("div", {
      "aria-live": "polite",
      class: CSS4.assistiveText
    }, filterEnabled && filterText && filteredData?.length ? h("div", {
      key: "aria-filter-enabled"
    }, messages.filterEnabled) : null, h("div", {
      key: "aria-item-count"
    }, messages.total.replace("{count}", numberStringFormatter.localize(filteredItems.length.toString()))), filteredItems.length ? h("ol", {
      key: "aria-item-list"
    }, filteredItems.map((item) => h("li", null, item.label))) : null) : null;
  }
  connectObserver() {
  ...
  handleNudgeEvent(event) {
    ...
    const dragEl2 = composedPath.find((el) => el?.tagName && el.matches(dragSelector));
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-IDJ56B53.js.map
