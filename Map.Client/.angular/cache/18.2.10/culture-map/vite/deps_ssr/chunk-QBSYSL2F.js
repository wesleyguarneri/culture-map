...
function r2(l, e, o2) {
  return __async(this, null, function* () {
    ...
    return (yield Promise.all(a2.map((o3, n2) => __async(this, null, function* () {
      return {
        value: o3,
        color: "opacity" === l.type ? yield t(o3, l, e) : (yield import("./visualVariableUtils-ZQZWRVTQ.js")).getColor(l, o3),
        label: r3 ? u3[n2] : c?.[n2] ?? ""
      };
    })))).reverse();
  });
...
function t(e, n2, r3) {
  return __async(this, null, function* () {
    const t2 = new u(r3 ?? o), a2 = (yield import("./visualVariableUtils-ZQZWRVTQ.js")).getOpacity(n2, e);
...
//# sourceMappingURL=chunk-QBSYSL2F.js.map
