...
function queryElementRoots(el, {
  ...
  return found || queryElementRoots(getHost(rootNode), {
    selector,
    id
  });
}
...
function queryMultiple(element, slotSelector, options) {
  ...
  matches2 = options?.matches ? matches2.filter((el) => el?.matches(options.matches)) : matches2;
...
function whenTransitionDone(targetEl, transitionProp, onStart, onEnd) {
  return __async(this, null, function* () {
    return whenTransitionOrAnimationDone(targetEl, transitionProp, "transition", onStart, onEnd);
  });
}
function whenTransitionOrAnimationDone(targetEl, transitionPropOrAnimationName, type, onStart, onEnd) {
  return __async(this, null, function* () {
...
@esri/calcite-components/dist/components/dom.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-AHYZNZSK.js.map
