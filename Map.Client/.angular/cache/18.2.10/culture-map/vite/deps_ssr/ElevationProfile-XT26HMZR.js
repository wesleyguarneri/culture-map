...
import {
  n as n7
} from "./chunk-6WPN45VZ.js";
import {
  e as e10
} from "./chunk-OBEJKP6E.js";
import {
  pe
...
function y2(e14, t5, s8, o10, a7, i8, h5) {
  return __async(this, null, function* () {
    ...
    if (!v7) {
      const {
        planarLength: t6
      } = yield import("./geometryEngineAsync-B5I5LOGI.js");
...
var p6 = class extends S {
  ...
  _show(i8, o10) {
    this._loadingTask = e(this._loadingTask), this._loadingTask = d2((t5) => __async(this, null, function* () {
      if ("2d" === i8.type) {
        const e14 = import("./ElevationProfileView2D-2CCZIGRU.js"), s8 = (yield h(e14, t5)).ElevationProfileView2D;
        this._implementation = new s8(i8, o10);
      } else if ("3d" === i8.type) {
        const e14 = import("./ElevationProfileView3D-P6UOFU66.js"), s8 = (yield h(e14, t5)).ElevationProfileView3D;
        this._implementation = new s8(i8, o10);
      }
    }));
  }
...
var j6 = class extends B {
  ...
  _initializeChart(t5) {
    e(this._chartInitTask), this._chartInitTask = d2((e14) => __async(this, null, function* () {
      const {
        createChart: i8
      } = yield import("./chartUtils-BR3MQLOE.js");
      s(e14);
      const n11 = yield i8({
        container: t5,
        abortOptions: {
...
//# sourceMappingURL=ElevationProfile-XT26HMZR.js.map
