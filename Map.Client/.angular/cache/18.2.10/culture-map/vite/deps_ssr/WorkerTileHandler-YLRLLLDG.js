...
import {
  ...
  l as l3,
  t as t3
} from "./chunk-YP4QSIWZ.js";
import "./chunk-ZU246SKZ.js";
import {
  E,
  I
} from "./chunk-LWQIYZ7J.js";
import {
  a as a3,
  l as l2,
  m,
...
var h3 = 17;
var l4 = class {
  constructor(t5, e5, i6, o6, s6, c5, h5) {
    this._glyphItems = t5, this._maxWidth = e5, this._lineHeight = i6, this._letterSpacing = o6, this._hAnchor = s6, this._vAnchor = c5, this._justify = h5;
  }
  getShaping(s6, c5, h5) {
    ...
    for (const t5 of s6) {
      ...
      const i6 = h5 && e4(e5);
      let s7;
      for (const t6 of this._glyphItems) if (s7 = t6[e5], s7) break;
      m2.push({
        codePoint: e5,
        x: f3,
        y: p4,
    ...
    for (let e5 = 0; e5 < x2 - 1; e5++) {
      const o6 = m2[e5].codePoint, s7 = c3(o6);
      if (s3(o6) || s7) {
        let t5 = 0;
        if (10 === o6) t5 -= 1e4;
    ...
    for (let t5 = 0; t5 < u4.length; t5++) {
      const i6 = u4[t5];
      let o6 = I4;
      for (; o6 < i6 && a4(m2[o6].codePoint); ) m2[o6].glyphMosaicItem = null, ++o6;
      let s7 = i6 - 1;
      for (; s7 > o6 && a4(m2[s7].codePoint); ) m2[s7].glyphMosaicItem = null, --s7;
      if (o6 <= s7) {
        const t6 = m2[o6].x;
        for (let i7 = o6; i7 <= s7; i7++) m2[i7].x -= t6, m2[i7].y = p4;
        let e5 = m2[s7].x;
    ...
    if (m2.length > 0) {
      ...
      c5 && t5 && (i6 += t5 * n5);
      for (const o6 of m2) o6.x += e5, o6.y += i6;
    }
    return m2.filter((t5) => t5.glyphMosaicItem);
  }
  static getTextBox(t5, e5) {
    if (!t5.length) return null;
    let i6 = 1 / 0, o6 = 1 / 0, s6 = 0, c5 = 0;
    for (const l6 of t5) {
      const t6 = l6.glyphMosaicItem.metrics.advance, n5 = l6.x, a6 = l6.y - h3, r6 = n5 + t6, m2 = a6 + e5;
      i6 = Math.min(i6, n5), s6 = Math.max(s6, r6), o6 = Math.min(o6, a6), c5 = Math.max(c5, m2);
    }
    return {
      x: i6,
      y: o6,
  ...
  static getBox(t5) {
    ...
    for (const c5 of t5) {
      const {
        ...
        top: l6,
        width: n5
      } = c5.glyphMosaicItem.metrics, a6 = c5.x, r6 = c5.y - (t6 - Math.abs(l6)), m2 = a6 + n5 + h5, f3 = r6 + t6;
  ...
  static addDecoration(t5, e5) {
    ...
    for (let n5 = 1; n5 < i6; n5++) {
      ...
      if (i7.y !== h5) {
        ...
        }), h5 = i7.y, c5 = i7.x + i7.glyphMosaicItem.metrics.left;
      }
    }
    const l6 = t5[i6 - 1].x + t5[i6 - 1].glyphMosaicItem.metrics.left + t5[i6 - 1].glyphMosaicItem.metrics.width;
    t5.push({
      codePoint: 0,
      x: c5,
      y: h5 + e5 - o6,
  ...
  _buildBreak(t5, e5, i6, o6, s6, c5) {
    let h5 = null, l6 = this._breakScore(e5, i6, s6, c5);
    for (const n5 of o6) {
      const t6 = e5 - n5.x, o7 = this._breakScore(t6, i6, s6, c5) + n5.score;
      o7 <= l6 && (h5 = n5, l6 = o7);
    }
    return {
      index: t5,
  ...
  _applyJustification(t5, e5, i6) {
    const o6 = t5[i6], s6 = o6.vertical ? c4 : o6.glyphMosaicItem ? o6.glyphMosaicItem.metrics.advance : 0, h5 = (o6.x + s6) * this._justify;
    for (let c5 = e5; c5 <= i6; c5++) t5[c5].x -= h5;
  }
};
...
var f2 = class {
  constructor(e5, t5, i6, s6, o6, a6 = w, l6 = r) {
    this.anchor = e5, this.labelAngle = t5, this.glyphAngle = i6, this.page = s6, this.alternateVerticalGlyph = o6, this.minzoom = a6, this.maxzoom = l6;
  }
};
var I2 = class {
  constructor(e5, t5, i6, n5, s6, o6, a6, l6, h5, r6, c5, g2) {
    this.tl = e5, this.tr = t5, this.bl = i6, this.br = n5, this.mosaicRect = s6, this.labelAngle = o6, this.minAngle = a6, this.maxAngle = l6, this.anchor = h5, this.minzoom = r6, this.maxzoom = c5, this.page = g2;
  }
};
var u2 = class {
  constructor(e5) {
...
var b2 = class {
  ...
  _addIconPlacement(t5, i6, s6, o6, a6) {
    ...
    if (t5.shapes.push(M), (!o6.allowOverlap || !o6.ignorePlacement) && o2) {
      const e5 = o6.size, s7 = o6.padding, l7 = {
        xTile: i6.x,
        yTile: i6.y,
        dxPixels: x2 * e5 - s7,
        dyPixels: d2 * e5 - s7,
  ...
  getTextPlacement(s6, o6, a6, c5) {
    ...
    let B = false;
    for (const e5 of o6) if (e5.vertical) {
      B = true;
      break;
    }
    let H, V = 0, j = 0;
    if (!k && B) {
      const e5 = l4.getTextBox(o6, c5.lineHeight * c4);
      switch (c5.anchor) {
        case m.LEFT:
    ...
    for (const t5 of o6) {
      ...
      if (k) {
        ...
        if (O2 = this._placeGlyph(s6, O2, i6, a6, s6.segment, 1, t5.vertical, g2, m2), b4 && (O2 = this._placeGlyph(s6, O2, i6, a6, s6.segment, -1, t5.vertical, g2, m2)), O2 >= T) break;
      ...
      if (!k && B) {
        if (t5.vertical) {
          ...
          q = new h(-i6 - G + V, t6 - G + j), U2 = new h(q.x + l6.width, q.y + l6.height), D = new h(q.x, U2.y), J = new h(U2.x, q.y);
      ...
      for (const i6 of m2) {
        ...
        if (0 !== x3) {
          ...
          n5 = n5.clone(), o8 = o8?.clone(), a7 = a7?.clone(), r6 = r6?.clone(), n5.rotate(e5, t6), r6?.rotate(e5, t6), o8?.rotate(e5, t6), a7?.rotate(e5, t6);
        }
        let p4 = 0, w2 = 256;
        if (k && B ? t5.vertical ? i6.alternateVerticalGlyph ? (p4 = 32, w2 = 96) : (p4 = 224, w2 = 32) : (p4 = 224, w2 = 96) : (p4 = 192, w2 = 64), E2.push(new I2(n5, a7, o8, r6, l6, i6.labelAngle, p4, w2, i6.anchor, i6.minzoom, i6.maxzoom, i6.page)), M && (!v || this._legible(i6.labelAngle))) {
  ...
  _placeGlyph(t5, s6, l6, h5, r6, c5, g2, m2, x2) {
    ...
    for (; ; ) {
      const e5 = y2.x - T2.x, t6 = y2.y - T2.y, i6 = Math.sqrt(e5 * e5 + t6 * t6), n5 = Math.max(l6 / i6, s6), c6 = e5 / i6, u4 = t6 / i6, b4 = a2(Math.atan2(u4, c6) + w2, e2);
...
var o4 = class extends t3 {
  ...
  add(t5, o6, r6, u4, h5, a6, n5, d2, e5, p4, i6, c5) {
    const M = this.array;
    let l6 = t3.i1616to32(t5, o6);
    M.push(l6);
    const m2 = 31;
    l6 = t3.i8888to32(Math.round(m2 * r6), Math.round(m2 * u4), Math.round(m2 * h5), Math.round(m2 * a6)), M.push(l6), l6 = t3.i8888to32(Math.round(m2 * n5), Math.round(m2 * d2), Math.round(m2 * e5), Math.round(m2 * p4)), M.push(l6), l6 = t3.i1616to32(i6, 0), M.push(l6), c5 && M.push(...c5);
  }
};
...
var h4 = class extends t3 {
  ...
  add(o6, r6, u4, h5, a6, n5, d2, e5, p4, i6, c5, M) {
    const l6 = this.array;
    let m2 = t3.i1616to32(o6, r6);
    l6.push(m2), m2 = t3.i1616to32(Math.round(8 * u4), Math.round(8 * h5)), l6.push(m2), m2 = t3.i8888to32(a6 / 4, n5 / 4, e5, p4), l6.push(m2), m2 = t3.i8888to32(0, f(d2), 10 * i6, Math.min(10 * c5, 255)), l6.push(m2), M && l6.push(...M);
  }
};
...
var r4 = class extends t4 {
  constructor(t5, r6, i6, c5, s6) {
    super(t5, r6, i6), this.type = E.CIRCLE, this._circleVertexBuffer = c5, this._circleIndexBuffer = s6;
  }
  ...
  processFeatures(e5) {
    ...
    const i6 = this.layer, c5 = this.zoom;
    e5 && e5.setExtent(this.layerExtent);
    for (const s6 of this._features) {
      const n5 = s6.getGeometry(e5);
      if (!n5) continue;
      const l6 = i6.circleMaterial.encodeAttributes(s6, c5, i6);
      for (const e6 of n5) if (e6) for (const i7 of e6) {
        const e7 = t5.index;
        t5.add(i7.x, i7.y, 0, 0, l6), t5.add(i7.x, i7.y, 0, 1, l6), t5.add(i7.x, i7.y, 1, 0, l6), t5.add(i7.x, i7.y, 1, 1, l6), r6.add(e7, e7 + 1, e7 + 2), r6.add(e7 + 1, e7 + 2, e7 + 3), this._circleIndexCount += 6;
      }
    }
  }
  serialize() {
    ...
    for (let c5 = 0; c5 < this.layerUIDs.length; c5++) t5[i6++] = this.layerUIDs[c5];
    t5[i6++] = this._circleIndexStart, t5[i6++] = this._circleIndexCount, t5[i6++] = this._circleVertexBuffer.array.length;
    for (let c5 = 0; c5 < this._circleVertexBuffer.array.length; c5++) r6[i6++] = this._circleVertexBuffer.array[c5];
    t5[i6++] = this._circleIndexBuffer.array.length;
    for (let c5 = 0; c5 < this._circleIndexBuffer.array.length; c5++) t5[i6++] = this._circleIndexBuffer.array[c5];
    return t5.buffer;
  }
};
...
var s4 = class _s extends t4 {
  ...
  getResources(t5, e5, i6) {
    ...
    if (n5) if (n5.isDataDriven) for (const s6 of this._features) e5(n5.getValue(l6, s6), true);
    else e5(n5.getValue(l6), true);
  }
  processFeatures(t5) {
    ...
    const e5 = this.layer, i6 = this.zoom, {
      fillMaterial: r6,
      outlineMaterial: l6,
      hasDataDrivenFill: n5,
      hasDataDrivenOutline: s6
    } = e5;
    t5 && t5.setExtent(this.layerExtent);
    const o6 = e5.getPaintProperty("fill-pattern"), a6 = o6?.isDataDriven;
    ...
    const u4 = this._features, d2 = t5?.validateTessellation;
    if (a6) {
      const n6 = [];
      for (const a7 of u4) {
        const u5 = o6.getValue(i6, a7), h5 = this._spriteInfo[u5];
        if (!h5?.rect) continue;
        const x2 = r6.encodeAttributes(a7, i6, e5, h5), c5 = f3 && s6 ? l6.encodeAttributes(a7, i6, e5) : [], _2 = a7.getGeometry(t5);
        n6.push({
          ddFillAttributes: x2,
          ddOutlineAttributes: c5,
          page: h5.page,
          geometry: _2
        }), n6.sort((t6, e6) => t6.page - e6.page);
        for (const {
          ddFillAttributes: t6,
          ddOutlineAttributes: i7,
          page: r7,
          geometry: l7
        } of n6) this._processFeature(l7, f3, e5.outlineUsesFillColor, t6, i7, d2, r7);
      }
    } else for (const h5 of u4) {
      const o7 = n5 ? r6.encodeAttributes(h5, i6, e5) : null, a7 = f3 && s6 ? l6.encodeAttributes(h5, i6, e5) : null, u5 = h5.getGeometry(t5);
  ...
  serialize() {
    ...
    for (let s6 = 0; s6 < this.layerUIDs.length; s6++) e5[r6++] = this.layerUIDs[s6];
    ...
    if (e5[r6++] = n5, n5 > 0) for (const [s6, [o6, a6]] of l6) e5[r6++] = s6, e5[r6++] = o6, e5[r6++] = a6;
    ...
    for (let s6 = 0; s6 < this._fillIndexBuffer.array.length; s6++) e5[r6++] = this._fillIndexBuffer.array[s6];
    ...
    for (let s6 = 0; s6 < this._outlineIndexBuffer.array.length; s6++) e5[r6++] = this._outlineIndexBuffer.array[s6];
    return e5.buffer;
  }
  _processFeature(t5, e5, i6, r6, l6, n5, o6) {
    if (!t5) return;
    const a6 = t5.length, f3 = !l6 || 0 === l6.length;
    if (e5 && (!i6 || f3)) for (let s6 = 0; s6 < a6; s6++) this._processOutline(t5[s6], l6);
    const u4 = 32;
    let d2;
  ...
  _processOutline(t5, e5) {
    const i6 = this._outlineVertexBuffer, l6 = this._outlineIndexBuffer, n5 = l6.index;
    let s6, o6, a6;
    ...
    if (!(I4 - p4 < 2)) {
      for (let r6 = p4; r6 < I4; ++r6) {
        ...
        V > 8 && (V = 8), B2 >= 0 ? (c5 = i6.add(o6.x, o6.y, f3.x, f3.y, 0, 1, e5), -1 === _2 && (_2 = c5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i6.add(o6.x, o6.y, V * -d2.x, V * -d2.y, 0, -1, e5), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = x2, x2 = c5, c5 = i6.add(o6.x, o6.y, d2.x, d2.y, 0, 1, e5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i6.add(o6.x, o6.y, u4.x, u4.y, 0, 1, e5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5)) : (c5 = i6.add(o6.x, o6.y, V * d2.x, V * d2.y, 0, 1, e5), -1 === _2 && (_2 = c5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i6.add(o6.x, o6.y, -f3.x, -f3.y, 0, -1, e5), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = x2, x2 = c5, c5 = i6.add(o6.x, o6.y, -d2.x, -d2.y, 0, -1, e5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = i6.add(o6.x, o6.y, -u4.x, -u4.y, 0, -1, e5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5));
      }
  ...
  _processFill(r6, l6, n5, s6, o6) {
    ...
    for (const t5 of l6) {
      ...
      for (let t6 = 0; t6 < i6; ++t6) d2.push(e5[t6].x, e5[t6].y);
    }
    const h5 = i2(d2, a6, 2);
    if (s6 && i2.deviation(d2, a6, 2, h5) > 0) {
      const t5 = l6.map((t6) => r6[t6].length), {
        buffer: e5,
        vertexCount: s7
      } = a(d2, t5);
      if (s7 > 0) {
        const t6 = this._fillVertexBuffer.index;
        for (let i6 = 0; i6 < s7; i6++) this._fillVertexBuffer.add(e5[2 * i6], e5[2 * i6 + 1], n5);
      ...
      if (t5 > 0) {
        ...
        let i6 = 0;
        for (; i6 < u4; ) this._fillVertexBuffer.add(d2[i6++], d2[i6++], n5);
        let r7 = 0;
        for (; r7 < t5; ) this._fillIndexBuffer.add(e5 + h5[r7++], e5 + h5[r7++], e5 + h5[r7++]);
        if (void 0 !== o6) {
  ...
  static _area(t5) {
    ...
    for (let r6 = 0; r6 < i6; r6++) e5 += (t5[r6].x - t5[r6 + 1].x) * (t5[r6].y + t5[r6 + 1].y);
...
var n4 = class extends t4 {
  constructor(t5, s6, n5, a6, o6) {
    super(t5, s6, n5), this.type = E.LINE, this._tessellationOptions = {
      pixelCoordRatio: 8,
      halfWidth: 0,
      offset: 0
      ...
      _ddValues: null
    }, this.tessellationProperties._lineVertexBuffer = a6, this.tessellationProperties._lineIndexBuffer = o6, this._lineTessellator = new c2(r5(this.tessellationProperties), l5(this.tessellationProperties), t5.canUseThinTessellation);
  }
  get lineIndexStart() {
  ...
  getResources(e5, t5, i6) {
    ...
    if (!r6 && !l6) return;
    const o6 = a6?.getValue(n5) || 0, u4 = a6?.isDataDriven, f3 = r6?.isDataDriven, h5 = l6?.isDataDriven;
    if (f3 || h5) for (const p4 of this._features) t5(f3 ? r6.getValue(n5, p4) : this._getDashArrayKey(p4, n5, s6, l6, u4, a6, o6));
      ...
      const e6 = l6.getValue(n5);
      t5(s6.getDashKey(e6, o6));
    }
  }
  processFeatures(e5) {
    this._lineIndexStart = 3 * this.tessellationProperties._lineIndexBuffer.index, this._lineIndexCount = 0;
    const t5 = this.layer, i6 = this.zoom, s6 = this._features, n5 = this._tessellationOptions, {
      hasDataDrivenLine: r6,
      lineMaterial: l6
    } = t5;
    e5 && e5.setExtent(this.layerExtent);
    const a6 = t5.getPaintProperty("line-pattern"), o6 = t5.getPaintProperty("line-dasharray"), u4 = a6?.isDataDriven, f3 = o6?.isDataDriven;
    let h5;
    h5 = t5.getLayoutProperty("line-cap");
    const p4 = h5?.isDataDriven ? h5 : null, g2 = p4 ? null : t5.getLayoutValue("line-cap", i6), y2 = g2 || 0, d2 = !!p4;
    h5 = t5.getLayoutProperty("line-join");
    const c5 = h5?.isDataDriven ? h5 : null, _2 = c5 ? null : t5.getLayoutValue("line-join", i6);
    h5 = t5.getLayoutProperty("line-miter-limit");
    const x2 = h5?.isDataDriven ? h5 : null, V = x2 ? null : t5.getLayoutValue("line-miter-limit", i6);
    h5 = t5.getLayoutProperty("line-round-limit");
    const m2 = h5?.isDataDriven ? h5 : null, D = m2 ? null : t5.getLayoutValue("line-round-limit", i6);
    h5 = t5.getPaintProperty("line-width");
    const P = h5?.isDataDriven ? h5 : null, I4 = P ? null : t5.getPaintValue("line-width", i6);
    h5 = t5.getPaintProperty("line-offset");
    const L2 = h5?.isDataDriven ? h5 : null, B = L2 ? null : t5.getPaintValue("line-offset", i6);
    if (u4 || f3) {
      const r7 = [];
      for (const n6 of s6) {
        const s7 = u4 ? a6.getValue(i6, n6) : this._getDashArrayKey(n6, i6, t5, o6, d2, p4, y2), f4 = this._spriteInfo[s7];
        if (!f4?.rect) continue;
        const h6 = l6.encodeAttributes(n6, i6, t5, f4), v = n6.getGeometry(e5);
        r7.push({
          ddAttributes: h6,
          page: f4.page,
          cap: p4 ? p4.getValue(i6, n6) : g2,
          join: c5 ? c5.getValue(i6, n6) : _2,
          miterLimit: x2 ? x2.getValue(i6, n6) : V,
          roundLimit: m2 ? m2.getValue(i6, n6) : D,
          halfWidth: 0.5 * (P ? P.getValue(i6, n6) : I4),
          offset: L2 ? L2.getValue(i6, n6) : B,
          geometry: v
        });
      }
      ...
      for (const {
        ...
        offset: u5,
        geometry: f4
      } of r7) n5.capType = i7, n5.joinType = s7, n5.miterLimit = l7, n5.roundLimit = a7, n5.halfWidth = o7, n5.offset = u5, this._processFeature(f4, e6, t6);
    } else {
      if (a6) {
      ...
      for (const a7 of s6) {
        const s7 = r6 ? l6.encodeAttributes(a7, i6, t5) : null;
        p4 && (n5.capType = p4.getValue(i6, a7)), c5 && (n5.joinType = c5.getValue(i6, a7)), x2 && (n5.miterLimit = x2.getValue(i6, a7)), m2 && (n5.roundLimit = m2.getValue(i6, a7)), P && (n5.halfWidth = 0.5 * P.getValue(i6, a7)), L2 && (n5.offset = L2.getValue(i6, a7));
  ...
  serialize() {
    ...
    for (let l6 = 0; l6 < this.tessellationProperties._lineVertexBuffer.array.length; l6++) i6[s6++] = this.tessellationProperties._lineVertexBuffer.array[l6];
  ...
  _processFeature(e5, t5, i6) {
    if (!e5) return;
    const s6 = e5.length;
    for (let n5 = 0; n5 < s6; n5++) this._processGeometry(e5[n5], t5, i6);
  }
  _processGeometry(e5, t5, i6) {
    if (e5.length < 2) return;
    const n5 = 1e-3;
    let r6, l6, a6 = e5[0], o6 = 1;
    for (; o6 < e5.length; ) r6 = e5[o6].x - a6.x, l6 = e5[o6].y - a6.y, r6 * r6 + l6 * l6 < n5 * n5 ? e5.splice(o6, 1) : (a6 = e5[o6], ++o6);
    if (e5.length < 2) return;
  ...
  _getDashArrayKey(e5, t5, i6, s6, n5, r6, l6) {
    const a6 = n5 ? r6.getValue(t5, e5) : l6, o6 = s6.getValue(t5, e5);
    return i6.getDashKey(o6, a6);
  }
};
var r5 = (e5) => (t5, i6, s6, n5, r6, l6, a6, o6, u4, f3, h5) => (e5._lineVertexBuffer.add(t5, i6, a6, o6, s6, n5, r6, l6, u4, f3, h5, e5._ddValues), e5._lineVertexBuffer.index - 1);
var l5 = (e5) => (t5, i6, s6) => {
...
var L = class _L extends t4 {
  ...
  getResources(e5, t5, i6) {
    ...
    for (const m2 of this._features) {
      ...
      if (!p4 && !_2) continue;
      const P = s6.getLayoutValue("symbol-sort-key", a6, m2), I4 = {
        feature: m2,
        sprite: p4,
        label: _2,
        rtl: M,
        geometry: u4,
        hash: (_2 ? l(_2) : 0) ^ (p4 ? l(p4) : 0),
        priority: P,
        textFont: g2
      };
      x2.push(I4);
  ...
  processFeatures(e5) {
    ...
    for (const o6 of this._symbolFeatures) {
      ...
      if (y3) {
        ...
        const e7 = r6 && T2.rotationAlignment === l2.MAP ? T2.keepUpright : T2.writingMode && T2.writingMode.includes(p2.VERTICAL);
        let i6 = 0.5;
        switch (T2.anchor) {
          case m.TOP_LEFT:
          case m.LEFT:
        ...
        const x2 = T2.letterSpacing * c4, c5 = r6 ? 0 : T2.maxWidth * c4, m2 = T2.lineHeight * c4, P = o6.textFont.map((e8) => V.getGlyphItems(e8));
        if (n6 = new l4(P, c5, m2, x2, i6, a7, l7).getShaping(y3, o6.rtl, e7), n6 && n6.length > 0) {
          let e8 = 1e30, t5 = -1e30;
          for (const i7 of n6) e8 = Math.min(e8, i7.x), t5 = Math.max(t5, i7.x);
          g3 = (t5 - e8 + 2 * c4) * C2 * p3;
        }
      }
      for (let t5 of o6.geometry) {
        const s7 = [];
        if (a6 === n3.LINE) {
          if (n6?.length && T2?.size) {
            const e7 = T2.size * p3 * (2 + Math.min(2, 4 * Math.abs(T2.offset[1])));
            t5 = _L._smoothVertices(t5, e7);
          }
          _L._pushAnchors(s7, t5, l6, g3);
        } else a6 === n3.LINE_CENTER ? _L._pushCenterAnchor(s7, t5) : o6.feature.type === i3.Polygon ? _L._pushCentroid(s7, t5) : s7.push(new y(t5[0].x, t5[0].y));
        for (const i6 of s7) {
          if (i6.x < 0 || i6.x > x || i6.y < 0 || i6.y > x) continue;
          if (r6 && g3 > 0 && T2?.rotationAlignment === l2.MAP && !_L._honorsTextMaxAngle(t5, i6, g3, R, D)) continue;
          const s8 = {
            shaping: n6,
            line: t5,
            iconMosaicItem: e6,
  ...
  static _symbolsSerializationLength(e5) {
    ...
    for (const n5 of e5 || []) {
      t5 += 5, t5 += 1;
      for (const e6 of n5.textColliders) t5 += b3;
      for (const e6 of n5.iconColliders) t5 += b3;
  ...
  static serializeSymbols(e5, t5, n5, i6, s6) {
    ...
    for (const a6 of s6) {
      ...
      for (const e6 of a6.textColliders) t5[i6++] = e6.xTile, t5[i6++] = e6.yTile, t5[i6++] = e6.dxPixels, t5[i6++] = e6.dyPixels, t5[i6++] = e6.hard ? 1 : 0, t5[i6++] = e6.partIndex, n5[i6++] = e6.minLod, n5[i6++] = e6.maxLod, t5[i6++] = e6.width, t5[i6++] = e6.height;
      for (const e6 of a6.iconColliders) t5[i6++] = e6.xTile, t5[i6++] = e6.yTile, t5[i6++] = e6.dxPixels, t5[i6++] = e6.dyPixels, t5[i6++] = e6.hard ? 1 : 0, t5[i6++] = e6.partIndex, n5[i6++] = e6.minLod, n5[i6++] = e6.maxLod, t5[i6++] = e6.width, t5[i6++] = e6.height;
      t5[i6++] = a6.textVertexRanges.length;
      for (const [e6, n6] of a6.textVertexRanges) t5[i6++] = e6, t5[i6++] = n6;
      t5[i6++] = a6.iconVertexRanges.length;
      for (const [e6, n6] of a6.iconVertexRanges) t5[i6++] = e6, t5[i6++] = n6;
    }
    return i6;
  }
  _replaceKeys(e5, t5) {
  ...
  _processFeature(e5, t5, n5) {
    const {
      ...
      shaping: a6,
      anchor: o6
    } = e5, l6 = this.zoom, h5 = this.layer, x2 = !!s6;
    let c5 = true;
    x2 && (c5 = t5?.optional || !s6);
    const d2 = a6 && a6.length > 0, f3 = !d2 || n5?.optional;
    let g2, y2;
    if (x2 && (g2 = this._placementEngine.getIconPlacement(o6, s6, t5)), (g2 || c5) && (d2 && (y2 = this._placementEngine.getTextPlacement(o6, a6, i6, n5)), y2 || f3)) {
      if (g2 && y2 || (f3 || c5 ? f3 || y2 ? c5 || g2 || (y2 = null) : g2 = null : (g2 = null, y2 = null)), y2) {
        const t6 = h5.hasDataDrivenText ? h5.textMaterial.encodeAttributes(e5.symbolFeature.feature, l6, h5) : null;
        if (this._storePlacedGlyphs(e5, y2.shapes, l6, n5.rotationAlignment, t6), y2.textColliders) {
          e5.textColliders = y2.textColliders;
          for (const e6 of y2.textColliders) {
            e6.minLod = Math.max(l6 + h2(e6.minLod), 0), e6.maxLod = Math.min(l6 + h2(e6.maxLod), 25);
            const t7 = e6.angle;
            if (t7) {
              const n6 = Math.cos(t7), i7 = Math.sin(t7), s7 = e6.dxPixels * n6 - e6.dyPixels * i7, a7 = e6.dxPixels * i7 + e6.dyPixels * n6, o7 = (e6.dxPixels + e6.width) * n6 - e6.dyPixels * i7, r6 = (e6.dxPixels + e6.width) * i7 + e6.dyPixels * n6, l7 = e6.dxPixels * n6 - (e6.dyPixels + e6.height) * i7, h6 = e6.dxPixels * i7 + (e6.dyPixels + e6.height) * n6, x3 = (e6.dxPixels + e6.width) * n6 - (e6.dyPixels + e6.height) * i7, c6 = (e6.dxPixels + e6.width) * i7 + (e6.dyPixels + e6.height) * n6, d3 = Math.min(s7, o7, l7, x3), f4 = Math.max(s7, o7, l7, x3), g3 = Math.min(a7, r6, h6, c6), y3 = Math.max(a7, r6, h6, c6);
      ...
      if (g2) {
        const n6 = h5.hasDataDrivenIcon ? h5.iconMaterial.encodeAttributes(e5.symbolFeature.feature, l6, h5) : null;
        if (this._addPlacedIcons(e5, g2.shapes, l6, s6.page, t5.rotationAlignment === l2.VIEWPORT, n6), g2.iconColliders) {
          e5.iconColliders = g2.iconColliders;
          for (const e6 of g2.iconColliders) {
            e6.minLod = Math.max(l6 + h2(e6.minLod), 0), e6.maxLod = Math.min(l6 + h2(e6.maxLod), 25);
            const t6 = e6.angle;
            if (t6) {
              const n7 = Math.cos(t6), i7 = Math.sin(t6), s7 = e6.dxPixels * n7 - e6.dyPixels * i7, a7 = e6.dxPixels * i7 + e6.dyPixels * n7, o7 = (e6.dxPixels + e6.width) * n7 - e6.dyPixels * i7, r6 = (e6.dxPixels + e6.width) * i7 + e6.dyPixels * n7, l7 = e6.dxPixels * n7 - (e6.dyPixels + e6.height) * i7, h6 = e6.dxPixels * i7 + (e6.dyPixels + e6.height) * n7, x3 = (e6.dxPixels + e6.width) * n7 - (e6.dyPixels + e6.height) * i7, c6 = (e6.dxPixels + e6.width) * i7 + (e6.dyPixels + e6.height) * n7, d3 = Math.min(s7, o7, l7, x3), f4 = Math.max(s7, o7, l7, x3), g3 = Math.min(a7, r6, h6, c6), y3 = Math.max(a7, r6, h6, c6);
              e6.dxPixels = d3, e6.dyPixels = g3, e6.width = f4 - d3, e6.height = y3 - g3;
            }
          }
        }
  ...
  _addPlacedIcons(e5, t5, n5, i6, s6, a6) {
    ...
    for (const c5 of t5) {
      ...
      l6.add(P.x, P.y, f3.x, f3.y, b4, A2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, g2.x, g2.y, L2, A2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, y2.x, y2.y, b4, T2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, m2.x, m2.y, L2, T2, p4, _2, M, t6, d2, a6), e5.iconVertexRanges.length > 0 && e5.iconVertexRanges[0][0] + e5.iconVertexRanges[0][1] === V ? e5.iconVertexRanges[0][1] += 4 : e5.iconVertexRanges.push([V, 4]), h5.add(I4, I4 + 1, I4 + 2), h5.add(I4 + 1, I4 + 2, I4 + 3), x2.has(i6) ? x2.get(i6)[1] += 6 : x2.set(i6, [this._iconIndexStart + this._iconIndexCount, 6]), this._iconIndexCount += 6;
    }
  }
  _addPlacedGlyphs() {
    ...
    for (const [i6, s6] of this._glyphBufferDataStorage) for (const a6 of s6) {
      const s7 = e5.index, o6 = a6.symbolInstance, r6 = a6.ddAttributes, l6 = e5.index;
  ...
  _storePlacedGlyphs(e5, t5, n5, i6, s6) {
    const a6 = Math.max(n5 - 1, 0), o6 = i6 === l2.VIEWPORT;
    ...
    for (const u4 of t5) {
      ...
      this._glyphBufferDataStorage.get(u4.page).push({
        glyphAnchor: [p4.x, p4.y],
        tl: [x2.x, x2.y],
        tr: [c5.x, c5.y],
        bl: [d2.x, d2.y],
        br: [f3.x, f3.y],
  ...
  static _pushAnchors(e5, t5, n5, i6) {
    ...
    for (let s6 = 0; s6 < f3; s6++) {
      ...
      for (; d2 + n5 < c5 + f4; ) {
        d2 += n5;
        const t6 = (d2 - c5) / f4, y2 = p(i7.x, a7.x, t6), m2 = p(i7.y, a7.y, t6);
  ...
  static _pushCenterAnchor(e5, t5) {
    let n5 = 0;
    const i6 = t5.length - 1;
    for (let l6 = 0; l6 < i6; l6++) n5 += h.distance(t5[l6], t5[l6 + 1]);
    const a6 = n5 / 2;
    let o6 = 0;
    const r6 = t5.length - 1;
    for (let s6 = 0; s6 < r6; s6++) {
      const n6 = t5[s6], i7 = t5[s6 + 1], r7 = i7.x - n6.x, h5 = i7.y - n6.y, c5 = Math.sqrt(r7 * r7 + h5 * h5);
      if (a6 < o6 + c5) {
        const t6 = (a6 - o6) / c5, d2 = p(n6.x, i7.x, t6), f3 = p(n6.y, i7.y, t6), g2 = Math.atan2(h5, r7);
  ...
  static _honorsTextMaxAngle(e5, t5, n5, i6, a6) {
    ...
    for (; o6 > -r6; ) {
      ...
      o6 -= h.distance(e5[h5], l6), l6 = e5[h5];
    }
    ...
    for (; o6 < r6; ) {
      ...
      for (x2.push({
        deviation: g2,
        distToAnchor: o6
      }), c5 += g2; o6 - x2[0].distToAnchor > a6; ) c5 -= x2.shift().deviation;
      if (Math.abs(c5) > i6) return false;
  ...
  static _smoothVertices(e5, t5) {
    ...
    if (n5 = o6 + 1, n5 < 3) return e5;
    t5 = Math.min(t5, 0.2 * a6);
    const r6 = e5[0].x, l6 = e5[0].y, h5 = e5[n5 - 1].x, x2 = e5[n5 - 1].y, c5 = h.sub(e5[0], e5[1]);
    c5.normalize(), e5[0].x += t5 * c5.x, e5[0].y += t5 * c5.y, c5.assignSub(e5[n5 - 1], e5[n5 - 2]), c5.normalize(), e5[n5 - 1].x += t5 * c5.x, e5[n5 - 1].y += t5 * c5.y, i6[0] -= t5, i6[n5 - 1] += t5;
    const d2 = [];
    d2.push(new h(r6, l6));
    ...
    for (let y2 = 1; y2 < n5 - 1; y2++) {
      ...
      for (let n6 = y2 - 1; n6 >= 0; n6--) {
        ...
        if (s6 < 0) break;
        const l7 = i6[n6 + 1] - i6[n6], h6 = i6[y2] - i6[n6] < g2 ? 1 : s6 / l7;
        if (h6 < f3) break;
        const x3 = h6 * h6, c6 = h6 * s6 - 0.5 * x3 * l7, d3 = h6 * l7 / t5, m2 = e5[n6 + 1], u4 = e5[n6].x - m2.x, p4 = e5[n6].y - m2.y;
      ...
      for (let s6 = y2 + 1; s6 < n5; s6++) {
        ...
        if (n6 < 0) break;
        const l7 = i6[s6] - i6[s6 - 1], h6 = i6[s6] - i6[y2] < g2 ? 1 : n6 / l7;
        if (h6 < f3) break;
        const x3 = h6 * h6, c6 = h6 * n6 - 0.5 * x3 * l7, d3 = h6 * l7 / t5, m2 = e5[s6 - 1], u4 = e5[s6].x - m2.x, p4 = e5[s6].y - m2.y;
    ...
    return d2.push(new h(h5, x2)), e5[0].x = r6, e5[0].y = l6, e5[n5 - 1].x = h5, e5[n5 - 1].y = x2, d2;
  }
  static _pushCentroid(e5, t5) {
    const n5 = 0, i6 = 0, s6 = 4096, a6 = 4096, o6 = t5.length - 1;
    let r6 = 0, l6 = 0, h5 = 0, c5 = t5[0].x, d2 = t5[0].y;
    c5 > s6 && (c5 = s6), c5 < n5 && (c5 = n5), d2 > a6 && (d2 = a6), d2 < i6 && (d2 = i6);
    for (let x2 = 1; x2 < o6; x2++) {
      ...
      const y2 = (e6 - c5) * (g2 - d2) - (f3 - c5) * (o7 - d2);
      r6 += y2 * (c5 + e6 + f3), l6 += y2 * (d2 + o7 + g2), h5 += y2;
    }
    r6 /= 3 * h5, l6 /= 3 * h5, isNaN(r6) || isNaN(l6) || e5.push(new y(r6, l6));
  }
};
L._bidiEngine = new C();
...
var g = class {
  constructor(t5, r6, o6, n5, l6, a6) {
    if (this._pbfTiles = {}, this._tileClippers = {}, this._client = o6, this._tile = r6, this._sourceDataMaxLOD = n5, a6) {
      ...
      for (const e5 of a6) this._styleLayerUIDs.add(e5);
    }
    this._styleRepository = l6, this._layers = this._styleRepository?.layers ?? [];
    ...
    for (const c5 of Object.keys(t5)) {
      ...
      if (r7.refKey) {
        ...
        if (t6 > 0) {
          ...
          this._tileClippers[c5] = new e(t6, r8, i6, 8, h5);
        }
      }
  ...
  parse(e5) {
    return __async(this, null, function* () {
      const t5 = i(), s6 = this._initialize(e5), {
        returnedBuckets: i6
      } = s6;
      this._processLayers(s6), this._linkReferences(s6), this._filterFeatures(s6);
      const o6 = [], c5 = /* @__PURE__ */ new Set(), n5 = (e6, t6) => {
        c5.has(e6) || (o6.push({
          name: e6,
          repeat: t6
        }), c5.add(e6));
      }, l6 = {};
      for (const r6 of i6) r6.getResources(r6.tileClipper, n5, l6);
      if (this._tile.status === I3.INVALID) return [];
      const a6 = this._fetchResources(o6, l6, e5);
  ...
  _processLayers(e5) {
    const {
      sourceNameToTileData: t5,
      zoom: r6,
      layers: s6,
      sourceNameToTileClipper: i6,
      sourceNameToUniqueSourceLayerBuckets: o6,
      sourceNameToUniqueSourceLayers: c5,
      returnedBuckets: n5,
      layerIdToBucket: l6,
      referencerUIDToReferencedId: a6
    } = e5, u4 = this._sourceDataMaxLOD;
    for (let f3 = s6.length - 1; f3 >= 0; f3--) {
      const e6 = s6[f3];
      if (r6 < u4) {
        if (e6.minzoom && r6 < Math.floor(e6.minzoom) || e6.maxzoom && r6 >= e6.maxzoom) continue;
      } else if (e6.maxzoom && r6 >= e6.maxzoom) continue;
      if (e6.type === a3.BACKGROUND || !this._canParseStyleLayer(e6.uid) || !t5[e6.source] || !i6[e6.source]) continue;
      const p4 = t5[e6.source], h5 = i6[e6.source], m2 = e6.sourceLayer, _2 = p4[m2];
      if (_2) {
        let t6 = c5[e6.source];
        if (t6 || (t6 = c5[e6.source] = /* @__PURE__ */ new Set()), t6.add(e6.sourceLayer), e6.refLayerId) a6.set(e6.uid, e6.refLayerId);
        else {
          ...
          if (t7) {
            ...
            r7 || (r7 = o6[e6.source] = {});
            let s7 = r7[m2];
            s7 || (s7 = r7[m2] = []), s7.push(t7), n5.push(t7), l6[e6.id] = t7;
          }
        }
      }
    }
  ...
  _linkReferences(e5) {
    const {
      layerIdToBucket: t5,
      referencerUIDToReferencedId: r6
    } = e5;
    r6.forEach((e6, r7) => {
  ...
  _filterFeatures(e5) {
    const {
      signal: r6,
      sourceNameToTileData: s6,
      sourceNameToUniqueSourceLayerBuckets: i6,
      sourceNameToUniqueSourceLayers: c5
    } = e5, n5 = 10 * this._level, l6 = 10 * (this._level + 1), a6 = [], u4 = [];
    ...
    for (let f3 = 0; f3 < a6.length; f3++) {
      const e6 = u4[f3], c6 = a6[f3];
      if (!s6[e6] || !i6[e6]) continue;
      const p4 = s6[e6][c6], h5 = i6[e6][c6];
  ...
  _fetchResources(e5, t5, r6) {
    ...
    for (const n5 in t5) {
      const e6 = t5[n5];
      e6.size > 0 && (c5 = i6.fetchGlyphs(this._tile.tileKey, n5, e6, this._client, r6), s6.push(c5));
    }
    return s6;
  }
  _processFeatures(e5) {
...
var i4 = class {
  ...
  parse(e5, s6) {
    return __async(this, null, function* () {
      ...
      const u4 = [...l6];
      let h5 = null;
      return o6.length > 0 && (h5 = Uint32Array.from(o6), u4.push(h5.buffer)), n5.emptyBuckets = h5, {
        result: n5,
        transferList: u4
      };
    });
...
var i5 = class {
  ...
  createTileAndParse(t5, r6) {
    return __async(this, null, function* () {
      ...
      try {
        return yield a6.parse(__spreadProps(__spreadValues({}, t5), {
  ...
  fetchSprites(e5, t5, s6) {
    ...
    return 0 === r6.length ? Promise.resolve() : t5.invoke("getSprites", r6, {
      signal: s6?.signal
    }).then((e6) => {
      for (const t6 in e6) {
        const s7 = e6[t6];
  ...
  fetchGlyphs(e5, t5, s6, r6, o6) {
    ...
    return a6 ? s6.forEach((e6) => {
      a6[e6] || i6.push(e6);
    }) : (a6 = this._glyphInfo[t5] = [], s6.forEach((e6) => i6.push(e6))), 0 === i6.length ? Promise.resolve() : r6.invoke("getGlyphs", {
      tileID: e5,
      font: t5,
      codePoints: i6
    }, o6).then((e6) => {
      for (let t6 = 0; t6 < e6.length; t6++) e6[t6] && (a6[t6] = e6[t6]);
    });
  }
  getGlyphItems(e5) {
...
//# sourceMappingURL=WorkerTileHandler-YLRLLLDG.js.map
