...
var c = class {
  constructor(t, e3, i2) {
    this._writeVertex = t, this._writeTriangle = e3, this._canUseThinTessellation = i2, this._prevNormal = {
      x: void 0,
      y: void 0
    }, this._nextNormal = {
      x: void 0,
...
function r2() {
  return __async(this, null, function* () {
    const s3 = has("esri-csp-restrictions") ? yield import("./libtess-asm-XQONOC7K.js").then((t) => t.l) : yield import("./libtess-6MISSJNT.js").then((t) => t.l);
    e2 = yield s3.default({
      locateFile: (s4) => n(`esri/core/libs/libtess/${s4}`)
    });
  });
}
function a2(t, n5) {
...
//# sourceMappingURL=chunk-QJK66QPF.js.map
